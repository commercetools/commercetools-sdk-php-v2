...
class Resource76 extends Resource
{
    ...
    public function email(): Resource77 {
        return new Resource77($this->getUri() . '/email', $this->getArgs());
    }
    /**
     * @return Resource79
     */
    public function password(): Resource79 {
        return new Resource79($this->getUri() . '/password', $this->getArgs());
    }
    /**
     * @return Resource81
     */
    public function signup(): Resource81 {
        return new Resource81($this->getUri() . '/signup', $this->getArgs());
    }
    /**
     * @return Resource82
     */
    public function login(): Resource82 {
        return new Resource82($this->getUri() . '/login', $this->getArgs());
    }
    /**
     * @return Resource83
     */
    public function activeCart(): Resource83 {
        return new Resource83($this->getUri() . '/active-cart', $this->getArgs());
    }
    /**
     * @return Resource84
     */
    public function carts(): Resource84 {
        return new Resource84($this->getUri() . '/carts', $this->getArgs());
    }
    /**
     * @return Resource86
     */
    public function orders(): Resource86 {
        return new Resource86($this->getUri() . '/orders', $this->getArgs());
    }
