...
class ShippingMethodAddShippingRateActionModel extends ShippingMethodUpdateActionModel implements ShippingMethodAddShippingRateAction {
    ...
    public function getShippingRate()
    {
        if (is_null($this->shippingRate)) {
            $value = $this->raw(ShippingMethodAddShippingRateAction::FIELD_SHIPPING_RATE);
            if (is_null($value)) {
    ...
    public function getZone()
    {
        if (is_null($this->zone)) {
            $value = $this->raw(ShippingMethodAddShippingRateAction::FIELD_ZONE);
            if (is_null($value)) {
