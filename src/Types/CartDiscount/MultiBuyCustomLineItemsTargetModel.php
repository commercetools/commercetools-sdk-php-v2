...
class MultiBuyCustomLineItemsTargetModel extends CartDiscountTargetModel implements MultiBuyCustomLineItemsTarget {
    ...
    public function getPredicate()
    {
        if (is_null($this->predicate)) {
            $value = $this->raw(MultiBuyCustomLineItemsTarget::FIELD_PREDICATE);
            $value = (string)$value;
    ...
    public function getTriggerQuantity()
    {
        if (is_null($this->triggerQuantity)) {
            $value = $this->raw(MultiBuyCustomLineItemsTarget::FIELD_TRIGGER_QUANTITY);
            $value = (int)$value;
    ...
    public function getDiscountedQuantity()
    {
        if (is_null($this->discountedQuantity)) {
            $value = $this->raw(MultiBuyCustomLineItemsTarget::FIELD_DISCOUNTED_QUANTITY);
            $value = (int)$value;
    ...
    public function getMaxOccurrence()
    {
        if (is_null($this->maxOccurrence)) {
            $value = $this->raw(MultiBuyCustomLineItemsTarget::FIELD_MAX_OCCURRENCE);
            $value = (int)$value;
    ...
    public function getSelectionMode()
    {
        if (is_null($this->selectionMode)) {
            $value = $this->raw(MultiBuyCustomLineItemsTarget::FIELD_SELECTION_MODE);
            $value = (string)$value;
