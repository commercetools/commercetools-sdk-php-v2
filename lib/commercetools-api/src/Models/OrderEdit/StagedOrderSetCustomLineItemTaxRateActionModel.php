...
final class StagedOrderSetCustomLineItemTaxRateActionModel extends JsonObjectModel implements StagedOrderSetCustomLineItemTaxRateAction
{
    ...
    public function getCustomLineItemId()
    {
        if (is_null($this->customLineItemId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(StagedOrderSetCustomLineItemTaxRateAction::FIELD_CUSTOM_LINE_ITEM_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getExternalTaxRate()
    {
        if (is_null($this->externalTaxRate)) {
            ...
            $data = $this->raw(StagedOrderSetCustomLineItemTaxRateAction::FIELD_EXTERNAL_TAX_RATE);
            if (is_null($data)) {
                return null;
            }
