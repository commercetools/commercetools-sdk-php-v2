...
/**
 * @implements Builder<StagedOrderSetShippingMethodAction>
 */
final class StagedOrderSetShippingMethodActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedOrderSetShippingMethodAction
    {
        return new StagedOrderSetShippingMethodActionModel(
    ...
    public static function of(): StagedOrderSetShippingMethodActionBuilder
    {
        return new self();
    }
}
