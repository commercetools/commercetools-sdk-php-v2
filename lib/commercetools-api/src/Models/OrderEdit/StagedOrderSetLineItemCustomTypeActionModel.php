...
final class StagedOrderSetLineItemCustomTypeActionModel extends JsonObjectModel implements StagedOrderSetLineItemCustomTypeAction
{
    ...
    public function getLineItemId()
    {
        if (is_null($this->lineItemId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(StagedOrderSetLineItemCustomTypeAction::FIELD_LINE_ITEM_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            ...
            $data = $this->raw(StagedOrderSetLineItemCustomTypeAction::FIELD_TYPE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderSetLineItemCustomTypeAction::FIELD_FIELDS);
            if (is_null($data)) {
                return null;
            }
