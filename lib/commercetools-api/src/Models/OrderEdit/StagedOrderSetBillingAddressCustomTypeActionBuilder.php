 ...
 */
final class StagedOrderSetBillingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedOrderSetBillingAddressCustomTypeAction
    {
        return new StagedOrderSetBillingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): StagedOrderSetBillingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
