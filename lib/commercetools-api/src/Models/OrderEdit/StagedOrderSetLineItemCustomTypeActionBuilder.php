 ...
 */
final class StagedOrderSetLineItemCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Line Item with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Line Item.</p>
    ...
    public function build(): StagedOrderSetLineItemCustomTypeAction
    {
        return new StagedOrderSetLineItemCustomTypeActionModel(
            $this->lineItemId,
            $this->lineItemKey,
    ...
    public static function of(): StagedOrderSetLineItemCustomTypeActionBuilder
    {
        return new self();
    }
}
