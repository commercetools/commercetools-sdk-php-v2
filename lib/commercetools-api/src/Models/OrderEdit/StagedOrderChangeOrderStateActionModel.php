...
final class StagedOrderChangeOrderStateActionModel extends JsonObjectModel implements StagedOrderChangeOrderStateAction
{
    ...
    final public function getOrderState()
    {
       if (is_null($this->orderState)) {
           /** @psalm-var ?string $data */
           $data = $this->raw(StagedOrderChangeOrderStateAction::FIELD_ORDER_STATE);
           if (is_null($data)) {
               return null;
           }
