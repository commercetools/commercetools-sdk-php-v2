...
/**
 * @implements Builder<OrderEditSetBillingAddressCustomTypeAction>
 */
final class OrderEditSetBillingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): OrderEditSetBillingAddressCustomTypeAction
    {
        return new OrderEditSetBillingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): OrderEditSetBillingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
