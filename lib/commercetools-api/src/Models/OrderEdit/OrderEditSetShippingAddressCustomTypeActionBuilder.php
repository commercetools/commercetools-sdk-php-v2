...
/**
 * @implements Builder<OrderEditSetShippingAddressCustomTypeAction>
 */
final class OrderEditSetShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): OrderEditSetShippingAddressCustomTypeAction
    {
        return new OrderEditSetShippingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): OrderEditSetShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
