...
/**
 * @implements Builder<StagedOrderSetDirectDiscountsAction>
 */
final class StagedOrderSetDirectDiscountsActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedOrderSetDirectDiscountsAction
    {
        return new StagedOrderSetDirectDiscountsActionModel(
            $this->discounts
        );
    }

    public static function of(): StagedOrderSetDirectDiscountsActionBuilder
    {
        return new self();
    }
}
