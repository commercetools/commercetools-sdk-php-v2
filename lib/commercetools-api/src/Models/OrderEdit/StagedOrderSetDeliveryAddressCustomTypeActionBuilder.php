 ...
 */
final class StagedOrderSetDeliveryAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the <a href="ctp:api:type:Delivery">Delivery</a> <code>address</code> with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the <a href="ctp:api:type:Delivery">Delivery</a> <code>address</code>.</p>
    ...
    public function build(): StagedOrderSetDeliveryAddressCustomTypeAction
    {
        return new StagedOrderSetDeliveryAddressCustomTypeActionModel(
            $this->deliveryId,
            $this->deliveryKey,
    ...
    public static function of(): StagedOrderSetDeliveryAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
