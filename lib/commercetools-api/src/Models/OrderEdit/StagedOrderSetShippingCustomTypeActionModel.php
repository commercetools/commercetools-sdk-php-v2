 ...
 * @internal
 */
final class StagedOrderSetShippingCustomTypeActionModel extends JsonObjectModel implements StagedOrderSetShippingCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'setShippingCustomType';
    /**
     *
     * @var ?string
     */
