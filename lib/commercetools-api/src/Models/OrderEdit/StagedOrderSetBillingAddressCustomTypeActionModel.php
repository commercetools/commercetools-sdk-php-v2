 ...
 * @internal
 */
final class StagedOrderSetBillingAddressCustomTypeActionModel extends JsonObjectModel implements StagedOrderSetBillingAddressCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'setBillingAddressCustomType';
    /**
     *
     * @var ?string
     */
