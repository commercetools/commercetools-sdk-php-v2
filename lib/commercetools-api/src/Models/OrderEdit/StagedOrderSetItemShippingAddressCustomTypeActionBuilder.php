 ...
 */
final class StagedOrderSetItemShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the <code>itemShippingAddress</code> with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the <code>itemShippingAddress</code>.</p>
    ...
    public function build(): StagedOrderSetItemShippingAddressCustomTypeAction
    {
        return new StagedOrderSetItemShippingAddressCustomTypeActionModel(
            $this->addressKey,
    ...
    public static function of(): StagedOrderSetItemShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
