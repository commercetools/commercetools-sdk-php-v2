...
final class StagedOrderTransitionLineItemStateActionModel extends JsonObjectModel implements StagedOrderTransitionLineItemStateAction
{
    ...
    public function getLineItemId()
    {
        if (is_null($this->lineItemId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(StagedOrderTransitionLineItemStateAction::FIELD_LINE_ITEM_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getQuantity()
    {
        if (is_null($this->quantity)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(StagedOrderTransitionLineItemStateAction::FIELD_QUANTITY);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getFromState()
    {
        if (is_null($this->fromState)) {
            ...
            $data = $this->raw(StagedOrderTransitionLineItemStateAction::FIELD_FROM_STATE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getToState()
    {
        if (is_null($this->toState)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderTransitionLineItemStateAction::FIELD_TO_STATE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getActualTransitionDate()
    {
        if (is_null($this->actualTransitionDate)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(StagedOrderTransitionLineItemStateAction::FIELD_ACTUAL_TRANSITION_DATE);
            if (is_null($data)) {
                return null;
            }
    ...
    {
        $data = $this->toArray();
        if (isset($data[StagedOrderTransitionLineItemStateAction::FIELD_ACTUAL_TRANSITION_DATE]) && $data[StagedOrderTransitionLineItemStateAction::FIELD_ACTUAL_TRANSITION_DATE] instanceof \DateTimeImmutable) {
            $data[StagedOrderTransitionLineItemStateAction::FIELD_ACTUAL_TRANSITION_DATE] = $data[StagedOrderTransitionLineItemStateAction::FIELD_ACTUAL_TRANSITION_DATE]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
