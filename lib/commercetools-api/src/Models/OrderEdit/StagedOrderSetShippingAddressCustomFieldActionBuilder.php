 ...
 */
final class StagedOrderSetShippingAddressCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): StagedOrderSetShippingAddressCustomFieldAction
    {
        return new StagedOrderSetShippingAddressCustomFieldActionModel(
            $this->name,
            $this->value
        );
    }

    public static function of(): StagedOrderSetShippingAddressCustomFieldActionBuilder
    {
        return new self();
    }
}
