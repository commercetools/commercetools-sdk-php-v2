...
/**
 * @implements Builder<StagedOrderSetShippingCustomTypeAction>
 */
final class StagedOrderSetShippingCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedOrderSetShippingCustomTypeAction
    {
        return new StagedOrderSetShippingCustomTypeActionModel(
            $this->shippingKey,
    ...
    public static function of(): StagedOrderSetShippingCustomTypeActionBuilder
    {
        return new self();
    }
}
