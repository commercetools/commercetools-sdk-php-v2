...
final class StagedOrderSetShippingAddressCustomTypeActionBuilder implements Builder
{
    ...
    public function build(): StagedOrderSetShippingAddressCustomTypeAction
    {
        return new StagedOrderSetShippingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): StagedOrderSetShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
