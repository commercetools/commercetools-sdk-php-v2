...
final class StagedOrderSetCustomShippingMethodActionModel extends JsonObjectModel implements StagedOrderSetCustomShippingMethodAction
{
    ...
    public function getShippingMethodName()
    {
        if (is_null($this->shippingMethodName)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(StagedOrderSetCustomShippingMethodAction::FIELD_SHIPPING_METHOD_NAME);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getShippingRate()
    {
        if (is_null($this->shippingRate)) {
            ...
            $data = $this->raw(StagedOrderSetCustomShippingMethodAction::FIELD_SHIPPING_RATE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getTaxCategory()
    {
        if (is_null($this->taxCategory)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderSetCustomShippingMethodAction::FIELD_TAX_CATEGORY);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getExternalTaxRate()
    {
        if (is_null($this->externalTaxRate)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderSetCustomShippingMethodAction::FIELD_EXTERNAL_TAX_RATE);
            if (is_null($data)) {
                return null;
            }
