...
final class StagedOrderRemoveLineItemActionModel extends JsonObjectModel implements StagedOrderRemoveLineItemAction
{
    ...
    public function getQuantity()
    {
        if (is_null($this->quantity)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(StagedOrderRemoveLineItemAction::FIELD_QUANTITY);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getExternalTotalPrice()
    {
        if (is_null($this->externalTotalPrice)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderRemoveLineItemAction::FIELD_EXTERNAL_TOTAL_PRICE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getShippingDetailsToRemove()
    {
        if (is_null($this->shippingDetailsToRemove)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(StagedOrderRemoveLineItemAction::FIELD_SHIPPING_DETAILS_TO_REMOVE);
            if (is_null($data)) {
                return null;
            }
