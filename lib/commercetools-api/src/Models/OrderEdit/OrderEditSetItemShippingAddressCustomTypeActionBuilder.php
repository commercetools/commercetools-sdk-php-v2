...
/**
 * @implements Builder<OrderEditSetItemShippingAddressCustomTypeAction>
 */
final class OrderEditSetItemShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderEditSetItemShippingAddressCustomTypeAction
    {
        return new OrderEditSetItemShippingAddressCustomTypeActionModel(
            $this->addressKey,
    ...
    public static function of(): OrderEditSetItemShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
