 ...
 */
final class ChannelSetAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): ChannelSetAddressCustomTypeAction
    {
        return new ChannelSetAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ChannelSetAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
