...
/**
 * @implements Builder<ChannelSetCustomTypeAction>
 */
final class ChannelSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Channel with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Channel.</p>
    ...
    public function build(): ChannelSetCustomTypeAction
    {
        return new ChannelSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ChannelSetCustomTypeActionBuilder
    {
        return new self();
    }
}
