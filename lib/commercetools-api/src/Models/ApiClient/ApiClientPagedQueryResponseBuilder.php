...
/**
 * @implements Builder<ApiClientPagedQueryResponse>
 */
final class ApiClientPagedQueryResponseBuilder implements Builder
{
    ...
    /**
     *
     * @return ApiClientCollection|null
     */
     ...
     * @return $this
     */
    final public function withResults(?ApiClientCollection $results)
    {
    ...
    public static function of(): ApiClientPagedQueryResponseBuilder
    {
        return new self();
    }
}