...
final class CustomerGroupSetCustomTypeActionModel extends JsonObjectModel implements CustomerGroupSetCustomTypeAction
{
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            ...
            $data = $this->raw(CustomerGroupSetCustomTypeAction::FIELD_TYPE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(CustomerGroupSetCustomTypeAction::FIELD_FIELDS);
            if (is_null($data)) {
                return null;
            }
