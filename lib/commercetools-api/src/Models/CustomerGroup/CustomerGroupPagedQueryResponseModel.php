...
final class CustomerGroupPagedQueryResponseModel extends JsonObjectModel implements CustomerGroupPagedQueryResponse
{
    ...
    /**
     *
     * @return CustomerGroupCollection|null
     */
    final public function getResults()
    {
       if (is_null($this->results)) {
           ...
           $this->results = CustomerGroupCollection::fromArray($data);
       }
       return $this->results;
    }
    ...
    final public function setResults(?CustomerGroupCollection $results): void
    {
        $this->results = $results;
    }
