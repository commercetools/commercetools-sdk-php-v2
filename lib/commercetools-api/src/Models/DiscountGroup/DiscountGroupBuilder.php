...
/**
 * @implements Builder<DiscountGroup>
 */
final class DiscountGroupBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroup
    {
        return new DiscountGroupModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupBuilder
    {
        return new self();
    }
}
