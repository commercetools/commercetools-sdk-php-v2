 ...
 * @internal
 */
final class ExtensionReferenceModel extends JsonObjectModel implements ExtensionReference
{
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = ExtensionModel::of($data);
        }
     ...
     * @param ?Extension $obj
     */
    public function setObj(?Extension $obj): void
    {
        $this->obj = $obj;
    }
}
