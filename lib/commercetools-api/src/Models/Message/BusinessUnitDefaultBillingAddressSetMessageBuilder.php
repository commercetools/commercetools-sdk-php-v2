...
/**
 * @implements Builder<BusinessUnitDefaultBillingAddressSetMessage>
 */
final class BusinessUnitDefaultBillingAddressSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitDefaultBillingAddressSetMessage
    {
        return new BusinessUnitDefaultBillingAddressSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitDefaultBillingAddressSetMessageBuilder
    {
        return new self();
    }
}
