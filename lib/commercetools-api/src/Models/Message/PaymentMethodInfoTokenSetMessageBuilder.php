...
/**
 * @implements Builder<PaymentMethodInfoTokenSetMessage>
 */
final class PaymentMethodInfoTokenSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoTokenSetMessage
    {
        return new PaymentMethodInfoTokenSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoTokenSetMessageBuilder
    {
        return new self();
    }
}
