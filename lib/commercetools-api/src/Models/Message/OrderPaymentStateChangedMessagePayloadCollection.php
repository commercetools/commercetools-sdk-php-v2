...
/**
 * @extends OrderMessagePayloadCollection<OrderPaymentStateChangedMessagePayload>
 ...
 */
class OrderPaymentStateChangedMessagePayloadCollection extends OrderMessagePayloadCollection
{
    /**
