...
/**
 * @implements Builder<CustomerShippingAddressAddedMessage>
 */
final class CustomerShippingAddressAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was added to the <a href="ctp:api:type:Customer">Customer</a> <code>shippingAddressIds</code>.</p>
     *
    ...
    public function build(): CustomerShippingAddressAddedMessage
    {
        return new CustomerShippingAddressAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerShippingAddressAddedMessageBuilder
    {
        return new self();
    }
}
