...
/**
 * @implements Builder<CartDiscountStoreAddedMessage>
 */
final class CartDiscountStoreAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The <a href="ctp:api:type:Store">Store</a> that was added to the <a href="ctp:api:type:CartDiscount">Cart Discount</a>.</p>
     *
    ...
    public function build(): CartDiscountStoreAddedMessage
    {
        return new CartDiscountStoreAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartDiscountStoreAddedMessageBuilder
    {
        return new self();
    }
}
