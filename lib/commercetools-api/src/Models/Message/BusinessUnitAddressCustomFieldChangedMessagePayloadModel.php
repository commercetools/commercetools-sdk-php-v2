 ...
 * @internal
 */
final class BusinessUnitAddressCustomFieldChangedMessagePayloadModel extends JsonObjectModel implements BusinessUnitAddressCustomFieldChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitAddressCustomFieldChanged';
    /**
     *
     * @var ?string
     */
