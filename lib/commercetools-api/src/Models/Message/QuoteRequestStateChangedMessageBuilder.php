...
/**
 * @implements Builder<QuoteRequestStateChangedMessage>
 */
final class QuoteRequestStateChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRequestStateChangedMessage
    {
        return new QuoteRequestStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteRequestStateChangedMessageBuilder
    {
        return new self();
    }
}
