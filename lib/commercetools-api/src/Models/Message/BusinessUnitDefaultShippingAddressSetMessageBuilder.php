 ...
 */
final class BusinessUnitDefaultShippingAddressSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitDefaultShippingAddressSetMessage
    {
        return new BusinessUnitDefaultShippingAddressSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitDefaultShippingAddressSetMessageBuilder
    {
        return new self();
    }
}
