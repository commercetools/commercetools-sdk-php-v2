 ...
 * @internal
 */
final class StagedQuoteValidToSetMessageModel extends JsonObjectModel implements StagedQuoteValidToSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[StagedQuoteValidToSetMessage::FIELD_VALID_TO]) && $data[StagedQuoteValidToSetMessage::FIELD_VALID_TO] instanceof \DateTimeImmutable) {
            $data[StagedQuoteValidToSetMessage::FIELD_VALID_TO] = $data[StagedQuoteValidToSetMessage::FIELD_VALID_TO]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
