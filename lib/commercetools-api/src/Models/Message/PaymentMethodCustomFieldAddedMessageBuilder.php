...
/**
 * @implements Builder<PaymentMethodCustomFieldAddedMessage>
 */
final class PaymentMethodCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomFieldAddedMessage
    {
        return new PaymentMethodCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
