...
/**
 * @implements Builder<CartDiscountStoreRemovedMessage>
 */
final class CartDiscountStoreRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountStoreRemovedMessage
    {
        return new CartDiscountStoreRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartDiscountStoreRemovedMessageBuilder
    {
        return new self();
    }
}
