...
/**
 * @implements Builder<BusinessUnitCustomFieldAddedMessage>
 */
final class BusinessUnitCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomFieldAddedMessage
    {
        return new BusinessUnitCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
