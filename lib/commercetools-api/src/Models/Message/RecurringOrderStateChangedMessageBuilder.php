...
/**
 * @implements Builder<RecurringOrderStateChangedMessage>
 */
final class RecurringOrderStateChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderStateChangedMessage
    {
        return new RecurringOrderStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderStateChangedMessageBuilder
    {
        return new self();
    }
}
