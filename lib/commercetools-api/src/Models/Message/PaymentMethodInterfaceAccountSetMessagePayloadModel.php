 ...
 * @internal
 */
final class PaymentMethodInterfaceAccountSetMessagePayloadModel extends JsonObjectModel implements PaymentMethodInterfaceAccountSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodInterfaceAccountSet';
    /**
     *
     * @var ?string
     */
