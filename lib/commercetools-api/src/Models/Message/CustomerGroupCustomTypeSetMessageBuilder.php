...
/**
 * @implements Builder<CustomerGroupCustomTypeSetMessage>
 */
final class CustomerGroupCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomTypeSetMessage
    {
        return new CustomerGroupCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
