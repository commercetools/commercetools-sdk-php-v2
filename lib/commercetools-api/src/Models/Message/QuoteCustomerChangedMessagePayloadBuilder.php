 ...
 */
final class QuoteCustomerChangedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteCustomerChangedMessagePayload
    {
        return new QuoteCustomerChangedMessagePayloadModel(
    ...
    public static function of(): QuoteCustomerChangedMessagePayloadBuilder
    {
        return new self();
    }
}
