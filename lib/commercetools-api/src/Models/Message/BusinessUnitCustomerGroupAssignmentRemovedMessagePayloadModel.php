 ...
 * @internal
 */
final class BusinessUnitCustomerGroupAssignmentRemovedMessagePayloadModel extends JsonObjectModel implements BusinessUnitCustomerGroupAssignmentRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitCustomerGroupAssignmentRemoved';
    /**
     *
     * @var ?string
     */
