...
/**
 * @implements Builder<BusinessUnitStoreAddedMessage>
 */
final class BusinessUnitStoreAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStoreAddedMessage
    {
        return new BusinessUnitStoreAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitStoreAddedMessageBuilder
    {
        return new self();
    }
}
