...
/**
 * @implements Builder<OrderCustomLineItemRemovedMessage>
 */
final class OrderCustomLineItemRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomLineItemRemovedMessage
    {
        return new OrderCustomLineItemRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomLineItemRemovedMessageBuilder
    {
        return new self();
    }
}
