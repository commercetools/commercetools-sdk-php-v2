...
/**
 * @implements Builder<CustomerShippingAddressRemovedMessage>
 */
final class CustomerShippingAddressRemovedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was removed from the <a href="ctp:api:type:Customer">Customer</a> <code>shippingAddressIds</code>.</p>
     *
    ...
    public function build(): CustomerShippingAddressRemovedMessage
    {
        return new CustomerShippingAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerShippingAddressRemovedMessageBuilder
    {
        return new self();
    }
}
