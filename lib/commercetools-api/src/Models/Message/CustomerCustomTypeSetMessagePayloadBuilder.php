 ...
 */
final class CustomerCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomTypeSetMessagePayload
    {
        return new CustomerCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->previousTypeId
        );
    }

    public static function of(): CustomerCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
