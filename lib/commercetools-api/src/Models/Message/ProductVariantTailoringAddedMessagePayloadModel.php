...
use Commercetools\Api\Models\ProductTailoring\ProductVariantTailoringModel;
 ...
 * @internal
 */
final class ProductVariantTailoringAddedMessagePayloadModel extends JsonObjectModel implements ProductVariantTailoringAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductVariantTailoringAdded';
    /**
     *
     * @var ?string
     */
    ...
    public function __construct(
        ...
        ?int $variantId = null,
        ?ProductVariantTailoring $variant = null,
        ?string $type = null
    ) {
        $this->store = $store;
    ...
    public function getVariant()
    {
        if (is_null($this->variant)) {
            ...
            $this->variant = ProductVariantTailoringModel::of($data);
        }
