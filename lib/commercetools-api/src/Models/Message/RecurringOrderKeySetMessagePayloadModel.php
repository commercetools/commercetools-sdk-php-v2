 ...
 * @internal
 */
final class RecurringOrderKeySetMessagePayloadModel extends JsonObjectModel implements RecurringOrderKeySetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'RecurringOrderKeySet';
    /**
     *
     * @var ?string
     */
