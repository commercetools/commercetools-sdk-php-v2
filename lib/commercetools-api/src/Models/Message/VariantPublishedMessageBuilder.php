...
/**
 * @implements Builder<VariantPublishedMessage>
 */
final class VariantPublishedMessageBuilder implements Builder
{
    /**
    ...
    public static function of(): VariantPublishedMessageBuilder
    {
        return new self();
    }
}
