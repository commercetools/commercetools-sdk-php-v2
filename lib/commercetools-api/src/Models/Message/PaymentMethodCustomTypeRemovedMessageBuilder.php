...
/**
 * @implements Builder<PaymentMethodCustomTypeRemovedMessage>
 */
final class PaymentMethodCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomTypeRemovedMessage
    {
        return new PaymentMethodCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
