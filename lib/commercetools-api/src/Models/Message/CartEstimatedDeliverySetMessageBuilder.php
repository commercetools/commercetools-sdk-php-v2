...
/**
 * @implements Builder<CartEstimatedDeliverySetMessage>
 */
final class CartEstimatedDeliverySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartEstimatedDeliverySetMessage
    {
        return new CartEstimatedDeliverySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartEstimatedDeliverySetMessageBuilder
    {
        return new self();
    }
}
