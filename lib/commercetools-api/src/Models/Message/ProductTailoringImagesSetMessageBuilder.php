...
/**
 * @implements Builder<ProductTailoringImagesSetMessage>
 */
final class ProductTailoringImagesSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringImagesSetMessage
    {
        return new ProductTailoringImagesSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringImagesSetMessageBuilder
    {
        return new self();
    }
}
