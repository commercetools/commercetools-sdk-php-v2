...
/**
 * @implements Builder<PaymentMethodInterfaceAccountSetMessage>
 */
final class PaymentMethodInterfaceAccountSetMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Interface account of the Payment Method after the <a href="ctp:api:type:PaymentMethodSetInterfaceAccountAction">Set InterfaceAccount</a> update action.</p>
     *
    ...
    /**
     * <p>Interface account of the Payment Method before the <a href="ctp:api:type:PaymentMethodSetInterfaceAccountAction">Set InterfaceAccount</a> update action.</p>
     *
    ...
    public function build(): PaymentMethodInterfaceAccountSetMessage
    {
        return new PaymentMethodInterfaceAccountSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInterfaceAccountSetMessageBuilder
    {
        return new self();
    }
}
