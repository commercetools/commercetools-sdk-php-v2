 ...
 */
final class ShoppingListLineItemAddedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ShoppingListLineItemAddedMessagePayload
    {
        return new ShoppingListLineItemAddedMessagePayloadModel(
            $this->lineItem instanceof ShoppingListLineItemBuilder ? $this->lineItem->build() : $this->lineItem
        );
    }

    public static function of(): ShoppingListLineItemAddedMessagePayloadBuilder
    {
        return new self();
    }
}
