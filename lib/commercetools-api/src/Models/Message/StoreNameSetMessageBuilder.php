...
/**
 * @implements Builder<StoreNameSetMessage>
 */
final class StoreNameSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreNameSetMessage
    {
        return new StoreNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreNameSetMessageBuilder
    {
        return new self();
    }
}
