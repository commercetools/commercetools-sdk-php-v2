 ...
 * @internal
 */
final class RecurringOrderFailedMessageModel extends JsonObjectModel implements RecurringOrderFailedMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[RecurringOrderFailedMessage::FIELD_FAILED_AT]) && $data[RecurringOrderFailedMessage::FIELD_FAILED_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderFailedMessage::FIELD_FAILED_AT] = $data[RecurringOrderFailedMessage::FIELD_FAILED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[RecurringOrderFailedMessage::FIELD_ORDER_SCHEDULED_AT]) && $data[RecurringOrderFailedMessage::FIELD_ORDER_SCHEDULED_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderFailedMessage::FIELD_ORDER_SCHEDULED_AT] = $data[RecurringOrderFailedMessage::FIELD_ORDER_SCHEDULED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
