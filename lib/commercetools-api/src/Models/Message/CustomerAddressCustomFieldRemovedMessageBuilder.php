...
/**
 * @implements Builder<CustomerAddressCustomFieldRemovedMessage>
 */
final class CustomerAddressCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddressCustomFieldRemovedMessage
    {
        return new CustomerAddressCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
