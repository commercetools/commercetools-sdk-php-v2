...
/**
 * @implements Builder<CustomerCustomFieldChangedMessage>
 */
final class CustomerCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomFieldChangedMessage
    {
        return new CustomerCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
