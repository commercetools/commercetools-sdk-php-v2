 ...
 * @internal
 */
final class PaymentMethodInfoCustomFieldAddedMessageModel extends JsonObjectModel implements PaymentMethodInfoCustomFieldAddedMessage
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodInfoCustomFieldAdded';
    /**
     *
     * @var ?string
     */
