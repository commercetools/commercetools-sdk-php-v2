 ...
 * @internal
 */
final class PaymentMethodInfoCustomTypeSetMessagePayloadModel extends JsonObjectModel implements PaymentMethodInfoCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodInfoCustomTypeSet';
    /**
     *
     * @var ?string
     */
