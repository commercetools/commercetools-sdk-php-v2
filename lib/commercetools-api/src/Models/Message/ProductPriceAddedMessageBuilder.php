...
/**
 * @implements Builder<ProductPriceAddedMessage>
 */
final class ProductPriceAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceAddedMessage
    {
        return new ProductPriceAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceAddedMessageBuilder
    {
        return new self();
    }
}
