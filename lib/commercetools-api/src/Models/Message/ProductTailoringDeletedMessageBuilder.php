...
/**
 * @implements Builder<ProductTailoringDeletedMessage>
 */
final class ProductTailoringDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringDeletedMessage
    {
        return new ProductTailoringDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringDeletedMessageBuilder
    {
        return new self();
    }
}
