 ...
 * @internal
 */
final class CartDiscountStoreRemovedMessagePayloadModel extends JsonObjectModel implements CartDiscountStoreRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CartDiscountStoreRemoved';
    /**
     *
     * @var ?string
     */
