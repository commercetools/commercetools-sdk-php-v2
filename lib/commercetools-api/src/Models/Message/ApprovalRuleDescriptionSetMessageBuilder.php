...
/**
 * @implements Builder<ApprovalRuleDescriptionSetMessage>
 */
final class ApprovalRuleDescriptionSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleDescriptionSetMessage
    {
        return new ApprovalRuleDescriptionSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleDescriptionSetMessageBuilder
    {
        return new self();
    }
}
