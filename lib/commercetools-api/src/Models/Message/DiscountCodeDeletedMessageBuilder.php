...
/**
 * @implements Builder<DiscountCodeDeletedMessage>
 */
final class DiscountCodeDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountCodeDeletedMessage
    {
        return new DiscountCodeDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountCodeDeletedMessageBuilder
    {
        return new self();
    }
}
