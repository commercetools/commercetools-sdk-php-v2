 ...
 */
final class StandalonePriceValidFromAndUntilSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceValidFromAndUntilSetMessage
    {
        return new StandalonePriceValidFromAndUntilSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceValidFromAndUntilSetMessageBuilder
    {
        return new self();
    }
}
