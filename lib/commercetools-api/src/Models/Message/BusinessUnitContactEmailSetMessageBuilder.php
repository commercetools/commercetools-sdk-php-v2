...
/**
 * @implements Builder<BusinessUnitContactEmailSetMessage>
 */
final class BusinessUnitContactEmailSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitContactEmailSetMessage
    {
        return new BusinessUnitContactEmailSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
