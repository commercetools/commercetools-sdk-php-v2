...
/**
 * @implements Builder<StagedQuoteSellerCommentSetMessage>
 */
final class StagedQuoteSellerCommentSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteSellerCommentSetMessage
    {
        return new StagedQuoteSellerCommentSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteSellerCommentSetMessageBuilder
    {
        return new self();
    }
}
