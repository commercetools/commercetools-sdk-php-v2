...
/**
 * @implements Builder<StandalonePriceTiersSetMessage>
 */
final class StandalonePriceTiersSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceTiersSetMessage
    {
        return new StandalonePriceTiersSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceTiersSetMessageBuilder
    {
        return new self();
    }
}
