...
/**
 * @implements Builder<BusinessUnitAddressCustomTypeRemovedMessage>
 */
final class BusinessUnitAddressCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressCustomTypeRemovedMessage
    {
        return new BusinessUnitAddressCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
