 ...
 */
final class ProductTailoringDeletedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringDeletedMessagePayload
    {
        return new ProductTailoringDeletedMessagePayloadModel(
    ...
    public static function of(): ProductTailoringDeletedMessagePayloadBuilder
    {
        return new self();
    }
}
