 ...
 */
final class CustomerEmailTokenCreatedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerEmailTokenCreatedMessagePayload
    {
        return new CustomerEmailTokenCreatedMessagePayloadModel(
            $this->customerId,
            $this->expiresAt,
            $this->value,
    ...
    public static function of(): CustomerEmailTokenCreatedMessagePayloadBuilder
    {
        return new self();
    }
}
