...
/**
 * @implements Builder<PaymentMethodCustomFieldChangedMessage>
 */
final class PaymentMethodCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomFieldChangedMessage
    {
        return new PaymentMethodCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
