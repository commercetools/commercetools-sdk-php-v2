...
/**
 * @implements Builder<ShoppingListLineItemAddedMessage>
 */
final class ShoppingListLineItemAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ShoppingListLineItemAddedMessage
    {
        return new ShoppingListLineItemAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ShoppingListLineItemAddedMessageBuilder
    {
        return new self();
    }
}
