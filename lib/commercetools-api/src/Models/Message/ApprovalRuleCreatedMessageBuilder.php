...
/**
 * @implements Builder<ApprovalRuleCreatedMessage>
 */
final class ApprovalRuleCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleCreatedMessage
    {
        return new ApprovalRuleCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleCreatedMessageBuilder
    {
        return new self();
    }
}
