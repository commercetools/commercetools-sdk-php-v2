 ...
 * @internal
 */
final class BusinessUnitAssociateAddedMessagePayloadModel extends JsonObjectModel implements BusinessUnitAssociateAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitAssociateAdded';
    /**
     *
     * @var ?string
     */
