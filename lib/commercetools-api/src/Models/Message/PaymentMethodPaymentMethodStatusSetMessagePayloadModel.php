 ...
 * @internal
 */
final class PaymentMethodPaymentMethodStatusSetMessagePayloadModel extends JsonObjectModel implements PaymentMethodPaymentMethodStatusSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodPaymentMethodStatusSet';
    /**
     *
     * @var ?string
     */
