 ...
 * @internal
 */
final class BusinessUnitCustomerGroupAssignmentAddedMessagePayloadModel extends JsonObjectModel implements BusinessUnitCustomerGroupAssignmentAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitCustomerGroupAssignmentAdded';
    /**
     *
     * @var ?string
     */
