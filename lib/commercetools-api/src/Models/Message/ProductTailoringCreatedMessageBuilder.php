...
/**
 * @implements Builder<ProductTailoringCreatedMessage>
 */
final class ProductTailoringCreatedMessageBuilder implements Builder
{
    /**
    ...
    public static function of(): ProductTailoringCreatedMessageBuilder
    {
        return new self();
    }
}
