...
/**
 * @implements Builder<ProductPriceKeySetMessage>
 */
final class ProductPriceKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceKeySetMessage
    {
        return new ProductPriceKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceKeySetMessageBuilder
    {
        return new self();
    }
}
