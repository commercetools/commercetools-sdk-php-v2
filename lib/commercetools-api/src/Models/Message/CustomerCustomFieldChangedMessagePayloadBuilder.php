 ...
 */
final class CustomerCustomFieldChangedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomFieldChangedMessagePayload
    {
        return new CustomerCustomFieldChangedMessagePayloadModel(
            $this->name,
            $this->value,
            $this->previousValue
        );
    ...
    public static function of(): CustomerCustomFieldChangedMessagePayloadBuilder
    {
        return new self();
    }
}
