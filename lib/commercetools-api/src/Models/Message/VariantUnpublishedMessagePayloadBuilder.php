...
/**
 * @implements Builder<VariantUnpublishedMessagePayload>
 */
final class VariantUnpublishedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): VariantUnpublishedMessagePayload
    {
        return new VariantUnpublishedMessagePayloadModel(
            $this->product instanceof ProductReferenceBuilder ? $this->product->build() : $this->product
        );
    }

    public static function of(): VariantUnpublishedMessagePayloadBuilder
    {
        return new self();
    }
}
