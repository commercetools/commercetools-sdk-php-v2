...
/**
 * @implements Builder<ApprovalFlowRejectedMessage>
 */
final class ApprovalFlowRejectedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalFlowRejectedMessage
    {
        return new ApprovalFlowRejectedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalFlowRejectedMessageBuilder
    {
        return new self();
    }
}
