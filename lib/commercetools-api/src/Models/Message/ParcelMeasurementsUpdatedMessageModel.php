...
final class ParcelMeasurementsUpdatedMessageModel extends JsonObjectModel implements ParcelMeasurementsUpdatedMessage
{
    ...
    public function getDeliveryId()
    {
        if (is_null($this->deliveryId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ParcelMeasurementsUpdatedMessage::FIELD_DELIVERY_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getMeasurements()
    {
        if (is_null($this->measurements)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ParcelMeasurementsUpdatedMessage::FIELD_MEASUREMENTS);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getParcelId()
    {
        if (is_null($this->parcelId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ParcelMeasurementsUpdatedMessage::FIELD_PARCEL_ID);
            if (is_null($data)) {
                return null;
            }
