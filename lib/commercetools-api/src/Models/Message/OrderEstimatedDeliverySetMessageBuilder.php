...
/**
 * @implements Builder<OrderEstimatedDeliverySetMessage>
 */
final class OrderEstimatedDeliverySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderEstimatedDeliverySetMessage
    {
        return new OrderEstimatedDeliverySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderEstimatedDeliverySetMessageBuilder
    {
        return new self();
    }
}
