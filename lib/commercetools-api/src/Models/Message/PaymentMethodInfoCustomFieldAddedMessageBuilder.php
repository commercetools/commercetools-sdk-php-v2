...
/**
 * @implements Builder<PaymentMethodInfoCustomFieldAddedMessage>
 */
final class PaymentMethodInfoCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoCustomFieldAddedMessage
    {
        return new PaymentMethodInfoCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
