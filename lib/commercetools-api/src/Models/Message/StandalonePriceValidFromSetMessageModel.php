 ...
 * @internal
 */
final class StandalonePriceValidFromSetMessageModel extends JsonObjectModel implements StandalonePriceValidFromSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[StandalonePriceValidFromSetMessage::FIELD_VALID_FROM]) && $data[StandalonePriceValidFromSetMessage::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromSetMessage::FIELD_VALID_FROM] = $data[StandalonePriceValidFromSetMessage::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePriceValidFromSetMessage::FIELD_PREVIOUS_VALID_FROM]) && $data[StandalonePriceValidFromSetMessage::FIELD_PREVIOUS_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromSetMessage::FIELD_PREVIOUS_VALID_FROM] = $data[StandalonePriceValidFromSetMessage::FIELD_PREVIOUS_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
