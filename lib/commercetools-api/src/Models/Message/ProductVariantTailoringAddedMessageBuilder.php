...
/**
 * @implements Builder<ProductVariantTailoringAddedMessage>
 */
final class ProductVariantTailoringAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductVariantTailoringAddedMessage
    {
        return new ProductVariantTailoringAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductVariantTailoringAddedMessageBuilder
    {
        return new self();
    }
}
