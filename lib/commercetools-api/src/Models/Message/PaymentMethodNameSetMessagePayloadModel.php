 ...
 * @internal
 */
final class PaymentMethodNameSetMessagePayloadModel extends JsonObjectModel implements PaymentMethodNameSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodNameSet';
    /**
     *
     * @var ?string
     */
