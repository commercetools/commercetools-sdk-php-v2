...
/**
 * @implements Builder<CustomerCustomTypeRemovedMessage>
 */
final class CustomerCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomTypeRemovedMessage
    {
        return new CustomerCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
