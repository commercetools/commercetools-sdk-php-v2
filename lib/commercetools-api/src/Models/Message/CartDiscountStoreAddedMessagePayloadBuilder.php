 ...
 */
final class CartDiscountStoreAddedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountStoreAddedMessagePayload
    {
        return new CartDiscountStoreAddedMessagePayloadModel(
            $this->store instanceof StoreKeyReferenceBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): CartDiscountStoreAddedMessagePayloadBuilder
    {
        return new self();
    }
}
