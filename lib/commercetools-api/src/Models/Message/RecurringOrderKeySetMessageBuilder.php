...
/**
 * @implements Builder<RecurringOrderKeySetMessage>
 */
final class RecurringOrderKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderKeySetMessage
    {
        return new RecurringOrderKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderKeySetMessageBuilder
    {
        return new self();
    }
}
