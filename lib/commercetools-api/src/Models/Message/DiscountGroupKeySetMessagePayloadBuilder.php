...
/**
 * @implements Builder<DiscountGroupKeySetMessagePayload>
 */
final class DiscountGroupKeySetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupKeySetMessagePayload
    {
        return new DiscountGroupKeySetMessagePayloadModel(
            $this->key,
            $this->oldKey
        );
    }

    public static function of(): DiscountGroupKeySetMessagePayloadBuilder
    {
        return new self();
    }
}
