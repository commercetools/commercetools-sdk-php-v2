 ...
 * @internal
 */
final class PaymentMethodKeySetMessagePayloadModel extends JsonObjectModel implements PaymentMethodKeySetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodKeySet';
    /**
     *
     * @var ?string
     */
