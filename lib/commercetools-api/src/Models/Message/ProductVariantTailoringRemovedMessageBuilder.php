...
/**
 * @implements Builder<ProductVariantTailoringRemovedMessage>
 */
final class ProductVariantTailoringRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductVariantTailoringRemovedMessage
    {
        return new ProductVariantTailoringRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductVariantTailoringRemovedMessageBuilder
    {
        return new self();
    }
}
