...
/**
 * @implements Builder<StoreContactUrlSetMessage>
 */
final class StoreContactUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreContactUrlSetMessage
    {
        return new StoreContactUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreContactUrlSetMessageBuilder
    {
        return new self();
    }
}
