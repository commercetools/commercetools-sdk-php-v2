...
/**
 * @implements Builder<ReturnInfoAddedMessage>
 */
final class ReturnInfoAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ReturnInfoAddedMessage
    {
        return new ReturnInfoAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ReturnInfoAddedMessageBuilder
    {
        return new self();
    }
}
