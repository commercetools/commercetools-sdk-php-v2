 ...
 */
final class ProductPriceCustomFieldRemovedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldRemovedMessagePayload
    {
        return new ProductPriceCustomFieldRemovedMessagePayloadModel(
            $this->priceId,
            $this->variantId,
            $this->staged,
            $this->name
    ...
    public static function of(): ProductPriceCustomFieldRemovedMessagePayloadBuilder
    {
        return new self();
    }
}
