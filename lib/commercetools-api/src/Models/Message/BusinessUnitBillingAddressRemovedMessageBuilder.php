...
/**
 * @implements Builder<BusinessUnitBillingAddressRemovedMessage>
 */
final class BusinessUnitBillingAddressRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitBillingAddressRemovedMessage
    {
        return new BusinessUnitBillingAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitBillingAddressRemovedMessageBuilder
    {
        return new self();
    }
}
