...
/**
 * @implements Builder<BusinessUnitAddressRemovedMessage>
 */
final class BusinessUnitAddressRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressRemovedMessage
    {
        return new BusinessUnitAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressRemovedMessageBuilder
    {
        return new self();
    }
}
