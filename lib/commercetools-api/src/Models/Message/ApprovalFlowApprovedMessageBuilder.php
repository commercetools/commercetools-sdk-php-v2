...
/**
 * @implements Builder<ApprovalFlowApprovedMessage>
 */
final class ApprovalFlowApprovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalFlowApprovedMessage
    {
        return new ApprovalFlowApprovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalFlowApprovedMessageBuilder
    {
        return new self();
    }
}
