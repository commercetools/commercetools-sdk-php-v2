...
/**
 * @implements Builder<RecurringOrderStartsAtSetMessage>
 */
final class RecurringOrderStartsAtSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderStartsAtSetMessage
    {
        return new RecurringOrderStartsAtSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderStartsAtSetMessageBuilder
    {
        return new self();
    }
}
