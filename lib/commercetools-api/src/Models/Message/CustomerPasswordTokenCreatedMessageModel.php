 ...
 * @internal
 */
final class CustomerPasswordTokenCreatedMessageModel extends JsonObjectModel implements CustomerPasswordTokenCreatedMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[CustomerPasswordTokenCreatedMessage::FIELD_EXPIRES_AT]) && $data[CustomerPasswordTokenCreatedMessage::FIELD_EXPIRES_AT] instanceof \DateTimeImmutable) {
            $data[CustomerPasswordTokenCreatedMessage::FIELD_EXPIRES_AT] = $data[CustomerPasswordTokenCreatedMessage::FIELD_EXPIRES_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
