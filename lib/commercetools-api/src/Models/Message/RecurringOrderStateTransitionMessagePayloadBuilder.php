 ...
 */
final class RecurringOrderStateTransitionMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderStateTransitionMessagePayload
    {
        return new RecurringOrderStateTransitionMessagePayloadModel(
    ...
    public static function of(): RecurringOrderStateTransitionMessagePayloadBuilder
    {
        return new self();
    }
}
