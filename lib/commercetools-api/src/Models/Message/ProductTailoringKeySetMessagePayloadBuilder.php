...
/**
 * @implements Builder<ProductTailoringKeySetMessagePayload>
 */
final class ProductTailoringKeySetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringKeySetMessagePayload
    {
        return new ProductTailoringKeySetMessagePayloadModel(
    ...
    public static function of(): ProductTailoringKeySetMessagePayloadBuilder
    {
        return new self();
    }
}
