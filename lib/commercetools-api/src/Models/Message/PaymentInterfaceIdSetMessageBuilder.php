...
/**
 * @implements Builder<PaymentInterfaceIdSetMessage>
 */
final class PaymentInterfaceIdSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentInterfaceIdSetMessage
    {
        return new PaymentInterfaceIdSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentInterfaceIdSetMessageBuilder
    {
        return new self();
    }
}
