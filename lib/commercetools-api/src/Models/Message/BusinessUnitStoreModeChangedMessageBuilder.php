...
/**
 * @implements Builder<BusinessUnitStoreModeChangedMessage>
 */
final class BusinessUnitStoreModeChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStoreModeChangedMessage
    {
        return new BusinessUnitStoreModeChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitStoreModeChangedMessageBuilder
    {
        return new self();
    }
}
