...
/**
 * @implements Builder<BusinessUnitStoresSetMessage>
 */
final class BusinessUnitStoresSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStoresSetMessage
    {
        return new BusinessUnitStoresSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitStoresSetMessageBuilder
    {
        return new self();
    }
}
