...
/**
 * @implements Builder<ProductTailoringDescriptionSetMessage>
 */
final class ProductTailoringDescriptionSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringDescriptionSetMessage
    {
        return new ProductTailoringDescriptionSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringDescriptionSetMessageBuilder
    {
        return new self();
    }
}
