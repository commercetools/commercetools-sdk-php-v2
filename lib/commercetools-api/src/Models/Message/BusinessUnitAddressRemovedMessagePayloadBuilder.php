 ...
 */
final class BusinessUnitAddressRemovedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public static function of(): BusinessUnitAddressRemovedMessagePayloadBuilder
    {
        return new self();
    }
}
