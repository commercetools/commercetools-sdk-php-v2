...
/**
 * @implements Builder<ApprovalRuleApproversSetMessage>
 */
final class ApprovalRuleApproversSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleApproversSetMessage
    {
        return new ApprovalRuleApproversSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleApproversSetMessageBuilder
    {
        return new self();
    }
}
