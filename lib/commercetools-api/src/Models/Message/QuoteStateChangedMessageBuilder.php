...
/**
 * @implements Builder<QuoteStateChangedMessage>
 */
final class QuoteStateChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteStateChangedMessage
    {
        return new QuoteStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteStateChangedMessageBuilder
    {
        return new self();
    }
}
