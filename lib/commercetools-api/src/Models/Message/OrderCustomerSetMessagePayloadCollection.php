...
/**
 * @extends OrderMessagePayloadCollection<OrderCustomerSetMessagePayload>
 * @method OrderCustomerSetMessagePayload current()
 * @method OrderCustomerSetMessagePayload end()
 * @method OrderCustomerSetMessagePayload at($offset)
 */
class OrderCustomerSetMessagePayloadCollection extends OrderMessagePayloadCollection
{
    /**
