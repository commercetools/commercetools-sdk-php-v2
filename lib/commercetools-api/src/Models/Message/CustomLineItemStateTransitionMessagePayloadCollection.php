...
/**
 * @extends OrderMessagePayloadCollection<CustomLineItemStateTransitionMessagePayload>
 * @method CustomLineItemStateTransitionMessagePayload current()
 * @method CustomLineItemStateTransitionMessagePayload end()
 * @method CustomLineItemStateTransitionMessagePayload at($offset)
 */
class CustomLineItemStateTransitionMessagePayloadCollection extends OrderMessagePayloadCollection
{
    /**
