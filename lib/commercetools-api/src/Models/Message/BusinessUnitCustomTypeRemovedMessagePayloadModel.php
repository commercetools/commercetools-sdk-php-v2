 ...
 * @internal
 */
final class BusinessUnitCustomTypeRemovedMessagePayloadModel extends JsonObjectModel implements BusinessUnitCustomTypeRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitCustomTypeRemoved';
    /**
     *
     * @var ?string
     */
