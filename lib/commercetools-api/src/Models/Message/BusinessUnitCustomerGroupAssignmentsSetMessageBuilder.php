 ...
 */
final class BusinessUnitCustomerGroupAssignmentsSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomerGroupAssignmentsSetMessage
    {
        return new BusinessUnitCustomerGroupAssignmentsSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomerGroupAssignmentsSetMessageBuilder
    {
        return new self();
    }
}
