...
/**
 * @implements Builder<OrderCustomFieldRemovedMessage>
 */
final class OrderCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomFieldRemovedMessage
    {
        return new OrderCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
