...
/**
 * @implements Builder<QuoteRequestDeletedMessage>
 */
final class QuoteRequestDeletedMessageBuilder implements Builder
{
    ...
    public function build(): QuoteRequestDeletedMessage
    {
        return new QuoteRequestDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteRequestDeletedMessageBuilder
    {
        return new self();
    }
}
