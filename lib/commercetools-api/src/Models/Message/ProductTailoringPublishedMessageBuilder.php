...
/**
 * @implements Builder<ProductTailoringPublishedMessage>
 */
final class ProductTailoringPublishedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringPublishedMessage
    {
        return new ProductTailoringPublishedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringPublishedMessageBuilder
    {
        return new self();
    }
}
