 ...
 */
final class QuoteRequestStateTransitionMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRequestStateTransitionMessagePayload
    {
    ...
    public static function of(): QuoteRequestStateTransitionMessagePayloadBuilder
    {
        return new self();
    }
}
