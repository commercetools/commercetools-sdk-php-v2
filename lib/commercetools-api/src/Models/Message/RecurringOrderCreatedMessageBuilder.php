...
/**
 * @implements Builder<RecurringOrderCreatedMessage>
 */
final class RecurringOrderCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCreatedMessage
    {
        return new RecurringOrderCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderCreatedMessageBuilder
    {
        return new self();
    }
}
