...
/**
 * @implements Builder<StandalonePriceActiveChangedMessage>
 */
final class StandalonePriceActiveChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceActiveChangedMessage
    {
        return new StandalonePriceActiveChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceActiveChangedMessageBuilder
    {
        return new self();
    }
}
