...
/**
 * @implements Builder<CustomerEmailTokenCreatedMessage>
 */
final class CustomerEmailTokenCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerEmailTokenCreatedMessage
    {
        return new CustomerEmailTokenCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerEmailTokenCreatedMessageBuilder
    {
        return new self();
    }
}
