...
/**
 * @implements Builder<CartFrozenMessage>
 */
final class CartFrozenMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartFrozenMessage
    {
        return new CartFrozenMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartFrozenMessageBuilder
    {
        return new self();
    }
}
