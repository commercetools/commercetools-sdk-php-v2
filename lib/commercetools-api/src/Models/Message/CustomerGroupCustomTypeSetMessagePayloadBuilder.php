 ...
 */
final class CustomerGroupCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomTypeSetMessagePayload
    {
        return new CustomerGroupCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->oldTypeId
        );
    }

    public static function of(): CustomerGroupCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
