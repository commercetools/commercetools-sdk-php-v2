...
/**
 * @implements Builder<CustomerGroupAssignmentsSetMessage>
 */
final class CustomerGroupAssignmentsSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupAssignmentsSetMessage
    {
        return new CustomerGroupAssignmentsSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupAssignmentsSetMessageBuilder
    {
        return new self();
    }
}
