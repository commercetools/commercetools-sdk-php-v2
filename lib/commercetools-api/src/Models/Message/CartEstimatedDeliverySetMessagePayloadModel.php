 ...
 * @internal
 */
final class CartEstimatedDeliverySetMessagePayloadModel extends JsonObjectModel implements CartEstimatedDeliverySetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CartEstimatedDeliverySet';
    /**
     *
     * @var ?string
     */
