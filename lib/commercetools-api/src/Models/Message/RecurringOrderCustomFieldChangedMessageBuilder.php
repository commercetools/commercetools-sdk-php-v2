 ...
 */
final class RecurringOrderCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCustomFieldChangedMessage
    {
        return new RecurringOrderCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
