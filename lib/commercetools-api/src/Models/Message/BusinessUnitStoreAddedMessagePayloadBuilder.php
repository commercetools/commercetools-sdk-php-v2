 ...
 */
final class BusinessUnitStoreAddedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStoreAddedMessagePayload
    {
    ...
    public static function of(): BusinessUnitStoreAddedMessagePayloadBuilder
    {
        return new self();
    }
}
