...
/**
 * @implements Builder<StandalonePriceStagedChangesRemovedMessage>
 */
final class StandalonePriceStagedChangesRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceStagedChangesRemovedMessage
    {
    ...
    public static function of(): StandalonePriceStagedChangesRemovedMessageBuilder
    {
        return new self();
    }
}
