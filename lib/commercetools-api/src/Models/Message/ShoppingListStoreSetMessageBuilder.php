...
/**
 * @implements Builder<ShoppingListStoreSetMessage>
 */
final class ShoppingListStoreSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ShoppingListStoreSetMessage
    {
        return new ShoppingListStoreSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ShoppingListStoreSetMessageBuilder
    {
        return new self();
    }
}
