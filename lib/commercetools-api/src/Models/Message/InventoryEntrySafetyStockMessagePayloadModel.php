 ...
 * @internal
 */
final class InventoryEntrySafetyStockMessagePayloadModel extends JsonObjectModel implements InventoryEntrySafetyStockMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'InventoryEntrySafetyStock';
    /**
     *
     * @var ?string
     */
