 ...
 */
final class CustomerAddressCustomFieldAddedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public static function of(): CustomerAddressCustomFieldAddedMessagePayloadBuilder
    {
        return new self();
    }
}
