...
/**
 * @implements Builder<AssociateRoleCreatedMessage>
 */
final class AssociateRoleCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRoleCreatedMessage
    {
        return new AssociateRoleCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRoleCreatedMessageBuilder
    {
        return new self();
    }
}
