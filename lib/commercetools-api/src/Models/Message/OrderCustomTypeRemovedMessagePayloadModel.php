 ...
 * @internal
 */
final class OrderCustomTypeRemovedMessagePayloadModel extends JsonObjectModel implements OrderCustomTypeRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'OrderCustomTypeRemoved';
    /**
     *
     * @var ?string
     */
