...
/**
 * @implements Builder<RecurringOrderCustomTypeRemovedMessage>
 */
final class RecurringOrderCustomTypeRemovedMessageBuilder implements Builder
{
    ...
    public function build(): RecurringOrderCustomTypeRemovedMessage
    {
    ...
    public static function of(): RecurringOrderCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
