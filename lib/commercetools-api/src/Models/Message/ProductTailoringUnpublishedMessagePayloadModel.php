 ...
 * @internal
 */
final class ProductTailoringUnpublishedMessagePayloadModel extends JsonObjectModel implements ProductTailoringUnpublishedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductTailoringUnpublished';
    /**
     *
     * @var ?string
     */
