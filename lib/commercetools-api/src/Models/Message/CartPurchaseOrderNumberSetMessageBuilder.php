...
/**
 * @implements Builder<CartPurchaseOrderNumberSetMessage>
 */
final class CartPurchaseOrderNumberSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartPurchaseOrderNumberSetMessage
    {
        return new CartPurchaseOrderNumberSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartPurchaseOrderNumberSetMessageBuilder
    {
        return new self();
    }
}
