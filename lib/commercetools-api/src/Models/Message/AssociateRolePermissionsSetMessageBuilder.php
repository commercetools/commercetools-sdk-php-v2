...
/**
 * @implements Builder<AssociateRolePermissionsSetMessage>
 */
final class AssociateRolePermissionsSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRolePermissionsSetMessage
    {
        return new AssociateRolePermissionsSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRolePermissionsSetMessageBuilder
    {
        return new self();
    }
}
