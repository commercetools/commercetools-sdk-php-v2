...
/**
 * @implements Builder<CartDiscountStoresSetMessage>
 */
final class CartDiscountStoresSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountStoresSetMessage
    {
        return new CartDiscountStoresSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartDiscountStoresSetMessageBuilder
    {
        return new self();
    }
}
