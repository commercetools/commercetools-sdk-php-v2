...
/**
 * @implements Builder<CustomerCustomFieldRemovedMessage>
 */
final class CustomerCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomFieldRemovedMessage
    {
    ...
    public static function of(): CustomerCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
