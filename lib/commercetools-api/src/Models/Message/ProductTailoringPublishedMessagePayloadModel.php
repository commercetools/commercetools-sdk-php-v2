 ...
 * @internal
 */
final class ProductTailoringPublishedMessagePayloadModel extends JsonObjectModel implements ProductTailoringPublishedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductTailoringPublished';
    /**
     *
     * @var ?string
     */
