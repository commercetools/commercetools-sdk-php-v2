 ...
 * @internal
 */
final class PaymentMethodCustomTypeRemovedMessagePayloadModel extends JsonObjectModel implements PaymentMethodCustomTypeRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodCustomTypeRemoved';
    /**
     *
     * @var ?string
     */
