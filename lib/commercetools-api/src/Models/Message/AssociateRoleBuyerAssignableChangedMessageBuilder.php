...
/**
 * @implements Builder<AssociateRoleBuyerAssignableChangedMessage>
 */
final class AssociateRoleBuyerAssignableChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRoleBuyerAssignableChangedMessage
    {
        return new AssociateRoleBuyerAssignableChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRoleBuyerAssignableChangedMessageBuilder
    {
        return new self();
    }
}
