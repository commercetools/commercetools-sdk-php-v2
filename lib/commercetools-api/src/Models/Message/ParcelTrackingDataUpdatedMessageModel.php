...
final class ParcelTrackingDataUpdatedMessageModel extends JsonObjectModel implements ParcelTrackingDataUpdatedMessage
{
    ...
    public function getDeliveryId()
    {
        if (is_null($this->deliveryId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ParcelTrackingDataUpdatedMessage::FIELD_DELIVERY_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getTrackingData()
    {
        if (is_null($this->trackingData)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ParcelTrackingDataUpdatedMessage::FIELD_TRACKING_DATA);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getParcelId()
    {
        if (is_null($this->parcelId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ParcelTrackingDataUpdatedMessage::FIELD_PARCEL_ID);
            if (is_null($data)) {
                return null;
            }
