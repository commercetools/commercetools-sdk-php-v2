...
/**
 * @implements Builder<BusinessUnitAddressChangedMessage>
 */
final class BusinessUnitAddressChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressChangedMessage
    {
        return new BusinessUnitAddressChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressChangedMessageBuilder
    {
        return new self();
    }
}
