...
final class MessageModel extends JsonObjectModel implements Message
{
    ...
    private static $discriminatorClasses = [
       ...
       'BusinessUnitCustomerGroupAssignmentAdded' => BusinessUnitCustomerGroupAssignmentAddedMessageModel::class,
       'BusinessUnitCustomerGroupAssignmentRemoved' => BusinessUnitCustomerGroupAssignmentRemovedMessageModel::class,
       'BusinessUnitCustomerGroupAssignmentsSet' => BusinessUnitCustomerGroupAssignmentsSetMessageModel::class,
       ...
       'CartEstimatedDeliverySet' => CartEstimatedDeliverySetMessageModel::class,
       ...
       'CustomerBillingAddressAdded' => CustomerBillingAddressAddedMessageModel::class,
       'CustomerBillingAddressRemoved' => CustomerBillingAddressRemovedMessageModel::class,
       ...
       'CustomerDefaultBillingAddressSet' => CustomerDefaultBillingAddressSetMessageModel::class,
       'CustomerDefaultShippingAddressSet' => CustomerDefaultShippingAddressSetMessageModel::class,
       ...
       'CustomerExternalIdSet' => CustomerExternalIdSetMessageModel::class,
       ...
       'CustomerShippingAddressAdded' => CustomerShippingAddressAddedMessageModel::class,
       'CustomerShippingAddressRemoved' => CustomerShippingAddressRemovedMessageModel::class,
       'CustomerStoresSet' => CustomerStoresSetMessageModel::class,
       ...
       'InventoryEntryOutOfStock' => InventoryEntryOutOfStockMessageModel::class,
       'InventoryEntryQuantitySet' => InventoryEntryQuantitySetMessageModel::class,
       'InventoryEntryReorderPoint' => InventoryEntryReorderPointMessageModel::class,
       'InventoryEntryReservationExpirationInMinutesSet' => InventoryEntryReservationExpirationInMinutesSetMessageModel::class,
       'InventoryEntrySafetyStock' => InventoryEntrySafetyStockMessageModel::class,
       ...
       'OrderEstimatedDeliverySet' => OrderEstimatedDeliverySetMessageModel::class,
       ...
       'RecurringOrderFailed' => RecurringOrderFailedMessageModel::class,
       ...
       'StoreCheckoutUrlTemplateSet' => StoreCheckoutUrlTemplateSetMessageModel::class,
       'StoreContactUrlSet' => StoreContactUrlSetMessageModel::class,
       'StoreCookiePolicyUrlSet' => StoreCookiePolicyUrlSetMessageModel::class,
       ...
       'StoreFaqUrlSet' => StoreFaqUrlSetMessageModel::class,
       'StoreImprintUrlSet' => StoreImprintUrlSetMessageModel::class,
       'StoreLanguagesChanged' => StoreLanguagesChangedMessageModel::class,
       'StoreNameSet' => StoreNameSetMessageModel::class,
       'StoreOrderUrlTemplateSet' => StoreOrderUrlTemplateSetMessageModel::class,
       'StorePrivacyPolicyUrlSet' => StorePrivacyPolicyUrlSetMessageModel::class,
       'StoreProductSelectionsChanged' => StoreProductSelectionsChangedMessageModel::class,
       'StoreRefundPolicyUrlSet' => StoreRefundPolicyUrlSetMessageModel::class,
       'StoreShippingPolicyUrlSet' => StoreShippingPolicyUrlSetMessageModel::class,
       'StoreSupplyChannelsChanged' => StoreSupplyChannelsChangedMessageModel::class,
       'StoreTermsOfServiceUrlSet' => StoreTermsOfServiceUrlSetMessageModel::class,
