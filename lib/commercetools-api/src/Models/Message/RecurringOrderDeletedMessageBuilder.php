...
/**
 * @implements Builder<RecurringOrderDeletedMessage>
 */
final class RecurringOrderDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderDeletedMessage
    {
    ...
    public static function of(): RecurringOrderDeletedMessageBuilder
    {
        return new self();
    }
}
