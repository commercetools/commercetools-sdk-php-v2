...
/**
 * @implements Builder<CustomerCustomFieldAddedMessage>
 */
final class CustomerCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomFieldAddedMessage
    {
        return new CustomerCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
