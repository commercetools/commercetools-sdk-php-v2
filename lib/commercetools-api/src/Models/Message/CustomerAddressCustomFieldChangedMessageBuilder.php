...
/**
 * @implements Builder<CustomerAddressCustomFieldChangedMessage>
 */
final class CustomerAddressCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddressCustomFieldChangedMessage
    {
        return new CustomerAddressCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
