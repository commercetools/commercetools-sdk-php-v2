...
/**
 * @implements Builder<BusinessUnitCustomFieldRemovedMessage>
 */
final class BusinessUnitCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomFieldRemovedMessage
    {
        return new BusinessUnitCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
