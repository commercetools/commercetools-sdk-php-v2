...
/**
 * @implements Builder<CustomerStoresSetMessage>
 */
final class CustomerStoresSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerStoresSetMessage
    {
        return new CustomerStoresSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerStoresSetMessageBuilder
    {
        return new self();
    }
}
