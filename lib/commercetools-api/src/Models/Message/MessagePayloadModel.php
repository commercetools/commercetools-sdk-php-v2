...
final class MessagePayloadModel extends JsonObjectModel implements MessagePayload
{
    ...
    private static $discriminatorClasses = [
       ...
       'BusinessUnitCustomerGroupAssignmentAdded' => BusinessUnitCustomerGroupAssignmentAddedMessagePayloadModel::class,
       'BusinessUnitCustomerGroupAssignmentRemoved' => BusinessUnitCustomerGroupAssignmentRemovedMessagePayloadModel::class,
       'BusinessUnitCustomerGroupAssignmentsSet' => BusinessUnitCustomerGroupAssignmentsSetMessagePayloadModel::class,
       ...
       'CartEstimatedDeliverySet' => CartEstimatedDeliverySetMessagePayloadModel::class,
       'CartFrozen' => CartFrozenMessagePayloadModel::class,
       'CartLocked' => CartLockedMessagePayloadModel::class,
       ...
       'CartUnlocked' => CartUnlockedMessagePayloadModel::class,
       ...
       'CustomerBillingAddressAdded' => CustomerBillingAddressAddedMessagePayloadModel::class,
       'CustomerBillingAddressRemoved' => CustomerBillingAddressRemovedMessagePayloadModel::class,
       ...
       'CustomerDefaultBillingAddressSet' => CustomerDefaultBillingAddressSetMessagePayloadModel::class,
       'CustomerDefaultShippingAddressSet' => CustomerDefaultShippingAddressSetMessagePayloadModel::class,
       ...
       'CustomerExternalIdSet' => CustomerExternalIdSetMessagePayloadModel::class,
       ...
       'CustomerShippingAddressAdded' => CustomerShippingAddressAddedMessagePayloadModel::class,
       'CustomerShippingAddressRemoved' => CustomerShippingAddressRemovedMessagePayloadModel::class,
       'CustomerStoresSet' => CustomerStoresSetMessagePayloadModel::class,
       ...
       'InventoryEntryOutOfStock' => InventoryEntryOutOfStockMessagePayloadModel::class,
       'InventoryEntryQuantitySet' => InventoryEntryQuantitySetMessagePayloadModel::class,
       'InventoryEntryReorderPoint' => InventoryEntryReorderPointMessagePayloadModel::class,
       'InventoryEntryReservationExpirationInMinutesSet' => InventoryEntryReservationExpirationInMinutesSetMessagePayloadModel::class,
       'InventoryEntrySafetyStock' => InventoryEntrySafetyStockMessagePayloadModel::class,
       ...
       'OrderEstimatedDeliverySet' => OrderEstimatedDeliverySetMessagePayloadModel::class,
       ...
       'OrderPaymentRemoved' => OrderPaymentRemovedMessagePayloadModel::class,
       ...
       'StoreCheckoutUrlTemplateSet' => StoreCheckoutUrlTemplateSetMessagePayloadModel::class,
       'StoreContactUrlSet' => StoreContactUrlSetMessagePayloadModel::class,
       'StoreCookiePolicyUrlSet' => StoreCookiePolicyUrlSetMessagePayloadModel::class,
       ...
       'StoreFaqUrlSet' => StoreFaqUrlSetMessagePayloadModel::class,
       'StoreImprintUrlSet' => StoreImprintUrlSetMessagePayloadModel::class,
       'StoreLanguagesChanged' => StoreLanguagesChangedMessagePayloadModel::class,
       'StoreNameSet' => StoreNameSetMessagePayloadModel::class,
       'StoreOrderUrlTemplateSet' => StoreOrderUrlTemplateSetMessagePayloadModel::class,
       'StorePrivacyPolicyUrlSet' => StorePrivacyPolicyUrlSetMessagePayloadModel::class,
       'StoreProductSelectionsChanged' => StoreProductSelectionsChangedMessagePayloadModel::class,
       'StoreRefundPolicyUrlSet' => StoreRefundPolicyUrlSetMessagePayloadModel::class,
       'StoreShippingPolicyUrlSet' => StoreShippingPolicyUrlSetMessagePayloadModel::class,
       'StoreSupplyChannelsChanged' => StoreSupplyChannelsChangedMessagePayloadModel::class,
       'StoreTermsOfServiceUrlSet' => StoreTermsOfServiceUrlSetMessagePayloadModel::class,
