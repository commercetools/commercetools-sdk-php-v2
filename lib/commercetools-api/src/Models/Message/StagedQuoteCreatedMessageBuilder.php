...
/**
 * @implements Builder<StagedQuoteCreatedMessage>
 */
final class StagedQuoteCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): StagedQuoteCreatedMessage
    {
        return new StagedQuoteCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteCreatedMessageBuilder
    {
        return new self();
    }
}
