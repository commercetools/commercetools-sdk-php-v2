...
/**
 * @implements Builder<ShoppingListMessage>
 */
final class ShoppingListMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ShoppingListMessage
    {
        return new ShoppingListMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ShoppingListMessageBuilder
    {
        return new self();
    }
}
