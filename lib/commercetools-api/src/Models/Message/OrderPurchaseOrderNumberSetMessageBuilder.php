...
/**
 * @implements Builder<OrderPurchaseOrderNumberSetMessage>
 */
final class OrderPurchaseOrderNumberSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderPurchaseOrderNumberSetMessage
    {
        return new OrderPurchaseOrderNumberSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderPurchaseOrderNumberSetMessageBuilder
    {
        return new self();
    }
}
