 ...
 */
final class OrderCustomFieldChangedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomFieldChangedMessagePayload
    {
        return new OrderCustomFieldChangedMessagePayloadModel(
            $this->name,
            $this->value,
            $this->previousValue
        );
    ...
    public static function of(): OrderCustomFieldChangedMessagePayloadBuilder
    {
        return new self();
    }
}
