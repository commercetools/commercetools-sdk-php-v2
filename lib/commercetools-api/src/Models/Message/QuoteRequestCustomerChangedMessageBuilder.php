...
/**
 * @implements Builder<QuoteRequestCustomerChangedMessage>
 */
final class QuoteRequestCustomerChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRequestCustomerChangedMessage
    {
        return new QuoteRequestCustomerChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteRequestCustomerChangedMessageBuilder
    {
        return new self();
    }
}
