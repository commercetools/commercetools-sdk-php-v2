...
/**
 * @implements Builder<RecurringOrderCustomTypeSetMessage>
 */
final class RecurringOrderCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCustomTypeSetMessage
    {
        return new RecurringOrderCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
