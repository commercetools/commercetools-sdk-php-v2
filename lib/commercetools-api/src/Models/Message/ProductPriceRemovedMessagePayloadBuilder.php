 ...
 */
final class ProductPriceRemovedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceRemovedMessagePayload
    {
        return new ProductPriceRemovedMessagePayloadModel(
            $this->variantId,
    ...
    public static function of(): ProductPriceRemovedMessagePayloadBuilder
    {
        return new self();
    }
}
