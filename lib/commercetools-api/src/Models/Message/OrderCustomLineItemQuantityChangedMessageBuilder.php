 ...
 */
final class OrderCustomLineItemQuantityChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomLineItemQuantityChangedMessage
    {
        return new OrderCustomLineItemQuantityChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomLineItemQuantityChangedMessageBuilder
    {
        return new self();
    }
}
