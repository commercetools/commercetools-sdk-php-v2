 ...
 * @internal
 */
final class ProductPriceCustomFieldAddedMessagePayloadModel extends JsonObjectModel implements ProductPriceCustomFieldAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductPriceCustomFieldAdded';
    /**
     *
     * @var ?string
     */
