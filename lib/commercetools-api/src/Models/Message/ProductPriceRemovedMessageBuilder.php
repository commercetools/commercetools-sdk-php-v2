...
/**
 * @implements Builder<ProductPriceRemovedMessage>
 */
final class ProductPriceRemovedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Unique identifier of the <a href="ctp:api:type:ProductVariant">ProductVariant</a> for which the Price was removed.</p>
     *
    ...
    /**
     * <p>The Embedded Price that was removed from the <a href="ctp:api:type:ProductVariant">ProductVariant</a>.</p>
     *
    ...
    public function build(): ProductPriceRemovedMessage
    {
        return new ProductPriceRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceRemovedMessageBuilder
    {
        return new self();
    }
}
