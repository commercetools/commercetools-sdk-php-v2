...
/**
 * @implements Builder<OrderCustomTypeRemovedMessage>
 */
final class OrderCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomTypeRemovedMessage
    {
        return new OrderCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
