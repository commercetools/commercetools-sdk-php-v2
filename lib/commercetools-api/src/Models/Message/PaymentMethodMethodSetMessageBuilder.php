...
/**
 * @implements Builder<PaymentMethodMethodSetMessage>
 */
final class PaymentMethodMethodSetMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Payment Method after the <a href="ctp:api:type:PaymentMethodSetMethodAction">Set Method</a> update action.</p>
     *
    ...
    /**
     * <p>Payment Method before the <a href="ctp:api:type:PaymentMethodSetMethodAction">Set Method</a> update action.</p>
     *
    ...
    public function build(): PaymentMethodMethodSetMessage
    {
        return new PaymentMethodMethodSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodMethodSetMessageBuilder
    {
        return new self();
    }
}
