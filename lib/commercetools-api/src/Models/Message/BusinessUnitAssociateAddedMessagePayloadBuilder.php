 ...
 */
final class BusinessUnitAssociateAddedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociateAddedMessagePayload
    {
        return new BusinessUnitAssociateAddedMessagePayloadModel(
