...
/**
 * @implements Builder<PaymentMethodCustomFieldRemovedMessage>
 */
final class PaymentMethodCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomFieldRemovedMessage
    {
        return new PaymentMethodCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
