 ...
 */
final class PaymentMethodInfoCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoCustomTypeSetMessagePayload
    {
        return new PaymentMethodInfoCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->oldTypeId
        );
    }

    public static function of(): PaymentMethodInfoCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
