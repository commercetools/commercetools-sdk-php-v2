...
/**
 * @implements Builder<PaymentMethodInfoNameSetMessage>
 */
final class PaymentMethodInfoNameSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoNameSetMessage
    {
        return new PaymentMethodInfoNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoNameSetMessageBuilder
    {
        return new self();
    }
}
