...
/**
 * @implements Builder<OrderCustomTypeSetMessage>
 */
final class OrderCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomTypeSetMessage
    {
        return new OrderCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
