 ...
 */
final class ProductVariantTailoringRemovedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductVariantTailoringRemovedMessagePayload
    {
        return new ProductVariantTailoringRemovedMessagePayloadModel(
    ...
    public static function of(): ProductVariantTailoringRemovedMessagePayloadBuilder
    {
        return new self();
    }
}
