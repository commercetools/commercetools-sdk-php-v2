...
/**
 * @implements Builder<CustomerGroupCustomFieldChangedMessage>
 */
final class CustomerGroupCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomFieldChangedMessage
    {
        return new CustomerGroupCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
