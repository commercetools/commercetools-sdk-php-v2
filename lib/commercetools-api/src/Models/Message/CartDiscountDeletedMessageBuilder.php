...
/**
 * @implements Builder<CartDiscountDeletedMessage>
 */
final class CartDiscountDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountDeletedMessage
    {
        return new CartDiscountDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartDiscountDeletedMessageBuilder
    {
        return new self();
    }
}
