...
/**
 * @implements Builder<StagedQuoteDeletedMessage>
 */
final class StagedQuoteDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteDeletedMessage
    {
        return new StagedQuoteDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteDeletedMessageBuilder
    {
        return new self();
    }
}
