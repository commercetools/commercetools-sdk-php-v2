...
/**
 * @implements Builder<StandalonePriceValidUntilSetMessage>
 */
final class StandalonePriceValidUntilSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceValidUntilSetMessage
    {
        return new StandalonePriceValidUntilSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceValidUntilSetMessageBuilder
    {
        return new self();
    }
}
