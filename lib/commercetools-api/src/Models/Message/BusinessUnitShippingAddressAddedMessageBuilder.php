...
/**
 * @implements Builder<BusinessUnitShippingAddressAddedMessage>
 */
final class BusinessUnitShippingAddressAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was added to the <a href="ctp:api:type:BusinessUnit">Business Unit</a> as shipping address.</p>
     *
    ...
    public function build(): BusinessUnitShippingAddressAddedMessage
    {
        return new BusinessUnitShippingAddressAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitShippingAddressAddedMessageBuilder
    {
        return new self();
    }
}
