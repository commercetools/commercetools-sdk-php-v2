...
/**
 * @implements Builder<StandalonePriceTierAddedMessage>
 */
final class StandalonePriceTierAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceTierAddedMessage
    {
        return new StandalonePriceTierAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceTierAddedMessageBuilder
    {
        return new self();
    }
}
