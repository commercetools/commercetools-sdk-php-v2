...
/**
 * @implements Builder<PaymentMethodCustomTypeSetMessage>
 */
final class PaymentMethodCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomTypeSetMessage
    {
        return new PaymentMethodCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
