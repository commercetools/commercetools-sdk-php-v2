...
/**
 * @implements Builder<PaymentMethodInfoInterfaceSetMessage>
 */
final class PaymentMethodInfoInterfaceSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoInterfaceSetMessage
    {
        return new PaymentMethodInfoInterfaceSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoInterfaceSetMessageBuilder
    {
        return new self();
    }
}
