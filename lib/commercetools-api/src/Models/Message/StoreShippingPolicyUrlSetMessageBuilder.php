...
/**
 * @implements Builder<StoreShippingPolicyUrlSetMessage>
 */
final class StoreShippingPolicyUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreShippingPolicyUrlSetMessage
    {
        return new StoreShippingPolicyUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreShippingPolicyUrlSetMessageBuilder
    {
        return new self();
    }
}
