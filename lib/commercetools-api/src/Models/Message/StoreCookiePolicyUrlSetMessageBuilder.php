...
/**
 * @implements Builder<StoreCookiePolicyUrlSetMessage>
 */
final class StoreCookiePolicyUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreCookiePolicyUrlSetMessage
    {
        return new StoreCookiePolicyUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreCookiePolicyUrlSetMessageBuilder
    {
        return new self();
    }
}
