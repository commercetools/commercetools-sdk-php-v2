...
/**
 * @implements Builder<BusinessUnitAddressCustomFieldRemovedMessage>
 */
final class BusinessUnitAddressCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressCustomFieldRemovedMessage
    {
        return new BusinessUnitAddressCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
