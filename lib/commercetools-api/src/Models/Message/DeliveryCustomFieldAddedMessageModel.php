 ...
 * @internal
 */
final class DeliveryCustomFieldAddedMessageModel extends JsonObjectModel implements DeliveryCustomFieldAddedMessage
{
    public const DISCRIMINATOR_VALUE = 'DeliveryCustomFieldAdded';
    /**
     *
     * @var ?string
     */
