 ...
 * @internal
 */
final class RecurringOrderCustomTypeRemovedMessagePayloadModel extends JsonObjectModel implements RecurringOrderCustomTypeRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'RecurringOrderCustomTypeRemoved';
    /**
     *
     * @var ?string
     */
