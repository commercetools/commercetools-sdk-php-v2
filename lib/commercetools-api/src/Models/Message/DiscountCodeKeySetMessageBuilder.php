...
/**
 * @implements Builder<DiscountCodeKeySetMessage>
 */
final class DiscountCodeKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountCodeKeySetMessage
    {
        return new DiscountCodeKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountCodeKeySetMessageBuilder
    {
        return new self();
    }
}
