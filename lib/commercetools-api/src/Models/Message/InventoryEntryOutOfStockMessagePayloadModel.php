 ...
 * @internal
 */
final class InventoryEntryOutOfStockMessagePayloadModel extends JsonObjectModel implements InventoryEntryOutOfStockMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'InventoryEntryOutOfStock';
    /**
     *
     * @var ?string
     */
