...
/**
 * @implements Builder<StandalonePriceTierRemovedMessage>
 */
final class StandalonePriceTierRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceTierRemovedMessage
    {
        return new StandalonePriceTierRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceTierRemovedMessageBuilder
    {
        return new self();
    }
}
