...
/**
 * @implements Builder<OrderCustomLineItemAddedMessage>
 */
final class OrderCustomLineItemAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomLineItemAddedMessage
    {
    ...
    public static function of(): OrderCustomLineItemAddedMessageBuilder
    {
        return new self();
    }
}
