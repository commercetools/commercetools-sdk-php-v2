...
/**
 * @implements Builder<VariantUnpublishedMessage>
 */
final class VariantUnpublishedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): VariantUnpublishedMessage
    {
        return new VariantUnpublishedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): VariantUnpublishedMessageBuilder
    {
        return new self();
    }
}
