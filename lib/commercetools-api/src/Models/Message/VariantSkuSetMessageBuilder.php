...
/**
 * @implements Builder<VariantSkuSetMessage>
 */
final class VariantSkuSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): VariantSkuSetMessage
    {
        return new VariantSkuSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): VariantSkuSetMessageBuilder
    {
        return new self();
    }
}
