...
/**
 * @implements Builder<ProductPriceCustomFieldRemovedMessage>
 */
final class ProductPriceCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldRemovedMessage
    {
        return new ProductPriceCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
