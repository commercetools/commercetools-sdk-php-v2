...
/**
 * @implements Builder<BusinessUnitTopLevelUnitSetMessage>
 */
final class BusinessUnitTopLevelUnitSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitTopLevelUnitSetMessage
    {
        return new BusinessUnitTopLevelUnitSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
