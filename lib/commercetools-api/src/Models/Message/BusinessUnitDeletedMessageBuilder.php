...
/**
 * @implements Builder<BusinessUnitDeletedMessage>
 */
final class BusinessUnitDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitDeletedMessage
    {
        return new BusinessUnitDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitDeletedMessageBuilder
    {
        return new self();
    }
}
