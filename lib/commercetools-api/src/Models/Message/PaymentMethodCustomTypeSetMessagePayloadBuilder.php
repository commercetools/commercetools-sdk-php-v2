 ...
 */
final class PaymentMethodCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCustomTypeSetMessagePayload
    {
        return new PaymentMethodCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->oldTypeId
        );
    }

    public static function of(): PaymentMethodCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
