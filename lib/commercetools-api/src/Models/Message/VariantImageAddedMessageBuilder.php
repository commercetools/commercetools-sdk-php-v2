...
/**
 * @implements Builder<VariantImageAddedMessage>
 */
final class VariantImageAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): VariantImageAddedMessage
    {
        return new VariantImageAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): VariantImageAddedMessageBuilder
    {
        return new self();
    }
}
