...
/**
 * @implements Builder<BusinessUnitNameChangedMessage>
 */
final class BusinessUnitNameChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitNameChangedMessage
    {
        return new BusinessUnitNameChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitNameChangedMessageBuilder
    {
        return new self();
    }
}
