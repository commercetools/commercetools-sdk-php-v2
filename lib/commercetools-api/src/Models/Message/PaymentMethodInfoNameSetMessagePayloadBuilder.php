 ...
 */
final class PaymentMethodInfoNameSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoNameSetMessagePayload
    {
        return new PaymentMethodInfoNameSetMessagePayloadModel(
            $this->name instanceof LocalizedStringBuilder ? $this->name->build() : $this->name,
            $this->oldName instanceof LocalizedStringBuilder ? $this->oldName->build() : $this->oldName
        );
    }

    public static function of(): PaymentMethodInfoNameSetMessagePayloadBuilder
    {
        return new self();
    }
}
