...
/**
 * @implements Builder<CustomerExternalIdSetMessage>
 */
final class CustomerExternalIdSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerExternalIdSetMessage
    {
        return new CustomerExternalIdSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerExternalIdSetMessageBuilder
    {
        return new self();
    }
}
