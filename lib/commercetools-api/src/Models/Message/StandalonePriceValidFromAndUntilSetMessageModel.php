 ...
 * @internal
 */
final class StandalonePriceValidFromAndUntilSetMessageModel extends JsonObjectModel implements StandalonePriceValidFromAndUntilSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_FROM]) && $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_FROM] = $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_FROM]) && $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_FROM] = $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_UNTIL]) && $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_UNTIL] = $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL]) && $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL] = $data[StandalonePriceValidFromAndUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
