...
/**
 * @implements Builder<OrderCustomFieldAddedMessage>
 */
final class OrderCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomFieldAddedMessage
    {
        return new OrderCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
