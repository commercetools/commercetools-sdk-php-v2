...
/**
 * @implements Builder<BusinessUnitShippingAddressRemovedMessage>
 */
final class BusinessUnitShippingAddressRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitShippingAddressRemovedMessage
    {
        return new BusinessUnitShippingAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitShippingAddressRemovedMessageBuilder
    {
        return new self();
    }
}
