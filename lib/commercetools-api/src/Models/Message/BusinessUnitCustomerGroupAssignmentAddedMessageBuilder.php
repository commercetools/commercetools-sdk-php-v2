...
/**
 * @implements Builder<BusinessUnitCustomerGroupAssignmentAddedMessage>
 */
final class BusinessUnitCustomerGroupAssignmentAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomerGroupAssignmentAddedMessage
    {
        return new BusinessUnitCustomerGroupAssignmentAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomerGroupAssignmentAddedMessageBuilder
    {
        return new self();
    }
}
