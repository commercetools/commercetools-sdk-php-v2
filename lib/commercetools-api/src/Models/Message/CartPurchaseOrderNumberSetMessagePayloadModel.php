 ...
 * @internal
 */
final class CartPurchaseOrderNumberSetMessagePayloadModel extends JsonObjectModel implements CartPurchaseOrderNumberSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CartPurchaseOrderNumberSet';
    /**
     *
     * @var ?string
     */
