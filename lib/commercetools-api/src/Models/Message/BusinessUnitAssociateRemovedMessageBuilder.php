...
/**
 * @implements Builder<BusinessUnitAssociateRemovedMessage>
 */
final class BusinessUnitAssociateRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociateRemovedMessage
    {
        return new BusinessUnitAssociateRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAssociateRemovedMessageBuilder
    {
        return new self();
    }
}
