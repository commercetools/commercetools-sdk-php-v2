...
/**
 * @implements Builder<DiscountGroupKeySetMessage>
 */
final class DiscountGroupKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupKeySetMessage
    {
        return new DiscountGroupKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupKeySetMessageBuilder
    {
        return new self();
    }
}
