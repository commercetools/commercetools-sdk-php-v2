...
/**
 * @implements Builder<CustomerCustomTypeSetMessage>
 */
final class CustomerCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerCustomTypeSetMessage
    {
        return new CustomerCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
