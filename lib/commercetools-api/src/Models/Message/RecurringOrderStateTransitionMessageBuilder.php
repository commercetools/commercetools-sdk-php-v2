...
/**
 * @implements Builder<RecurringOrderStateTransitionMessage>
 */
final class RecurringOrderStateTransitionMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderStateTransitionMessage
    {
        return new RecurringOrderStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderStateTransitionMessageBuilder
    {
        return new self();
    }
}
