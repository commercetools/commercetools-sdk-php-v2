...
/**
 * @implements Builder<StagedQuoteStateTransitionMessage>
 */
final class StagedQuoteStateTransitionMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p><a href="ctp:api:type:State">State</a> of the <a href="ctp:api:type:Quote">Quote</a> after the <a href="ctp:api:type:StagedQuoteTransitionStateAction">Transition State</a> update action.</p>
     *
    ...
    /**
     * <p><a href="ctp:api:type:State">State</a> of the <a href="ctp:api:type:Quote">Quote</a> before the <a href="ctp:api:type:StagedQuoteTransitionStateAction">Transition State</a> update action.</p>
     *
    ...
    public function build(): StagedQuoteStateTransitionMessage
    {
        return new StagedQuoteStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteStateTransitionMessageBuilder
    {
        return new self();
    }
}
