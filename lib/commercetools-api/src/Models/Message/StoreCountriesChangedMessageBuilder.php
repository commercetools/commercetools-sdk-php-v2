...
/**
 * @implements Builder<StoreCountriesChangedMessage>
 */
final class StoreCountriesChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreCountriesChangedMessage
    {
        return new StoreCountriesChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreCountriesChangedMessageBuilder
    {
        return new self();
    }
}
