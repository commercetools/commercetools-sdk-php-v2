...
/**
 * @implements Builder<StagedQuoteStateChangedMessage>
 */
final class StagedQuoteStateChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteStateChangedMessage
    {
        return new StagedQuoteStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteStateChangedMessageBuilder
    {
        return new self();
    }
}
