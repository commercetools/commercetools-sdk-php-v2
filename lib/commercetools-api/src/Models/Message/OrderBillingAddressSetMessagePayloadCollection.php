...
/**
 * @extends OrderMessagePayloadCollection<OrderBillingAddressSetMessagePayload>
 * @method OrderBillingAddressSetMessagePayload current()
 * @method OrderBillingAddressSetMessagePayload end()
 * @method OrderBillingAddressSetMessagePayload at($offset)
 */
class OrderBillingAddressSetMessagePayloadCollection extends OrderMessagePayloadCollection
{
    /**
