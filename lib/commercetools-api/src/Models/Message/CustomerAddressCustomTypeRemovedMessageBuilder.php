...
/**
 * @implements Builder<CustomerAddressCustomTypeRemovedMessage>
 */
final class CustomerAddressCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddressCustomTypeRemovedMessage
    {
        return new CustomerAddressCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
