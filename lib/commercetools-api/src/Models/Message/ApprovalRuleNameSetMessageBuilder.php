...
/**
 * @implements Builder<ApprovalRuleNameSetMessage>
 */
final class ApprovalRuleNameSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleNameSetMessage
    {
        return new ApprovalRuleNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleNameSetMessageBuilder
    {
        return new self();
    }
}
