...
/**
 * @implements Builder<ShoppingListLineItemRemovedMessage>
 */
final class ShoppingListLineItemRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ShoppingListLineItemRemovedMessage
    {
        return new ShoppingListLineItemRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ShoppingListLineItemRemovedMessageBuilder
    {
        return new self();
    }
}
