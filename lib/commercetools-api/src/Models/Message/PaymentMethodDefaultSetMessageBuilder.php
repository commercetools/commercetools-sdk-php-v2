...
/**
 * @implements Builder<PaymentMethodDefaultSetMessage>
 */
final class PaymentMethodDefaultSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodDefaultSetMessage
    {
        return new PaymentMethodDefaultSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodDefaultSetMessageBuilder
    {
        return new self();
    }
}
