...
/**
 * @implements Builder<ProductSelectionProductExcludedMessage>
 */
final class ProductSelectionProductExcludedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductSelectionProductExcludedMessage
    {
        return new ProductSelectionProductExcludedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductSelectionProductExcludedMessageBuilder
    {
        return new self();
    }
}
