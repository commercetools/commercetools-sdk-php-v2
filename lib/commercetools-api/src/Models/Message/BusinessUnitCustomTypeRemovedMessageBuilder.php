...
/**
 * @implements Builder<BusinessUnitCustomTypeRemovedMessage>
 */
final class BusinessUnitCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomTypeRemovedMessage
    {
        return new BusinessUnitCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
