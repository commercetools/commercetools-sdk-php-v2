...
/**
 * @implements Builder<BusinessUnitAssociateModeChangedMessage>
 */
final class BusinessUnitAssociateModeChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociateModeChangedMessage
    {
        return new BusinessUnitAssociateModeChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAssociateModeChangedMessageBuilder
    {
        return new self();
    }
}
