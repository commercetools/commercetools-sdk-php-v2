...
/**
 * @implements Builder<ApprovalFlowCreatedMessage>
 */
final class ApprovalFlowCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalFlowCreatedMessage
    {
        return new ApprovalFlowCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalFlowCreatedMessageBuilder
    {
        return new self();
    }
}
