 ...
 * @internal
 */
final class StandalonePriceStagedChangesRemovedMessagePayloadModel extends JsonObjectModel implements StandalonePriceStagedChangesRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'StandalonePriceStagedChangesRemoved';
    /**
     *
     * @var ?string
     */
