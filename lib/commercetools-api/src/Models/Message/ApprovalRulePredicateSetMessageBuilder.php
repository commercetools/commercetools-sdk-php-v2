...
/**
 * @implements Builder<ApprovalRulePredicateSetMessage>
 */
final class ApprovalRulePredicateSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRulePredicateSetMessage
    {
        return new ApprovalRulePredicateSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRulePredicateSetMessageBuilder
    {
        return new self();
    }
}
