...
/**
 * @implements Builder<ProductTailoringImageAddedMessage>
 */
final class ProductTailoringImageAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringImageAddedMessage
    {
        return new ProductTailoringImageAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringImageAddedMessageBuilder
    {
        return new self();
    }
}
