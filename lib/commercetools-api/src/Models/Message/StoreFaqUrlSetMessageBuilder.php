...
/**
 * @implements Builder<StoreFaqUrlSetMessage>
 */
final class StoreFaqUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreFaqUrlSetMessage
    {
        return new StoreFaqUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreFaqUrlSetMessageBuilder
    {
        return new self();
    }
}
