...
/**
 * @implements Builder<StandalonePriceValidFromSetMessage>
 */
final class StandalonePriceValidFromSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceValidFromSetMessage
    {
        return new StandalonePriceValidFromSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceValidFromSetMessageBuilder
    {
        return new self();
    }
}
