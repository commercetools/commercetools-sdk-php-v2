 ...
 * @internal
 */
final class PaymentMethodCustomTypeSetMessagePayloadModel extends JsonObjectModel implements PaymentMethodCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodCustomTypeSet';
    /**
     *
     * @var ?string
     */
