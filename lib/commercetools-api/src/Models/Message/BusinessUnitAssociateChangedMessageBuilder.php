...
/**
 * @implements Builder<BusinessUnitAssociateChangedMessage>
 */
final class BusinessUnitAssociateChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociateChangedMessage
    {
        return new BusinessUnitAssociateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAssociateChangedMessageBuilder
    {
        return new self();
    }
}
