 ...
 * @internal
 */
final class QuoteRequestCustomerChangedMessagePayloadModel extends JsonObjectModel implements QuoteRequestCustomerChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'QuoteRequestCustomerChanged';
    /**
     *
     * @var ?string
     */
