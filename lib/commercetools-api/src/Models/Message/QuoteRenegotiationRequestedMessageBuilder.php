...
/**
 * @implements Builder<QuoteRenegotiationRequestedMessage>
 */
final class QuoteRenegotiationRequestedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRenegotiationRequestedMessage
    {
        return new QuoteRenegotiationRequestedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteRenegotiationRequestedMessageBuilder
    {
        return new self();
    }
}
