...
/**
 * @implements Builder<PaymentMethodPaymentMethodStatusSetMessage>
 */
final class PaymentMethodPaymentMethodStatusSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodPaymentMethodStatusSetMessage
    {
        return new PaymentMethodPaymentMethodStatusSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodPaymentMethodStatusSetMessageBuilder
    {
        return new self();
    }
}
