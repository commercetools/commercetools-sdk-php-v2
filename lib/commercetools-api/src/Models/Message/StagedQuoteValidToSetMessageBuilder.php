...
/**
 * @implements Builder<StagedQuoteValidToSetMessage>
 */
final class StagedQuoteValidToSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteValidToSetMessage
    {
        return new StagedQuoteValidToSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StagedQuoteValidToSetMessageBuilder
    {
        return new self();
    }
}
