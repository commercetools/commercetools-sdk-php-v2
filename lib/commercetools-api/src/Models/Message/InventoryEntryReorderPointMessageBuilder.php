...
/**
 * @implements Builder<InventoryEntryReorderPointMessage>
 */
final class InventoryEntryReorderPointMessageBuilder implements Builder
{
    /**
    ...
    public function build(): InventoryEntryReorderPointMessage
    {
        return new InventoryEntryReorderPointMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): InventoryEntryReorderPointMessageBuilder
    {
        return new self();
    }
}
