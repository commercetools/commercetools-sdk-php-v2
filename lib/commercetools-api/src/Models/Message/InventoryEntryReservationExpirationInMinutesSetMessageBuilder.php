...
/**
 * @implements Builder<InventoryEntryReservationExpirationInMinutesSetMessage>
 */
final class InventoryEntryReservationExpirationInMinutesSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): InventoryEntryReservationExpirationInMinutesSetMessage
    {
        return new InventoryEntryReservationExpirationInMinutesSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): InventoryEntryReservationExpirationInMinutesSetMessageBuilder
    {
        return new self();
    }
}
