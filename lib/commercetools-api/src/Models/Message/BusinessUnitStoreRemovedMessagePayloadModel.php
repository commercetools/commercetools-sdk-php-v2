 ...
 * @internal
 */
final class BusinessUnitStoreRemovedMessagePayloadModel extends JsonObjectModel implements BusinessUnitStoreRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitStoreRemoved';
    /**
     *
     * @var ?string
     */
