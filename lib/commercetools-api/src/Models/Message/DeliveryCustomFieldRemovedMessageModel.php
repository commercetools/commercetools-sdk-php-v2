 ...
 * @internal
 */
final class DeliveryCustomFieldRemovedMessageModel extends JsonObjectModel implements DeliveryCustomFieldRemovedMessage
{
    public const DISCRIMINATOR_VALUE = 'DeliveryCustomFieldRemoved';
    /**
     *
     * @var ?string
     */
