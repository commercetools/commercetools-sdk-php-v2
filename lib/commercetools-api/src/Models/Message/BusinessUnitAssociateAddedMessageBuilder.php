...
/**
 * @implements Builder<BusinessUnitAssociateAddedMessage>
 */
final class BusinessUnitAssociateAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociateAddedMessage
    {
        return new BusinessUnitAssociateAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
