 ...
 */
final class ProductTailoringPublishedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringPublishedMessagePayload
    {
        return new ProductTailoringPublishedMessagePayloadModel(
    ...
    public static function of(): ProductTailoringPublishedMessagePayloadBuilder
    {
        return new self();
    }
}
