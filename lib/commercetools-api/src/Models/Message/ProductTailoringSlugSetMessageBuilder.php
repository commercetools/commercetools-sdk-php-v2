...
/**
 * @implements Builder<ProductTailoringSlugSetMessage>
 */
final class ProductTailoringSlugSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringSlugSetMessage
    {
        return new ProductTailoringSlugSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringSlugSetMessageBuilder
    {
        return new self();
    }
}
