...
/**
 * @extends OrderMessagePayloadCollection<OrderImportedMessagePayload>
 * @method OrderImportedMessagePayload current()
 * @method OrderImportedMessagePayload end()
 * @method OrderImportedMessagePayload at($offset)
 */
class OrderImportedMessagePayloadCollection extends OrderMessagePayloadCollection
{
    /**
