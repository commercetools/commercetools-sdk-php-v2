...
/**
 * @implements Builder<OrderCreatedFromRecurringOrderMessage>
 */
final class OrderCreatedFromRecurringOrderMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCreatedFromRecurringOrderMessage
    {
        return new OrderCreatedFromRecurringOrderMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCreatedFromRecurringOrderMessageBuilder
    {
        return new self();
    }
}
