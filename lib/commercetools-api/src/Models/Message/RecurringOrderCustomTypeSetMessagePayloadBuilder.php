 ...
 */
final class RecurringOrderCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCustomTypeSetMessagePayload
    {
        return new RecurringOrderCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->previousTypeId
        );
    }

    public static function of(): RecurringOrderCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
