 ...
 */
final class InventoryEntrySafetyStockMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): InventoryEntrySafetyStockMessagePayload
    {
        return new InventoryEntrySafetyStockMessagePayloadModel(
            $this->sku,
    ...
    public static function of(): InventoryEntrySafetyStockMessagePayloadBuilder
    {
        return new self();
    }
}
