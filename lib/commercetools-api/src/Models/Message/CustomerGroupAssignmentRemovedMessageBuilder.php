...
/**
 * @implements Builder<CustomerGroupAssignmentRemovedMessage>
 */
final class CustomerGroupAssignmentRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupAssignmentRemovedMessage
    {
        return new CustomerGroupAssignmentRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupAssignmentRemovedMessageBuilder
    {
        return new self();
    }
}
