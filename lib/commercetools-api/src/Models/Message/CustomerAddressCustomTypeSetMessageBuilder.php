...
/**
 * @implements Builder<CustomerAddressCustomTypeSetMessage>
 */
final class CustomerAddressCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddressCustomTypeSetMessage
    {
        return new CustomerAddressCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
