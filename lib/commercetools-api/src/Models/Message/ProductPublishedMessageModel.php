...
final class ProductPublishedMessageModel extends JsonObjectModel implements ProductPublishedMessage
{
    ...
    public function getRemovedImageUrls()
    {
        if (is_null($this->removedImageUrls)) {
            ...
            $data = $this->raw(ProductPublishedMessage::FIELD_REMOVED_IMAGE_URLS);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getProductProjection()
    {
        if (is_null($this->productProjection)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ProductPublishedMessage::FIELD_PRODUCT_PROJECTION);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getScope()
    {
        if (is_null($this->scope)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ProductPublishedMessage::FIELD_SCOPE);
            if (is_null($data)) {
                return null;
            }
