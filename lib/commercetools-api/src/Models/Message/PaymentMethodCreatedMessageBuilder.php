...
/**
 * @implements Builder<PaymentMethodCreatedMessage>
 */
final class PaymentMethodCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodCreatedMessage
    {
        return new PaymentMethodCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodCreatedMessageBuilder
    {
        return new self();
    }
}
