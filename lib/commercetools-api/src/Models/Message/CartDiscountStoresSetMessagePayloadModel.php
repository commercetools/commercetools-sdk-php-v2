 ...
 * @internal
 */
final class CartDiscountStoresSetMessagePayloadModel extends JsonObjectModel implements CartDiscountStoresSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CartDiscountStoresSet';
    /**
     *
     * @var ?string
     */
