...
/**
 * @implements Builder<BusinessUnitStatusChangedMessage>
 */
final class BusinessUnitStatusChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStatusChangedMessage
    {
        return new BusinessUnitStatusChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitStatusChangedMessageBuilder
    {
        return new self();
    }
}
