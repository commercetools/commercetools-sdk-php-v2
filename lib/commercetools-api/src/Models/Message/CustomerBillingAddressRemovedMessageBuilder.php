...
/**
 * @implements Builder<CustomerBillingAddressRemovedMessage>
 */
final class CustomerBillingAddressRemovedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was removed from the <a href="ctp:api:type:Customer">Customer</a> <code>billingAddressIds</code>.</p>
     *
    ...
    public function build(): CustomerBillingAddressRemovedMessage
    {
        return new CustomerBillingAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerBillingAddressRemovedMessageBuilder
    {
        return new self();
    }
}
