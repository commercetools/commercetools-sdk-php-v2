...
/**
 * @implements Builder<RecurringOrderFailedMessage>
 */
final class RecurringOrderFailedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderFailedMessage
    {
        return new RecurringOrderFailedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderFailedMessageBuilder
    {
        return new self();
    }
}
