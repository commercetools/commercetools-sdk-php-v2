...
/**
 * @implements Builder<DiscountCodeCreatedMessage>
 */
final class DiscountCodeCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountCodeCreatedMessage
    {
        return new DiscountCodeCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountCodeCreatedMessageBuilder
    {
        return new self();
    }
}
