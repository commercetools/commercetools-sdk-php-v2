 ...
 * @internal
 */
final class CustomerPasswordTokenCreatedMessagePayloadModel extends JsonObjectModel implements CustomerPasswordTokenCreatedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CustomerPasswordTokenCreated';
    /**
     *
     * @var ?string
     */
    ...
    {
        $data = $this->toArray();
        if (isset($data[CustomerPasswordTokenCreatedMessagePayload::FIELD_EXPIRES_AT]) && $data[CustomerPasswordTokenCreatedMessagePayload::FIELD_EXPIRES_AT] instanceof \DateTimeImmutable) {
            $data[CustomerPasswordTokenCreatedMessagePayload::FIELD_EXPIRES_AT] = $data[CustomerPasswordTokenCreatedMessagePayload::FIELD_EXPIRES_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
