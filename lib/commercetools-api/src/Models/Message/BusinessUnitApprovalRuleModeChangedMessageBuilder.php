...
/**
 * @implements Builder<BusinessUnitApprovalRuleModeChangedMessage>
 */
final class BusinessUnitApprovalRuleModeChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitApprovalRuleModeChangedMessage
    {
        return new BusinessUnitApprovalRuleModeChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitApprovalRuleModeChangedMessageBuilder
    {
        return new self();
    }
}
