 ...
 * @internal
 */
final class StandalonePriceValidUntilSetMessageModel extends JsonObjectModel implements StandalonePriceValidUntilSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[StandalonePriceValidUntilSetMessage::FIELD_VALID_UNTIL]) && $data[StandalonePriceValidUntilSetMessage::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidUntilSetMessage::FIELD_VALID_UNTIL] = $data[StandalonePriceValidUntilSetMessage::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePriceValidUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL]) && $data[StandalonePriceValidUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[StandalonePriceValidUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL] = $data[StandalonePriceValidUntilSetMessage::FIELD_PREVIOUS_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
