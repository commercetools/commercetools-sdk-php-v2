...
/**
 * @implements Builder<AssociateRolePermissionAddedMessage>
 */
final class AssociateRolePermissionAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRolePermissionAddedMessage
    {
        return new AssociateRolePermissionAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRolePermissionAddedMessageBuilder
    {
        return new self();
    }
}
