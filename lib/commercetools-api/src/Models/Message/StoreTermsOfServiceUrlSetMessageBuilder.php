...
/**
 * @implements Builder<StoreTermsOfServiceUrlSetMessage>
 */
final class StoreTermsOfServiceUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreTermsOfServiceUrlSetMessage
    {
        return new StoreTermsOfServiceUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreTermsOfServiceUrlSetMessageBuilder
    {
        return new self();
    }
}
