 ...
 * @internal
 */
final class BusinessUnitAssociateChangedMessagePayloadModel extends JsonObjectModel implements BusinessUnitAssociateChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitAssociateChanged';
    /**
     *
     * @var ?string
     */
