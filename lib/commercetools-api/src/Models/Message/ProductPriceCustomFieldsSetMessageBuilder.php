...
/**
 * @implements Builder<ProductPriceCustomFieldsSetMessage>
 */
final class ProductPriceCustomFieldsSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldsSetMessage
    {
        return new ProductPriceCustomFieldsSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceCustomFieldsSetMessageBuilder
    {
        return new self();
    }
}
