...
/**
 * @implements Builder<StorePrivacyPolicyUrlSetMessage>
 */
final class StorePrivacyPolicyUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StorePrivacyPolicyUrlSetMessage
    {
        return new StorePrivacyPolicyUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StorePrivacyPolicyUrlSetMessageBuilder
    {
        return new self();
    }
}
