...
/**
 * @implements Builder<PaymentMethodInfoCustomFieldChangedMessage>
 */
final class PaymentMethodInfoCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoCustomFieldChangedMessage
    {
        return new PaymentMethodInfoCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
