 ...
 */
final class ProductSelectionVariantExclusionChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductSelectionVariantExclusionChangedMessage
    {
        return new ProductSelectionVariantExclusionChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductSelectionVariantExclusionChangedMessageBuilder
    {
        return new self();
    }
}
