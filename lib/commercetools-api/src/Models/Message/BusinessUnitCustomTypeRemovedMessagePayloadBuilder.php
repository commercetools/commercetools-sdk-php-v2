 ...
 */
final class BusinessUnitCustomTypeRemovedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomTypeRemovedMessagePayload
    {
        return new BusinessUnitCustomTypeRemovedMessagePayloadModel(
            $this->oldTypeId
        );
    }

    public static function of(): BusinessUnitCustomTypeRemovedMessagePayloadBuilder
    {
        return new self();
    }
}
