...
/**
 * @implements Builder<StoreLanguagesChangedMessage>
 */
final class StoreLanguagesChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreLanguagesChangedMessage
    {
        return new StoreLanguagesChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreLanguagesChangedMessageBuilder
    {
        return new self();
    }
}
