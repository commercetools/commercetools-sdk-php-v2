...
/**
 * @implements Builder<CustomerGroupCustomFieldAddedMessage>
 */
final class CustomerGroupCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomFieldAddedMessage
    {
        return new CustomerGroupCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
