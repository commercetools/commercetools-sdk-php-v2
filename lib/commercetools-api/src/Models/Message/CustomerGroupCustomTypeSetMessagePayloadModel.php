 ...
 * @internal
 */
final class CustomerGroupCustomTypeSetMessagePayloadModel extends JsonObjectModel implements CustomerGroupCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CustomerGroupCustomTypeSet';
    /**
     *
     * @var ?string
     */
