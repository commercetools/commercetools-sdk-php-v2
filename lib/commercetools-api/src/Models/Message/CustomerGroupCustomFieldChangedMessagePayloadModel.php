 ...
 * @internal
 */
final class CustomerGroupCustomFieldChangedMessagePayloadModel extends JsonObjectModel implements CustomerGroupCustomFieldChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CustomerGroupCustomFieldChanged';
    /**
     *
     * @var ?string
     */
