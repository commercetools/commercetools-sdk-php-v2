...
/**
 * @implements Builder<CustomerDefaultBillingAddressSetMessage>
 */
final class CustomerDefaultBillingAddressSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerDefaultBillingAddressSetMessage
    {
        return new CustomerDefaultBillingAddressSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerDefaultBillingAddressSetMessageBuilder
    {
        return new self();
    }
}
