 ...
 * @internal
 */
final class RecurringOrderStartsAtSetMessageModel extends JsonObjectModel implements RecurringOrderStartsAtSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[RecurringOrderStartsAtSetMessage::FIELD_STARTS_AT]) && $data[RecurringOrderStartsAtSetMessage::FIELD_STARTS_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderStartsAtSetMessage::FIELD_STARTS_AT] = $data[RecurringOrderStartsAtSetMessage::FIELD_STARTS_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[RecurringOrderStartsAtSetMessage::FIELD_OLD_STARTS_AT]) && $data[RecurringOrderStartsAtSetMessage::FIELD_OLD_STARTS_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderStartsAtSetMessage::FIELD_OLD_STARTS_AT] = $data[RecurringOrderStartsAtSetMessage::FIELD_OLD_STARTS_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
