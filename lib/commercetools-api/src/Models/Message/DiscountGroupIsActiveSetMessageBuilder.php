...
/**
 * @implements Builder<DiscountGroupIsActiveSetMessage>
 */
final class DiscountGroupIsActiveSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupIsActiveSetMessage
    {
        return new DiscountGroupIsActiveSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupIsActiveSetMessageBuilder
    {
        return new self();
    }
}
