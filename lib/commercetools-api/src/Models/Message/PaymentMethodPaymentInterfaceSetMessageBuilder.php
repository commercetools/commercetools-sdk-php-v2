 ...
 */
final class PaymentMethodPaymentInterfaceSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodPaymentInterfaceSetMessage
    {
        return new PaymentMethodPaymentInterfaceSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodPaymentInterfaceSetMessageBuilder
    {
        return new self();
    }
}
