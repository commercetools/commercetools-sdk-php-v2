...
/**
 * @implements Builder<OrderCustomFieldChangedMessage>
 */
final class OrderCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomFieldChangedMessage
    {
        return new OrderCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
