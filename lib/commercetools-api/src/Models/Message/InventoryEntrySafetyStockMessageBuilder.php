...
/**
 * @implements Builder<InventoryEntrySafetyStockMessage>
 */
final class InventoryEntrySafetyStockMessageBuilder implements Builder
{
    /**
    ...
    public function build(): InventoryEntrySafetyStockMessage
    {
        return new InventoryEntrySafetyStockMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): InventoryEntrySafetyStockMessageBuilder
    {
        return new self();
    }
}
