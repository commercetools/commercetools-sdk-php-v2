...
/**
 * @implements Builder<AssociateRoleDeletedMessage>
 */
final class AssociateRoleDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRoleDeletedMessage
    {
        return new AssociateRoleDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRoleDeletedMessageBuilder
    {
        return new self();
    }
}
