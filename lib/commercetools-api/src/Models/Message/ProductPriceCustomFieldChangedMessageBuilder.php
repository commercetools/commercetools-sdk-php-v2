...
/**
 * @implements Builder<ProductPriceCustomFieldChangedMessage>
 */
final class ProductPriceCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldChangedMessage
    {
        return new ProductPriceCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
