 ...
 * @internal
 */
final class RecurringOrderCustomFieldChangedMessagePayloadModel extends JsonObjectModel implements RecurringOrderCustomFieldChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'RecurringOrderCustomFieldChanged';
    /**
     *
     * @var ?string
     */
