...
/**
 * @implements Builder<BusinessUnitAddressCustomFieldChangedMessage>
 */
final class BusinessUnitAddressCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressCustomFieldChangedMessage
    {
        return new BusinessUnitAddressCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
