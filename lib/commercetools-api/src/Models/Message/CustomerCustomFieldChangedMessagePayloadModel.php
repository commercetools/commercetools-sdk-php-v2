 ...
 * @internal
 */
final class CustomerCustomFieldChangedMessagePayloadModel extends JsonObjectModel implements CustomerCustomFieldChangedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CustomerCustomFieldChanged';
    /**
     *
     * @var ?string
     */
