 ...
 * @internal
 */
final class OrderCustomTypeSetMessagePayloadModel extends JsonObjectModel implements OrderCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'OrderCustomTypeSet';
    /**
     *
     * @var ?string
     */
