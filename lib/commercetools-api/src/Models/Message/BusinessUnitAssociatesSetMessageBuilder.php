...
/**
 * @implements Builder<BusinessUnitAssociatesSetMessage>
 */
final class BusinessUnitAssociatesSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAssociatesSetMessage
    {
        return new BusinessUnitAssociatesSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAssociatesSetMessageBuilder
    {
        return new self();
    }
}
