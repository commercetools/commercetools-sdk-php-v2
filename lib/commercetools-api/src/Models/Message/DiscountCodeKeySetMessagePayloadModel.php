 ...
 * @internal
 */
final class DiscountCodeKeySetMessagePayloadModel extends JsonObjectModel implements DiscountCodeKeySetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'DiscountCodeKeySet';
    /**
     *
     * @var ?string
     */
