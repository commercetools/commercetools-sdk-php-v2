 ...
 */
final class BusinessUnitAddressChangedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public static function of(): BusinessUnitAddressChangedMessagePayloadBuilder
    {
        return new self();
    }
}
