...
/**
 * @implements Builder<PaymentMethodInfoInterfaceAccountSetMessage>
 */
final class PaymentMethodInfoInterfaceAccountSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoInterfaceAccountSetMessage
    {
        return new PaymentMethodInfoInterfaceAccountSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoInterfaceAccountSetMessageBuilder
    {
        return new self();
    }
}
