 ...
 * @internal
 */
final class StandalonePriceKeySetMessagePayloadModel extends JsonObjectModel implements StandalonePriceKeySetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'StandalonePriceKeySet';
    /**
     *
     * @var ?string
     */
