...
/**
 * @implements Builder<PaymentMethodKeySetMessage>
 */
final class PaymentMethodKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodKeySetMessage
    {
        return new PaymentMethodKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodKeySetMessageBuilder
    {
        return new self();
    }
}
