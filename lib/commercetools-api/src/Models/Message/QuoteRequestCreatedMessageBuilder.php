...
/**
 * @implements Builder<QuoteRequestCreatedMessage>
 */
final class QuoteRequestCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRequestCreatedMessage
    {
    ...
    public static function of(): QuoteRequestCreatedMessageBuilder
    {
        return new self();
    }
}
