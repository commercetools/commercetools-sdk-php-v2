 ...
 */
final class StagedQuoteStateTransitionMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteStateTransitionMessagePayload
    {
        return new StagedQuoteStateTransitionMessagePayloadModel(
    ...
    public static function of(): StagedQuoteStateTransitionMessagePayloadBuilder
    {
        return new self();
    }
}
