...
/**
 * @implements Builder<BusinessUnitStoreRemovedMessage>
 */
final class BusinessUnitStoreRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitStoreRemovedMessage
    {
        return new BusinessUnitStoreRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitStoreRemovedMessageBuilder
    {
        return new self();
    }
}
