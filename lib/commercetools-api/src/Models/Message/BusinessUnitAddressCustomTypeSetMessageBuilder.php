...
/**
 * @implements Builder<BusinessUnitAddressCustomTypeSetMessage>
 */
final class BusinessUnitAddressCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressCustomTypeSetMessage
    {
        return new BusinessUnitAddressCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
