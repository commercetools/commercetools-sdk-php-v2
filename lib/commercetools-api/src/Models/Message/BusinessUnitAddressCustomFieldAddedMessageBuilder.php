...
/**
 * @implements Builder<BusinessUnitAddressCustomFieldAddedMessage>
 */
final class BusinessUnitAddressCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressCustomFieldAddedMessage
    {
        return new BusinessUnitAddressCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
