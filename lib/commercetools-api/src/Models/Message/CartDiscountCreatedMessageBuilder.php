...
/**
 * @implements Builder<CartDiscountCreatedMessage>
 */
final class CartDiscountCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountCreatedMessage
    {
        return new CartDiscountCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartDiscountCreatedMessageBuilder
    {
        return new self();
    }
}
