...
/**
 * @implements Builder<ProductTailoringNameSetMessage>
 */
final class ProductTailoringNameSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringNameSetMessage
    {
        return new ProductTailoringNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringNameSetMessageBuilder
    {
        return new self();
    }
}
