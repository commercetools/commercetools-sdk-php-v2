...
/**
 * @implements Builder<CustomerPasswordTokenCreatedMessage>
 */
final class CustomerPasswordTokenCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerPasswordTokenCreatedMessage
    {
        return new CustomerPasswordTokenCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerPasswordTokenCreatedMessageBuilder
    {
        return new self();
    }
}
