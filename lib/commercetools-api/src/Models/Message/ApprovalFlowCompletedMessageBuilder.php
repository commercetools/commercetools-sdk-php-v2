...
/**
 * @implements Builder<ApprovalFlowCompletedMessage>
 */
final class ApprovalFlowCompletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalFlowCompletedMessage
    {
        return new ApprovalFlowCompletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalFlowCompletedMessageBuilder
    {
        return new self();
    }
}
