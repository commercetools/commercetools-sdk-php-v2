...
/**
 * @implements Builder<BusinessUnitCustomerGroupAssignmentRemovedMessage>
 */
final class BusinessUnitCustomerGroupAssignmentRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomerGroupAssignmentRemovedMessage
    {
        return new BusinessUnitCustomerGroupAssignmentRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomerGroupAssignmentRemovedMessageBuilder
    {
        return new self();
    }
}
