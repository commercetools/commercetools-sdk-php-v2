...
/**
 * @implements Builder<ProductPriceCustomFieldAddedMessage>
 */
final class ProductPriceCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldAddedMessage
    {
        return new ProductPriceCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
