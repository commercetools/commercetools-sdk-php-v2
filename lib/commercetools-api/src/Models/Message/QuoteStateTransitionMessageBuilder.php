...
/**
 * @implements Builder<QuoteStateTransitionMessage>
 */
final class QuoteStateTransitionMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteStateTransitionMessage
    {
        return new QuoteStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteStateTransitionMessageBuilder
    {
        return new self();
    }
}
