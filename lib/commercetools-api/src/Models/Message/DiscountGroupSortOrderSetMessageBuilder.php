...
/**
 * @implements Builder<DiscountGroupSortOrderSetMessage>
 */
final class DiscountGroupSortOrderSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupSortOrderSetMessage
    {
        return new DiscountGroupSortOrderSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupSortOrderSetMessageBuilder
    {
        return new self();
    }
}
