...
/**
 * @implements Builder<PaymentTransactionInterfaceIdSetMessage>
 */
final class PaymentTransactionInterfaceIdSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentTransactionInterfaceIdSetMessage
    {
        return new PaymentTransactionInterfaceIdSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentTransactionInterfaceIdSetMessageBuilder
    {
        return new self();
    }
}
