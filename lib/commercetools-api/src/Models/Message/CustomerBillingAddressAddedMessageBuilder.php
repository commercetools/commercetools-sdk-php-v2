...
/**
 * @implements Builder<CustomerBillingAddressAddedMessage>
 */
final class CustomerBillingAddressAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was added to the <a href="ctp:api:type:Customer">Customer</a> <code>billingAddressIds</code>.</p>
     *
    ...
    public function build(): CustomerBillingAddressAddedMessage
    {
        return new CustomerBillingAddressAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerBillingAddressAddedMessageBuilder
    {
        return new self();
    }
}
