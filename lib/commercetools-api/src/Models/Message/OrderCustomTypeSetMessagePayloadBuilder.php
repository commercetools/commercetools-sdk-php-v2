...
/**
 * @implements Builder<OrderCustomTypeSetMessagePayload>
 */
final class OrderCustomTypeSetMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): OrderCustomTypeSetMessagePayload
    {
        return new OrderCustomTypeSetMessagePayloadModel(
            $this->customFields instanceof CustomFieldsBuilder ? $this->customFields->build() : $this->customFields,
            $this->previousTypeId
        );
    }

    public static function of(): OrderCustomTypeSetMessagePayloadBuilder
    {
        return new self();
    }
}
