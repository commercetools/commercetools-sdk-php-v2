 ...
 * @internal
 */
final class DeliveryCustomTypeSetMessagePayloadModel extends JsonObjectModel implements DeliveryCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'DeliveryCustomTypeSet';
    /**
     *
     * @var ?string
     */
