...
/**
 * @implements Builder<VariantImagesSetMessage>
 */
final class VariantImagesSetMessageBuilder implements Builder
{
    /**
    ...
    public static function of(): VariantImagesSetMessageBuilder
    {
        return new self();
    }
}
