 ...
 * @internal
 */
final class RecurringOrderExpiresAtSetMessageModel extends JsonObjectModel implements RecurringOrderExpiresAtSetMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[RecurringOrderExpiresAtSetMessage::FIELD_NEW_EXPIRES_AT]) && $data[RecurringOrderExpiresAtSetMessage::FIELD_NEW_EXPIRES_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderExpiresAtSetMessage::FIELD_NEW_EXPIRES_AT] = $data[RecurringOrderExpiresAtSetMessage::FIELD_NEW_EXPIRES_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[RecurringOrderExpiresAtSetMessage::FIELD_OLD_EXPIRES_AT]) && $data[RecurringOrderExpiresAtSetMessage::FIELD_OLD_EXPIRES_AT] instanceof \DateTimeImmutable) {
            $data[RecurringOrderExpiresAtSetMessage::FIELD_OLD_EXPIRES_AT] = $data[RecurringOrderExpiresAtSetMessage::FIELD_OLD_EXPIRES_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
