...
/**
 * @implements Builder<StoreCheckoutUrlTemplateSetMessage>
 */
final class StoreCheckoutUrlTemplateSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreCheckoutUrlTemplateSetMessage
    {
        return new StoreCheckoutUrlTemplateSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreCheckoutUrlTemplateSetMessageBuilder
    {
        return new self();
    }
}
