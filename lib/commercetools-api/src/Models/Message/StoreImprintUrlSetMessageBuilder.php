...
/**
 * @implements Builder<StoreImprintUrlSetMessage>
 */
final class StoreImprintUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreImprintUrlSetMessage
    {
        return new StoreImprintUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreImprintUrlSetMessageBuilder
    {
        return new self();
    }
}
