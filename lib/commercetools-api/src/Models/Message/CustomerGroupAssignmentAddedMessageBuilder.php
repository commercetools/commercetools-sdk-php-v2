...
/**
 * @implements Builder<CustomerGroupAssignmentAddedMessage>
 */
final class CustomerGroupAssignmentAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p><a href="ctp:api:type:CustomerGroupAssignment">CustomerGroupAssignment</a> that was added during the <a href="ctp:api:type:CustomerAddCustomerGroupAssignmentAction">Add CustomerGroupAssignment</a> update action.</p>
     *
    ...
    public function build(): CustomerGroupAssignmentAddedMessage
    {
        return new CustomerGroupAssignmentAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupAssignmentAddedMessageBuilder
    {
        return new self();
    }
}
