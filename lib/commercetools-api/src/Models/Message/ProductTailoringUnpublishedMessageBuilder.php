...
/**
 * @implements Builder<ProductTailoringUnpublishedMessage>
 */
final class ProductTailoringUnpublishedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringUnpublishedMessage
    {
        return new ProductTailoringUnpublishedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringUnpublishedMessageBuilder
    {
        return new self();
    }
}
