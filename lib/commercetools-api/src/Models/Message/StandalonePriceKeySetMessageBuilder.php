...
/**
 * @implements Builder<StandalonePriceKeySetMessage>
 */
final class StandalonePriceKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceKeySetMessage
    {
        return new StandalonePriceKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceKeySetMessageBuilder
    {
        return new self();
    }
}
