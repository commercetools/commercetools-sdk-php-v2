 ...
 */
final class PaymentMethodInfoCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoCustomTypeRemovedMessage
    {
        return new PaymentMethodInfoCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
