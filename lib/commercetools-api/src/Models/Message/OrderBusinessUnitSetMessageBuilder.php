...
/**
 * @implements Builder<OrderBusinessUnitSetMessage>
 */
final class OrderBusinessUnitSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): OrderBusinessUnitSetMessage
    {
        return new OrderBusinessUnitSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderBusinessUnitSetMessageBuilder
    {
        return new self();
    }
}
