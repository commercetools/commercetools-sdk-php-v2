 ...
 * @internal
 */
final class ProductPriceCustomFieldRemovedMessageModel extends JsonObjectModel implements ProductPriceCustomFieldRemovedMessage
{
    public const DISCRIMINATOR_VALUE = 'ProductPriceCustomFieldRemoved';
    /**
     *
     * @var ?string
     */
