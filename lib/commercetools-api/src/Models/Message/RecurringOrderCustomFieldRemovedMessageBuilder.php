...
/**
 * @implements Builder<RecurringOrderCustomFieldRemovedMessage>
 */
final class RecurringOrderCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCustomFieldRemovedMessage
    {
        return new RecurringOrderCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
