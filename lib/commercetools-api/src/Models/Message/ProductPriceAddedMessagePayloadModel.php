 ...
 * @internal
 */
final class ProductPriceAddedMessagePayloadModel extends JsonObjectModel implements ProductPriceAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductPriceAdded';
    /**
     *
     * @var ?string
     */
