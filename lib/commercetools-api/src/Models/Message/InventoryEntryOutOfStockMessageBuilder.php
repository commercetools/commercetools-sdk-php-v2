...
/**
 * @implements Builder<InventoryEntryOutOfStockMessage>
 */
final class InventoryEntryOutOfStockMessageBuilder implements Builder
{
    /**
    ...
    public function build(): InventoryEntryOutOfStockMessage
    {
        return new InventoryEntryOutOfStockMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): InventoryEntryOutOfStockMessageBuilder
    {
        return new self();
    }
}
