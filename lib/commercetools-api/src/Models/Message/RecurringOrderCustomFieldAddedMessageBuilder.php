...
/**
 * @implements Builder<RecurringOrderCustomFieldAddedMessage>
 */
final class RecurringOrderCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderCustomFieldAddedMessage
    {
        return new RecurringOrderCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
