 ...
 */
final class ProductPriceCustomFieldChangedMessagePayloadBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldChangedMessagePayload
    {
        return new ProductPriceCustomFieldChangedMessagePayloadModel(
            $this->priceId,
            $this->variantId,
            $this->staged,
            $this->name,
    ...
    public static function of(): ProductPriceCustomFieldChangedMessagePayloadBuilder
    {
        return new self();
    }
}
