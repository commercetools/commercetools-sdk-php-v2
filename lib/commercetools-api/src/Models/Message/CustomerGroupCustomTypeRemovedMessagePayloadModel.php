 ...
 * @internal
 */
final class CustomerGroupCustomTypeRemovedMessagePayloadModel extends JsonObjectModel implements CustomerGroupCustomTypeRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'CustomerGroupCustomTypeRemoved';
    /**
     *
     * @var ?string
     */
