 ...
 * @internal
 */
final class ShoppingListLineItemRemovedMessagePayloadModel extends JsonObjectModel implements ShoppingListLineItemRemovedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ShoppingListLineItemRemoved';
    /**
     *
     * @var ?string
     */
