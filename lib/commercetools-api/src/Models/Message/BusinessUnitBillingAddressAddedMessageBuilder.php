...
/**
 * @implements Builder<BusinessUnitBillingAddressAddedMessage>
 */
final class BusinessUnitBillingAddressAddedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p>The address that was added to the <a href="ctp:api:type:BusinessUnit">Business Unit</a> as billing address.</p>
     *
    ...
    public function build(): BusinessUnitBillingAddressAddedMessage
    {
        return new BusinessUnitBillingAddressAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitBillingAddressAddedMessageBuilder
    {
        return new self();
    }
}
