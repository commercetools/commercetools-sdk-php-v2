...
/**
 * @implements Builder<ApprovalRuleStatusSetMessage>
 */
final class ApprovalRuleStatusSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleStatusSetMessage
    {
        return new ApprovalRuleStatusSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleStatusSetMessageBuilder
    {
        return new self();
    }
}
