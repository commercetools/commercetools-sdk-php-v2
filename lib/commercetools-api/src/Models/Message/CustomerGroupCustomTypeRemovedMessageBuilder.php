...
/**
 * @implements Builder<CustomerGroupCustomTypeRemovedMessage>
 */
final class CustomerGroupCustomTypeRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomTypeRemovedMessage
    {
        return new CustomerGroupCustomTypeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupCustomTypeRemovedMessageBuilder
    {
        return new self();
    }
}
