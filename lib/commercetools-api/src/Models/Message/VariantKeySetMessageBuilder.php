...
/**
 * @implements Builder<VariantKeySetMessage>
 */
final class VariantKeySetMessageBuilder implements Builder
{
    /**
    ...
    public static function of(): VariantKeySetMessageBuilder
    {
        return new self();
    }
}
