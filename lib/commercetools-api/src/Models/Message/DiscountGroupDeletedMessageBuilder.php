...
/**
 * @implements Builder<DiscountGroupDeletedMessage>
 */
final class DiscountGroupDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupDeletedMessage
    {
        return new DiscountGroupDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupDeletedMessageBuilder
    {
        return new self();
    }
}
