...
/**
 * @implements Builder<CartLockedMessage>
 */
final class CartLockedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartLockedMessage
    {
        return new CartLockedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartLockedMessageBuilder
    {
        return new self();
    }
}
