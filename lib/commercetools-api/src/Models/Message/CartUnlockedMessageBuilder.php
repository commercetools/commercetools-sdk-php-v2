...
/**
 * @implements Builder<CartUnlockedMessage>
 */
final class CartUnlockedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartUnlockedMessage
    {
        return new CartUnlockedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartUnlockedMessageBuilder
    {
        return new self();
    }
}
