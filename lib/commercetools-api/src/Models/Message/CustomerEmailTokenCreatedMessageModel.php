 ...
 * @internal
 */
final class CustomerEmailTokenCreatedMessageModel extends JsonObjectModel implements CustomerEmailTokenCreatedMessage
{
    ...
    public function jsonSerialize()
    {
        ...
        if (isset($data[CustomerEmailTokenCreatedMessage::FIELD_EXPIRES_AT]) && $data[CustomerEmailTokenCreatedMessage::FIELD_EXPIRES_AT] instanceof \DateTimeImmutable) {
            $data[CustomerEmailTokenCreatedMessage::FIELD_EXPIRES_AT] = $data[CustomerEmailTokenCreatedMessage::FIELD_EXPIRES_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
