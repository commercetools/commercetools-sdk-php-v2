...
/**
 * @implements Builder<BusinessUnitCreatedMessage>
 */
final class BusinessUnitCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCreatedMessage
    {
        return new BusinessUnitCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCreatedMessageBuilder
    {
        return new self();
    }
}
