...
/**
 * @implements Builder<ProductPriceChangedMessage>
 */
final class ProductPriceChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceChangedMessage
    {
        return new ProductPriceChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceChangedMessageBuilder
    {
        return new self();
    }
}
