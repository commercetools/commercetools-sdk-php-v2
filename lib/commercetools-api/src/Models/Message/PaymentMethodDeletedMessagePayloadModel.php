 ...
 * @internal
 */
final class PaymentMethodDeletedMessagePayloadModel extends JsonObjectModel implements PaymentMethodDeletedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'PaymentMethodDeleted';
    /**
     *
     * @var ?string
     */
