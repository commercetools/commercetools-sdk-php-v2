...
/**
 * @implements Builder<ProductTailoringKeySetMessage>
 */
final class ProductTailoringKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringKeySetMessage
    {
        return new ProductTailoringKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductTailoringKeySetMessageBuilder
    {
        return new self();
    }
}
