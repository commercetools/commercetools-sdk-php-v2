...
/**
 * @implements Builder<QuoteDeletedMessage>
 */
final class QuoteDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteDeletedMessage
    {
        return new QuoteDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteDeletedMessageBuilder
    {
        return new self();
    }
}
