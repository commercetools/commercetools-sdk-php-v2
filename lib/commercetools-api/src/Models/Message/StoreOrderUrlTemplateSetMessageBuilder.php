...
/**
 * @implements Builder<StoreOrderUrlTemplateSetMessage>
 */
final class StoreOrderUrlTemplateSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreOrderUrlTemplateSetMessage
    {
        return new StoreOrderUrlTemplateSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreOrderUrlTemplateSetMessageBuilder
    {
        return new self();
    }
}
