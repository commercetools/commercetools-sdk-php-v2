...
/**
 * @implements Builder<CustomerDefaultShippingAddressSetMessage>
 */
final class CustomerDefaultShippingAddressSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerDefaultShippingAddressSetMessage
    {
        return new CustomerDefaultShippingAddressSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerDefaultShippingAddressSetMessageBuilder
    {
        return new self();
    }
}
