...
/**
 * @implements Builder<RecurringOrderScheduleSetMessage>
 */
final class RecurringOrderScheduleSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderScheduleSetMessage
    {
        return new RecurringOrderScheduleSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderScheduleSetMessageBuilder
    {
        return new self();
    }
}
