...
/**
 * @implements Builder<VariantStagedChangesRemovedMessage>
 */
final class VariantStagedChangesRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): VariantStagedChangesRemovedMessage
    {
        return new VariantStagedChangesRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): VariantStagedChangesRemovedMessageBuilder
    {
        return new self();
    }
}
