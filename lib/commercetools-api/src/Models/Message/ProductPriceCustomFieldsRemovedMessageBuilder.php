...
/**
 * @implements Builder<ProductPriceCustomFieldsRemovedMessage>
 */
final class ProductPriceCustomFieldsRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceCustomFieldsRemovedMessage
    {
        return new ProductPriceCustomFieldsRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceCustomFieldsRemovedMessageBuilder
    {
        return new self();
    }
}
