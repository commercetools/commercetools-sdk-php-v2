...
/**
 * @implements Builder<RecurringOrderExpiresAtSetMessage>
 */
final class RecurringOrderExpiresAtSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): RecurringOrderExpiresAtSetMessage
    {
        return new RecurringOrderExpiresAtSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): RecurringOrderExpiresAtSetMessageBuilder
    {
        return new self();
    }
}
