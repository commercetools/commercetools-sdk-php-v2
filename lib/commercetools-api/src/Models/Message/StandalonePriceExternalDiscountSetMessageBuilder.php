 ...
 */
final class StandalonePriceExternalDiscountSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceExternalDiscountSetMessage
    {
        return new StandalonePriceExternalDiscountSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StandalonePriceExternalDiscountSetMessageBuilder
    {
        return new self();
    }
}
