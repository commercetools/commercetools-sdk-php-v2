 ...
 * @internal
 */
final class RecurringOrderCustomTypeSetMessagePayloadModel extends JsonObjectModel implements RecurringOrderCustomTypeSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'RecurringOrderCustomTypeSet';
    /**
     *
     * @var ?string
     */
