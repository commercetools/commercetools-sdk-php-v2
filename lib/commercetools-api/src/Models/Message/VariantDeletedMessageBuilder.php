...
/**
 * @implements Builder<VariantDeletedMessage>
 */
final class VariantDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): VariantDeletedMessage
    {
        return new VariantDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): VariantDeletedMessageBuilder
    {
        return new self();
    }
}
