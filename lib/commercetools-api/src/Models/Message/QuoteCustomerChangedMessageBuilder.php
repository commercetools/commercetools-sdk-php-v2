...
/**
 * @implements Builder<QuoteCustomerChangedMessage>
 */
final class QuoteCustomerChangedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteCustomerChangedMessage
    {
        return new QuoteCustomerChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteCustomerChangedMessageBuilder
    {
        return new self();
    }
}
