...
/**
 * @implements Builder<PaymentMethodInfoMethodSetMessage>
 */
final class PaymentMethodInfoMethodSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoMethodSetMessage
    {
        return new PaymentMethodInfoMethodSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoMethodSetMessageBuilder
    {
        return new self();
    }
}
