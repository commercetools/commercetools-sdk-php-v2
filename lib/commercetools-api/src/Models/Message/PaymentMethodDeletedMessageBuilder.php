...
/**
 * @implements Builder<PaymentMethodDeletedMessage>
 */
final class PaymentMethodDeletedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodDeletedMessage
    {
        return new PaymentMethodDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodDeletedMessageBuilder
    {
        return new self();
    }
}
