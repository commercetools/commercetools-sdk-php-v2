...
/**
 * @implements Builder<CartUnfrozenMessage>
 */
final class CartUnfrozenMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CartUnfrozenMessage
    {
        return new CartUnfrozenMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CartUnfrozenMessageBuilder
    {
        return new self();
    }
}
