...
/**
 * @implements Builder<DiscountGroupCreatedMessage>
 */
final class DiscountGroupCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DiscountGroupCreatedMessage
    {
        return new DiscountGroupCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DiscountGroupCreatedMessageBuilder
    {
        return new self();
    }
}
