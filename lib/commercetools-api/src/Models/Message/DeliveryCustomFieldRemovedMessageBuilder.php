...
/**
 * @implements Builder<DeliveryCustomFieldRemovedMessage>
 */
final class DeliveryCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): DeliveryCustomFieldRemovedMessage
    {
        return new DeliveryCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DeliveryCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
