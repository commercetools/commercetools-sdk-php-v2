...
/**
 * @implements Builder<BusinessUnitCustomFieldChangedMessage>
 */
final class BusinessUnitCustomFieldChangedMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p><a href="ctp:api:type:CustomFieldValue">CustomFieldValue</a> based on the <a href="ctp:api:type:FieldType">FieldType</a> after the <a href="ctp:api:type:BusinessUnitSetCustomFieldAction">Set CustomField</a> update action.</p>
     *
    ...
    /**
     * <p><a href="ctp:api:type:CustomFieldValue">CustomFieldValue</a> based on the <a href="ctp:api:type:FieldType">FieldType</a> before the <a href="ctp:api:type:BusinessUnitSetCustomFieldAction">Set CustomField</a> update action.</p>
     *
    ...
    public function build(): BusinessUnitCustomFieldChangedMessage
    {
        return new BusinessUnitCustomFieldChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomFieldChangedMessageBuilder
    {
        return new self();
    }
}
