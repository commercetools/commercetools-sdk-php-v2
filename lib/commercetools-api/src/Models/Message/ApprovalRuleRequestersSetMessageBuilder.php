...
/**
 * @implements Builder<ApprovalRuleRequestersSetMessage>
 */
final class ApprovalRuleRequestersSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleRequestersSetMessage
    {
        return new ApprovalRuleRequestersSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleRequestersSetMessageBuilder
    {
        return new self();
    }
}
