...
final class ProductImageAddedMessageModel extends JsonObjectModel implements ProductImageAddedMessage
{
    ...
    public function getImage()
    {
        if (is_null($this->image)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ProductImageAddedMessage::FIELD_IMAGE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getStaged()
    {
        if (is_null($this->staged)) {
            /** @psalm-var ?bool $data */
            $data = $this->raw(ProductImageAddedMessage::FIELD_STAGED);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getVariantId()
    {
        if (is_null($this->variantId)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductImageAddedMessage::FIELD_VARIANT_ID);
            if (is_null($data)) {
                return null;
            }
