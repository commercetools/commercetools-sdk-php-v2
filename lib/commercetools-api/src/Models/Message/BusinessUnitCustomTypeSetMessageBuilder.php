...
/**
 * @implements Builder<BusinessUnitCustomTypeSetMessage>
 */
final class BusinessUnitCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitCustomTypeSetMessage
    {
        return new BusinessUnitCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
