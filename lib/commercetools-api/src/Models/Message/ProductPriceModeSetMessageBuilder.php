...
/**
 * @implements Builder<ProductPriceModeSetMessage>
 */
final class ProductPriceModeSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ProductPriceModeSetMessage
    {
        return new ProductPriceModeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceModeSetMessageBuilder
    {
        return new self();
    }
}
