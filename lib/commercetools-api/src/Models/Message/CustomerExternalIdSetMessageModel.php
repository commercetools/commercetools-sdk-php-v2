 ...
 * @internal
 */
final class CustomerExternalIdSetMessageModel extends JsonObjectModel implements CustomerExternalIdSetMessage
{
    public const DISCRIMINATOR_VALUE = 'CustomerExternalIdSet';
    /**
     *
     * @var ?string
     */
