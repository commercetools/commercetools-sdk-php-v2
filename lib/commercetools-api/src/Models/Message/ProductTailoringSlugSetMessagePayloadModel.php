 ...
 * @internal
 */
final class ProductTailoringSlugSetMessagePayloadModel extends JsonObjectModel implements ProductTailoringSlugSetMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'ProductTailoringSlugSet';
    /**
     *
     * @var ?string
     */
