...
/**
 * @implements Builder<PaymentMethodInfoCustomFieldRemovedMessage>
 */
final class PaymentMethodInfoCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoCustomFieldRemovedMessage
    {
        return new PaymentMethodInfoCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
