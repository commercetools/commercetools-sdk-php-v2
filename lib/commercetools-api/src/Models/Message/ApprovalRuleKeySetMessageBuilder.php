...
/**
 * @implements Builder<ApprovalRuleKeySetMessage>
 */
final class ApprovalRuleKeySetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): ApprovalRuleKeySetMessage
    {
        return new ApprovalRuleKeySetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ApprovalRuleKeySetMessageBuilder
    {
        return new self();
    }
}
