...
/**
 * @implements Builder<QuoteRequestStateTransitionMessage>
 */
final class QuoteRequestStateTransitionMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteRequestStateTransitionMessage
    {
        return new QuoteRequestStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteRequestStateTransitionMessageBuilder
    {
        return new self();
    }
}
