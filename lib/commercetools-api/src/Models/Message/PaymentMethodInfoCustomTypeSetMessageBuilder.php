...
/**
 * @implements Builder<PaymentMethodInfoCustomTypeSetMessage>
 */
final class PaymentMethodInfoCustomTypeSetMessageBuilder implements Builder
{
    /**
    ...
    /**
     * <p><code>id</code> of the previous <a href="ctp:api:type:Type">Type</a>. Absent if there was no previous Custom Type present.</p>
     *
    ...
    public function build(): PaymentMethodInfoCustomTypeSetMessage
    {
        return new PaymentMethodInfoCustomTypeSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodInfoCustomTypeSetMessageBuilder
    {
        return new self();
    }
}
