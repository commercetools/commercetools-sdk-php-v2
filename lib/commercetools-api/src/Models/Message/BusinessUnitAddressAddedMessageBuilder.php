...
/**
 * @implements Builder<BusinessUnitAddressAddedMessage>
 */
final class BusinessUnitAddressAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddressAddedMessage
    {
        return new BusinessUnitAddressAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): BusinessUnitAddressAddedMessageBuilder
    {
        return new self();
    }
}
