...
/**
 * @implements Builder<CustomerAddressCustomFieldAddedMessage>
 */
final class CustomerAddressCustomFieldAddedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddressCustomFieldAddedMessage
    {
        return new CustomerAddressCustomFieldAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressCustomFieldAddedMessageBuilder
    {
        return new self();
    }
}
