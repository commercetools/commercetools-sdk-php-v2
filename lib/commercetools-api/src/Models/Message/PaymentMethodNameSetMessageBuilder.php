...
/**
 * @implements Builder<PaymentMethodNameSetMessage>
 */
final class PaymentMethodNameSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodNameSetMessage
    {
        return new PaymentMethodNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentMethodNameSetMessageBuilder
    {
        return new self();
    }
}
