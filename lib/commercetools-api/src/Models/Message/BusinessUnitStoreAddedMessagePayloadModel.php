 ...
 * @internal
 */
final class BusinessUnitStoreAddedMessagePayloadModel extends JsonObjectModel implements BusinessUnitStoreAddedMessagePayload
{
    public const DISCRIMINATOR_VALUE = 'BusinessUnitStoreAdded';
    /**
     *
     * @var ?string
     */
