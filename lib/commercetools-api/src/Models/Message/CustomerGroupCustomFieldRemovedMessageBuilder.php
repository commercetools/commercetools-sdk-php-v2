...
/**
 * @implements Builder<CustomerGroupCustomFieldRemovedMessage>
 */
final class CustomerGroupCustomFieldRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerGroupCustomFieldRemovedMessage
    {
        return new CustomerGroupCustomFieldRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerGroupCustomFieldRemovedMessageBuilder
    {
        return new self();
    }
}
