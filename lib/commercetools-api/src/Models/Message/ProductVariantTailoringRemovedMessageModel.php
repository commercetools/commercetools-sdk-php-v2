 ...
 * @internal
 */
final class ProductVariantTailoringRemovedMessageModel extends JsonObjectModel implements ProductVariantTailoringRemovedMessage
{
    public const DISCRIMINATOR_VALUE = 'ProductVariantTailoringRemoved';
    /**
     *
     * @var ?string
     */
