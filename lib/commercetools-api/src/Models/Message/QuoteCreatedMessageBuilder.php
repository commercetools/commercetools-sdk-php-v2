...
/**
 * @implements Builder<QuoteCreatedMessage>
 */
final class QuoteCreatedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteCreatedMessage
    {
        return new QuoteCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): QuoteCreatedMessageBuilder
    {
        return new self();
    }
}
