...
/**
 * @implements Builder<AssociateRolePermissionRemovedMessage>
 */
final class AssociateRolePermissionRemovedMessageBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRolePermissionRemovedMessage
    {
        return new AssociateRolePermissionRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRolePermissionRemovedMessageBuilder
    {
        return new self();
    }
}
