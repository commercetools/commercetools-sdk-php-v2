...
/**
 * @implements Builder<StoreRefundPolicyUrlSetMessage>
 */
final class StoreRefundPolicyUrlSetMessageBuilder implements Builder
{
    /**
    ...
    public function build(): StoreRefundPolicyUrlSetMessage
    {
        return new StoreRefundPolicyUrlSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreRefundPolicyUrlSetMessageBuilder
    {
        return new self();
    }
}
