 ...
 * @internal
 */
final class QuoteRequestChangeCustomerActionModel extends JsonObjectModel implements QuoteRequestChangeCustomerAction
{
    public const DISCRIMINATOR_VALUE = 'changeCustomer';
    /**
     *
     * @var ?string
     */
