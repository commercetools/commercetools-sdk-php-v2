...
/**
 * @implements Builder<QuoteRequestSetCustomTypeAction>
 */
final class QuoteRequestSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the QuoteRequest with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the QuoteRequest.</p>
    ...
    public function build(): QuoteRequestSetCustomTypeAction
    {
        return new QuoteRequestSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): QuoteRequestSetCustomTypeActionBuilder
    {
        return new self();
    }
}
