 ...
 */
final class ProductTailoringAddExternalImageActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringAddExternalImageAction
    {
        return new ProductTailoringAddExternalImageActionModel(
            $this->variantId,
            $this->sku,
    ...
    public static function of(): ProductTailoringAddExternalImageActionBuilder
    {
        return new self();
    }
}
