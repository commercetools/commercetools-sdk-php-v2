 ...
 */
final class ProductTailoringMoveImageToPositionActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringMoveImageToPositionAction
    {
        return new ProductTailoringMoveImageToPositionActionModel(
            $this->variantId,
            $this->sku,
            $this->imageUrl,
            $this->position,
    ...
    public static function of(): ProductTailoringMoveImageToPositionActionBuilder
    {
        return new self();
    }
}
