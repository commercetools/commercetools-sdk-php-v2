 ...
 */
final class ProductTailoringSetMetaKeywordsActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringSetMetaKeywordsAction
    {
        return new ProductTailoringSetMetaKeywordsActionModel(
            $this->metaKeywords instanceof LocalizedStringBuilder ? $this->metaKeywords->build() : $this->metaKeywords,
            $this->staged
        );
    }

    public static function of(): ProductTailoringSetMetaKeywordsActionBuilder
    {
        return new self();
    }
}
