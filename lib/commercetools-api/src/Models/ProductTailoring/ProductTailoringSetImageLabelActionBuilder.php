 ...
 */
final class ProductTailoringSetImageLabelActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringSetImageLabelAction
    {
        return new ProductTailoringSetImageLabelActionModel(
            $this->sku,
            $this->variantId,
            $this->imageUrl,
            $this->label,
    ...
    public static function of(): ProductTailoringSetImageLabelActionBuilder
    {
        return new self();
    }
}
