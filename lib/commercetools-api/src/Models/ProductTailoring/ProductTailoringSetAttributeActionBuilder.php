...
/**
 * @implements Builder<ProductTailoringSetAttributeAction>
 */
final class ProductTailoringSetAttributeActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringSetAttributeAction
    {
        return new ProductTailoringSetAttributeActionModel(
            $this->variantId,
            $this->sku,
            $this->name,
            $this->value,
    ...
    public static function of(): ProductTailoringSetAttributeActionBuilder
    {
        return new self();
    }
}
