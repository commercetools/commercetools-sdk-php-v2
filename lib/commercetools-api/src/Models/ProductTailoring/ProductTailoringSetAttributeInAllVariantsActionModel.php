 ...
 * @internal
 */
final class ProductTailoringSetAttributeInAllVariantsActionModel extends JsonObjectModel implements ProductTailoringSetAttributeInAllVariantsAction
{
    ...
    /**
     * <p>Value to set for the Attributes. If omitted, any existing value is removed.</p>
