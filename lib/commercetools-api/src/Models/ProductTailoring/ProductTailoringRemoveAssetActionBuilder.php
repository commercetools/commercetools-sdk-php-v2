 ...
 */
final class ProductTailoringRemoveAssetActionBuilder implements Builder
{
    /**
    ...
    public function build(): ProductTailoringRemoveAssetAction
    {
        return new ProductTailoringRemoveAssetActionModel(
            $this->variantId,
            $this->sku,
            $this->staged,
            $this->assetId,
    ...
    public static function of(): ProductTailoringRemoveAssetActionBuilder
    {
        return new self();
    }
}
