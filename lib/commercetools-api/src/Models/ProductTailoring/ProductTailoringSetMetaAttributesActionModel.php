 ...
 * @internal
 */
final class ProductTailoringSetMetaAttributesActionModel extends JsonObjectModel implements ProductTailoringSetMetaAttributesAction
{
    public const DISCRIMINATOR_VALUE = 'setMetaAttributes';
    /**
     *
     * @var ?string
     */
