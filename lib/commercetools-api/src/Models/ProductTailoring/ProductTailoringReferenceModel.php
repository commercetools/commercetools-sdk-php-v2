 ...
 * @internal
 */
final class ProductTailoringReferenceModel extends JsonObjectModel implements ProductTailoringReference
{
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = ProductTailoringModel::of($data);
        }
