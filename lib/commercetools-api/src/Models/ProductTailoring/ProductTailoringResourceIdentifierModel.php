 ...
 * @internal
 */
final class ProductTailoringResourceIdentifierModel extends JsonObjectModel implements ProductTailoringResourceIdentifier
{
    public const DISCRIMINATOR_VALUE = 'product-tailoring';
    /**
     *
     * @var ?string
     */
