 ...
 */
final class ProductTailoringSetAssetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Asset with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Asset.</p>
    ...
    public function build(): ProductTailoringSetAssetCustomTypeAction
    {
        return new ProductTailoringSetAssetCustomTypeActionModel(
            $this->variantId,
            $this->sku,
            $this->staged,
            $this->assetId,
    ...
    public static function of(): ProductTailoringSetAssetCustomTypeActionBuilder
    {
        return new self();
    }
}
