 ...
 * @internal
 */
final class ProductTailoringPagedQueryResponseModel extends JsonObjectModel implements ProductTailoringPagedQueryResponse
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?ProductTailoringCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = ProductTailoringCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?ProductTailoringCollection $results): void
    {
        $this->results = $results;
    }
}
