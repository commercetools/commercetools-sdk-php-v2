...
/**
 * @implements Builder<CountOnCustomLineItemUnits>
 */
final class CountOnCustomLineItemUnitsBuilder implements Builder
{
    /**
    ...
    public function build(): CountOnCustomLineItemUnits
    {
        return new CountOnCustomLineItemUnitsModel(
            $this->predicate,
            $this->minCount,
            $this->maxCount,
            $this->excludeCount
    ...
    public static function of(): CountOnCustomLineItemUnitsBuilder
    {
        return new self();
    }
}
