...
final class CartDiscountUpdateModel extends JsonObjectModel implements CartDiscountUpdate
{
    ...
    final public function getActions()
    {
       if (is_null($this->actions)) {
           ...
           $data = $this->raw(CartDiscountUpdate::FIELD_ACTIONS);
           if (is_null($data)) {
               return null;
           }
    ...
    final public function getVersion()
    {
       if (is_null($this->version)) {
           /** @psalm-var ?int $data */
           $data = $this->raw(CartDiscountUpdate::FIELD_VERSION);
           if (is_null($data)) {
               return null;
           }
    ...
    final public function setActions(?CartDiscountUpdateActionCollection $actions): void
    {
        $this->actions = $actions;
    }
