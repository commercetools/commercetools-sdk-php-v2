...
/**
 * @implements Builder<CartDiscountRemoveStoreAction>
 */
final class CartDiscountRemoveStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): CartDiscountRemoveStoreAction
    {
        return new CartDiscountRemoveStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): CartDiscountRemoveStoreActionBuilder
    {
        return new self();
    }
}
