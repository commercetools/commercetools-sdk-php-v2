...
interface CartDiscountSetCustomTypeAction extends CartDiscountUpdateAction
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the CartDiscount with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the CartDiscount.</p>
