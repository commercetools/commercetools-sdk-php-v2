...
/**
 * @implements Builder<AgentResponsesRequest>
 */
final class AgentResponsesRequestBuilder implements Builder
{
    /**
    ...
    /**
     * <p><a href="ctp:api:type:BusinessUnit">BusinessUnit</a> to use for the request. If omitted, the Intake Agent resolves it from <code>prompt</code>.</p>
     *
    ...
    /**
     * <p><a href="ctp:api:type:Store">Store</a> to use for the request. If omitted, the Intake Agent resolves it from <code>prompt</code>.</p>
     *
    ...
    public function build(): AgentResponsesRequest
    {
        return new AgentResponsesRequestModel(
            $this->outputType,
            $this->locale,
            $this->prompt,
    ...
    public static function of(): AgentResponsesRequestBuilder
    {
        return new self();
    }
}
