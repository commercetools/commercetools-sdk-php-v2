...
use Commercetools\Api\Models\Error\AuthErrorResponseModel;
 ...
 * @internal
 */
final class AgentResponsesAuthErrorModel extends JsonObjectModel implements AgentResponsesAuthError
{
    /**
     *
     * @var ?int
