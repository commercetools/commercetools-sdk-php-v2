...
use Commercetools\Api\Models\Error\AuthErrorResponse;
use Commercetools\Api\Models\Error\AuthErrorResponseBuilder;
...
/**
 * @implements Builder<AgentResponsesAuthError>
 */
final class AgentResponsesAuthErrorBuilder implements Builder
{
    /**
    ...
    public function build(): AgentResponsesAuthError
    {
        return new AgentResponsesAuthErrorModel(
            $this->statusCode,
            $this->message,
            $this->errors,
            $this->error,
    ...
    public static function of(): AgentResponsesAuthErrorBuilder
    {
        return new self();
    }
}
