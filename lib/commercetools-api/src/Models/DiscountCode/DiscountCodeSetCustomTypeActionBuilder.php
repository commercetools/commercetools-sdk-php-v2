...
/**
 * @implements Builder<DiscountCodeSetCustomTypeAction>
 */
final class DiscountCodeSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the DiscountCode with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the DiscountCode.</p>
    ...
    public function build(): DiscountCodeSetCustomTypeAction
    {
        return new DiscountCodeSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): DiscountCodeSetCustomTypeActionBuilder
    {
        return new self();
    }
}
