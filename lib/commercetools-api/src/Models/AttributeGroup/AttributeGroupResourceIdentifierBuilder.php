...
/**
 * @implements Builder<AttributeGroupResourceIdentifier>
 */
final class AttributeGroupResourceIdentifierBuilder implements Builder
{
    /**
    ...
    public function build(): AttributeGroupResourceIdentifier
    {
        return new AttributeGroupResourceIdentifierModel(
            $this->id,
            $this->key
        );
    }

    public static function of(): AttributeGroupResourceIdentifierBuilder
    {
        return new self();
    }
}
