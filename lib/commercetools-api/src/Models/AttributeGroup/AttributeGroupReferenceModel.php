 ...
 * @internal
 */
final class AttributeGroupReferenceModel extends JsonObjectModel implements AttributeGroupReference
{
    public const DISCRIMINATOR_VALUE = 'attribute-group';
    /**
     *
     * @var ?string
     */
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = AttributeGroupModel::of($data);
        }
