...
/**
 * @implements Builder<AttributeGroupDraft>
 */
final class AttributeGroupDraftBuilder implements Builder
{
    /**
    ...
    public function build(): AttributeGroupDraft
    {
        return new AttributeGroupDraftModel(
    ...
    public static function of(): AttributeGroupDraftBuilder
    {
        return new self();
    }
}
