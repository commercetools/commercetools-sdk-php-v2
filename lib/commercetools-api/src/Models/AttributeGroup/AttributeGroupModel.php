 ...
 * @internal
 */
final class AttributeGroupModel extends JsonObjectModel implements AttributeGroup
{
    /**
     *
     * @var ?string
    ...
    {
        $data = $this->toArray();
        if (isset($data[AttributeGroup::FIELD_CREATED_AT]) && $data[AttributeGroup::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[AttributeGroup::FIELD_CREATED_AT] = $data[AttributeGroup::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[AttributeGroup::FIELD_LAST_MODIFIED_AT]) && $data[AttributeGroup::FIELD_LAST_MODIFIED_AT] instanceof \DateTimeImmutable) {
            $data[AttributeGroup::FIELD_LAST_MODIFIED_AT] = $data[AttributeGroup::FIELD_LAST_MODIFIED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
