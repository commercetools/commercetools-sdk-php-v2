 ...
 * @internal
 */
final class AttributeGroupRemoveAttributeActionModel extends JsonObjectModel implements AttributeGroupRemoveAttributeAction
{
    public const DISCRIMINATOR_VALUE = 'removeAttribute';
    /**
     *
     * @var ?string
     */
