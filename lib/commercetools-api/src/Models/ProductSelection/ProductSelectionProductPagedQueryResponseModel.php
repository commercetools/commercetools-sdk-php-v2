...
final class ProductSelectionProductPagedQueryResponseModel extends JsonObjectModel implements ProductSelectionProductPagedQueryResponse
{
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?AssignedProductReferenceCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = AssignedProductReferenceCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?AssignedProductReferenceCollection $results): void
    {
        $this->results = $results;
    }
}
