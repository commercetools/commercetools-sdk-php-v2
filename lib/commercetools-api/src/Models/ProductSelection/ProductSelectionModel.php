...
final class ProductSelectionModel extends JsonObjectModel implements ProductSelection
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[ProductSelection::FIELD_CREATED_AT]) && $data[ProductSelection::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[ProductSelection::FIELD_CREATED_AT] = $data[ProductSelection::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[ProductSelection::FIELD_LAST_MODIFIED_AT]) && $data[ProductSelection::FIELD_LAST_MODIFIED_AT] instanceof \DateTimeImmutable) {
            $data[ProductSelection::FIELD_LAST_MODIFIED_AT] = $data[ProductSelection::FIELD_LAST_MODIFIED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
