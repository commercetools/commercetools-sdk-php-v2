...
/**
 * @implements Builder<IndividualProductSelectionType>
 */
final class IndividualProductSelectionTypeBuilder implements Builder
{
    ...
    public function build(): IndividualProductSelectionType
    {
    ...
    public static function of(): IndividualProductSelectionTypeBuilder
    {
        return new self();
    }
}
