 ...
 * @internal
 */
final class ProductSelectionExcludeProductActionModel extends JsonObjectModel implements ProductSelectionExcludeProductAction
{
    public const DISCRIMINATOR_VALUE = 'excludeProduct';
    /**
     *
     * @var ?string
     */
