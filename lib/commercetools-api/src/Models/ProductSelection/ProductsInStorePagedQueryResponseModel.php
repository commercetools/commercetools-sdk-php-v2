 ...
 * @internal
 */
final class ProductsInStorePagedQueryResponseModel extends JsonObjectModel implements ProductsInStorePagedQueryResponse
{
    /**
     * @var ?int
     */
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?ProductSelectionAssignmentCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = ProductSelectionAssignmentCollection::fromArray($data);
        }
