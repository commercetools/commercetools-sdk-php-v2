 ...
 * @internal
 */
final class ProductVariantSelectionIncludeOnlyModel extends JsonObjectModel implements ProductVariantSelectionIncludeOnly
{
    public const DISCRIMINATOR_VALUE = 'includeOnly';
    /**
     *
     * @var ?string
     */
