...
/**
 * @implements Builder<ProductSelectionSetCustomTypeAction>
 */
final class ProductSelectionSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the ProductSelection with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the ProductSelection.</p>
    ...
    public function build(): ProductSelectionSetCustomTypeAction
    {
        return new ProductSelectionSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ProductSelectionSetCustomTypeActionBuilder
    {
        return new self();
    }
}
