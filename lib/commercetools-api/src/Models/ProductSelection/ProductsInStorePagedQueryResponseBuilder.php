...
/**
 * @implements Builder<ProductsInStorePagedQueryResponse>
 */
final class ProductsInStorePagedQueryResponseBuilder implements Builder
{
    /**
     * @var ?int
     */
     ...
     * @return $this
     */
    public function withResults(?ProductSelectionAssignmentCollection $results)
    {
    ...
    public function build(): ProductsInStorePagedQueryResponse
    {
        return new ProductsInStorePagedQueryResponseModel(
            $this->limit,
            $this->offset,
            $this->count,
            $this->total,
    ...
    public static function of(): ProductsInStorePagedQueryResponseBuilder
    {
        return new self();
    }
}
