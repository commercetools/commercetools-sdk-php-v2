 ...
 * @internal
 */
final class AssignedProductSelectionPagedQueryResponseModel extends JsonObjectModel implements AssignedProductSelectionPagedQueryResponse
{
    /**
     * @var ?int
     */
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?AssignedProductSelectionCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = AssignedProductSelectionCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?AssignedProductSelectionCollection $results): void
    {
        $this->results = $results;
    }
}
