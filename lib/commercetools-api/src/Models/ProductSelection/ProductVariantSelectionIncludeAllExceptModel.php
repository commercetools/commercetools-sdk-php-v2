 ...
 * @internal
 */
final class ProductVariantSelectionIncludeAllExceptModel extends JsonObjectModel implements ProductVariantSelectionIncludeAllExcept
{
    public const DISCRIMINATOR_VALUE = 'includeAllExcept';
    /**
     *
     * @var ?string
     */
