...
final class ShippingMethodPagedQueryResponseModel extends JsonObjectModel implements ShippingMethodPagedQueryResponse
{
    ...
    final public function getTotal()
    {
       if (is_null($this->total)) {
           /** @psalm-var ?int $data */
           $data = $this->raw(ShippingMethodPagedQueryResponse::FIELD_TOTAL);
           if (is_null($data)) {
               return null;
           }
           $this->total = (int)$data;
    ...
    final public function getOffset()
    {
       if (is_null($this->offset)) {
           /** @psalm-var ?int $data */
           $data = $this->raw(ShippingMethodPagedQueryResponse::FIELD_OFFSET);
           if (is_null($data)) {
               return null;
           }
    ...
    /**
     *
     * @return ShippingMethodCollection|null
     */
    final public function getResults()
    {
       if (is_null($this->results)) {
           /** @psalm-var ?array<int, stdClass> $data */
           $data = $this->raw(ShippingMethodPagedQueryResponse::FIELD_RESULTS);
           if (is_null($data)) {
               return null;
           }
           $this->results = ShippingMethodCollection::fromArray($data);
       }
       return $this->results;
    }
    ...
    final public function setResults(?ShippingMethodCollection $results): void
    {
        $this->results = $results;
    }
