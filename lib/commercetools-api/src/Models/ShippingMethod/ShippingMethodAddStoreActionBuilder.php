...
/**
 * @implements Builder<ShippingMethodAddStoreAction>
 */
final class ShippingMethodAddStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodAddStoreAction
    {
        return new ShippingMethodAddStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): ShippingMethodAddStoreActionBuilder
    {
        return new self();
    }
}
