...
final class ShippingMethodReferenceBuilder implements Builder
{
    ...
    /**
     * @var ?ShippingMethodBuilder|ShippingMethod
     */
    protected $obj;
     ...
     * @return $this
     */
    final public function withObj(?ShippingMethod $obj)
    {
        $this->obj = $obj;
     ...
     * @return $this
     */
    final public function withObjBuilder(?ShippingMethodBuilder $obj)
    {
        $this->obj = $obj;
