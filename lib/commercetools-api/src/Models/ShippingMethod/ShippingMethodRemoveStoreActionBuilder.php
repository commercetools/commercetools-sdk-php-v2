...
/**
 * @implements Builder<ShippingMethodRemoveStoreAction>
 */
final class ShippingMethodRemoveStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodRemoveStoreAction
    {
        return new ShippingMethodRemoveStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): ShippingMethodRemoveStoreActionBuilder
    {
        return new self();
    }
}
