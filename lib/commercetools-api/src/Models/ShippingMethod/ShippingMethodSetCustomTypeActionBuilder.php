...
/**
 * @implements Builder<ShippingMethodSetCustomTypeAction>
 */
final class ShippingMethodSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the ShippingMethod with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the ShippingMethod.</p>
    ...
    public function build(): ShippingMethodSetCustomTypeAction
    {
        return new ShippingMethodSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ShippingMethodSetCustomTypeActionBuilder
    {
        return new self();
    }
}
