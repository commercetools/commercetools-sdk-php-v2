...
/**
 * @implements Builder<VariantPagedQueryResponse>
 */
final class VariantPagedQueryResponseBuilder implements Builder
{
    /**
     ...
     * @return $this
     */
    public function withResults(?VariantCollection $results)
    {
    ...
    public function build(): VariantPagedQueryResponse
    {
        return new VariantPagedQueryResponseModel(
            $this->limit,
            $this->offset,
            $this->count,
            $this->total,
    ...
    public static function of(): VariantPagedQueryResponseBuilder
    {
        return new self();
    }
}
