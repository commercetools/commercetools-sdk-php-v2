...
/**
 * @implements Builder<VariantSetAssetSourcesAction>
 */
final class VariantSetAssetSourcesActionBuilder implements Builder
{
    /**
    ...
    public function build(): VariantSetAssetSourcesAction
    {
        return new VariantSetAssetSourcesActionModel(
            $this->staged,
            $this->assetId,
            $this->assetKey,
            $this->sources
    ...
    public static function of(): VariantSetAssetSourcesActionBuilder
    {
        return new self();
    }
}
