...
/**
 * @implements Builder<VariantSetAssetCustomTypeAction>
 */
final class VariantSetAssetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): VariantSetAssetCustomTypeAction
    {
        return new VariantSetAssetCustomTypeActionModel(
            $this->staged,
            $this->assetId,
            $this->assetKey,
    ...
    public static function of(): VariantSetAssetCustomTypeActionBuilder
    {
        return new self();
    }
}
