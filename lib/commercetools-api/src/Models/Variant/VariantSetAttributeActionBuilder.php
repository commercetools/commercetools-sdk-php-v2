 ...
 */
final class VariantSetAttributeActionBuilder implements Builder
{
    /**
     ...
     * <li>For <a href="ctp:api:type:AttributeNestedType">Nested Type</a> Attributes, use the list of values of all Attributes of the nested Variant as <code>value</code>.</li>
    ...
    public function build(): VariantSetAttributeAction
    {
        return new VariantSetAttributeActionModel(
            $this->name,
            $this->value,
            $this->staged
        );
    ...
    public static function of(): VariantSetAttributeActionBuilder
    {
        return new self();
    }
}
