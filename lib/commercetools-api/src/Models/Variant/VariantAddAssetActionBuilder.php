...
/**
 * @implements Builder<VariantAddAssetAction>
 */
final class VariantAddAssetActionBuilder implements Builder
{
    /**
    ...
    public function build(): VariantAddAssetAction
    {
        return new VariantAddAssetActionModel(
            $this->staged,
    ...
    public static function of(): VariantAddAssetActionBuilder
    {
        return new self();
    }
}
