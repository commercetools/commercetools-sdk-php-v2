 ...
 * @internal
 */
final class VariantReferenceModel extends JsonObjectModel implements VariantReference
{
     ...
     * @param ?Variant $obj
     */
    public function setObj(?Variant $obj): void
    {
        $this->obj = $obj;
    }
}
