 ...
 * @internal
 */
final class VariantPagedQueryResponseModel extends JsonObjectModel implements VariantPagedQueryResponse
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?VariantCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = VariantCollection::fromArray($data);
        }
