 ...
 */
final class VariantRemoveAssetActionBuilder implements Builder
{
    /**
    ...
    public function build(): VariantRemoveAssetAction
    {
        return new VariantRemoveAssetActionModel(
            $this->staged,
            $this->assetId,
            $this->assetKey
        );
    ...
    public static function of(): VariantRemoveAssetActionBuilder
    {
        return new self();
    }
}
