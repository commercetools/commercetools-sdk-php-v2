...
/**
 * @implements Builder<VariantSetAssetCustomFieldAction>
 */
final class VariantSetAssetCustomFieldActionBuilder implements Builder
{
    /**
    ...
    public function build(): VariantSetAssetCustomFieldAction
    {
        return new VariantSetAssetCustomFieldActionModel(
            $this->staged,
            $this->assetId,
            $this->assetKey,
            $this->name,
    ...
    public static function of(): VariantSetAssetCustomFieldActionBuilder
    {
        return new self();
    }
}
