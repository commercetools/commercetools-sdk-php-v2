...
final class ProductProjectionPagedQueryResponseModel extends JsonObjectModel implements ProductProjectionPagedQueryResponse
{
    ...
    public function getLimit()
    {
        if (is_null($this->limit)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductProjectionPagedQueryResponse::FIELD_LIMIT);
            if (is_null($data)) {
                return null;
            }
            $this->limit = (int) $data;
    ...
    public function getCount()
    {
        if (is_null($this->count)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductProjectionPagedQueryResponse::FIELD_COUNT);
            if (is_null($data)) {
                return null;
            }
            $this->count = (int) $data;
    ...
    public function getTotal()
    {
        if (is_null($this->total)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductProjectionPagedQueryResponse::FIELD_TOTAL);
            if (is_null($data)) {
                return null;
            }
            $this->total = (int) $data;
    ...
    public function getOffset()
    {
        if (is_null($this->offset)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductProjectionPagedQueryResponse::FIELD_OFFSET);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $data = $this->raw(ProductProjectionPagedQueryResponse::FIELD_RESULTS);
            if (is_null($data)) {
                return null;
            }
