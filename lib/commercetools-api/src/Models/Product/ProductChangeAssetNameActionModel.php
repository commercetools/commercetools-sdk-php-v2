...
final class ProductChangeAssetNameActionModel extends JsonObjectModel implements ProductChangeAssetNameAction
{
    ...
    public function getVariantId()
    {
        if (is_null($this->variantId)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(ProductChangeAssetNameAction::FIELD_VARIANT_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getSku()
    {
        if (is_null($this->sku)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ProductChangeAssetNameAction::FIELD_SKU);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getAssetKey()
    {
        if (is_null($this->assetKey)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(ProductChangeAssetNameAction::FIELD_ASSET_KEY);
            if (is_null($data)) {
                return null;
            }
