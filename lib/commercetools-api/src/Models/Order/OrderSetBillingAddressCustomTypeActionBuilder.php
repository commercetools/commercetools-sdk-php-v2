...
/**
 * @implements Builder<OrderSetBillingAddressCustomTypeAction>
 */
final class OrderSetBillingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the <code>billingAddress</code> with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the <code>billingAddress</code>.</p>
    ...
    public function build(): OrderSetBillingAddressCustomTypeAction
    {
        return new OrderSetBillingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): OrderSetBillingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
