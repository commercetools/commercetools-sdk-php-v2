 ...
 */
final class OrderSetBillingAddressCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderSetBillingAddressCustomFieldAction
    {
        return new OrderSetBillingAddressCustomFieldActionModel(
            $this->name,
            $this->value
        );
    }

    public static function of(): OrderSetBillingAddressCustomFieldActionBuilder
    {
        return new self();
    }
}
