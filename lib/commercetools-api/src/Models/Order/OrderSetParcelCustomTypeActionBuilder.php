...
/**
 * @implements Builder<OrderSetParcelCustomTypeAction>
 */
final class OrderSetParcelCustomTypeActionBuilder implements Builder
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Parcel with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Parcel.</p>
    ...
    public function build(): OrderSetParcelCustomTypeAction
    {
    ...
    public static function of(): OrderSetParcelCustomTypeActionBuilder
    {
        return new self();
    }
}
