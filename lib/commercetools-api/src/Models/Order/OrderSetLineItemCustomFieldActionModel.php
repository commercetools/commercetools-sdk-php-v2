...
final class OrderSetLineItemCustomFieldActionModel extends JsonObjectModel implements OrderSetLineItemCustomFieldAction
{
    ...
    public function getLineItemId()
    {
        if (is_null($this->lineItemId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(OrderSetLineItemCustomFieldAction::FIELD_LINE_ITEM_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getName()
    {
        if (is_null($this->name)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(OrderSetLineItemCustomFieldAction::FIELD_NAME);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getValue()
    {
        if (is_null($this->value)) {
            ...
            $data = $this->raw(OrderSetLineItemCustomFieldAction::FIELD_VALUE);
            if (is_null($data)) {
                return null;
            }
