 ...
 */
final class OrderSetDeliveryAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): OrderSetDeliveryAddressCustomTypeAction
    {
    ...
    public static function of(): OrderSetDeliveryAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
