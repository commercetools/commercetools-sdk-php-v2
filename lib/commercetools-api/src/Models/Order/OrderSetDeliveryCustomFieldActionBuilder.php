...
/**
 * @implements Builder<OrderSetDeliveryCustomFieldAction>
 */
final class OrderSetDeliveryCustomFieldActionBuilder implements Builder
{
    /**
    ...
    public static function of(): OrderSetDeliveryCustomFieldActionBuilder
    {
        return new self();
    }
}
