 ...
 */
final class OrderSetCustomLineItemCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Custom Line Item with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Custom Line Item.</p>
    ...
    public function build(): OrderSetCustomLineItemCustomTypeAction
    {
        return new OrderSetCustomLineItemCustomTypeActionModel(
    ...
    public static function of(): OrderSetCustomLineItemCustomTypeActionBuilder
    {
        return new self();
    }
}
