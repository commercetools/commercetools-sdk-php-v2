 ...
 */
final class OrderSearchStringValueBuilder implements Builder
{
    /**
    ...
    public function build(): OrderSearchStringValue
    {
        return new OrderSearchStringValueModel(
            $this->field,
            $this->boost,
            $this->customType,
            $this->value,
    ...
    public static function of(): OrderSearchStringValueBuilder
    {
        return new self();
    }
}
