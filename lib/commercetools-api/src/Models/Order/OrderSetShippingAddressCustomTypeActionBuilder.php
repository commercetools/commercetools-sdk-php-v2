 ...
 */
final class OrderSetShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the <code>shippingAddress</code> with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the <code>shippingAddress</code>.</p>
    ...
    public function build(): OrderSetShippingAddressCustomTypeAction
    {
        return new OrderSetShippingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): OrderSetShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
