...
/**
 * @implements Builder<OrderSetShippingCustomFieldAction>
 */
final class OrderSetShippingCustomFieldActionBuilder implements Builder
{
    /**
    ...
    public function build(): OrderSetShippingCustomFieldAction
    {
        return new OrderSetShippingCustomFieldActionModel(
            $this->shippingKey,
            $this->name,
            $this->value
        );
    ...
    public static function of(): OrderSetShippingCustomFieldActionBuilder
    {
        return new self();
    }
}
