 ...
 */
final class OrderSetItemShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): OrderSetItemShippingAddressCustomTypeAction
    {
        return new OrderSetItemShippingAddressCustomTypeActionModel(
            $this->addressKey,
    ...
    public static function of(): OrderSetItemShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
