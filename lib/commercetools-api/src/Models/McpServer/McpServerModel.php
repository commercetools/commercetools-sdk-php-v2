 ...
 * @internal
 */
final class McpServerModel extends JsonObjectModel implements McpServer
{
    /**
     *
     * @var ?string
    ...
    public function getMcpServer()
    {
        if (is_null($this->mcpServer)) {
            ...
            $className = McpServerConfigModel::resolveDiscriminatorClass($data);
    ...
    {
        $data = $this->toArray();
        if (isset($data[McpServer::FIELD_CREATED_AT]) && $data[McpServer::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[McpServer::FIELD_CREATED_AT] = $data[McpServer::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[McpServer::FIELD_LAST_MODIFIED_AT]) && $data[McpServer::FIELD_LAST_MODIFIED_AT] instanceof \DateTimeImmutable) {
            $data[McpServer::FIELD_LAST_MODIFIED_AT] = $data[McpServer::FIELD_LAST_MODIFIED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
