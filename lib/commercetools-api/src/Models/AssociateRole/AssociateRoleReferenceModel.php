 ...
 * @internal
 */
final class AssociateRoleReferenceModel extends JsonObjectModel implements AssociateRoleReference
{
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = AssociateRoleModel::of($data);
        }
