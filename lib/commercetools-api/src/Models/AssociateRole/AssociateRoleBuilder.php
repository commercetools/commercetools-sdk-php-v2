...
/**
 * @implements Builder<AssociateRole>
 */
final class AssociateRoleBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRole
    {
        return new AssociateRoleModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): AssociateRoleBuilder
    {
        return new self();
    }
}
