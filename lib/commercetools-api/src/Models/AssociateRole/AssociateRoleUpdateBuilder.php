...
/**
 * @implements Builder<AssociateRoleUpdate>
 */
final class AssociateRoleUpdateBuilder implements Builder
{
    /**
     ...
     * @return $this
     */
    public function withActions(?AssociateRoleUpdateActionCollection $actions)
    {
    ...
    public function build(): AssociateRoleUpdate
    {
        return new AssociateRoleUpdateModel(
            $this->version,
            $this->actions
        );
    }

    public static function of(): AssociateRoleUpdateBuilder
    {
        return new self();
    }
}
