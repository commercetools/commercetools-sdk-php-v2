...
/**
 * @implements Builder<AssociateRoleResourceIdentifier>
 */
final class AssociateRoleResourceIdentifierBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRoleResourceIdentifier
    {
        return new AssociateRoleResourceIdentifierModel(
            $this->id,
            $this->key
        );
    }

    public static function of(): AssociateRoleResourceIdentifierBuilder
    {
        return new self();
    }
}
