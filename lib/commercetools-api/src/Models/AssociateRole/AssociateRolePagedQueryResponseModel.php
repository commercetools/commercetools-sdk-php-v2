 ...
 * @internal
 */
final class AssociateRolePagedQueryResponseModel extends JsonObjectModel implements AssociateRolePagedQueryResponse
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?AssociateRoleCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = AssociateRoleCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?AssociateRoleCollection $results): void
    {
        $this->results = $results;
    }
}
