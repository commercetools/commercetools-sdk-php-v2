...
/**
 * @implements Builder<AssociateRoleSetCustomTypeAction>
 */
final class AssociateRoleSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): AssociateRoleSetCustomTypeAction
    {
        return new AssociateRoleSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): AssociateRoleSetCustomTypeActionBuilder
    {
        return new self();
    }
}
