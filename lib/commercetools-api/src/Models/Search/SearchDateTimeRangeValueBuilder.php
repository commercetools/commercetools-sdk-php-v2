 ...
 */
final class SearchDateTimeRangeValueBuilder implements Builder
{
    /**
    ...
    public function build(): SearchDateTimeRangeValue
    {
        return new SearchDateTimeRangeValueModel(
            $this->field,
            $this->boost,
            $this->fieldType,
            $this->gte,
    ...
    public static function of(): SearchDateTimeRangeValueBuilder
    {
        return new self();
    }
}
