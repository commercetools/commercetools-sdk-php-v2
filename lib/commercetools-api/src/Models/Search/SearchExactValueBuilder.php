...
/**
 * @implements Builder<SearchExactValue>
 */
final class SearchExactValueBuilder implements Builder
{
    /**
    ...
    public function build(): SearchExactValue
    {
        return new SearchExactValueModel(
            $this->field,
            $this->boost,
            $this->fieldType,
            $this->value,
    ...
    public static function of(): SearchExactValueBuilder
    {
        return new self();
    }
}
