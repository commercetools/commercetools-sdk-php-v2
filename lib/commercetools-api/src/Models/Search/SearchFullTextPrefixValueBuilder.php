...
/**
 * @implements Builder<SearchFullTextPrefixValue>
 */
final class SearchFullTextPrefixValueBuilder implements Builder
{
    /**
    ...
    public function build(): SearchFullTextPrefixValue
    {
        return new SearchFullTextPrefixValueModel(
            $this->field,
            $this->boost,
            $this->fieldType,
            $this->value,
    ...
    public static function of(): SearchFullTextPrefixValueBuilder
    {
        return new self();
    }
}
