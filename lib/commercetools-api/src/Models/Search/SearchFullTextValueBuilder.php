...
/**
 * @implements Builder<SearchFullTextValue>
 */
final class SearchFullTextValueBuilder implements Builder
{
    /**
    ...
    public function build(): SearchFullTextValue
    {
        return new SearchFullTextValueModel(
            $this->field,
            $this->boost,
            $this->fieldType,
            $this->value,
    ...
    public static function of(): SearchFullTextValueBuilder
    {
        return new self();
    }
}
