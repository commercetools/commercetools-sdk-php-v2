...
/**
 * @implements Builder<SearchTimeRangeValue>
 */
final class SearchTimeRangeValueBuilder implements Builder
{
    /**
    ...
    public function build(): SearchTimeRangeValue
    {
        return new SearchTimeRangeValueModel(
            $this->field,
            $this->boost,
            $this->fieldType,
            $this->gte,
    ...
    public static function of(): SearchTimeRangeValueBuilder
    {
        return new self();
    }
}
