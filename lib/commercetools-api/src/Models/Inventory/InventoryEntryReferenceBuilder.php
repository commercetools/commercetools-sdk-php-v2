...
final class InventoryEntryReferenceBuilder implements Builder
{
    ...
    /**
     * @var ?InventoryEntryBuilder|InventoryEntry
     */
    protected $obj;
     ...
     * @return $this
     */
    final public function withObj(?InventoryEntry $obj)
    {
        $this->obj = $obj;
     ...
     * @return $this
     */
    final public function withObjBuilder(?InventoryEntryBuilder $obj)
    {
        $this->obj = $obj;
