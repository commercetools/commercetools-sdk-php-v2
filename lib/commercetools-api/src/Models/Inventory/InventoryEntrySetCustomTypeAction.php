...
interface InventoryEntrySetCustomTypeAction extends InventoryEntryUpdateAction
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the InventoryEntry with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the InventoryEntry.</p>
