...
final class MyShoppingListModel extends JsonObjectModel implements MyShoppingList
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[MyShoppingList::FIELD_CREATED_AT]) && $data[MyShoppingList::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[MyShoppingList::FIELD_CREATED_AT] = $data[MyShoppingList::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
