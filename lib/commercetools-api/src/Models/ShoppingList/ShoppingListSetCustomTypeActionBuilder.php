...
/**
 * @implements Builder<ShoppingListSetCustomTypeAction>
 */
final class ShoppingListSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the ShoppingList with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the ShoppingList.</p>
    ...
    public function build(): ShoppingListSetCustomTypeAction
    {
        return new ShoppingListSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ShoppingListSetCustomTypeActionBuilder
    {
        return new self();
    }
}
