...
final class MyCustomerUpdateModel extends JsonObjectModel implements MyCustomerUpdate
{
    ...
    public function __construct(
        ?int $version = null,
        ?MyCustomerUpdateActionCollection $actions = null
    ) {
    ...
    /**
     * <p>Expected version of the Customer on which the changes should be applied.
    ...
    public function getActions()
    {
        if (is_null($this->actions)) {
            ...
            $this->actions = MyCustomerUpdateActionCollection::fromArray($data);
        }
