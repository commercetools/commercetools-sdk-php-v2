...
final class MyShoppingListAddTextLineItemActionModel extends JsonObjectModel implements MyShoppingListAddTextLineItemAction
{
    ...
    public function getName()
    {
        if (is_null($this->name)) {
            ...
            $data = $this->raw(MyShoppingListAddTextLineItemAction::FIELD_NAME);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getDescription()
    {
        if (is_null($this->description)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(MyShoppingListAddTextLineItemAction::FIELD_DESCRIPTION);
            if (is_null($data)) {
                return null;
            }
    ...
    {
        $data = $this->toArray();
        if (isset($data[MyShoppingListAddTextLineItemAction::FIELD_ADDED_AT]) && $data[MyShoppingListAddTextLineItemAction::FIELD_ADDED_AT] instanceof \DateTimeImmutable) {
            $data[MyShoppingListAddTextLineItemAction::FIELD_ADDED_AT] = $data[MyShoppingListAddTextLineItemAction::FIELD_ADDED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
