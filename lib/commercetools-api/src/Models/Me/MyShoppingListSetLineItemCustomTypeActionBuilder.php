 ...
 */
final class MyShoppingListSetLineItemCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the ShoppingListLineItem with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the ShoppingListLineItem.</p>
    ...
    public function build(): MyShoppingListSetLineItemCustomTypeAction
    {
        return new MyShoppingListSetLineItemCustomTypeActionModel(
            $this->lineItemId,
    ...
    public static function of(): MyShoppingListSetLineItemCustomTypeActionBuilder
    {
        return new self();
    }
}
