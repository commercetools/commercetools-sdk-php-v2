 ...
 */
final class MyBusinessUnitAddShippingAddressIdActionBuilder implements Builder
{
    /**
    ...
    public function build(): MyBusinessUnitAddShippingAddressIdAction
    {
        return new MyBusinessUnitAddShippingAddressIdActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): MyBusinessUnitAddShippingAddressIdActionBuilder
    {
        return new self();
    }
}
