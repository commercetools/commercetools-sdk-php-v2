...
final class MyCartUpdateActionModel extends JsonObjectModel implements MyCartUpdateAction
{
    ...
    private static $discriminatorClasses = [
       ...
       'setCustomLineItemRecurrenceInfo' => MyCartSetCustomLineItemRecurrenceInfoActionModel::class,
       ...
       'setLineItemRecurrenceInfo' => MyCartSetLineItemRecurrenceInfoActionModel::class,
