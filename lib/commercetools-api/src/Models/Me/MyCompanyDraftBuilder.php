...
/**
 * @implements Builder<MyCompanyDraft>
 */
final class MyCompanyDraftBuilder implements Builder
{
    /**
    ...
    public function build(): MyCompanyDraft
    {
        return new MyCompanyDraftModel(
            $this->key,
            $this->name,
            $this->contactEmail,
    ...
    public static function of(): MyCompanyDraftBuilder
    {
        return new self();
    }
}
