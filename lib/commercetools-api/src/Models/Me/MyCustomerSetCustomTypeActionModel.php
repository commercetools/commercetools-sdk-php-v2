 ...
 * @internal
 */
final class MyCustomerSetCustomTypeActionModel extends JsonObjectModel implements MyCustomerSetCustomTypeAction
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the MyCustomer with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the MyCustomer.</p>
