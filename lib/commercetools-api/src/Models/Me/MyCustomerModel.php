...
final class MyCustomerModel extends JsonObjectModel implements MyCustomer
{
    ...
    public function getCreatedAt()
    {
        if (is_null($this->createdAt)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_CREATED_AT);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getLastModifiedAt()
    {
        if (is_null($this->lastModifiedAt)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_LAST_MODIFIED_AT);
            if (is_null($data)) {
                return null;
            }
            $data = DateTimeImmutable::createFromFormat(MapperFactory::DATETIME_FORMAT, $data);
    ...
    public function getCreatedBy()
    {
        if (is_null($this->createdBy)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(MyCustomer::FIELD_CREATED_BY);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getLastName()
    {
        if (is_null($this->lastName)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_LAST_NAME);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getCompanyName()
    {
        if (is_null($this->companyName)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_COMPANY_NAME);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getVatId()
    {
        if (is_null($this->vatId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_VAT_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getShippingAddressIds()
    {
        if (is_null($this->shippingAddressIds)) {
            ...
            $data = $this->raw(MyCustomer::FIELD_SHIPPING_ADDRESS_IDS);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getCustomerGroup()
    {
        if (is_null($this->customerGroup)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(MyCustomer::FIELD_CUSTOMER_GROUP);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getCustom()
    {
        if (is_null($this->custom)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(MyCustomer::FIELD_CUSTOM);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getSalutation()
    {
        if (is_null($this->salutation)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyCustomer::FIELD_SALUTATION);
            if (is_null($data)) {
                return null;
            }
    ...
    {
        $data = $this->toArray();
        if (isset($data[MyCustomer::FIELD_CREATED_AT]) && $data[MyCustomer::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[MyCustomer::FIELD_CREATED_AT] = $data[MyCustomer::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[MyCustomer::FIELD_LAST_MODIFIED_AT]) && $data[MyCustomer::FIELD_LAST_MODIFIED_AT] instanceof \DateTimeImmutable) {
            $data[MyCustomer::FIELD_LAST_MODIFIED_AT] = $data[MyCustomer::FIELD_LAST_MODIFIED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[MyCustomer::FIELD_DATE_OF_BIRTH]) && $data[MyCustomer::FIELD_DATE_OF_BIRTH] instanceof \DateTimeImmutable) {
            $data[MyCustomer::FIELD_DATE_OF_BIRTH] = $data[MyCustomer::FIELD_DATE_OF_BIRTH]->format('Y-m-d');
        }
        return (object) $data;
    }
