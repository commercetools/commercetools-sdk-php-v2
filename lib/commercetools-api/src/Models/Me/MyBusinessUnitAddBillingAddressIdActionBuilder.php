 ...
 */
final class MyBusinessUnitAddBillingAddressIdActionBuilder implements Builder
{
    /**
    ...
    public function build(): MyBusinessUnitAddBillingAddressIdAction
    {
    ...
    public static function of(): MyBusinessUnitAddBillingAddressIdActionBuilder
    {
        return new self();
    }
}
