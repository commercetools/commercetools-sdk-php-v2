...
final class MyPaymentUpdateActionModel extends JsonObjectModel implements MyPaymentUpdateAction
{
    ...
    private static $discriminatorClasses = [
       ...
       'setMethodInfoCustomField' => MyPaymentSetMethodInfoCustomFieldActionModel::class,
       'setMethodInfoCustomType' => MyPaymentSetMethodInfoCustomTypeActionModel::class,
       'setMethodInfoInterface' => MyPaymentSetMethodInfoInterfaceActionModel::class,
       'setMethodInfoInterfaceAccount' => MyPaymentSetMethodInfoInterfaceAccountActionModel::class,
