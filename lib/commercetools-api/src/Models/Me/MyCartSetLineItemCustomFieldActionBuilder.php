...
/**
 * @implements Builder<MyCartSetLineItemCustomFieldAction>
 */
final class MyCartSetLineItemCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): MyCartSetLineItemCustomFieldAction
    {
        return new MyCartSetLineItemCustomFieldActionModel(
            $this->lineItemId,
            $this->name,
            $this->value
        );
    ...
    public static function of(): MyCartSetLineItemCustomFieldActionBuilder
    {
        return new self();
    }
}
