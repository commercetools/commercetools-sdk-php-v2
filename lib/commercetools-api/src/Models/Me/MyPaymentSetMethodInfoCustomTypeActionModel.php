 ...
 * @internal
 */
final class MyPaymentSetMethodInfoCustomTypeActionModel extends JsonObjectModel implements MyPaymentSetMethodInfoCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'setMethodInfoCustomType';
    /**
     *
     * @var ?string
     */
