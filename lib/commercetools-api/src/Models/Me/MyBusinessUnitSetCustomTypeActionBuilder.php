...
/**
 * @implements Builder<MyBusinessUnitSetCustomTypeAction>
 */
final class MyBusinessUnitSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the BusinessUnit.</p>
    ...
    public function build(): MyBusinessUnitSetCustomTypeAction
    {
        return new MyBusinessUnitSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): MyBusinessUnitSetCustomTypeActionBuilder
    {
        return new self();
    }
}
