 ...
 */
final class MyBusinessUnitSetAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the <code>address</code> with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the <code>address</code>.</p>
    ...
    public function build(): MyBusinessUnitSetAddressCustomTypeAction
    {
        return new MyBusinessUnitSetAddressCustomTypeActionModel(
    ...
    public static function of(): MyBusinessUnitSetAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
