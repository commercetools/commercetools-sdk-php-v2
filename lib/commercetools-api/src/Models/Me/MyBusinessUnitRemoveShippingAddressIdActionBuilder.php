 ...
 */
final class MyBusinessUnitRemoveShippingAddressIdActionBuilder implements Builder
{
    /**
    ...
    public function build(): MyBusinessUnitRemoveShippingAddressIdAction
    {
        return new MyBusinessUnitRemoveShippingAddressIdActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): MyBusinessUnitRemoveShippingAddressIdActionBuilder
    {
        return new self();
    }
}
