 ...
 */
final class MyCartSetCustomLineItemRecurrenceInfoActionBuilder implements Builder
{
    /**
    ...
    public function build(): MyCartSetCustomLineItemRecurrenceInfoAction
    {
        return new MyCartSetCustomLineItemRecurrenceInfoActionModel(
    ...
    public static function of(): MyCartSetCustomLineItemRecurrenceInfoActionBuilder
    {
        return new self();
    }
}
