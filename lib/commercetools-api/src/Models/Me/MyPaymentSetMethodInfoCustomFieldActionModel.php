 ...
 * @internal
 */
final class MyPaymentSetMethodInfoCustomFieldActionModel extends JsonObjectModel implements MyPaymentSetMethodInfoCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'setMethodInfoCustomField';
    /**
     *
     * @var ?string
     */
