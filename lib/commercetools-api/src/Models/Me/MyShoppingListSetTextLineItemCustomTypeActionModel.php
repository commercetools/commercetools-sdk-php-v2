...
final class MyShoppingListSetTextLineItemCustomTypeActionModel extends JsonObjectModel implements MyShoppingListSetTextLineItemCustomTypeAction
{
    ...
    public function getTextLineItemId()
    {
        if (is_null($this->textLineItemId)) {
            /** @psalm-var ?string $data */
            $data = $this->raw(MyShoppingListSetTextLineItemCustomTypeAction::FIELD_TEXT_LINE_ITEM_ID);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            ...
            $data = $this->raw(MyShoppingListSetTextLineItemCustomTypeAction::FIELD_TYPE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(MyShoppingListSetTextLineItemCustomTypeAction::FIELD_FIELDS);
            if (is_null($data)) {
                return null;
            }
