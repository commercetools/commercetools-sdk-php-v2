...
final class MyShoppingListSetTextLineItemCustomTypeActionBuilder implements Builder
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the TextLineItem with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the TextLineItem.</p>
    ...
    public static function of(): MyShoppingListSetTextLineItemCustomTypeActionBuilder
    {
        return new self();
    }
}
