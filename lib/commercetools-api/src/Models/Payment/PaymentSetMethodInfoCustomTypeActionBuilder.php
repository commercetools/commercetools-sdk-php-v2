 ...
 */
final class PaymentSetMethodInfoCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentSetMethodInfoCustomTypeAction
    {
        return new PaymentSetMethodInfoCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): PaymentSetMethodInfoCustomTypeActionBuilder
    {
        return new self();
    }
}
