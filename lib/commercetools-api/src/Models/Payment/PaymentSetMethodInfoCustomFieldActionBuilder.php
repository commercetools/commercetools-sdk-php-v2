 ...
 */
final class PaymentSetMethodInfoCustomFieldActionBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentSetMethodInfoCustomFieldAction
    {
        return new PaymentSetMethodInfoCustomFieldActionModel(
            $this->name,
            $this->value
        );
    }

    public static function of(): PaymentSetMethodInfoCustomFieldActionBuilder
    {
        return new self();
    }
}
