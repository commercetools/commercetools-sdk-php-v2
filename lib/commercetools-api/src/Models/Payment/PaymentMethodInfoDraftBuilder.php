...
/**
 * @implements Builder<PaymentMethodInfoDraft>
 */
final class PaymentMethodInfoDraftBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodInfoDraft
    {
        return new PaymentMethodInfoDraftModel(
    ...
    public static function of(): PaymentMethodInfoDraftBuilder
    {
        return new self();
    }
}
