...
/**
 * @implements Builder<PaymentSetMethodInfoAction>
 */
final class PaymentSetMethodInfoActionBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentSetMethodInfoAction
    {
        return new PaymentSetMethodInfoActionModel(
    ...
    public static function of(): PaymentSetMethodInfoActionBuilder
    {
        return new self();
    }
}
