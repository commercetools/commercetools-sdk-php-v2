...
/**
 * @implements Builder<BusinessUnitSearchRequest>
 */
final class BusinessUnitSearchRequestBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitSearchRequest
    {
        return new BusinessUnitSearchRequestModel(
    ...
    public static function of(): BusinessUnitSearchRequestBuilder
    {
        return new self();
    }
}
