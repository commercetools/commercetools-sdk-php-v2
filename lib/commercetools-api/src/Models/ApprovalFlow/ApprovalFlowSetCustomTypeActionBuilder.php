...
/**
 * @implements Builder<ApprovalFlowSetCustomTypeAction>
 */
final class ApprovalFlowSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the ApprovalFlow with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
     * If absent, any existing Type and Custom Fields are removed from the ApprovalFlow.</p>
     *
    ...
    public function build(): ApprovalFlowSetCustomTypeAction
    {
        return new ApprovalFlowSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ApprovalFlowSetCustomTypeActionBuilder
    {
        return new self();
    }
}
