 ...
 * @internal
 */
final class ProjectChangeBusinessUnitSearchStatusActionModel extends JsonObjectModel implements ProjectChangeBusinessUnitSearchStatusAction
{
    public const DISCRIMINATOR_VALUE = 'changeBusinessUnitSearchStatus';
    /**
     *
     * @var ?string
     */
