 ...
 * @internal
 */
final class ProjectChangeCustomerSearchStatusActionModel extends JsonObjectModel implements ProjectChangeCustomerSearchStatusAction
{
    public const DISCRIMINATOR_VALUE = 'changeCustomerSearchStatus';
    /**
     *
     * @var ?string
     */
