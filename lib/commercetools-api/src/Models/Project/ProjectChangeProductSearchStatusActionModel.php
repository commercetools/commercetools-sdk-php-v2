 ...
 * @internal
 */
final class ProjectChangeProductSearchStatusActionModel extends JsonObjectModel implements ProjectChangeProductSearchStatusAction
{
    public const DISCRIMINATOR_VALUE = 'changeProductSearchStatus';
    /**
     *
     * @var ?string
     */
