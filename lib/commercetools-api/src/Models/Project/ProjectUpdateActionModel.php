...
final class ProjectUpdateActionModel extends JsonObjectModel implements ProjectUpdateAction
{
    ...
    private static $discriminatorClasses = [
       'changeBusinessUnitSearchStatus' => ProjectChangeBusinessUnitSearchStatusActionModel::class,
       ...
       'changePriceRoundingMode' => ProjectChangePriceRoundingModeActionModel::class,
       ...
       'changeTaxRoundingMode' => ProjectChangeTaxRoundingModeActionModel::class,
