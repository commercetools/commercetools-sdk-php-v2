...
/**
 * @implements Builder<ProductSearchHit>
 */
final class ProductSearchHitBuilder implements Builder
{
    /**
     ...
     * @return $this
     */
    public function withMatchingVariants(?ProductSearchMatchingVariantCollection $matchingVariants)
    {
    ...
    public function build(): ProductSearchHit
    {
        return new ProductSearchHitModel(
            $this->id,
    ...
    public static function of(): ProductSearchHitBuilder
    {
        return new self();
    }
}
