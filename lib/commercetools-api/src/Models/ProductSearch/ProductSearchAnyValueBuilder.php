...
/**
 * @implements Builder<ProductSearchAnyValue>
 */
final class ProductSearchAnyValueBuilder implements Builder
{
    /**
    ...
    public function build(): ProductSearchAnyValue
    {
        return new ProductSearchAnyValueModel(
            $this->field,
            $this->boost,
            $this->attributeType,
            $this->value,
    ...
    public static function of(): ProductSearchAnyValueBuilder
    {
        return new self();
    }
}
