 ...
 * @internal
 */
final class ProductSearchFacetBucketResultModel extends JsonObjectModel implements ProductSearchFacetBucketResult
{
    /**
     *
     * @var ?string
    ...
    public function __construct(
        ?string $name = null,
        ?ProductSearchFacetResultBucketCollection $buckets = null
    ) {
        $this->name = $name;
    ...
    public function getBuckets()
    {
        if (is_null($this->buckets)) {
            ...
            $this->buckets = ProductSearchFacetResultBucketCollection::fromArray($data);
        }
