...
/**
 * @implements Builder<ProductSearchDateRangeValue>
 */
final class ProductSearchDateRangeValueBuilder implements Builder
{
    /**
    ...
    public function build(): ProductSearchDateRangeValue
    {
        return new ProductSearchDateRangeValueModel(
            $this->field,
            $this->boost,
            $this->attributeType,
            $this->gte,
    ...
    public static function of(): ProductSearchDateRangeValueBuilder
    {
        return new self();
    }
}
