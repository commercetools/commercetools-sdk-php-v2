 ...
 */
final class RecurrencePolicyUpdateBuilder implements Builder
{
    /**
     ...
     * @var ?RecurrencePolicyUpdateActionCollection
     */
    private $actions;
     ...
     * @return $this
     */
    public function withActions(?RecurrencePolicyUpdateActionCollection $actions)
    {
    ...
    public function build(): RecurrencePolicyUpdate
    {
        return new RecurrencePolicyUpdateModel(
            $this->version,
            $this->actions
        );
    }

    public static function of(): RecurrencePolicyUpdateBuilder
    {
        return new self();
    }
}
