 ...
 * @internal
 */
final class RecurrencePolicyReferenceModel extends JsonObjectModel implements RecurrencePolicyReference
{
    public const DISCRIMINATOR_VALUE = 'recurrence-policy';
    /**
     *
     * @var ?string
     */
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = RecurrencePolicyModel::of($data);
        }
