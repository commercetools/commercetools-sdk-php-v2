 ...
 * @internal
 */
final class RecurrencePolicyUpdateModel extends JsonObjectModel implements RecurrencePolicyUpdate
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ?int $version = null,
        ?RecurrencePolicyUpdateActionCollection $actions = null
    ) {
    ...
    public function getActions()
    {
        if (is_null($this->actions)) {
            ...
            $this->actions = RecurrencePolicyUpdateActionCollection::fromArray($data);
        }
