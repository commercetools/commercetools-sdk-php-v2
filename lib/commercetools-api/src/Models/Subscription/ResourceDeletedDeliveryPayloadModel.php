...
final class ResourceDeletedDeliveryPayloadModel extends JsonObjectModel implements ResourceDeletedDeliveryPayload
{
    ...
    /**
     * <p>Whether the <code>dataErasure</code> <a href="/api/gdpr#data-erasure-of-personal-data">parameter</a> on the <code>DELETE</code> request was set to <code>true</code>.</p>
     *
     *
     * @return null|bool
     */
