...
final class ProductDiscountReferenceBuilder implements Builder
{
    ...
    /**
     * @var ?ProductDiscountBuilder|ProductDiscount
     */
    protected $obj;
     ...
     * @return $this
     */
    final public function withObj(?ProductDiscount $obj)
    {
        $this->obj = $obj;
     ...
     * @return $this
     */
    final public function withObjBuilder(?ProductDiscountBuilder $obj)
    {
        $this->obj = $obj;
