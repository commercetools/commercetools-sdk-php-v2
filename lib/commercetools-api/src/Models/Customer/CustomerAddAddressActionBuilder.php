...
/**
 * @implements Builder<CustomerAddAddressAction>
 */
final class CustomerAddAddressActionBuilder implements Builder
{
    ...
    public function build(): CustomerAddAddressAction
    {
        return new CustomerAddAddressActionModel(
            $this->address instanceof BaseAddressBuilder ? $this->address->build() : $this->address
        );
    }

    public static function of(): CustomerAddAddressActionBuilder
    {
        return new self();
    }
}
