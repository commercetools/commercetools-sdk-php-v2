...
final class CustomerUpdateActionModel extends JsonObjectModel implements CustomerUpdateAction
{
    ...
    private static $discriminatorClasses = [
       ...
       'addCustomerGroupAssignment' => CustomerAddCustomerGroupAssignmentActionModel::class,
       ...
       'removeCustomerGroupAssignment' => CustomerRemoveCustomerGroupAssignmentActionModel::class,
       ...
       'setCustomerGroupAssignments' => CustomerSetCustomerGroupAssignmentsActionModel::class,
