 ...
 */
final class CustomerAddStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): CustomerAddStoreAction
    {
        return new CustomerAddStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): CustomerAddStoreActionBuilder
    {
        return new self();
    }
}
