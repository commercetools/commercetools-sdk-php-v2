...
/**
 * @implements Builder<CartSetShippingCustomTypeAction>
 */
final class CartSetShippingCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): CartSetShippingCustomTypeAction
    {
        return new CartSetShippingCustomTypeActionModel(
            $this->shippingKey,
    ...
    public static function of(): CartSetShippingCustomTypeActionBuilder
    {
        return new self();
    }
}
