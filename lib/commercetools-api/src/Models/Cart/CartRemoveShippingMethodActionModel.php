 ...
 * @internal
 */
final class CartRemoveShippingMethodActionModel extends JsonObjectModel implements CartRemoveShippingMethodAction
{
    public const DISCRIMINATOR_VALUE = 'removeShippingMethod';
    /**
     *
     * @var ?string
     */
