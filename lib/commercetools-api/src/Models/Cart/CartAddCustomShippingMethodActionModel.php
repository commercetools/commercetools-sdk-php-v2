 ...
 * @internal
 */
final class CartAddCustomShippingMethodActionModel extends JsonObjectModel implements CartAddCustomShippingMethodAction
{
    public const DISCRIMINATOR_VALUE = 'addCustomShippingMethod';
    /**
     *
     * @var ?string
     */
