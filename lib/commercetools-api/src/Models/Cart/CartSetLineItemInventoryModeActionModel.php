 ...
 * @internal
 */
final class CartSetLineItemInventoryModeActionModel extends JsonObjectModel implements CartSetLineItemInventoryModeAction
{
    public const DISCRIMINATOR_VALUE = 'setLineItemInventoryMode';
    /**
     *
     * @var ?string
     */
