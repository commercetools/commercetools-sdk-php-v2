 ...
 */
final class CartSetShippingAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): CartSetShippingAddressCustomTypeAction
    {
        return new CartSetShippingAddressCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): CartSetShippingAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
