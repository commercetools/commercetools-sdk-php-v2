 ...
 */
final class CartSetLineItemRecurrenceInfoActionBuilder implements Builder
{
    /**
    ...
    public function build(): CartSetLineItemRecurrenceInfoAction
    {
        return new CartSetLineItemRecurrenceInfoActionModel(
            $this->lineItemId,
            $this->lineItemKey,
    ...
    public static function of(): CartSetLineItemRecurrenceInfoActionBuilder
    {
        return new self();
    }
}
