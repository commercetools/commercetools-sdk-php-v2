...
final class CartUpdateActionModel extends JsonObjectModel implements CartUpdateAction
{
    ...
    private static $discriminatorClasses = [
       ...
       'changePriceRoundingMode' => CartChangePriceRoundingModeActionModel::class,
       ...
       'setCustomLineItemRecurrenceInfo' => CartSetCustomLineItemRecurrenceInfoActionModel::class,
       ...
       'setDirectDiscountsIgnoreCartDiscounts' => CartSetDirectDiscountsIgnoreCartDiscountsActionModel::class,
       'setEstimatedDelivery' => CartSetEstimatedDeliveryActionModel::class,
       ...
       'setLineItemInventoryMode' => CartSetLineItemInventoryModeActionModel::class,
       'setLineItemPrice' => CartSetLineItemPriceActionModel::class,
       'setLineItemRecurrenceInfo' => CartSetLineItemRecurrenceInfoActionModel::class,
