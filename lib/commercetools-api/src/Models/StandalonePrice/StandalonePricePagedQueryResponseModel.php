...
final class StandalonePricePagedQueryResponseModel extends JsonObjectModel implements StandalonePricePagedQueryResponse
{
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?StandalonePriceCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = StandalonePriceCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?StandalonePriceCollection $results): void
    {
        $this->results = $results;
    }
}
