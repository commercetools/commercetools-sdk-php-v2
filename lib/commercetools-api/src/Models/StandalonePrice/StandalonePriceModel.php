...
final class StandalonePriceModel extends JsonObjectModel implements StandalonePrice
{
     ...
     * When a <a href="/../api/projects/productDiscounts#relative">relative discount</a> is applied and the fraction part of the <code>discounted</code> price is 0.5, the discounted price is rounded in favor of the customer with the <a href="https://en.wikipedia.org/wiki/Rounding#Round_half_down">half down rounding</a>.</p>
     *
    ...
    {
        $data = $this->toArray();
        if (isset($data[StandalonePrice::FIELD_CREATED_AT]) && $data[StandalonePrice::FIELD_CREATED_AT] instanceof \DateTimeImmutable) {
            $data[StandalonePrice::FIELD_CREATED_AT] = $data[StandalonePrice::FIELD_CREATED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePrice::FIELD_LAST_MODIFIED_AT]) && $data[StandalonePrice::FIELD_LAST_MODIFIED_AT] instanceof \DateTimeImmutable) {
            $data[StandalonePrice::FIELD_LAST_MODIFIED_AT] = $data[StandalonePrice::FIELD_LAST_MODIFIED_AT]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePrice::FIELD_VALID_FROM]) && $data[StandalonePrice::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[StandalonePrice::FIELD_VALID_FROM] = $data[StandalonePrice::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[StandalonePrice::FIELD_VALID_UNTIL]) && $data[StandalonePrice::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[StandalonePrice::FIELD_VALID_UNTIL] = $data[StandalonePrice::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
