...
/**
 * @implements Builder<StandalonePriceSetCustomTypeAction>
 */
final class StandalonePriceSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the StandalonePrice with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the StandalonePrice.</p>
    ...
    public function build(): StandalonePriceSetCustomTypeAction
    {
        return new StandalonePriceSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): StandalonePriceSetCustomTypeActionBuilder
    {
        return new self();
    }
}
