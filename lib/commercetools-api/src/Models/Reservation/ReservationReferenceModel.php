 ...
 * @internal
 */
final class ReservationReferenceModel extends JsonObjectModel implements ReservationReference
{
    public const DISCRIMINATOR_VALUE = 'reservation';
    /**
     *
     * @var ?string
     */
    ...
    public function getObj()
    {
        if (is_null($this->obj)) {
            ...
            $this->obj = ReservationModel::of($data);
        }
