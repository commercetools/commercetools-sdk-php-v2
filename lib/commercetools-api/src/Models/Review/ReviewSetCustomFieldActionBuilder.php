...
/**
 * @implements Builder<ReviewSetCustomFieldAction>
 */
final class ReviewSetCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ReviewSetCustomFieldAction
    {
        return new ReviewSetCustomFieldActionModel(
            $this->name,
            $this->value
        );
    }

    public static function of(): ReviewSetCustomFieldActionBuilder
    {
        return new self();
    }
}
