 ...
 * @internal
 */
final class PaymentMethodSetInterfaceAccountActionModel extends JsonObjectModel implements PaymentMethodSetInterfaceAccountAction
{
    public const DISCRIMINATOR_VALUE = 'setInterfaceAccount';
    /**
     *
     * @var ?string
     */
