 ...
 */
final class PaymentMethodSetCustomFieldActionBuilder implements Builder
{
    /**
    ...
    public function build(): PaymentMethodSetCustomFieldAction
    {
        return new PaymentMethodSetCustomFieldActionModel(
            $this->name,
            $this->value
        );
    }

    public static function of(): PaymentMethodSetCustomFieldActionBuilder
    {
        return new self();
    }
}
