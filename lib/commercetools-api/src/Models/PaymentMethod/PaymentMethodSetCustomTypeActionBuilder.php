...
/**
 * @implements Builder<PaymentMethodSetCustomTypeAction>
 */
final class PaymentMethodSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the PaymentMethod with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
     * If absent, any existing Type and Custom Fields are removed from the PaymentMethod.</p>
     *
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the PaymentMethod.</p>
    ...
    public function build(): PaymentMethodSetCustomTypeAction
    {
        return new PaymentMethodSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): PaymentMethodSetCustomTypeActionBuilder
    {
        return new self();
    }
}
