 ...
 * @internal
 */
final class PaymentMethodUpdateModel extends JsonObjectModel implements PaymentMethodUpdate
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ?int $version = null,
        ?PaymentMethodUpdateActionCollection $actions = null
    ) {
    ...
    public function getActions()
    {
        if (is_null($this->actions)) {
            ...
            $this->actions = PaymentMethodUpdateActionCollection::fromArray($data);
        }
