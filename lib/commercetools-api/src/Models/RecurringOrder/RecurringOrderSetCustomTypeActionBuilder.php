...
/**
 * @implements Builder<RecurringOrderSetCustomTypeAction>
 */
final class RecurringOrderSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the RecurringOrder with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the RecurringOrder.</p>
    ...
    public function build(): RecurringOrderSetCustomTypeAction
    {
        return new RecurringOrderSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): RecurringOrderSetCustomTypeActionBuilder
    {
        return new self();
    }
}
