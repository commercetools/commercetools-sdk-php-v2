 ...
 * @internal
 */
final class RecurringOrderUpdateModel extends JsonObjectModel implements RecurringOrderUpdate
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ?int $version = null,
        ?RecurringOrderUpdateActionCollection $actions = null
    ) {
    ...
    public function getActions()
    {
        if (is_null($this->actions)) {
            ...
            $this->actions = RecurringOrderUpdateActionCollection::fromArray($data);
        }
