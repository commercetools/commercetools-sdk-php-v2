 ...
 * @internal
 */
final class StoreSetCustomTypeActionModel extends JsonObjectModel implements StoreSetCustomTypeAction
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Store with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Store.</p>
