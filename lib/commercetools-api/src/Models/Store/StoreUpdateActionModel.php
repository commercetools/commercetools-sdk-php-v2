...
final class StoreUpdateActionModel extends JsonObjectModel implements StoreUpdateAction
{
    ...
    private static $discriminatorClasses = [
       'addCountry' => StoreAddCountryActionModel::class,
       ...
       'removeCountry' => StoreRemoveCountryActionModel::class,
       ...
       'setCheckoutUrlTemplate' => StoreSetCheckoutUrlTemplateActionModel::class,
       'setContactUrl' => StoreSetContactUrlActionModel::class,
       'setCookiePolicyUrl' => StoreSetCookiePolicyUrlActionModel::class,
       'setCountries' => StoreSetCountriesActionModel::class,
       ...
       'setFaqUrl' => StoreSetFaqUrlActionModel::class,
       'setImprintUrl' => StoreSetImprintUrlActionModel::class,
       'setLanguages' => StoreSetLanguagesActionModel::class,
       'setName' => StoreSetNameActionModel::class,
       'setOrderUrlTemplate' => StoreSetOrderUrlTemplateActionModel::class,
       'setPrivacyPolicyUrl' => StoreSetPrivacyPolicyUrlActionModel::class,
       'setProductSelections' => StoreSetProductSelectionsActionModel::class,
       'setRefundPolicyUrl' => StoreSetRefundPolicyUrlActionModel::class,
       'setShippingPolicyUrl' => StoreSetShippingPolicyUrlActionModel::class,
       'setSupplyChannels' => StoreSetSupplyChannelsActionModel::class,
       'setTermsOfServiceUrl' => StoreSetTermsOfServiceUrlActionModel::class,
    ];
