...
/**
 * @implements Builder<ApprovalRuleSetCustomTypeAction>
 */
final class ApprovalRuleSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the ApprovalRule.</p>
    ...
    public function build(): ApprovalRuleSetCustomTypeAction
    {
        return new ApprovalRuleSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): ApprovalRuleSetCustomTypeActionBuilder
    {
        return new self();
    }
}
