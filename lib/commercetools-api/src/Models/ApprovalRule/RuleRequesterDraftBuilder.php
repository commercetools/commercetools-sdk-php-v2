...
/**
 * @implements Builder<RuleRequesterDraft>
 */
final class RuleRequesterDraftBuilder implements Builder
{
    /**
    ...
    public function build(): RuleRequesterDraft
    {
        return new RuleRequesterDraftModel(
            $this->associateRole instanceof AssociateRoleResourceIdentifierBuilder ? $this->associateRole->build() : $this->associateRole
        );
    }

    public static function of(): RuleRequesterDraftBuilder
    {
        return new self();
    }
}
