 ...
 * @internal
 */
final class ApprovalRuleUpdateModel extends JsonObjectModel implements ApprovalRuleUpdate
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ?int $version = null,
        ?ApprovalRuleUpdateActionCollection $actions = null
    ) {
    ...
    public function getActions()
    {
        if (is_null($this->actions)) {
            ...
            $this->actions = ApprovalRuleUpdateActionCollection::fromArray($data);
        }
