 ...
 * @internal
 */
final class CustomerPagedSearchResponseModel extends JsonObjectModel implements CustomerPagedSearchResponse
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ...
        ?int $limit = null,
        ?int $offset = null,
        ?CustomerSearchResultCollection $results = null
    ) {
        $this->total = $total;
        $this->limit = $limit;
        $this->offset = $offset;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = CustomerSearchResultCollection::fromArray($data);
        }
