...
/**
 * @implements Builder<QuoteTransitionStateAction>
 */
final class QuoteTransitionStateActionBuilder implements Builder
{
    /**
    ...
    public function build(): QuoteTransitionStateAction
    {
        return new QuoteTransitionStateActionModel(
            $this->state instanceof StateResourceIdentifierBuilder ? $this->state->build() : $this->state,
            $this->force
        );
    }

    public static function of(): QuoteTransitionStateActionBuilder
    {
        return new self();
    }
}
