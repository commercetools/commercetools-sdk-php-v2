...
final class ExtensionUpdateActionsFailedErrorModel extends JsonObjectModel implements ExtensionUpdateActionsFailedError
{
    ...
    public function getLocalizedMessage()
    {
        if (is_null($this->localizedMessage)) {
            ...
            $data = $this->raw(ExtensionUpdateActionsFailedError::FIELD_LOCALIZED_MESSAGE);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getExtensionExtraInfo()
    {
        if (is_null($this->extensionExtraInfo)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ExtensionUpdateActionsFailedError::FIELD_EXTENSION_EXTRA_INFO);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getErrorByExtension()
    {
        if (is_null($this->errorByExtension)) {
            /** @psalm-var stdClass|array<string, mixed>|null $data */
            $data = $this->raw(ExtensionUpdateActionsFailedError::FIELD_ERROR_BY_EXTENSION);
            if (is_null($data)) {
                return null;
            }
