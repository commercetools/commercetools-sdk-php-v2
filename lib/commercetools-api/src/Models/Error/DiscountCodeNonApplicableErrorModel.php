...
final class DiscountCodeNonApplicableErrorModel extends JsonObjectModel implements DiscountCodeNonApplicableError
{
    ...
    final public function setValidityCheckTime(?DateTimeImmutable $validityCheckTime): void
    {
        $this->validityCheckTime = $validityCheckTime;
    }
    
    final public function setDiscountCode(?string $discountCode): void
    {
        $this->discountCode = $discountCode;
    }
    ...
    final public function setDicountCodeId(?string $dicountCodeId): void
    {
        $this->dicountCodeId = $dicountCodeId;
    }
