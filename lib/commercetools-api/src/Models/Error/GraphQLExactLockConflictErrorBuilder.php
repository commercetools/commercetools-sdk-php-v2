...
/**
 * @implements Builder<GraphQLExactLockConflictError>
 */
final class GraphQLExactLockConflictErrorBuilder implements Builder
{
    /**
    ...
    public function build(): GraphQLExactLockConflictError
    {
        return new GraphQLExactLockConflictErrorModel(
            $this->sku,
            $this->currency,
            $this->country,
    ...
    public static function of(): GraphQLExactLockConflictErrorBuilder
    {
        return new self();
    }
}
