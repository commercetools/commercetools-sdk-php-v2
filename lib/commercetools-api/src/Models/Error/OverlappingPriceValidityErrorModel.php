 ...
 * @internal
 */
final class OverlappingPriceValidityErrorModel extends JsonObjectModel implements OverlappingPriceValidityError
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[OverlappingPriceValidityError::FIELD_VALID_FROM]) && $data[OverlappingPriceValidityError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[OverlappingPriceValidityError::FIELD_VALID_FROM] = $data[OverlappingPriceValidityError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingPriceValidityError::FIELD_VALID_UNTIL]) && $data[OverlappingPriceValidityError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[OverlappingPriceValidityError::FIELD_VALID_UNTIL] = $data[OverlappingPriceValidityError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM]) && $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM] = $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]) && $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] = $data[OverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
