 ...
 * @internal
 */
final class GraphQLDiscountCodeNonApplicableErrorModel extends JsonObjectModel implements GraphQLDiscountCodeNonApplicableError
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_FROM]) && $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_FROM] = $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_UNTIL]) && $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_UNTIL] = $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLDiscountCodeNonApplicableError::FIELD_VALIDITY_CHECK_TIME]) && $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALIDITY_CHECK_TIME] instanceof \DateTimeImmutable) {
            $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALIDITY_CHECK_TIME] = $data[GraphQLDiscountCodeNonApplicableError::FIELD_VALIDITY_CHECK_TIME]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
