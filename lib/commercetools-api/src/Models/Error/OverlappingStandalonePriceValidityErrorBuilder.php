...
final class OverlappingStandalonePriceValidityErrorBuilder implements Builder
{
    ...
    public function build(): OverlappingStandalonePriceValidityError
    {
        return new OverlappingStandalonePriceValidityErrorModel(
            $this->message,
    ...
    public static function of(): OverlappingStandalonePriceValidityErrorBuilder
    {
        return new self();
    }
}
