...
/**
 * @implements Builder<ExactLockConflictError>
 */
final class ExactLockConflictErrorBuilder implements Builder
{
    /**
    ...
    public function build(): ExactLockConflictError
    {
        return new ExactLockConflictErrorModel(
            $this->message,
            $this->sku,
            $this->currency,
            $this->country,
    ...
    public static function of(): ExactLockConflictErrorBuilder
    {
        return new self();
    }
}
