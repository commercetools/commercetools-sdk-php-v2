 ...
 */
final class GraphQLDuplicateStandalonePriceScopeErrorBuilder implements Builder
{
    /**
    ...
    public function build(): GraphQLDuplicateStandalonePriceScopeError
    {
        return new GraphQLDuplicateStandalonePriceScopeErrorModel(
    ...
    public static function of(): GraphQLDuplicateStandalonePriceScopeErrorBuilder
    {
        return new self();
    }
}
