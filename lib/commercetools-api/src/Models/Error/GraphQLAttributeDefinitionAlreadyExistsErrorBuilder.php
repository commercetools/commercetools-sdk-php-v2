 ...
 */
final class GraphQLAttributeDefinitionAlreadyExistsErrorBuilder implements Builder
{
    /**
    ...
    public function build(): GraphQLAttributeDefinitionAlreadyExistsError
    {
        return new GraphQLAttributeDefinitionAlreadyExistsErrorModel(
    ...
    public static function of(): GraphQLAttributeDefinitionAlreadyExistsErrorBuilder
    {
        return new self();
    }
}
