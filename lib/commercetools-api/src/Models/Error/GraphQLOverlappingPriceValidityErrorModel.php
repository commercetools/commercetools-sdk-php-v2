 ...
 * @internal
 */
final class GraphQLOverlappingPriceValidityErrorModel extends JsonObjectModel implements GraphQLOverlappingPriceValidityError
{
    public const DISCRIMINATOR_VALUE = 'OverlappingPriceValidity';
    /**
     *
     * @var ?string
     */
    ...
    public function getConflictingPrice()
    {
        if (is_null($this->conflictingPrice)) {
            ...
            $this->conflictingPrice = (string) $data;
        }
    ...
    {
        $data = $this->toArray();
        if (isset($data[GraphQLOverlappingPriceValidityError::FIELD_VALID_FROM]) && $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_FROM] = $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLOverlappingPriceValidityError::FIELD_VALID_UNTIL]) && $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_UNTIL] = $data[GraphQLOverlappingPriceValidityError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM]) && $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM] = $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]) && $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] = $data[GraphQLOverlappingPriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
