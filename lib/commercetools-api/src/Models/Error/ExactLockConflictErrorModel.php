 ...
 * @internal
 */
final class ExactLockConflictErrorModel extends JsonObjectModel implements ExactLockConflictError
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[ExactLockConflictError::FIELD_VALID_FROM]) && $data[ExactLockConflictError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[ExactLockConflictError::FIELD_VALID_FROM] = $data[ExactLockConflictError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[ExactLockConflictError::FIELD_VALID_UNTIL]) && $data[ExactLockConflictError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[ExactLockConflictError::FIELD_VALID_UNTIL] = $data[ExactLockConflictError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
