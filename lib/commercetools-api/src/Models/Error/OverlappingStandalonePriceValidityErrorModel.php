 ...
 * @internal
 */
final class OverlappingStandalonePriceValidityErrorModel extends JsonObjectModel implements OverlappingStandalonePriceValidityError
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[OverlappingStandalonePriceValidityError::FIELD_VALID_FROM]) && $data[OverlappingStandalonePriceValidityError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[OverlappingStandalonePriceValidityError::FIELD_VALID_FROM] = $data[OverlappingStandalonePriceValidityError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingStandalonePriceValidityError::FIELD_VALID_UNTIL]) && $data[OverlappingStandalonePriceValidityError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[OverlappingStandalonePriceValidityError::FIELD_VALID_UNTIL] = $data[OverlappingStandalonePriceValidityError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_FROM]) && $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_FROM] = $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]) && $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_UNTIL] = $data[OverlappingStandalonePriceValidityError::FIELD_CONFLICTING_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
