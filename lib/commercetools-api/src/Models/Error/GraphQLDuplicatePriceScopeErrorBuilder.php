...
/**
 * @implements Builder<GraphQLDuplicatePriceScopeError>
 */
final class GraphQLDuplicatePriceScopeErrorBuilder implements Builder
{
    /**
    ...
    public function build(): GraphQLDuplicatePriceScopeError
    {
        return new GraphQLDuplicatePriceScopeErrorModel(
            $this->conflictingPrice instanceof PriceBuilder ? $this->conflictingPrice->build() : $this->conflictingPrice
        );
    }

    public static function of(): GraphQLDuplicatePriceScopeErrorBuilder
    {
        return new self();
    }
}
