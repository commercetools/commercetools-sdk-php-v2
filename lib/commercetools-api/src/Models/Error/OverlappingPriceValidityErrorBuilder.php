...
/**
 * @implements Builder<OverlappingPriceValidityError>
 */
final class OverlappingPriceValidityErrorBuilder implements Builder
{
    /**
    ...
    public function build(): OverlappingPriceValidityError
    {
        return new OverlappingPriceValidityErrorModel(
            $this->message,
    ...
    public static function of(): OverlappingPriceValidityErrorBuilder
    {
        return new self();
    }
}
