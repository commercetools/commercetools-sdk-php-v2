...
/**
 * @implements Builder<GraphQLEnumKeyDoesNotExistError>
 */
final class GraphQLEnumKeyDoesNotExistErrorBuilder implements Builder
{
    /**
    ...
    public function build(): GraphQLEnumKeyDoesNotExistError
    {
        return new GraphQLEnumKeyDoesNotExistErrorModel(
            $this->conflictingEnumKey,
            $this->conflictingAttributeName
        );
    }

    public static function of(): GraphQLEnumKeyDoesNotExistErrorBuilder
    {
        return new self();
    }
}
