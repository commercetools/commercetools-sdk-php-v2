...
/**
 * @implements Builder<ValidityLockConflictError>
 */
final class ValidityLockConflictErrorBuilder implements Builder
{
    /**
    ...
    public function build(): ValidityLockConflictError
    {
        return new ValidityLockConflictErrorModel(
            $this->message,
            $this->sku,
            $this->currency,
            $this->country,
    ...
    public static function of(): ValidityLockConflictErrorBuilder
    {
        return new self();
    }
}
