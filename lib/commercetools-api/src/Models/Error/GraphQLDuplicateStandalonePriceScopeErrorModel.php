 ...
 * @internal
 */
final class GraphQLDuplicateStandalonePriceScopeErrorModel extends JsonObjectModel implements GraphQLDuplicateStandalonePriceScopeError
{
    ...
    {
        $data = $this->toArray();
        if (isset($data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_FROM]) && $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_FROM] instanceof \DateTimeImmutable) {
            $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_FROM] = $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_FROM]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }

        if (isset($data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_UNTIL]) && $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_UNTIL] instanceof \DateTimeImmutable) {
            $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_UNTIL] = $data[GraphQLDuplicateStandalonePriceScopeError::FIELD_VALID_UNTIL]->setTimeZone(new \DateTimeZone('UTC'))->format('c');
        }
        return (object) $data;
    }
}
