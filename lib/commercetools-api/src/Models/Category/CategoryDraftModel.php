...
final class CategoryDraftModel extends JsonObjectModel implements CategoryDraft
{
     ...
     * <p>This field is optional for backwards compatibility reasons, but we strongly recommend setting it. Keys are mandatory for importing Categories with the <a href="/../api/import-export/overview">Import API</a> and the <a href="/../merchant-center/import-data">Merchant Center</a>.</p>
     *
     *
     * @return null|string
     */
