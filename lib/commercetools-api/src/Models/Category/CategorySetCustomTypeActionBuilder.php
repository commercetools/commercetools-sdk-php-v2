...
final class CategorySetCustomTypeActionBuilder implements Builder
{
    ...
    /**
     * <p>Defines the <a href="ctp:api:type:Type">Type</a> that extends the Category with <a href="ctp:api:type:CustomFields">Custom Fields</a>.
    ...
    /**
     * <p>Object containing the <a href="ctp:api:type:CustomFields">Custom Fields</a> fields for the Category.</p>
    ...
    public static function of(): CategorySetCustomTypeActionBuilder
    {
        return new self();
    }
}
