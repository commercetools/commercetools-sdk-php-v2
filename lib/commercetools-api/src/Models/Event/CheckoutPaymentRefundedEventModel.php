 ...
 * @internal
 */
final class CheckoutPaymentRefundedEventModel extends JsonObjectModel implements CheckoutPaymentRefundedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentRefunded';
    /**
     *
     * @var ?string
     */
