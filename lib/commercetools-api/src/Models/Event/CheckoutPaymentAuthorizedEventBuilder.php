...
/**
 * @implements Builder<CheckoutPaymentAuthorizedEvent>
 */
final class CheckoutPaymentAuthorizedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentAuthorizedEvent
    {
        return new CheckoutPaymentAuthorizedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentAuthorizedEventBuilder
    {
        return new self();
    }
}
