 ...
 * @internal
 */
final class ImportWaitForMasterVariantEventModel extends JsonObjectModel implements ImportWaitForMasterVariantEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportWaitForMasterVariant';
    /**
     *
     * @var ?string
     */
    ...
    /**
     *
     * @var ?ImportWaitForMasterVariantEventData
     */
    protected $data;
    ...
    public function __construct(
        ...
        ?ImportWaitForMasterVariantEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportWaitForMasterVariantEventDataModel::of($data);
        }
