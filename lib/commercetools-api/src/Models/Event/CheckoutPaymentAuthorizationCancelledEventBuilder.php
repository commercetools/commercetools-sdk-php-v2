 ...
 */
final class CheckoutPaymentAuthorizationCancelledEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentAuthorizationCancelledEvent
    {
        return new CheckoutPaymentAuthorizationCancelledEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentAuthorizationCancelledEventBuilder
    {
        return new self();
    }
}
