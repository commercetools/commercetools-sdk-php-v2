 ...
 * @internal
 */
final class CheckoutPaymentChargeFailedEventModel extends JsonObjectModel implements CheckoutPaymentChargeFailedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentChargeFailed';
    /**
     *
     * @var ?string
     */
