...
/**
 * @implements Builder<CheckoutPaymentRefundedEvent>
 */
final class CheckoutPaymentRefundedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentRefundedEvent
    {
        return new CheckoutPaymentRefundedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentRefundedEventBuilder
    {
        return new self();
    }
}
