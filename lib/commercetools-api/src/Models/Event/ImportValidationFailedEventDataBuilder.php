 ...
 */
final class ImportValidationFailedEventDataBuilder implements Builder
{
    /**
    ...
    public function build(): ImportValidationFailedEventData
    {
        return new ImportValidationFailedEventDataModel(
            $this->id,
            $this->version,
    ...
    public static function of(): ImportValidationFailedEventDataBuilder
    {
        return new self();
    }
}
