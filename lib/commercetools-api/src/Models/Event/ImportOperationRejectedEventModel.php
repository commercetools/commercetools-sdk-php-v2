 ...
 * @internal
 */
final class ImportOperationRejectedEventModel extends JsonObjectModel implements ImportOperationRejectedEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportOperationRejected';
    /**
     *
     * @var ?string
     */
    ...
    /**
     *
     * @var ?ImportOperationRejectedEventData
     */
    protected $data;
    ...
    public function __construct(
        ...
        ?ImportOperationRejectedEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportOperationRejectedEventDataModel::of($data);
        }
