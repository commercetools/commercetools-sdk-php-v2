 ...
 * @internal
 */
final class ImportContainerDeletedEventModel extends JsonObjectModel implements ImportContainerDeletedEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportContainerDeleted';
    /**
     *
     * @var ?string
     */
    ...
    /**
     *
     * @var ?ImportContainerDeletedEventData
     */
    protected $data;
    ...
    public function __construct(
        ...
        ?ImportContainerDeletedEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportContainerDeletedEventDataModel::of($data);
        }
     ...
     */
    public function setData(?ImportContainerDeletedEventData $data): void
    {
        $this->data = $data;
    }
