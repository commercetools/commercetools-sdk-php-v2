...
/**
 * @implements Builder<CheckoutPaymentRefundFailedEvent>
 */
final class CheckoutPaymentRefundFailedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentRefundFailedEvent
    {
        return new CheckoutPaymentRefundFailedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentRefundFailedEventBuilder
    {
        return new self();
    }
}
