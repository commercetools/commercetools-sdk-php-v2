 ...
 */
final class CheckoutPaymentAuthorizationFailedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentAuthorizationFailedEvent
    {
        return new CheckoutPaymentAuthorizationFailedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentAuthorizationFailedEventBuilder
    {
        return new self();
    }
}
