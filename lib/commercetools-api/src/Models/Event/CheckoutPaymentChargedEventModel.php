 ...
 * @internal
 */
final class CheckoutPaymentChargedEventModel extends JsonObjectModel implements CheckoutPaymentChargedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentCharged';
    /**
     *
     * @var ?string
     */
