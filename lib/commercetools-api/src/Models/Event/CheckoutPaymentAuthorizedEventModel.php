 ...
 * @internal
 */
final class CheckoutPaymentAuthorizedEventModel extends JsonObjectModel implements CheckoutPaymentAuthorizedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentAuthorized';
    /**
     *
     * @var ?string
     */
