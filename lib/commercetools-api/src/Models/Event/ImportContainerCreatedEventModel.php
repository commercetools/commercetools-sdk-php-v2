 ...
 * @internal
 */
final class ImportContainerCreatedEventModel extends JsonObjectModel implements ImportContainerCreatedEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportContainerCreated';
    /**
     *
     * @var ?string
     */
    ...
    /**
     *
     * @var ?ImportContainerCreatedEventData
     */
    protected $data;
    ...
    public function __construct(
        ...
        ?ImportContainerCreatedEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportContainerCreatedEventDataModel::of($data);
        }
