...
/**
 * @implements Builder<CheckoutPaymentChargedEvent>
 */
final class CheckoutPaymentChargedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentChargedEvent
    {
        return new CheckoutPaymentChargedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentChargedEventBuilder
    {
        return new self();
    }
}
