 ...
 * @internal
 */
final class ImportValidationFailedEventModel extends JsonObjectModel implements ImportValidationFailedEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportValidationFailed';
    /**
     *
     * @var ?string
     */
    ...
    /**
     *
     * @var ?ImportValidationFailedEventData
     */
    protected $data;
    ...
    public function __construct(
        ...
        ?ImportValidationFailedEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportValidationFailedEventDataModel::of($data);
        }
