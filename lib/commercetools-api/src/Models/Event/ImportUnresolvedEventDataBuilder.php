 ...
 */
final class ImportUnresolvedEventDataBuilder implements Builder
{
    /**
    ...
    public function build(): ImportUnresolvedEventData
    {
        return new ImportUnresolvedEventDataModel(
            $this->id,
            $this->version,
    ...
    public static function of(): ImportUnresolvedEventDataBuilder
    {
        return new self();
    }
}
