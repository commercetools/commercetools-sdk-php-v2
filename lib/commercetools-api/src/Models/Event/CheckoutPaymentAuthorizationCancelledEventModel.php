 ...
 * @internal
 */
final class CheckoutPaymentAuthorizationCancelledEventModel extends JsonObjectModel implements CheckoutPaymentAuthorizationCancelledEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentAuthorizationCancelled';
    /**
     *
     * @var ?string
     */
