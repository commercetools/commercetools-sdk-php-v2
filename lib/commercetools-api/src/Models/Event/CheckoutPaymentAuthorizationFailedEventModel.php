 ...
 * @internal
 */
final class CheckoutPaymentAuthorizationFailedEventModel extends JsonObjectModel implements CheckoutPaymentAuthorizationFailedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentAuthorizationFailed';
    /**
     *
     * @var ?string
     */
