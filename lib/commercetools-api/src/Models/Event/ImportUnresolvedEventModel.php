 ...
 * @internal
 */
final class ImportUnresolvedEventModel extends JsonObjectModel implements ImportUnresolvedEvent
{
    public const DISCRIMINATOR_VALUE = 'ImportUnresolved';
    /**
     *
     * @var ?string
     */
    ...
    public function __construct(
        ...
        ?ImportUnresolvedEventData $data = null,
        ?string $type = null
    ) {
        $this->id = $id;
    ...
    public function getData()
    {
        if (is_null($this->data)) {
            ...
            $this->data = ImportUnresolvedEventDataModel::of($data);
        }
