...
/**
 * @implements Builder<CheckoutPaymentChargeFailedEvent>
 */
final class CheckoutPaymentChargeFailedEventBuilder implements Builder
{
    /**
    ...
    public function build(): CheckoutPaymentChargeFailedEvent
    {
        return new CheckoutPaymentChargeFailedEventModel(
            $this->id,
    ...
    public static function of(): CheckoutPaymentChargeFailedEventBuilder
    {
        return new self();
    }
}
