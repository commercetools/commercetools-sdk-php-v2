 ...
 * @internal
 */
final class CheckoutPaymentCancelAuthorizationFailedEventModel extends JsonObjectModel implements CheckoutPaymentCancelAuthorizationFailedEvent
{
    public const DISCRIMINATOR_VALUE = 'CheckoutPaymentCancelAuthorizationFailed';
    /**
     *
     * @var ?string
     */
