...
/**
 * @implements Builder<BusinessUnitSetCustomTypeAction>
 */
final class BusinessUnitSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitSetCustomTypeAction
    {
    ...
    public static function of(): BusinessUnitSetCustomTypeActionBuilder
    {
        return new self();
    }
}
