 ...
 * @internal
 */
final class BusinessUnitDraftModel extends JsonObjectModel implements BusinessUnitDraft
{
    ...
    private static $discriminatorClasses = [
       'Company' => CompanyDraftModel::class,
       'Division' => DivisionDraftModel::class,
    ];
     ...
     * <p>If the Business Unit has Stores defined, then all of its <a href="ctp:api:type:Cart">Carts</a>, <a href="ctp:api:type:Order">Orders</a>, <a href="ctp:api:type:RecurringOrder">Recurring Orders</a>, <a href="ctp:api:type:Quote">Quotes</a>, <a href="ctp:api:type:QuoteRequest">Quote Requests</a>, or <a href="ctp:api:type:ShoppingList">Shopping Lists</a> must belong to one of the Business Unit's Stores.</p>
     * <p>If the Business Unit has no Stores, then all of its <a href="ctp:api:type:Cart">Carts</a>, <a href="ctp:api:type:Order">Orders</a>, <a href="ctp:api:type:RecurringOrder">Recurring Orders</a>, <a href="ctp:api:type:Quote">Quotes</a>, <a href="ctp:api:type:QuoteRequest">Quote Requests</a>, or <a href="ctp:api:type:ShoppingList">Shopping Lists</a> must not belong to any Store.</p>
     *
     *
     ...
     * @psalm-return class-string<BusinessUnitDraft>
     */
    public static function resolveDiscriminatorClass($value): string
    {
        $fieldName = BusinessUnitDraft::DISCRIMINATOR_FIELD;
        ...
        /** @psalm-var class-string<BusinessUnitDraft> */
        $type = BusinessUnitDraftModel::class;
        return $type;
    }
}
