...
/**
 * @implements Builder<BusinessUnitSetAddressCustomTypeAction>
 */
final class BusinessUnitSetAddressCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitSetAddressCustomTypeAction
    {
    ...
    public static function of(): BusinessUnitSetAddressCustomTypeActionBuilder
    {
        return new self();
    }
}
