 ...
 */
final class BusinessUnitChangeAddressActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitChangeAddressAction
    {
        return new BusinessUnitChangeAddressActionModel(
            $this->addressId,
            $this->addressKey,
    ...
    public static function of(): BusinessUnitChangeAddressActionBuilder
    {
        return new self();
    }
}
