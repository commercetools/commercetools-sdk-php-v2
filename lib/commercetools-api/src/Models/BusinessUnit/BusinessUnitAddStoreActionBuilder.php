...
/**
 * @implements Builder<BusinessUnitAddStoreAction>
 */
final class BusinessUnitAddStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitAddStoreAction
    {
        return new BusinessUnitAddStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): BusinessUnitAddStoreActionBuilder
    {
        return new self();
    }
}
