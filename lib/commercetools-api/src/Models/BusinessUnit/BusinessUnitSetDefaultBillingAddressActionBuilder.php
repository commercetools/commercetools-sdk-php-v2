 ...
 */
final class BusinessUnitSetDefaultBillingAddressActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitSetDefaultBillingAddressAction
    {
        return new BusinessUnitSetDefaultBillingAddressActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): BusinessUnitSetDefaultBillingAddressActionBuilder
    {
        return new self();
    }
}
