 ...
 * @internal
 */
final class BusinessUnitPagedQueryResponseModel extends JsonObjectModel implements BusinessUnitPagedQueryResponse
{
    /**
     *
     * @var ?int
    ...
    public function __construct(
        ...
        ?int $count = null,
        ?int $total = null,
        ?BusinessUnitCollection $results = null
    ) {
        $this->limit = $limit;
        $this->offset = $offset;
        $this->count = $count;
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $this->results = BusinessUnitCollection::fromArray($data);
        }
     ...
     */
    public function setResults(?BusinessUnitCollection $results): void
    {
        $this->results = $results;
    }
}
