...
/**
 * @implements Builder<BusinessUnitRemoveAssociateAction>
 */
final class BusinessUnitRemoveAssociateActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitRemoveAssociateAction
    {
        return new BusinessUnitRemoveAssociateActionModel(
            $this->customer instanceof CustomerResourceIdentifierBuilder ? $this->customer->build() : $this->customer
        );
    }

    public static function of(): BusinessUnitRemoveAssociateActionBuilder
    {
        return new self();
    }
}
