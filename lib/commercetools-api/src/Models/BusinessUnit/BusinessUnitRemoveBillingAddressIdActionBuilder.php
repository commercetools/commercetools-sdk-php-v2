 ...
 */
final class BusinessUnitRemoveBillingAddressIdActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitRemoveBillingAddressIdAction
    {
        return new BusinessUnitRemoveBillingAddressIdActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): BusinessUnitRemoveBillingAddressIdActionBuilder
    {
        return new self();
    }
}
