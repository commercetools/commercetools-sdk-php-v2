 ...
 */
final class BusinessUnitSetDefaultShippingAddressActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitSetDefaultShippingAddressAction
    {
        return new BusinessUnitSetDefaultShippingAddressActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): BusinessUnitSetDefaultShippingAddressActionBuilder
    {
        return new self();
    }
}
