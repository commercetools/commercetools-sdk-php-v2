 ...
 */
final class BusinessUnitRemoveShippingAddressIdActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitRemoveShippingAddressIdAction
    {
        return new BusinessUnitRemoveShippingAddressIdActionModel(
            $this->addressId,
            $this->addressKey
        );
    }

    public static function of(): BusinessUnitRemoveShippingAddressIdActionBuilder
    {
        return new self();
    }
}
