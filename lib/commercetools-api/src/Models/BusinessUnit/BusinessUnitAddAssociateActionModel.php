 ...
 * @internal
 */
final class BusinessUnitAddAssociateActionModel extends JsonObjectModel implements BusinessUnitAddAssociateAction
{
    public const DISCRIMINATOR_VALUE = 'addAssociate';
    /**
     *
     * @var ?string
     */
