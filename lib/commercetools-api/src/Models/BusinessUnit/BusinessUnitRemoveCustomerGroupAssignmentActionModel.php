 ...
 * @internal
 */
final class BusinessUnitRemoveCustomerGroupAssignmentActionModel extends JsonObjectModel implements BusinessUnitRemoveCustomerGroupAssignmentAction
{
    public const DISCRIMINATOR_VALUE = 'removeCustomerGroupAssignment';
    /**
     *
     * @var ?string
     */
