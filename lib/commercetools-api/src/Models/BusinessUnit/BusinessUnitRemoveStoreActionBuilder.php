...
/**
 * @implements Builder<BusinessUnitRemoveStoreAction>
 */
final class BusinessUnitRemoveStoreActionBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnitRemoveStoreAction
    {
        return new BusinessUnitRemoveStoreActionModel(
            $this->store instanceof StoreResourceIdentifierBuilder ? $this->store->build() : $this->store
        );
    }

    public static function of(): BusinessUnitRemoveStoreActionBuilder
    {
        return new self();
    }
}
