 ...
 * @internal
 */
final class BusinessUnitModel extends JsonObjectModel implements BusinessUnit
{
     ...
     * @psalm-return class-string<BusinessUnit>
     */
    public static function resolveDiscriminatorClass($value): string
    {
        $fieldName = BusinessUnit::DISCRIMINATOR_FIELD;
        ...
        /** @psalm-var class-string<BusinessUnit> */
        $type = BusinessUnitModel::class;
        return $type;
    }
}
