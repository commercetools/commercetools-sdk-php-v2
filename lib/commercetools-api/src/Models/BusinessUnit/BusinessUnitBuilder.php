...
/**
 * @implements Builder<BusinessUnit>
 */
final class BusinessUnitBuilder implements Builder
{
    /**
    ...
    public function build(): BusinessUnit
    {
    ...
    public static function of(): BusinessUnitBuilder
    {
        return new self();
    }
}
