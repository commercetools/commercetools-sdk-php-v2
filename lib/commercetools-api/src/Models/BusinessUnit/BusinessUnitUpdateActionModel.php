...
final class BusinessUnitUpdateActionModel extends JsonObjectModel implements BusinessUnitUpdateAction
{
    ...
    private static $discriminatorClasses = [
       ...
       'addCustomerGroupAssignment' => BusinessUnitAddCustomerGroupAssignmentActionModel::class,
       ...
       'removeCustomerGroupAssignment' => BusinessUnitRemoveCustomerGroupAssignmentActionModel::class,
       ...
       'setCustomerGroupAssignments' => BusinessUnitSetCustomerGroupAssignmentsActionModel::class,
       ...
       'setUnitType' => BusinessUnitSetUnitTypeActionModel::class,
    ];
