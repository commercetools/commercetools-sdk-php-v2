...
/**
 * @implements Builder<StagedQuoteSetCustomTypeAction>
 */
final class StagedQuoteSetCustomTypeActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteSetCustomTypeAction
    {
        return new StagedQuoteSetCustomTypeActionModel(
            $this->type instanceof TypeResourceIdentifierBuilder ? $this->type->build() : $this->type,
            $this->fields instanceof FieldContainerBuilder ? $this->fields->build() : $this->fields
        );
    }

    public static function of(): StagedQuoteSetCustomTypeActionBuilder
    {
        return new self();
    }
}
