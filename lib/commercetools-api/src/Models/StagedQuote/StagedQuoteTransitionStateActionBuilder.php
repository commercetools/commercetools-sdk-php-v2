 ...
 */
final class StagedQuoteTransitionStateActionBuilder implements Builder
{
    /**
    ...
    public function build(): StagedQuoteTransitionStateAction
    {
        return new StagedQuoteTransitionStateActionModel(
            $this->state instanceof StateResourceIdentifierBuilder ? $this->state->build() : $this->state,
            $this->force
        );
    }

    public static function of(): StagedQuoteTransitionStateActionBuilder
    {
        return new self();
    }
}
