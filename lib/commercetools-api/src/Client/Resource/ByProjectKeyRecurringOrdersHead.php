 ...
 * @template-implements Errorable<ByProjectKeyRecurringOrdersHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurringOrdersHead>
 */
class ByProjectKeyRecurringOrdersHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyRecurringOrdersHead
    {
