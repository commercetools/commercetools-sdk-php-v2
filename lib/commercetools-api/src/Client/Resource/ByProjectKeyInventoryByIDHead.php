 ...
 * @template-implements Errorable<ByProjectKeyInventoryByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyInventoryByIDHead>
 */
class ByProjectKeyInventoryByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
