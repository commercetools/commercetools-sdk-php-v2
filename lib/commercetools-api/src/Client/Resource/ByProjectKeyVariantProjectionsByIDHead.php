 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyVariantProjectionsByIDHead>
 * @template-implements ProjectionValidating<ByProjectKeyVariantProjectionsByIDHead>
 * @template-implements Errorable<ByProjectKeyVariantProjectionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantProjectionsByIDHead>
 */
class ByProjectKeyVariantProjectionsByIDHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withStaged($staged): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyVariantProjectionsByIDHead
    {
