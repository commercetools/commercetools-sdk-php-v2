 ...
 * @template-implements Errorable<ByProjectKeyCartsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyCartsByIDHead>
 */
class ByProjectKeyCartsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
