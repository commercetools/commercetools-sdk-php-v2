 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsMatchingCartLocationHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsMatchingCartLocationHead>
 */
class ByProjectKeyShippingMethodsMatchingCartLocationHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withCountry($country): ByProjectKeyShippingMethodsMatchingCartLocationHead
    {
     ...
     */
    public function withState($state): ByProjectKeyShippingMethodsMatchingCartLocationHead
    {
     ...
     */
    public function withCartId($cartId): ByProjectKeyShippingMethodsMatchingCartLocationHead
    {
