 ...
 * @template-implements Expandable<ByProjectKeyProductTailoringGet>
 * @template-implements Sortable<ByProjectKeyProductTailoringGet>
 * @template-implements Paging<ByProjectKeyProductTailoringGet>
 * @template-implements Query<ByProjectKeyProductTailoringGet>
 * @template-implements Errorable<ByProjectKeyProductTailoringGet>
 * @template-implements Deprecatable200<ByProjectKeyProductTailoringGet>
 */
class ByProjectKeyProductTailoringGet extends ApiRequest implements Expandable, Sortable, Paging, Query, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/product-tailoring');
     ...
     */
    public function withSort($sort): ByProjectKeyProductTailoringGet
    {
     ...
     */
    public function withLimit($limit): ByProjectKeyProductTailoringGet
    {
     ...
     */
    public function withWhere($where): ByProjectKeyProductTailoringGet
    {
     ...
     */
    public function withPredicateVar(string $varName, $predicateVar): ByProjectKeyProductTailoringGet
    {
