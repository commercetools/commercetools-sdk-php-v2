 ...
 * @template-implements Errorable<ByProjectKeySubscriptionsHead>
 * @template-implements Deprecatable200<ByProjectKeySubscriptionsHead>
 */
class ByProjectKeySubscriptionsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeySubscriptionsHead
    {
