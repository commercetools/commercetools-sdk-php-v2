 ...
 * @template-implements Conflicting<ByProjectKeyMcpServersKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyMcpServersKeyByKeyPost>
 */
class ByProjectKeyMcpServersKeyByKeyPost extends ApiRequest implements Conflicting, Errorable
{
    /**
