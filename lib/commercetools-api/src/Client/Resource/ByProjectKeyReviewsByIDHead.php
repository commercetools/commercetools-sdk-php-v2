 ...
 * @template-implements Errorable<ByProjectKeyReviewsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyReviewsByIDHead>
 */
class ByProjectKeyReviewsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
