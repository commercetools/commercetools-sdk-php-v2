 ...
 * @template-implements Errorable<ByProjectKeyMessagesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMessagesByIDHead>
 */
class ByProjectKeyMessagesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
