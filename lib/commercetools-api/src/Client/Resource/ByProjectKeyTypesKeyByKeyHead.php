 ...
 * @template-implements Errorable<ByProjectKeyTypesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyTypesKeyByKeyHead>
 */
class ByProjectKeyTypesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
