 ...
 * @template-implements Conflicting<ByProjectKeyStandalonePricesKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyStandalonePricesKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyStandalonePricesKeyByKeyPost>
 */
class ByProjectKeyStandalonePricesKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesKeyByKeyPost
    {
