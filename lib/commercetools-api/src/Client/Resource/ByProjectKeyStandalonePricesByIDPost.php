 ...
 * @template-implements Conflicting<ByProjectKeyStandalonePricesByIDPost>
 * @template-implements Expandable<ByProjectKeyStandalonePricesByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesByIDPost>
 * @template-implements Errorable<ByProjectKeyStandalonePricesByIDPost>
 */
class ByProjectKeyStandalonePricesByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesByIDPost
    {
