 ...
 * @template-implements Errorable<ByProjectKeyOrdersByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersByIDHead>
 */
class ByProjectKeyOrdersByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
