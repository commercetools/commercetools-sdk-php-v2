 ...
 * @template-implements Conflicting<ByProjectKeyInStoreKeyByStoreKeyMePasswordPost>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyMePasswordPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyMePasswordPost extends ApiRequest implements Conflicting, Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/me/password');
