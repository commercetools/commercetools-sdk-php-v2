 ...
 * @template-implements Errorable<ByProjectKeyChannelsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyChannelsKeyByKeyHead>
 */
class ByProjectKeyChannelsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
