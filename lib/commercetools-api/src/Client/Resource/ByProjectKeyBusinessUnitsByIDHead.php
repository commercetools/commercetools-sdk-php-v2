 ...
 * @template-implements Errorable<ByProjectKeyBusinessUnitsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyBusinessUnitsByIDHead>
 */
class ByProjectKeyBusinessUnitsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
