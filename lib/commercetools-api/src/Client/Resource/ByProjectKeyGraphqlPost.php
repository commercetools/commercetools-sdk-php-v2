 ...
 * @template-implements Errorable<ByProjectKeyGraphqlPost>
 */
class ByProjectKeyGraphqlPost extends ApiRequest implements Errorable
{
    /**
     ...
     * @return ErrorResponse|GraphQLResponse|JsonObject|T|null
     */
