 ...
 * @template-implements PriceSelecting<ByProjectKeyProductsByIDGet>
 * @template-implements Expandable<ByProjectKeyProductsByIDGet>
 * @template-implements Errorable<ByProjectKeyProductsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyProductsByIDGet>
 */
class ByProjectKeyProductsByIDGet extends ApiRequest implements PriceSelecting, Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/products/{ID}');
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyProductsByIDGet
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyProductsByIDGet
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyProductsByIDGet
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyProductsByIDGet
    {
     ...
     */
    public function withPriceRecurrencePolicy($priceRecurrencePolicy): ByProjectKeyProductsByIDGet
    {
