 ...
 * @template-implements Errorable<ByProjectKeyMeOrdersByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeOrdersByIDHead>
 */
class ByProjectKeyMeOrdersByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
