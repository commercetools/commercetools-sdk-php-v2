 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesKeyByKeyGet>
 */
class ByProjectKeyInStoreKeyByStoreKeyStagedQuotesKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyStagedQuotesKeyByKeyGet
    {
