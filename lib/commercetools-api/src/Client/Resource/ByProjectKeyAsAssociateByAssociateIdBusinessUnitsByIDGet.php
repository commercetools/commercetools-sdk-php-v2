 ...
 * @template-implements Expandable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet>
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDGet
    {
