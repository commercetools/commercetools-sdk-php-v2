 ...
 * @template-implements Expandable<ByProjectKeyChannelsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyChannelsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyChannelsKeyByKeyGet>
 */
class ByProjectKeyChannelsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyChannelsKeyByKeyGet
    {
