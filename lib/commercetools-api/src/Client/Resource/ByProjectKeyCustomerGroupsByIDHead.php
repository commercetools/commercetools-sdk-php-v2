 ...
 * @template-implements Errorable<ByProjectKeyCustomerGroupsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomerGroupsByIDHead>
 */
class ByProjectKeyCustomerGroupsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
