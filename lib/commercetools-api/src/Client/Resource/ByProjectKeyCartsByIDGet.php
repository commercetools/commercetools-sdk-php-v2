 ...
 * @template-implements Expandable<ByProjectKeyCartsByIDGet>
 * @template-implements Errorable<ByProjectKeyCartsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyCartsByIDGet>
 */
class ByProjectKeyCartsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyCartsByIDGet
    {
