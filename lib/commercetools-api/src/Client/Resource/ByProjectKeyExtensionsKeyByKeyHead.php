 ...
 * @template-implements Errorable<ByProjectKeyExtensionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyExtensionsKeyByKeyHead>
 */
class ByProjectKeyExtensionsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
