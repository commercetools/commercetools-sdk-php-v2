 ...
 * @template-implements Errorable<ByProjectKeyCartDiscountsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyCartDiscountsByIDHead>
 */
class ByProjectKeyCartDiscountsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
