 ...
 * @template-implements Errorable<ByProjectKeyProductTypesHead>
 * @template-implements Deprecatable200<ByProjectKeyProductTypesHead>
 */
class ByProjectKeyProductTypesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyProductTypesHead
    {
