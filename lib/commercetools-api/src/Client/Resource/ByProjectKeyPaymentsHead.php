 ...
 * @template-implements Errorable<ByProjectKeyPaymentsHead>
 * @template-implements Deprecatable200<ByProjectKeyPaymentsHead>
 */
class ByProjectKeyPaymentsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyPaymentsHead
    {
