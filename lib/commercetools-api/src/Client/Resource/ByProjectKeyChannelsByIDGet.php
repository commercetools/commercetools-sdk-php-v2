 ...
 * @template-implements Expandable<ByProjectKeyChannelsByIDGet>
 * @template-implements Errorable<ByProjectKeyChannelsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyChannelsByIDGet>
 */
class ByProjectKeyChannelsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
