 ...
 * @template-implements Expandable<ByProjectKeyMeCartsByIDGet>
 * @template-implements Errorable<ByProjectKeyMeCartsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyMeCartsByIDGet>
 */
class ByProjectKeyMeCartsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
