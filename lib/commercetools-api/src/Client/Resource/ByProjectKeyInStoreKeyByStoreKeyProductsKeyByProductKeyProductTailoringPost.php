 ...
 * @template-implements Conflicting<ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost>
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyProductsKeyByProductKeyProductTailoringPost
    {
