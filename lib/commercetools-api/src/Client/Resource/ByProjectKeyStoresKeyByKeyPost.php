 ...
 * @template-implements Conflicting<ByProjectKeyStoresKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyStoresKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyStoresKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyStoresKeyByKeyPost>
 */
class ByProjectKeyStoresKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStoresKeyByKeyPost
    {
