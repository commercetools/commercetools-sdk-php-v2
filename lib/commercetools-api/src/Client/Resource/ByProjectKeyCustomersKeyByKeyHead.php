 ...
 * @template-implements Errorable<ByProjectKeyCustomersKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomersKeyByKeyHead>
 */
class ByProjectKeyCustomersKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
