 ...
 * @template-implements Expandable<ByProjectKeyAttributeGroupsByIDGet>
 * @template-implements Errorable<ByProjectKeyAttributeGroupsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsByIDGet>
 */
class ByProjectKeyAttributeGroupsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAttributeGroupsByIDGet
    {
