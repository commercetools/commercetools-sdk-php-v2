 ...
 * @template-implements Errorable<ByProjectKeyMcpServersKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyMcpServersKeyByKeyGet>
 */
class ByProjectKeyMcpServersKeyByKeyGet extends ApiRequest implements Errorable, Deprecatable200
{
    /**
