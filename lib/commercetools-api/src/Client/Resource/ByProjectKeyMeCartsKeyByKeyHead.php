 ...
 * @template-implements Errorable<ByProjectKeyMeCartsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyMeCartsKeyByKeyHead>
 */
class ByProjectKeyMeCartsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
