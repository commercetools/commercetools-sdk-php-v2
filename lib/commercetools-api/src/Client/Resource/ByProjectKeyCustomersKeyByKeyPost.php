 ...
 * @template-implements Conflicting<ByProjectKeyCustomersKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyCustomersKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyCustomersKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyCustomersKeyByKeyPost>
 */
class ByProjectKeyCustomersKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyCustomersKeyByKeyPost
    {
