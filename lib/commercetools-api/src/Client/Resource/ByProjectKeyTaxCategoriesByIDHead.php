 ...
 * @template-implements Errorable<ByProjectKeyTaxCategoriesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyTaxCategoriesByIDHead>
 */
class ByProjectKeyTaxCategoriesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
