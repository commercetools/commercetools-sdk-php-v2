 ...
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyHead>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
