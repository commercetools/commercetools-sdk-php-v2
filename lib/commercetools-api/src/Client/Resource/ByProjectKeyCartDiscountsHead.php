 ...
 * @template-implements Errorable<ByProjectKeyCartDiscountsHead>
 * @template-implements Deprecatable200<ByProjectKeyCartDiscountsHead>
 */
class ByProjectKeyCartDiscountsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCartDiscountsHead
    {
