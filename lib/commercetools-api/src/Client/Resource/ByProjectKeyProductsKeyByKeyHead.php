 ...
 * @template-implements Errorable<ByProjectKeyProductsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyProductsKeyByKeyHead>
 */
class ByProjectKeyProductsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
