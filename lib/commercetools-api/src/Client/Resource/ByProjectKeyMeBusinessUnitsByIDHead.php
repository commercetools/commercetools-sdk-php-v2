 ...
 * @template-implements Errorable<ByProjectKeyMeBusinessUnitsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeBusinessUnitsByIDHead>
 */
class ByProjectKeyMeBusinessUnitsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
