 ...
 * @template-implements Expandable<ByProjectKeyTaxCategoriesPost>
 * @template-implements Deprecatable201<ByProjectKeyTaxCategoriesPost>
 * @template-implements Errorable<ByProjectKeyTaxCategoriesPost>
 */
class ByProjectKeyTaxCategoriesPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
