 ...
 * @template-implements Expandable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyGet>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAsAssociateByAssociateIdBusinessUnitsKeyByKeyGet
    {
