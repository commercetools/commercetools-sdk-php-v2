 ...
 * @template-implements Versioned<ByProjectKeyMeQuoteRequestsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyMeQuoteRequestsKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsKeyByKeyDelete>
 */
class ByProjectKeyMeQuoteRequestsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [$projectKey, $key], '{projectKey}/me/quote-requests/key={key}');
     ...
     */
    public function withVersion($version): ByProjectKeyMeQuoteRequestsKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsKeyByKeyDelete
    {
