 ...
 * @template-implements Conflicting<ByProjectKeyOrdersEditsByIDPost>
 * @template-implements Expandable<ByProjectKeyOrdersEditsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsByIDPost>
 * @template-implements Errorable<ByProjectKeyOrdersEditsByIDPost>
 */
class ByProjectKeyOrdersEditsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyOrdersEditsByIDPost
    {
