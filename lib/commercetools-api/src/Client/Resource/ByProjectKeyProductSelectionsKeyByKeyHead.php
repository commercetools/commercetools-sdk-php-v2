 ...
 * @template-implements Errorable<ByProjectKeyProductSelectionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyProductSelectionsKeyByKeyHead>
 */
class ByProjectKeyProductSelectionsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
