 ...
 * @template-implements Errorable<ByProjectKeyProductProjectionsSearchPost>
 */
class ByProjectKeyProductProjectionsSearchPost extends ApiRequest implements Errorable
{
    /**
