 ...
 * @template-implements Versioned<ByProjectKeyChannelsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyChannelsKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyChannelsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyChannelsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyChannelsKeyByKeyDelete>
 */
class ByProjectKeyChannelsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/channels/key={key}');
     ...
     */
    public function withVersion($version): ByProjectKeyChannelsKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyChannelsKeyByKeyDelete
    {
