 ...
 * @template-implements Expandable<ByProjectKeyAttributeGroupsPost>
 * @template-implements Deprecatable201<ByProjectKeyAttributeGroupsPost>
 * @template-implements Errorable<ByProjectKeyAttributeGroupsPost>
 */
class ByProjectKeyAttributeGroupsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAttributeGroupsPost
    {
