 ...
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsKeyByKeyGet>
 */
class ByProjectKeyMeQuoteRequestsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsKeyByKeyGet
    {
