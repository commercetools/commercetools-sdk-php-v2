...
class ByProjectKeySubscriptionsGet extends ApiRequest implements Sortable, Paging, Query, Errorable, Deprecatable200
{
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|ErrorResponse|JsonObject|SubscriptionPagedQueryResponse
     */
     ...
     */
    public function withPredicateVar(string $varName, $predicateVar): ByProjectKeySubscriptionsGet
    {
