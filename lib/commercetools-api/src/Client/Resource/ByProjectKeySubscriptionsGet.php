...
class ByProjectKeySubscriptionsGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|SubscriptionPagedQueryResponse|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case "200": $resultType = SubscriptionPagedQueryResponseModel::class; break;
     ...
     * @psalm-param ?class-string<T> $resultType
     * @param array $options
     * @return ErrorResponse|JsonObject|SubscriptionPagedQueryResponse|null
     */
