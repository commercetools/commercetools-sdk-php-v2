 ...
 * @template-implements Errorable<ByProjectKeyProductTypesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyProductTypesKeyByKeyHead>
 */
class ByProjectKeyProductTypesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
