 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead>
 * @template-implements ProjectionValidating<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withStaged($staged): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsByIDHead
    {
