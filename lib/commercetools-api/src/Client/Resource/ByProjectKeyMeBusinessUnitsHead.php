 ...
 * @template-implements Errorable<ByProjectKeyMeBusinessUnitsHead>
 * @template-implements Deprecatable200<ByProjectKeyMeBusinessUnitsHead>
 */
class ByProjectKeyMeBusinessUnitsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeBusinessUnitsHead
    {
