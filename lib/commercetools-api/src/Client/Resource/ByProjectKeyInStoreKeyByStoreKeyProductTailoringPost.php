 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyProductTailoringPost>
 * @template-implements Deprecatable201<ByProjectKeyInStoreKeyByStoreKeyProductTailoringPost>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyProductTailoringPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyProductTailoringPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyProductTailoringPost
    {
