...
class ByProjectKeyInStoreKeyByStoreKeyCartDiscountsHead extends ApiRequest implements Errorable, Deprecatable200
{
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/cart-discounts');
     ...
     */
    public function withWhere($where): ByProjectKeyInStoreKeyByStoreKeyCartDiscountsHead
    {
