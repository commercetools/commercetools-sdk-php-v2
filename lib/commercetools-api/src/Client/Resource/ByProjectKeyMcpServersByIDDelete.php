 ...
 * @template-implements Versioned<ByProjectKeyMcpServersByIDDelete>
 * @template-implements Conflicting<ByProjectKeyMcpServersByIDDelete>
 * @template-implements Errorable<ByProjectKeyMcpServersByIDDelete>
 * @template-implements Deprecatable200<ByProjectKeyMcpServersByIDDelete>
 */
class ByProjectKeyMcpServersByIDDelete extends ApiRequest implements Versioned, Conflicting, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/mcp-servers/{ID}');
     ...
     * @return ErrorResponse|JsonObject|McpServer|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, ?string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = McpServerModel::class;
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|ErrorResponse|JsonObject|McpServer
     */
     ...
     */
    public function withVersion($version): ByProjectKeyMcpServersByIDDelete
    {
