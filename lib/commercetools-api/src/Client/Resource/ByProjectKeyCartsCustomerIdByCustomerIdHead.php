 ...
 * @template-implements Errorable<ByProjectKeyCartsCustomerIdByCustomerIdHead>
 * @template-implements Deprecatable200<ByProjectKeyCartsCustomerIdByCustomerIdHead>
 */
class ByProjectKeyCartsCustomerIdByCustomerIdHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
