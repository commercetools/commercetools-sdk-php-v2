 ...
 * @template-implements Expandable<ByProjectKeyZonesByIDGet>
 * @template-implements Errorable<ByProjectKeyZonesByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyZonesByIDGet>
 */
class ByProjectKeyZonesByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
