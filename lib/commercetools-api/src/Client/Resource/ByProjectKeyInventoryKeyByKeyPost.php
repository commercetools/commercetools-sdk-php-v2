 ...
 * @template-implements Conflicting<ByProjectKeyInventoryKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyInventoryKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyInventoryKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyInventoryKeyByKeyPost>
 */
class ByProjectKeyInventoryKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/inventory/key={key}');
     ...
     */
    public function withExpand($expand): ByProjectKeyInventoryKeyByKeyPost
    {
