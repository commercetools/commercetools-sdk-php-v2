 ...
 * @template-implements Errorable<ByProjectKeyAttributeGroupsHead>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsHead>
 */
class ByProjectKeyAttributeGroupsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyAttributeGroupsHead
    {
