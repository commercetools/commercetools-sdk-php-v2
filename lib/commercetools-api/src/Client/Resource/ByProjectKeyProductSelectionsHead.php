 ...
 * @template-implements Errorable<ByProjectKeyProductSelectionsHead>
 * @template-implements Deprecatable200<ByProjectKeyProductSelectionsHead>
 */
class ByProjectKeyProductSelectionsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyProductSelectionsHead
    {
