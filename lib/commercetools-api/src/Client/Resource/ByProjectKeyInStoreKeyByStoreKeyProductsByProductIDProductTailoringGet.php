 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringGet>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringGet>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringGet>
 */
class ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringGet
    {
