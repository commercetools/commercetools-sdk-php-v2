 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsMatchingOrdereditHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsMatchingOrdereditHead>
 */
class ByProjectKeyShippingMethodsMatchingOrdereditHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withOrderEditId($orderEditId): ByProjectKeyShippingMethodsMatchingOrdereditHead
    {
     ...
     */
    public function withCountry($country): ByProjectKeyShippingMethodsMatchingOrdereditHead
    {
     ...
     */
    public function withState($state): ByProjectKeyShippingMethodsMatchingOrdereditHead
    {
