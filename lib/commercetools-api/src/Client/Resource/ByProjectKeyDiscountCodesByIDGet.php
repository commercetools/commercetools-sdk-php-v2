 ...
 * @template-implements Expandable<ByProjectKeyDiscountCodesByIDGet>
 * @template-implements Errorable<ByProjectKeyDiscountCodesByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyDiscountCodesByIDGet>
 */
class ByProjectKeyDiscountCodesByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
