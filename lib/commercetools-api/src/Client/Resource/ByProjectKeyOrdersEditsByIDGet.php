 ...
 * @template-implements Expandable<ByProjectKeyOrdersEditsByIDGet>
 * @template-implements Errorable<ByProjectKeyOrdersEditsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsByIDGet>
 */
class ByProjectKeyOrdersEditsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyOrdersEditsByIDGet
    {
