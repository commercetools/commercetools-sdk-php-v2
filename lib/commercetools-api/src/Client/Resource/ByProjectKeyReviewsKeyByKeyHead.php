 ...
 * @template-implements Errorable<ByProjectKeyReviewsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyReviewsKeyByKeyHead>
 */
class ByProjectKeyReviewsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
