...
class ResourceByProjectKeyCartsKeyByKey extends ApiResource
{
     ...
     * @psalm-param array<string, scalar|scalar[]> $headers
     */
    public function head($body = null, array $headers = []): ByProjectKeyCartsKeyByKeyHead
    {
        $args = $this->getArgs();

        return new ByProjectKeyCartsKeyByKeyHead($args['projectKey'], $args['key'], $body, $headers, $this->getClient());
    }
    /**
