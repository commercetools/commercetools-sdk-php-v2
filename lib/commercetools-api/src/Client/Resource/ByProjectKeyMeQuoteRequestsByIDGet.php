 ...
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsByIDGet>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsByIDGet>
 */
class ByProjectKeyMeQuoteRequestsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsByIDGet
    {
