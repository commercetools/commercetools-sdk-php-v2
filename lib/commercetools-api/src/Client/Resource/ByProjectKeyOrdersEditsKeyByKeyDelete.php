 ...
 * @template-implements Versioned<ByProjectKeyOrdersEditsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyOrdersEditsKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyOrdersEditsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyOrdersEditsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsKeyByKeyDelete>
 */
class ByProjectKeyOrdersEditsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/orders/edits/key={key}');
