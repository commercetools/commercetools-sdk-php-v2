 ...
 * @template-implements Errorable<ByProjectKeyTaxCategoriesHead>
 * @template-implements Deprecatable200<ByProjectKeyTaxCategoriesHead>
 */
class ByProjectKeyTaxCategoriesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyTaxCategoriesHead
    {
