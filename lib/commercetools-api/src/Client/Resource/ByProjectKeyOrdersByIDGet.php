 ...
 * @template-implements Deprecatable200<ByProjectKeyOrdersByIDGet>
 */
class ByProjectKeyOrdersByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
