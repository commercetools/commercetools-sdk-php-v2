...
class ResourceByProjectKeyProductDiscountsKeyByKey extends ApiResource
{
     ...
     * @psalm-param array<string, scalar|scalar[]> $headers
     */
    public function head($body = null, array $headers = []): ByProjectKeyProductDiscountsKeyByKeyHead
    {
        $args = $this->getArgs();

        return new ByProjectKeyProductDiscountsKeyByKeyHead($args['projectKey'], $args['key'], $body, $headers, $this->getClient());
    }
    /**
