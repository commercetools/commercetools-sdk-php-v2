 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyVariantProjectionsHead>
 * @template-implements ProjectionValidating<ByProjectKeyVariantProjectionsHead>
 * @template-implements Errorable<ByProjectKeyVariantProjectionsHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantProjectionsHead>
 */
class ByProjectKeyVariantProjectionsHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withStaged($staged): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyVariantProjectionsHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyVariantProjectionsHead
    {
