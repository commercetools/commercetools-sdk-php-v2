...
class ByProjectKeyTaxCategoriesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|TaxCategoryPagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyTaxCategoriesGet
    {
