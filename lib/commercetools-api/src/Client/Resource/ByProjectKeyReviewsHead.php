 ...
 * @template-implements Errorable<ByProjectKeyReviewsHead>
 * @template-implements Deprecatable200<ByProjectKeyReviewsHead>
 */
class ByProjectKeyReviewsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyReviewsHead
    {
