 ...
 * @template-implements Errorable<ByProjectKeyInventoryKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyInventoryKeyByKeyHead>
 */
class ByProjectKeyInventoryKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
