 ...
 * @template-implements Errorable<ByProjectKeyMeQuotesHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuotesHead>
 */
class ByProjectKeyMeQuotesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeQuotesHead
    {
