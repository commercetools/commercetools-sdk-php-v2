 ...
 * @template-implements Errorable<ByProjectKeyTypesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyTypesByIDHead>
 */
class ByProjectKeyTypesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
