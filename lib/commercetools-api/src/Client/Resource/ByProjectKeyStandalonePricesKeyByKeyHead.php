 ...
 * @template-implements Errorable<ByProjectKeyStandalonePricesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesKeyByKeyHead>
 */
class ByProjectKeyStandalonePricesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
