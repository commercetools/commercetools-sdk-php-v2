 ...
 * @template-implements Errorable<ByProjectKeyStagedQuotesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyStagedQuotesByIDHead>
 */
class ByProjectKeyStagedQuotesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
