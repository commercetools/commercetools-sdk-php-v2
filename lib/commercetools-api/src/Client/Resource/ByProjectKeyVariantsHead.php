 ...
 * @template-implements Errorable<ByProjectKeyVariantsHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantsHead>
 */
class ByProjectKeyVariantsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyVariantsHead
    {
