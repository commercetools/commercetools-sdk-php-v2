 ...
 * @template-implements Errorable<ByProjectKeyStagedQuotesHead>
 * @template-implements Deprecatable200<ByProjectKeyStagedQuotesHead>
 */
class ByProjectKeyStagedQuotesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyStagedQuotesHead
    {
