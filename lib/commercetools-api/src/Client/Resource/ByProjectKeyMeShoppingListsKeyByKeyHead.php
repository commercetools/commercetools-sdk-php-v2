 ...
 * @template-implements Errorable<ByProjectKeyMeShoppingListsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyMeShoppingListsKeyByKeyHead>
 */
class ByProjectKeyMeShoppingListsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
