 ...
 * @template-implements Errorable<ByProjectKeyTaxCategoriesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyTaxCategoriesKeyByKeyHead>
 */
class ByProjectKeyTaxCategoriesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
