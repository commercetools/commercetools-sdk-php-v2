 ...
 * @template-implements Errorable<ByProjectKeyStagedQuotesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyStagedQuotesKeyByKeyHead>
 */
class ByProjectKeyStagedQuotesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
