 ...
 * @template-implements Errorable<ByProjectKeyRecurringOrdersByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurringOrdersByIDHead>
 */
class ByProjectKeyRecurringOrdersByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
