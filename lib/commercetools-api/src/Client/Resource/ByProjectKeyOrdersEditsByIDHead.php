 ...
 * @template-implements Errorable<ByProjectKeyOrdersEditsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsByIDHead>
 */
class ByProjectKeyOrdersEditsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
