 ...
 * @template-implements Errorable<ByProjectKeyCustomersByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomersByIDHead>
 */
class ByProjectKeyCustomersByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
