 ...
 * @template-implements Errorable<ByProjectKeyMeBusinessUnitsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyMeBusinessUnitsKeyByKeyHead>
 */
class ByProjectKeyMeBusinessUnitsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
