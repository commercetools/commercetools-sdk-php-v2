 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead>
 * @template-implements ProjectionValidating<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withStaged($staged): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsHead
    {
