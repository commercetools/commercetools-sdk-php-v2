 ...
 * @template-implements Errorable<ByProjectKeyShoppingListsHead>
 * @template-implements Deprecatable200<ByProjectKeyShoppingListsHead>
 */
class ByProjectKeyShoppingListsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyShoppingListsHead
    {
