...
class ByProjectKeyMessagesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|MessagePagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyMessagesGet
    {
