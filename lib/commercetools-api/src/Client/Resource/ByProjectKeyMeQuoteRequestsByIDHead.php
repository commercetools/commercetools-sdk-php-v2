 ...
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsByIDHead>
 */
class ByProjectKeyMeQuoteRequestsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
