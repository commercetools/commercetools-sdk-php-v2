 ...
 * @template-implements Errorable<ByProjectKeyMeShoppingListsHead>
 * @template-implements Deprecatable200<ByProjectKeyMeShoppingListsHead>
 */
class ByProjectKeyMeShoppingListsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeShoppingListsHead
    {
