 ...
 * @template-implements Errorable<ByProjectKeyStandalonePricesHead>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesHead>
 */
class ByProjectKeyStandalonePricesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyStandalonePricesHead
    {
