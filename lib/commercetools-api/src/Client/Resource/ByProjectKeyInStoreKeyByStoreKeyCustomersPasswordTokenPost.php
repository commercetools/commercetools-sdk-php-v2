...
use Commercetools\Api\Models\Customer\CustomerToken;
use Commercetools\Api\Models\Customer\CustomerTokenModel;
 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/customers/password-token');
     ...
     * @return CustomerToken|ErrorResponse|JsonObject|T|null
     */
