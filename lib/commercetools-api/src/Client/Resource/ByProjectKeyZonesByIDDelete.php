 ...
 * @template-implements Versioned<ByProjectKeyZonesByIDDelete>
 * @template-implements Conflicting<ByProjectKeyZonesByIDDelete>
 * @template-implements Expandable<ByProjectKeyZonesByIDDelete>
 * @template-implements Errorable<ByProjectKeyZonesByIDDelete>
 * @template-implements Deprecatable200<ByProjectKeyZonesByIDDelete>
 */
class ByProjectKeyZonesByIDDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/zones/{ID}');
