 ...
 * @template-implements Errorable<ByProjectKeyBusinessUnitsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyBusinessUnitsKeyByKeyHead>
 */
class ByProjectKeyBusinessUnitsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
