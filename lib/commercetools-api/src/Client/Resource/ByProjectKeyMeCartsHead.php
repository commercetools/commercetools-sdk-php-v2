 ...
 * @template-implements Errorable<ByProjectKeyMeCartsHead>
 * @template-implements Deprecatable200<ByProjectKeyMeCartsHead>
 */
class ByProjectKeyMeCartsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeCartsHead
    {
