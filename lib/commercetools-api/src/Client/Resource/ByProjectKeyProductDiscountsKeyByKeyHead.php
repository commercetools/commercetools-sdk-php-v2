 ...
 * @template-implements Errorable<ByProjectKeyProductDiscountsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyProductDiscountsKeyByKeyHead>
 */
class ByProjectKeyProductDiscountsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
