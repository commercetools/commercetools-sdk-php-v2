 ...
 * @template-implements Expandable<ByProjectKeySubscriptionsKeyByKeyPost>
 ...
 */
class ByProjectKeySubscriptionsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
