 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead>
 * @template-implements ProjectionValidating<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withStaged($staged): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyHead
    {
