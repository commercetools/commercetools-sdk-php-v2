 ...
 * @template-implements Errorable<ByProjectKeyProductDiscountsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyProductDiscountsByIDHead>
 */
class ByProjectKeyProductDiscountsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
