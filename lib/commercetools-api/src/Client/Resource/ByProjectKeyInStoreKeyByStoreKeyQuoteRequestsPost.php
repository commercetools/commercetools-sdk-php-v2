 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsPost>
 * @template-implements Deprecatable201<ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsPost>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsPost
    {
