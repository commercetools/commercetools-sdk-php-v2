 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
