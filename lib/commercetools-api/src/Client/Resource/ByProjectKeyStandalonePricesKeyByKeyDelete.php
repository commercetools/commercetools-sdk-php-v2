 ...
 * @template-implements Versioned<ByProjectKeyStandalonePricesKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyStandalonePricesKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyStandalonePricesKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyStandalonePricesKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesKeyByKeyDelete>
 */
class ByProjectKeyStandalonePricesKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
     ...
     * @return ErrorResponse|JsonObject|StandalonePrice|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = StandalonePriceModel::class;
     ...
     */
    public function withVersion($version): ByProjectKeyStandalonePricesKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesKeyByKeyDelete
    {
