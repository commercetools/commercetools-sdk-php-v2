 ...
 * @template-implements Conflicting<ByProjectKeyAttributeGroupsKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyAttributeGroupsKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyAttributeGroupsKeyByKeyPost>
 */
class ByProjectKeyAttributeGroupsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAttributeGroupsKeyByKeyPost
    {
