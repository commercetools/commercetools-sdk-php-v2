 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsMatchingLocationHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsMatchingLocationHead>
 */
class ByProjectKeyShippingMethodsMatchingLocationHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/shipping-methods/matching-location');
     ...
     */
    public function withCountry($country): ByProjectKeyShippingMethodsMatchingLocationHead
    {
     ...
     */
    public function withState($state): ByProjectKeyShippingMethodsMatchingLocationHead
    {
     ...
     */
    public function withCurrency($currency): ByProjectKeyShippingMethodsMatchingLocationHead
    {
