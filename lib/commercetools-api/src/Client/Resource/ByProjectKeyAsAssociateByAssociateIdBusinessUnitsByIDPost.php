 ...
 * @template-implements Conflicting<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost>
 * @template-implements Expandable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost>
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDPost
    {
