 ...
 * @template-implements Errorable<ByProjectKeyMePaymentsHead>
 * @template-implements Deprecatable200<ByProjectKeyMePaymentsHead>
 */
class ByProjectKeyMePaymentsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMePaymentsHead
    {
