 ...
 * @template-implements Expandable<ByProjectKeyZonesPost>
 * @template-implements Deprecatable201<ByProjectKeyZonesPost>
 * @template-implements Errorable<ByProjectKeyZonesPost>
 */
class ByProjectKeyZonesPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
