 ...
 * @template-implements Conflicting<ByProjectKeyMeQuoteRequestsByIDPost>
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsByIDPost>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsByIDPost>
 */
class ByProjectKeyMeQuoteRequestsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/me/quote-requests/{ID}');
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsByIDPost
    {
