 ...
 * @template-implements Errorable<ByProjectKeyRecurringOrdersKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurringOrdersKeyByKeyHead>
 */
class ByProjectKeyRecurringOrdersKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
