 ...
 * @template-implements Expandable<ByProjectKeyAssociateRolesPost>
 * @template-implements Deprecatable201<ByProjectKeyAssociateRolesPost>
 * @template-implements Errorable<ByProjectKeyAssociateRolesPost>
 */
class ByProjectKeyAssociateRolesPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAssociateRolesPost
    {
