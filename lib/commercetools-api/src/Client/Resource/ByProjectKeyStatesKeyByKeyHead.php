 ...
 * @template-implements Errorable<ByProjectKeyStatesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyStatesKeyByKeyHead>
 */
class ByProjectKeyStatesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
