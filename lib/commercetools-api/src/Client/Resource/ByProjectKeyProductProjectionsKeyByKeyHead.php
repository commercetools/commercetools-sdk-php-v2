 ...
 * @template-implements Errorable<ByProjectKeyProductProjectionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyProductProjectionsKeyByKeyHead>
 */
class ByProjectKeyProductProjectionsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/product-projections/key={key}');
