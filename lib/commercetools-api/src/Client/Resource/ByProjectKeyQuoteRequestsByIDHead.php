 ...
 * @template-implements Errorable<ByProjectKeyQuoteRequestsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsByIDHead>
 */
class ByProjectKeyQuoteRequestsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
