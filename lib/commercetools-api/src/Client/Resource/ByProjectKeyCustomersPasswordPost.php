 ...
 * @template-implements Errorable<ByProjectKeyCustomersPasswordPost>
 */
class ByProjectKeyCustomersPasswordPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/customers/password');
