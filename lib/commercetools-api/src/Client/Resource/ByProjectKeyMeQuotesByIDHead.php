 ...
 * @template-implements Errorable<ByProjectKeyMeQuotesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuotesByIDHead>
 */
class ByProjectKeyMeQuotesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
