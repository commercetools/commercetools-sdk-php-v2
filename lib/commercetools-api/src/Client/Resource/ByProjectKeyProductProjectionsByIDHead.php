 ...
 * @template-implements Errorable<ByProjectKeyProductProjectionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyProductProjectionsByIDHead>
 */
class ByProjectKeyProductProjectionsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/product-projections/{ID}');
