 ...
 * @template-implements Errorable<ByProjectKeyMeShoppingListsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeShoppingListsByIDHead>
 */
class ByProjectKeyMeShoppingListsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
