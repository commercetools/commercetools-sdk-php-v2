 ...
 * @template-implements Expandable<ByProjectKeyStandalonePricesKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyStandalonePricesKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesKeyByKeyGet>
 */
class ByProjectKeyStandalonePricesKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesKeyByKeyGet
    {
