...
class ByProjectKeyInStoreKeyByStoreKeyCartsGet extends ApiRequest
{
    /**
     * @param ?object $body
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyInStoreKeyByStoreKeyCartsGet
    {
