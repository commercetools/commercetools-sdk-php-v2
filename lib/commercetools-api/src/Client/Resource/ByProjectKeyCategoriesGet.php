...
class ByProjectKeyCategoriesGet extends ApiRequest
{
     ...
     * @psalm-return CategoryPagedQueryResponse|ErrorResponse|JsonObject|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case "200": $resultType = CategoryPagedQueryResponseModel::class; break;
     ...
     * @psalm-param ?class-string<T> $resultType
     * @param array $options
     * @return CategoryPagedQueryResponse|ErrorResponse|JsonObject|null
     */
