 ...
 * @template-implements Errorable<ByProjectKeyOrdersEditsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsKeyByKeyHead>
 */
class ByProjectKeyOrdersEditsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
