 ...
 * @template-implements Errorable<ByProjectKeyAssociateRolesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyAssociateRolesKeyByKeyHead>
 */
class ByProjectKeyAssociateRolesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
