 ...
 * @template-implements Expandable<ByProjectKeyShoppingListsPost>
 * @template-implements Deprecatable201<ByProjectKeyShoppingListsPost>
 * @template-implements Errorable<ByProjectKeyShoppingListsPost>
 */
class ByProjectKeyShoppingListsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
