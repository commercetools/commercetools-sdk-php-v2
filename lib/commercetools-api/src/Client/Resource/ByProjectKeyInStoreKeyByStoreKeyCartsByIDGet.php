 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyCartsByIDGet>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCartsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyCartsByIDGet>
 */
class ByProjectKeyInStoreKeyByStoreKeyCartsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
