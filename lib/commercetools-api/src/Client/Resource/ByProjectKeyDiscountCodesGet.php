...
class ByProjectKeyDiscountCodesGet extends ApiRequest
{
     ...
     * @psalm-return DiscountCodePagedQueryResponse|ErrorResponse|JsonObject|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyDiscountCodesGet
    {
