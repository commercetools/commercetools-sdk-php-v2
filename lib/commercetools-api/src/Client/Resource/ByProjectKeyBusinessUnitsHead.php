 ...
 * @template-implements Errorable<ByProjectKeyBusinessUnitsHead>
 * @template-implements Deprecatable200<ByProjectKeyBusinessUnitsHead>
 */
class ByProjectKeyBusinessUnitsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyBusinessUnitsHead
    {
