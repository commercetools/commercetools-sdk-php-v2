 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsByIDHead>
 */
class ByProjectKeyShippingMethodsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
