 ...
 * @template-implements Errorable<ByProjectKeyPaymentMethodsHead>
 * @template-implements Deprecatable200<ByProjectKeyPaymentMethodsHead>
 */
class ByProjectKeyPaymentMethodsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyPaymentMethodsHead
    {
