 ...
 * @template-implements Expandable<ByProjectKeyExtensionsKeyByKeyPost>
 ...
 */
class ByProjectKeyExtensionsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
