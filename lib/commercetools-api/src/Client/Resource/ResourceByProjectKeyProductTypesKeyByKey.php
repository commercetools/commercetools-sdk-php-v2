...
class ResourceByProjectKeyProductTypesKeyByKey extends ApiResource
{
     ...
     * @psalm-param array<string, scalar|scalar[]> $headers
     */
    public function head($body = null, array $headers = []): ByProjectKeyProductTypesKeyByKeyHead
    {
        $args = $this->getArgs();

        return new ByProjectKeyProductTypesKeyByKeyHead($args['projectKey'], $args['key'], $body, $headers, $this->getClient());
    }
    /**
