 ...
 * @template-implements Errorable<ByProjectKeyZonesHead>
 * @template-implements Deprecatable200<ByProjectKeyZonesHead>
 */
class ByProjectKeyZonesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyZonesHead
    {
