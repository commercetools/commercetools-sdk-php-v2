 ...
 * @template-implements Errorable<ByProjectKeyCategoriesHead>
 * @template-implements Deprecatable200<ByProjectKeyCategoriesHead>
 */
class ByProjectKeyCategoriesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCategoriesHead
    {
