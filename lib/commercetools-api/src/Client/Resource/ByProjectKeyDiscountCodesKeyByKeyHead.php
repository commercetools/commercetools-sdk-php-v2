 ...
 * @template-implements Errorable<ByProjectKeyDiscountCodesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyDiscountCodesKeyByKeyHead>
 */
class ByProjectKeyDiscountCodesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
