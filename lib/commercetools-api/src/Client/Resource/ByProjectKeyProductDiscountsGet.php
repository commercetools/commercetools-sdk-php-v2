...
class ByProjectKeyProductDiscountsGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|ProductDiscountPagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyProductDiscountsGet
    {
