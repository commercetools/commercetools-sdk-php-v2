 ...
 * @template-implements Errorable<ByProjectKeyZonesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyZonesKeyByKeyHead>
 */
class ByProjectKeyZonesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
