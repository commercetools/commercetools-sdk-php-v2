 ...
 * @template-implements Errorable<ByProjectKeyOrdersQuotesPost>
 */
class ByProjectKeyOrdersQuotesPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/orders/quotes');
