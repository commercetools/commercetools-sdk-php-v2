 ...
 * @template-implements Errorable<ByProjectKeyCartDiscountsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyCartDiscountsKeyByKeyHead>
 */
class ByProjectKeyCartDiscountsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
