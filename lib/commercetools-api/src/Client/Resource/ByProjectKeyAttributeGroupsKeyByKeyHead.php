 ...
 * @template-implements Errorable<ByProjectKeyAttributeGroupsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsKeyByKeyHead>
 */
class ByProjectKeyAttributeGroupsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
