 ...
 * @template-implements Conflicting<ByProjectKeyMcpServersByIDPost>
 * @template-implements Errorable<ByProjectKeyMcpServersByIDPost>
 */
class ByProjectKeyMcpServersByIDPost extends ApiRequest implements Conflicting, Errorable
{
    /**
