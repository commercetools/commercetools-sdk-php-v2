 ...
 * @template-implements Expandable<ByProjectKeyCustomObjectsByContainerByKeyGet>
 * @template-implements Errorable<ByProjectKeyCustomObjectsByContainerByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyCustomObjectsByContainerByKeyGet>
 */
class ByProjectKeyCustomObjectsByContainerByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     * @param ?object|array|string $body
     * @psalm-param array<string, scalar|scalar[]> $headers
     */
    public function __construct(string $projectKey, string $container, string $key, $body = null, array $headers = [], ?ClientInterface $client = null)
    {
        $uri = str_replace(['{projectKey}', '{container}', '{key}'], [urlencode($projectKey), urlencode($container), urlencode($key)], '{projectKey}/custom-objects/{container}/{key}');
