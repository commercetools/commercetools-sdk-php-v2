 ...
 * @template-implements Conflicting<ByProjectKeyMeCartsKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyMeCartsKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyMeCartsKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyMeCartsKeyByKeyPost>
 */
class ByProjectKeyMeCartsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
