 ...
 * @template-implements Errorable<ByProjectKeyStoresHead>
 * @template-implements Deprecatable200<ByProjectKeyStoresHead>
 */
class ByProjectKeyStoresHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyStoresHead
    {
