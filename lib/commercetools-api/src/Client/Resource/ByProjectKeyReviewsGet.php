...
use Commercetools\Api\Models\Review\ReviewPagedQueryResponse;
use Commercetools\Api\Models\Review\ReviewPagedQueryResponseModel;
 ...
 * @template-implements Expandable<ByProjectKeyReviewsGet>
 * @template-implements Sortable<ByProjectKeyReviewsGet>
 * @template-implements Paging<ByProjectKeyReviewsGet>
 * @template-implements Query<ByProjectKeyReviewsGet>
 * @template-implements Errorable<ByProjectKeyReviewsGet>
 * @template-implements Deprecatable200<ByProjectKeyReviewsGet>
 */
class ByProjectKeyReviewsGet extends ApiRequest implements Expandable, Sortable, Paging, Query, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/reviews');
     ...
     * @return ErrorResponse|JsonObject|ReviewPagedQueryResponse|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, ?string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = ReviewPagedQueryResponseModel::class;
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|ErrorResponse|JsonObject|ReviewPagedQueryResponse
     */
     ...
     */
    public function withPredicateVar(string $varName, $predicateVar): ByProjectKeyReviewsGet
    {
