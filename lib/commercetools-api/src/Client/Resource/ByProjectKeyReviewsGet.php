...
class ByProjectKeyReviewsGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|ReviewPagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyReviewsGet
    {
