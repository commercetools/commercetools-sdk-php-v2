 ...
 * @template-implements Errorable<ByProjectKeyCartsHead>
 * @template-implements Deprecatable200<ByProjectKeyCartsHead>
 */
class ByProjectKeyCartsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCartsHead
    {
