 ...
 * @template-implements Expandable<ByProjectKeyCustomerGroupsByIDGet>
 * @template-implements Errorable<ByProjectKeyCustomerGroupsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyCustomerGroupsByIDGet>
 */
class ByProjectKeyCustomerGroupsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
