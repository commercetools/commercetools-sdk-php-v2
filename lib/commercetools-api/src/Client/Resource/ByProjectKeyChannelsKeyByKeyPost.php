 ...
 * @template-implements Conflicting<ByProjectKeyChannelsKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyChannelsKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyChannelsKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyChannelsKeyByKeyPost>
 */
class ByProjectKeyChannelsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyChannelsKeyByKeyPost
    {
