 ...
 * @template-implements Errorable<ByProjectKeyProductSelectionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyProductSelectionsByIDHead>
 */
class ByProjectKeyProductSelectionsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
