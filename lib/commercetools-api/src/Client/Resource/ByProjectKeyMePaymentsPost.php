 ...
 * @template-implements Expandable<ByProjectKeyMePaymentsPost>
 * @template-implements Deprecatable201<ByProjectKeyMePaymentsPost>
 * @template-implements Errorable<ByProjectKeyMePaymentsPost>
 */
class ByProjectKeyMePaymentsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMePaymentsPost
    {
