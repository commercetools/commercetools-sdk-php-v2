 ...
 * @template-implements Errorable<ByProjectKeyMeOrdersHead>
 * @template-implements Deprecatable200<ByProjectKeyMeOrdersHead>
 */
class ByProjectKeyMeOrdersHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeOrdersHead
    {
