 ...
 * @template-implements Expandable<ByProjectKeyQuoteRequestsPost>
 * @template-implements Deprecatable201<ByProjectKeyQuoteRequestsPost>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsPost>
 */
class ByProjectKeyQuoteRequestsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsPost
    {
