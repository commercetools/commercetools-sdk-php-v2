 ...
 * @template-implements Errorable<ByProjectKeyOrdersOrderNumberByOrderNumberHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersOrderNumberByOrderNumberHead>
 */
class ByProjectKeyOrdersOrderNumberByOrderNumberHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
