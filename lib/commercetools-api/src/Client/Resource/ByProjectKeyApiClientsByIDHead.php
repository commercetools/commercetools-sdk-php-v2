 ...
 * @template-implements Errorable<ByProjectKeyApiClientsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyApiClientsByIDHead>
 */
class ByProjectKeyApiClientsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
