 ...
 * @template-implements Errorable<ByProjectKeyProductProjectionsHead>
 * @template-implements Deprecatable200<ByProjectKeyProductProjectionsHead>
 */
class ByProjectKeyProductProjectionsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/product-projections');
     ...
     */
    public function withWhere($where): ByProjectKeyProductProjectionsHead
    {
