 ...
 * @template-implements Errorable<ByProjectKeyCategoriesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyCategoriesKeyByKeyHead>
 */
class ByProjectKeyCategoriesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
