 ...
 * @template-implements Conflicting<ByProjectKeyQuoteRequestsKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyQuoteRequestsKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsKeyByKeyPost>
 */
class ByProjectKeyQuoteRequestsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsKeyByKeyPost
    {
