 ...
 * @template-implements Errorable<ByProjectKeyExtensionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyExtensionsByIDHead>
 */
class ByProjectKeyExtensionsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
