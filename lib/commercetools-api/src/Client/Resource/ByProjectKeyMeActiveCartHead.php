 ...
 * @template-implements Errorable<ByProjectKeyMeActiveCartHead>
 * @template-implements Deprecatable200<ByProjectKeyMeActiveCartHead>
 */
class ByProjectKeyMeActiveCartHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
