 ...
 * @template-implements Errorable<ByProjectKeySubscriptionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeySubscriptionsByIDHead>
 */
class ByProjectKeySubscriptionsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
