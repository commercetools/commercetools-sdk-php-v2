 ...
 * @template-implements Expandable<ByProjectKeyOrdersEditsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyOrdersEditsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsKeyByKeyGet>
 */
class ByProjectKeyOrdersEditsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyOrdersEditsKeyByKeyGet
    {
