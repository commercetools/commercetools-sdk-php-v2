 ...
 * @template-implements Errorable<ByProjectKeyRecurrencePoliciesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurrencePoliciesByIDHead>
 */
class ByProjectKeyRecurrencePoliciesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
