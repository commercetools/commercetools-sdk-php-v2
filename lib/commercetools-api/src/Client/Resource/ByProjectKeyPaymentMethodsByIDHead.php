 ...
 * @template-implements Errorable<ByProjectKeyPaymentMethodsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyPaymentMethodsByIDHead>
 */
class ByProjectKeyPaymentMethodsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
