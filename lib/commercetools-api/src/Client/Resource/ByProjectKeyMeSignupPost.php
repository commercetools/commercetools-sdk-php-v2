 ...
 * @template-implements Errorable<ByProjectKeyMeSignupPost>
 */
class ByProjectKeyMeSignupPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/me/signup');
