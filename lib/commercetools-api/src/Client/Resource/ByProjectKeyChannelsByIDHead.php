 ...
 * @template-implements Errorable<ByProjectKeyChannelsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyChannelsByIDHead>
 */
class ByProjectKeyChannelsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
