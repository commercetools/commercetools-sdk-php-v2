 ...
 * @template-implements Errorable<ByProjectKeyOrdersEditsHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersEditsHead>
 */
class ByProjectKeyOrdersEditsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyOrdersEditsHead
    {
