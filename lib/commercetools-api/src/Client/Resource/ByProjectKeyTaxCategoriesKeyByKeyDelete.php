...
class ByProjectKeyTaxCategoriesKeyByKeyDelete extends ApiRequest
{
    /**
     ...
     * @psalm-return ErrorResponse|JsonObject|TaxCategory|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case "200": $resultType = TaxCategoryModel::class; break;
     ...
     * @psalm-param ?class-string<T> $resultType
     * @param array $options
     * @return ErrorResponse|JsonObject|TaxCategory|null
     */
