 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet>
 */
class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyOrdersByIDGet
    {
