...
class ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsByIDDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
     ...
     */
    public function withVersion($version): ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsByIDDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsByIDDelete
    {
