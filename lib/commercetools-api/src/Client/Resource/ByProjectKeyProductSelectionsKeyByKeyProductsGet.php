...
class ByProjectKeyProductSelectionsKeyByKeyProductsGet extends ApiRequest implements Expandable, Paging, Sortable, Errorable, Deprecatable200
{
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/product-selections/key={key}/products');
     ...
     */
    public function withLimit($limit): ByProjectKeyProductSelectionsKeyByKeyProductsGet
    {
     ...
     */
    public function withOffset($offset): ByProjectKeyProductSelectionsKeyByKeyProductsGet
    {
