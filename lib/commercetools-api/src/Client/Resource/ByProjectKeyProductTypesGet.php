...
class ByProjectKeyProductTypesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|ProductTypePagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyProductTypesGet
    {
