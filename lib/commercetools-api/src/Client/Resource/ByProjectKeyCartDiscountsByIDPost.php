 ...
 * @template-implements Conflicting<ByProjectKeyCartDiscountsByIDPost>
 * @template-implements Expandable<ByProjectKeyCartDiscountsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyCartDiscountsByIDPost>
 * @template-implements Errorable<ByProjectKeyCartDiscountsByIDPost>
 */
class ByProjectKeyCartDiscountsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
