 ...
 * @template-implements Errorable<ByProjectKeyStoresKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyStoresKeyByKeyHead>
 */
class ByProjectKeyStoresKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
