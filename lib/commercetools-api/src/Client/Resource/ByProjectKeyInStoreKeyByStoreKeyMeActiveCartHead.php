 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyMeActiveCartHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyMeActiveCartHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyMeActiveCartHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
