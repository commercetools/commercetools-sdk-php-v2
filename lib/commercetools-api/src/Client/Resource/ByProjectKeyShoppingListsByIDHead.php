 ...
 * @template-implements Errorable<ByProjectKeyShoppingListsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyShoppingListsByIDHead>
 */
class ByProjectKeyShoppingListsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
