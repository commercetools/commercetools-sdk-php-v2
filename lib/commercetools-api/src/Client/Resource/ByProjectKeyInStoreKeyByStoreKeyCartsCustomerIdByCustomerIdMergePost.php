 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdMergePost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdMergePost extends ApiRequest implements Errorable
{
    /**
