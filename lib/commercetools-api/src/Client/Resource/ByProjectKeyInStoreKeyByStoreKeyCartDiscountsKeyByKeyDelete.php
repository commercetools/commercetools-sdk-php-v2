 ...
 * @template-implements Versioned<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete>
 */
class ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withVersion($version): ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyDelete
    {
