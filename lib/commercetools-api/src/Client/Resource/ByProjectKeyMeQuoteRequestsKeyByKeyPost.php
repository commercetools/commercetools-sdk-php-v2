 ...
 * @template-implements Conflicting<ByProjectKeyMeQuoteRequestsKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsKeyByKeyPost>
 */
class ByProjectKeyMeQuoteRequestsKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/me/quote-requests/key={key}');
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsKeyByKeyPost
    {
