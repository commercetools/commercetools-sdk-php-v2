 ...
 * @template-implements Expandable<ByProjectKeyCustomersKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyCustomersKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyCustomersKeyByKeyGet>
 */
class ByProjectKeyCustomersKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyCustomersKeyByKeyGet
    {
