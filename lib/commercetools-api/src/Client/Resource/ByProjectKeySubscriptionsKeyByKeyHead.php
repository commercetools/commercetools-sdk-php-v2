 ...
 * @template-implements Errorable<ByProjectKeySubscriptionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeySubscriptionsKeyByKeyHead>
 */
class ByProjectKeySubscriptionsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
