 ...
 * @template-implements Errorable<ByProjectKeyDiscountGroupsHead>
 * @template-implements Deprecatable200<ByProjectKeyDiscountGroupsHead>
 */
class ByProjectKeyDiscountGroupsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyDiscountGroupsHead
    {
