 ...
 * @template-implements Errorable<ByProjectKeyMeQuotesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuotesKeyByKeyHead>
 */
class ByProjectKeyMeQuotesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
