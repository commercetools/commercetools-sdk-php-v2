 ...
 * @template-implements Errorable<ByProjectKeyCartsCustomerIdByCustomerIdMergePost>
 */
class ByProjectKeyCartsCustomerIdByCustomerIdMergePost extends ApiRequest implements Errorable
{
    /**
