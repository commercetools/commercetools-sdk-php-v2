 ...
 * @template-implements Errorable<ByProjectKeyQuoteRequestsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsKeyByKeyHead>
 */
class ByProjectKeyQuoteRequestsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
