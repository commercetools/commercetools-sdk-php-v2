 ...
 * @template-implements Expandable<ByProjectKeyOrdersEditsPost>
 * @template-implements Deprecatable201<ByProjectKeyOrdersEditsPost>
 * @template-implements Errorable<ByProjectKeyOrdersEditsPost>
 */
class ByProjectKeyOrdersEditsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyOrdersEditsPost
    {
