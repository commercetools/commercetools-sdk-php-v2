 ...
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyCustomersByIDGet
    {
