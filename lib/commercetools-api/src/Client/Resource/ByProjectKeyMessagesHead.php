 ...
 * @template-implements Errorable<ByProjectKeyMessagesHead>
 * @template-implements Deprecatable200<ByProjectKeyMessagesHead>
 */
class ByProjectKeyMessagesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMessagesHead
    {
