 ...
 * @template-implements Errorable<ByProjectKeyPaymentMethodsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyPaymentMethodsKeyByKeyHead>
 */
class ByProjectKeyPaymentMethodsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
