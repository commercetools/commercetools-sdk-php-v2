 ...
 * @template-implements Errorable<ByProjectKeyProductsSearchHead>
 * @template-implements Deprecatable200<ByProjectKeyProductsSearchHead>
 */
class ByProjectKeyProductsSearchHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
