 ...
 * @template-implements Expandable<ByProjectKeyQuoteRequestsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsKeyByKeyGet>
 */
class ByProjectKeyQuoteRequestsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsKeyByKeyGet
    {
