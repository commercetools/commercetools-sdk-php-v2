 ...
 * @template-implements Errorable<ByProjectKeyStatesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyStatesByIDHead>
 */
class ByProjectKeyStatesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
