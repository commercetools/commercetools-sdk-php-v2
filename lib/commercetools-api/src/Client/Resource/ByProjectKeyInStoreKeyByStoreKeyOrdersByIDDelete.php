...
class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDDelete extends ApiRequest
{
    /**
     ...
     * @param array $headers
     */
    public function __construct($projectKey, $storeKey, $ID, $body = null, array $headers = [], Client $client = null)
    {
    ...
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case "200": $resultType = OrderModel::class; break;
     ...
     * @psalm-param ?class-string<T> $resultType
     * @param array $options
     * @return ErrorResponse|JsonObject|Order|null
     */
