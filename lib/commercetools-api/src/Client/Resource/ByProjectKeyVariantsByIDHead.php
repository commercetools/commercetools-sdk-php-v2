 ...
 * @template-implements Errorable<ByProjectKeyVariantsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantsByIDHead>
 */
class ByProjectKeyVariantsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
