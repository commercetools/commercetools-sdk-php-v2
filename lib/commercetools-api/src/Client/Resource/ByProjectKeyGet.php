 ...
 * @template-implements Errorable<ByProjectKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyGet>
 */
class ByProjectKeyGet extends ApiRequest implements Errorable, Deprecatable200
{
    /**
