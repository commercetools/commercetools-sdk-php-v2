 ...
 * @template-implements Errorable<ByProjectKeyMeCartsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyMeCartsByIDHead>
 */
class ByProjectKeyMeCartsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
