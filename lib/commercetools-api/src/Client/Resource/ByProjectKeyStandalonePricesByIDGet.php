 ...
 * @template-implements Expandable<ByProjectKeyStandalonePricesByIDGet>
 * @template-implements Errorable<ByProjectKeyStandalonePricesByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesByIDGet>
 */
class ByProjectKeyStandalonePricesByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesByIDGet
    {
