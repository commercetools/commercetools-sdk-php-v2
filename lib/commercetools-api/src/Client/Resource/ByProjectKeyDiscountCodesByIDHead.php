 ...
 * @template-implements Errorable<ByProjectKeyDiscountCodesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyDiscountCodesByIDHead>
 */
class ByProjectKeyDiscountCodesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
