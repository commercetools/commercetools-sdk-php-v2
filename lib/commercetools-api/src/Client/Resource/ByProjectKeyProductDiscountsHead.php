 ...
 * @template-implements Errorable<ByProjectKeyProductDiscountsHead>
 * @template-implements Deprecatable200<ByProjectKeyProductDiscountsHead>
 */
class ByProjectKeyProductDiscountsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyProductDiscountsHead
    {
