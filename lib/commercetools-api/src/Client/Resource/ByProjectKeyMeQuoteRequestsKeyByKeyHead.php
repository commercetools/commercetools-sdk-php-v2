 ...
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsKeyByKeyHead>
 */
class ByProjectKeyMeQuoteRequestsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
