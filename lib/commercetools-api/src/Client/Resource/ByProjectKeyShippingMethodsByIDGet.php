 ...
 * @template-implements Expandable<ByProjectKeyShippingMethodsByIDGet>
 * @template-implements Errorable<ByProjectKeyShippingMethodsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsByIDGet>
 */
class ByProjectKeyShippingMethodsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
