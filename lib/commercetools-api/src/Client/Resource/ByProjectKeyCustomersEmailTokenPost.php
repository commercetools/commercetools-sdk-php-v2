 ...
 * @template-implements Errorable<ByProjectKeyCustomersEmailTokenPost>
 */
class ByProjectKeyCustomersEmailTokenPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/customers/email-token');
