 ...
 * @template-implements Errorable<ByProjectKeyTypesHead>
 * @template-implements Deprecatable200<ByProjectKeyTypesHead>
 */
class ByProjectKeyTypesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyTypesHead
    {
