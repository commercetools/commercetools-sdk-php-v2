 ...
 * @template-implements Expandable<ByProjectKeyShippingMethodsMatchingCartLocationGet>
 * @template-implements Errorable<ByProjectKeyShippingMethodsMatchingCartLocationGet>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsMatchingCartLocationGet>
 */
class ByProjectKeyShippingMethodsMatchingCartLocationGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/shipping-methods/matching-cart-location');
     ...
     */
    public function withCountry($country): ByProjectKeyShippingMethodsMatchingCartLocationGet
    {
     ...
     */
    public function withState($state): ByProjectKeyShippingMethodsMatchingCartLocationGet
    {
     ...
     */
    public function withCartId($cartId): ByProjectKeyShippingMethodsMatchingCartLocationGet
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyShippingMethodsMatchingCartLocationGet
    {
