 ...
 * @template-implements Errorable<ByProjectKeyDiscountGroupsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyDiscountGroupsKeyByKeyHead>
 */
class ByProjectKeyDiscountGroupsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
