 ...
 * @template-implements Errorable<ByProjectKeyAssociateRolesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyAssociateRolesByIDHead>
 */
class ByProjectKeyAssociateRolesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
