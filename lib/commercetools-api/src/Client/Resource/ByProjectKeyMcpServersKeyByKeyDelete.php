 ...
 * @template-implements Versioned<ByProjectKeyMcpServersKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyMcpServersKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyMcpServersKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyMcpServersKeyByKeyDelete>
 */
class ByProjectKeyMcpServersKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withVersion($version): ByProjectKeyMcpServersKeyByKeyDelete
    {
