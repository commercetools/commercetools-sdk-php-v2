 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesByIDHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyStagedQuotesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
