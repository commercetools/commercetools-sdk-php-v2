 ...
 * @template-implements Expandable<ByProjectKeyMePaymentsByIDGet>
 * @template-implements Errorable<ByProjectKeyMePaymentsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyMePaymentsByIDGet>
 */
class ByProjectKeyMePaymentsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMePaymentsByIDGet
    {
