 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersEmailConfirmPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersEmailConfirmPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/customers/email/confirm');
