 ...
 * @template-implements Errorable<ByProjectKeyProductTypesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyProductTypesByIDHead>
 */
class ByProjectKeyProductTypesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
