 ...
 * @template-implements Errorable<ByProjectKeyCustomerGroupsHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomerGroupsHead>
 */
class ByProjectKeyCustomerGroupsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCustomerGroupsHead
    {
