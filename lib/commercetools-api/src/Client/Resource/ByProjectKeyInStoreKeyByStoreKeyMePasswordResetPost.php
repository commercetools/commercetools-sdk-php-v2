 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyMePasswordResetPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/me/password/reset');
