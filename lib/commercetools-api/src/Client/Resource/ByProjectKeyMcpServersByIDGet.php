 ...
 * @template-implements Errorable<ByProjectKeyMcpServersByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyMcpServersByIDGet>
 */
class ByProjectKeyMcpServersByIDGet extends ApiRequest implements Errorable, Deprecatable200
{
    /**
