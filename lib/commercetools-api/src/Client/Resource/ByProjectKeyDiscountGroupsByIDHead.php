 ...
 * @template-implements Errorable<ByProjectKeyDiscountGroupsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyDiscountGroupsByIDHead>
 */
class ByProjectKeyDiscountGroupsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
