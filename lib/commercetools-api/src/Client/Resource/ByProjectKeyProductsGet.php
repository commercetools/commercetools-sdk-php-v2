...
class ByProjectKeyProductsGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|ProductPagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyProductsGet
    {
