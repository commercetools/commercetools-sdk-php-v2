 ...
 * @template-implements Errorable<ByProjectKeyOrdersImportPost>
 */
class ByProjectKeyOrdersImportPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/orders/import');
