 ...
 * @template-implements Errorable<ByProjectKeyInventoryHead>
 * @template-implements Deprecatable200<ByProjectKeyInventoryHead>
 */
class ByProjectKeyInventoryHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyInventoryHead
    {
