 ...
 * @template-implements Expandable<ByProjectKeyCustomerGroupsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyCustomerGroupsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyCustomerGroupsKeyByKeyGet>
 */
class ByProjectKeyCustomerGroupsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
