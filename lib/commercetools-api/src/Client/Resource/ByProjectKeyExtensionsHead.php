 ...
 * @template-implements Errorable<ByProjectKeyExtensionsHead>
 * @template-implements Deprecatable200<ByProjectKeyExtensionsHead>
 */
class ByProjectKeyExtensionsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyExtensionsHead
    {
