 ...
 * @template-implements Errorable<ByProjectKeyAttributeGroupsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsByIDHead>
 */
class ByProjectKeyAttributeGroupsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
