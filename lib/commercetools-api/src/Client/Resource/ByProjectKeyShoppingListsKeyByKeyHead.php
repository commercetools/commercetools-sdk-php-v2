 ...
 * @template-implements Errorable<ByProjectKeyShoppingListsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyShoppingListsKeyByKeyHead>
 */
class ByProjectKeyShoppingListsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
