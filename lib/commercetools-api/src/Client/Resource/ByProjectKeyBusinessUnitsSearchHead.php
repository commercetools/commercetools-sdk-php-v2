 ...
 * @template-implements Errorable<ByProjectKeyBusinessUnitsSearchHead>
 * @template-implements Deprecatable200<ByProjectKeyBusinessUnitsSearchHead>
 */
class ByProjectKeyBusinessUnitsSearchHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
