 ...
 * @template-implements DataErasure<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 * @template-implements Versioned<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 * @template-implements Expandable<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsKeyByKeyDelete>
 */
class ByProjectKeyQuoteRequestsKeyByKeyDelete extends ApiRequest implements DataErasure, Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withDataErasure($dataErasure): ByProjectKeyQuoteRequestsKeyByKeyDelete
    {
     ...
     */
    public function withVersion($version): ByProjectKeyQuoteRequestsKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsKeyByKeyDelete
    {
