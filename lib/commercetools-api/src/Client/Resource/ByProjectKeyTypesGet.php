...
class ByProjectKeyTypesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|TypePagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyTypesGet
    {
