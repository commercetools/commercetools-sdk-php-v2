 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersEmailTokenPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/customers/email-token');
