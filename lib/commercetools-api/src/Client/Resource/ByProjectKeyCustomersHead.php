 ...
 * @template-implements Errorable<ByProjectKeyCustomersHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomersHead>
 */
class ByProjectKeyCustomersHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCustomersHead
    {
