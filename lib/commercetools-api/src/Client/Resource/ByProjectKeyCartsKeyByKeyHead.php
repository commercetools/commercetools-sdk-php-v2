 ...
 * @template-implements Errorable<ByProjectKeyCartsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyCartsKeyByKeyHead>
 */
class ByProjectKeyCartsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
