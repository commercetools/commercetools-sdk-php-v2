 ...
 * @template-implements Errorable<ByProjectKeyQuoteRequestsHead>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsHead>
 */
class ByProjectKeyQuoteRequestsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyQuoteRequestsHead
    {
