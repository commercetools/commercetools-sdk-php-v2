 ...
 * @template-implements Errorable<ByProjectKeyVariantsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantsKeyByKeyHead>
 */
class ByProjectKeyVariantsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
