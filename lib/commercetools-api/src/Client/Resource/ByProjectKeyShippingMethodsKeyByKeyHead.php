 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsKeyByKeyHead>
 */
class ByProjectKeyShippingMethodsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
