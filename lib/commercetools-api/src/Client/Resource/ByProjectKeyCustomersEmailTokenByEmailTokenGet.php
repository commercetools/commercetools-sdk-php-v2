 ...
 * @template-implements Expandable<ByProjectKeyCustomersEmailTokenByEmailTokenGet>
 * @template-implements Errorable<ByProjectKeyCustomersEmailTokenByEmailTokenGet>
 * @template-implements Deprecatable200<ByProjectKeyCustomersEmailTokenByEmailTokenGet>
 */
class ByProjectKeyCustomersEmailTokenByEmailTokenGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
