 ...
 * @template-implements Versioned<ByProjectKeyStandalonePricesByIDDelete>
 * @template-implements Conflicting<ByProjectKeyStandalonePricesByIDDelete>
 * @template-implements Expandable<ByProjectKeyStandalonePricesByIDDelete>
 * @template-implements Errorable<ByProjectKeyStandalonePricesByIDDelete>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesByIDDelete>
 */
class ByProjectKeyStandalonePricesByIDDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withVersion($version): ByProjectKeyStandalonePricesByIDDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesByIDDelete
    {
