 ...
 * @template-implements Expandable<ByProjectKeyBusinessUnitsPost>
 * @template-implements Deprecatable201<ByProjectKeyBusinessUnitsPost>
 * @template-implements Errorable<ByProjectKeyBusinessUnitsPost>
 */
class ByProjectKeyBusinessUnitsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyBusinessUnitsPost
    {
