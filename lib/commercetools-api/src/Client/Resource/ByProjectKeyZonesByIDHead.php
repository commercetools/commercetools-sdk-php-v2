 ...
 * @template-implements Errorable<ByProjectKeyZonesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyZonesByIDHead>
 */
class ByProjectKeyZonesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
