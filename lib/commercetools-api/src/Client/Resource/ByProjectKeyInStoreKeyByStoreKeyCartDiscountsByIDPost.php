 ...
 * @template-implements Conflicting<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost>
 * @template-implements Expandable<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost>
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyCartDiscountsByIDPost
    {
