 ...
 * @template-implements Conflicting<ByProjectKeyQuoteRequestsByIDPost>
 * @template-implements Expandable<ByProjectKeyQuoteRequestsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsByIDPost>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsByIDPost>
 */
class ByProjectKeyQuoteRequestsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsByIDPost
    {
