 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyStagedQuotesHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyStagedQuotesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyInStoreKeyByStoreKeyStagedQuotesHead
    {
