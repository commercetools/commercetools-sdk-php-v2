 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withCartId($cartId): ByProjectKeyInStoreKeyByStoreKeyShippingMethodsMatchingCartHead
    {
