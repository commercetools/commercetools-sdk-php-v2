 ...
 * @template-implements Expandable<ByProjectKeyStandalonePricesPost>
 * @template-implements Deprecatable201<ByProjectKeyStandalonePricesPost>
 * @template-implements Errorable<ByProjectKeyStandalonePricesPost>
 */
class ByProjectKeyStandalonePricesPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStandalonePricesPost
    {
