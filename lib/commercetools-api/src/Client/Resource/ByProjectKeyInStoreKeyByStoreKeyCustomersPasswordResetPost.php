 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/customers/password/reset');
