 ...
 *
 */
class ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringImagesPost extends ApiRequest
{
    /**
     ...
     */
    public function withFilename($filename): ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringImagesPost
    {
     ...
     */
    public function withVariant($variant): ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringImagesPost
    {
     ...
     */
    public function withSku($sku): ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringImagesPost
    {
     ...
     */
    public function withStaged($staged): ByProjectKeyInStoreKeyByStoreKeyProductsByProductIDProductTailoringImagesPost
    {
