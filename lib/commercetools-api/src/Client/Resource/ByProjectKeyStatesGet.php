...
class ByProjectKeyStatesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|StatePagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyStatesGet
    {
