...
class ByProjectKeyMeLoginPost extends ApiRequest
{
    /**
     ...
     * @psalm-return CustomerSignInResult|ErrorResponse|JsonObject|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case "200": $resultType = CustomerSignInResultModel::class; break;
     ...
     * @psalm-param ?class-string<T> $resultType
     * @param array $options
     * @return CustomerSignInResult|ErrorResponse|JsonObject|null
     */
