 ...
 * @template-implements Errorable<ByProjectKeyMeLoginPost>
 */
class ByProjectKeyMeLoginPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/me/login');
