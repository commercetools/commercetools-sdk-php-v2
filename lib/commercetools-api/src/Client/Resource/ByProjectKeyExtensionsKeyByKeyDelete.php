 ...
 * @template-implements Expandable<ByProjectKeyExtensionsKeyByKeyDelete>
 ...
 */
class ByProjectKeyExtensionsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
