 ...
 * @template-implements Versioned<ByProjectKeyExtensionsKeyByKeyDelete>
 * @template-implements Conflicting<ByProjectKeyExtensionsKeyByKeyDelete>
 * @template-implements Errorable<ByProjectKeyExtensionsKeyByKeyDelete>
 * @template-implements Deprecatable200<ByProjectKeyExtensionsKeyByKeyDelete>
 */
class ByProjectKeyExtensionsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{key}'], [urlencode($projectKey), urlencode($key)], '{projectKey}/extensions/key={key}');
