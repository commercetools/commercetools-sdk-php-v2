 ...
 * @template-implements Errorable<ByProjectKeyCustomerGroupsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomerGroupsKeyByKeyHead>
 */
class ByProjectKeyCustomerGroupsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
