 ...
 * @template-implements Errorable<ByProjectKeyQuotesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyQuotesByIDHead>
 */
class ByProjectKeyQuotesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
