 ...
 * @template-implements Expandable<ByProjectKeyMeShoppingListsPost>
 * @template-implements Deprecatable201<ByProjectKeyMeShoppingListsPost>
 * @template-implements Errorable<ByProjectKeyMeShoppingListsPost>
 */
class ByProjectKeyMeShoppingListsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMeShoppingListsPost
    {
