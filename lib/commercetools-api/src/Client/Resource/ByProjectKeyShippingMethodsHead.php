 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsHead>
 */
class ByProjectKeyShippingMethodsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyShippingMethodsHead
    {
