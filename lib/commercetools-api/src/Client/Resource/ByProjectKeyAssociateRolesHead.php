 ...
 * @template-implements Errorable<ByProjectKeyAssociateRolesHead>
 * @template-implements Deprecatable200<ByProjectKeyAssociateRolesHead>
 */
class ByProjectKeyAssociateRolesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyAssociateRolesHead
    {
