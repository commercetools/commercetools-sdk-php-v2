 ...
 * @template-implements Errorable<ByProjectKeyRecurrencePoliciesHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurrencePoliciesHead>
 */
class ByProjectKeyRecurrencePoliciesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyRecurrencePoliciesHead
    {
