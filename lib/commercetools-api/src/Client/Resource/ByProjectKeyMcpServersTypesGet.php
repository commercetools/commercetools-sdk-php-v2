 ...
 * @template-implements Errorable<ByProjectKeyMcpServersTypesGet>
 * @template-implements Deprecatable200<ByProjectKeyMcpServersTypesGet>
 */
class ByProjectKeyMcpServersTypesGet extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/mcp-servers/types');
