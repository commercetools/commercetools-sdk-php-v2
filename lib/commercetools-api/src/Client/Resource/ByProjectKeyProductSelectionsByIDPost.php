 ...
 * @template-implements Conflicting<ByProjectKeyProductSelectionsByIDPost>
 * @template-implements Expandable<ByProjectKeyProductSelectionsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyProductSelectionsByIDPost>
 * @template-implements Errorable<ByProjectKeyProductSelectionsByIDPost>
 */
class ByProjectKeyProductSelectionsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyProductSelectionsByIDPost
    {
