 ...
 * @template-implements Errorable<ByProjectKeyStatesHead>
 * @template-implements Deprecatable200<ByProjectKeyStatesHead>
 */
class ByProjectKeyStatesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyStatesHead
    {
