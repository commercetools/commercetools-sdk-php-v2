 ...
 * @template-implements Errorable<ByProjectKeyPaymentsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyPaymentsKeyByKeyHead>
 */
class ByProjectKeyPaymentsKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
