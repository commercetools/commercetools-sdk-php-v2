 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyMeCartsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
