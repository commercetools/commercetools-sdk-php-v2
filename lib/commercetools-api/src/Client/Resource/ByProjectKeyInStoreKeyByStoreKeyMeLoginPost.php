 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyMeLoginPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyMeLoginPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/me/login');
