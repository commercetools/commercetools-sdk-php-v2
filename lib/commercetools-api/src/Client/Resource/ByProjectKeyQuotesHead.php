 ...
 * @template-implements Errorable<ByProjectKeyQuotesHead>
 * @template-implements Deprecatable200<ByProjectKeyQuotesHead>
 */
class ByProjectKeyQuotesHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyQuotesHead
    {
