 ...
 * @template-implements Expandable<ByProjectKeyProductSelectionsPost>
 * @template-implements Deprecatable201<ByProjectKeyProductSelectionsPost>
 * @template-implements Errorable<ByProjectKeyProductSelectionsPost>
 */
class ByProjectKeyProductSelectionsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyProductSelectionsPost
    {
