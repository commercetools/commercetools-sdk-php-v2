 ...
 * @template-implements Errorable<ByProjectKeyOrdersSearchHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersSearchHead>
 */
class ByProjectKeyOrdersSearchHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
