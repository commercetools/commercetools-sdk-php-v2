 ...
 * @template-implements Errorable<ByProjectKeyApiClientsHead>
 * @template-implements Deprecatable200<ByProjectKeyApiClientsHead>
 */
class ByProjectKeyApiClientsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyApiClientsHead
    {
