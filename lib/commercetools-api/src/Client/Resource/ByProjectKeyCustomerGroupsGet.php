...
use Commercetools\Api\Models\CustomerGroup\CustomerGroupPagedQueryResponse;
use Commercetools\Api\Models\CustomerGroup\CustomerGroupPagedQueryResponseModel;
...
class ByProjectKeyCustomerGroupsGet extends ApiRequest
{
     ...
     * @psalm-return CustomerGroupPagedQueryResponse|ErrorResponse|JsonObject|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = CustomerGroupPagedQueryResponseModel::class;
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyCustomerGroupsGet
    {
