 ...
 * @template-implements Conflicting<ByProjectKeyAttributeGroupsByIDPost>
 * @template-implements Expandable<ByProjectKeyAttributeGroupsByIDPost>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsByIDPost>
 * @template-implements Errorable<ByProjectKeyAttributeGroupsByIDPost>
 */
class ByProjectKeyAttributeGroupsByIDPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAttributeGroupsByIDPost
    {
