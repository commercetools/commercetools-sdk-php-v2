 ...
 * @template-implements Errorable<ByProjectKeyQuotesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyQuotesKeyByKeyHead>
 */
class ByProjectKeyQuotesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
