 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyOrdersQuotesPost>
 */
class ByProjectKeyInStoreKeyByStoreKeyOrdersQuotesPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/orders/quotes');
