 ...
 * @template-implements Expandable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost>
 * @template-implements Deprecatable201<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost>
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAsAssociateByAssociateIdBusinessUnitsPost
    {
