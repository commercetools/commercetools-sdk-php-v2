 ...
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsHead>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsHead>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyAsAssociateByAssociateIdBusinessUnitsHead
    {
