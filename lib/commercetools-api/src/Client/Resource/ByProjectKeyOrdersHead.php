 ...
 * @template-implements Errorable<ByProjectKeyOrdersHead>
 * @template-implements Deprecatable200<ByProjectKeyOrdersHead>
 */
class ByProjectKeyOrdersHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}'], [urlencode($projectKey)], '{projectKey}/orders');
     ...
     */
    public function withWhere($where): ByProjectKeyOrdersHead
    {
