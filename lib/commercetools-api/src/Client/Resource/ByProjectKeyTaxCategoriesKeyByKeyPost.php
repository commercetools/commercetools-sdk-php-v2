 ...
 * @template-implements Conflicting<ByProjectKeyTaxCategoriesKeyByKeyPost>
 * @template-implements Expandable<ByProjectKeyTaxCategoriesKeyByKeyPost>
 * @template-implements Deprecatable200<ByProjectKeyTaxCategoriesKeyByKeyPost>
 * @template-implements Errorable<ByProjectKeyTaxCategoriesKeyByKeyPost>
 */
class ByProjectKeyTaxCategoriesKeyByKeyPost extends ApiRequest implements Conflicting, Expandable, Deprecatable200, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyTaxCategoriesKeyByKeyPost
    {
