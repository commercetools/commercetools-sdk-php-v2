 ...
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdInBusinessUnitKeyByBusinessUnitKeyOrdersQuotesPost>
 */
class ByProjectKeyAsAssociateByAssociateIdInBusinessUnitKeyByBusinessUnitKeyOrdersQuotesPost extends ApiRequest implements Errorable
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{associateId}', '{businessUnitKey}'], [urlencode($projectKey), urlencode($associateId), urlencode($businessUnitKey)], '{projectKey}/as-associate/{associateId}/in-business-unit/key={businessUnitKey}/orders/quotes');
