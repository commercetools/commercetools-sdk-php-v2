 ...
 * @template-implements Expandable<ByProjectKeyReviewsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyReviewsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyReviewsKeyByKeyGet>
 */
class ByProjectKeyReviewsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
