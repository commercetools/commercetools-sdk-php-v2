 ...
 * @template-implements Errorable<ByProjectKeyRecurrencePoliciesKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyRecurrencePoliciesKeyByKeyHead>
 */
class ByProjectKeyRecurrencePoliciesKeyByKeyHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
