 ...
 * @template-implements Errorable<ByProjectKeyStoresByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyStoresByIDHead>
 */
class ByProjectKeyStoresByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
