 ...
 * @template-implements Errorable<ByProjectKeyStandalonePricesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyStandalonePricesByIDHead>
 */
class ByProjectKeyStandalonePricesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
