 ...
 * @template-implements Errorable<ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDHead>
 */
class ByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}', '{ID}'], [urlencode($projectKey), urlencode($storeKey), urlencode($ID)], '{projectKey}/in-store/key={storeKey}/product-projections/{ID}');
