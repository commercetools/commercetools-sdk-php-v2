 ...
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsHead>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsHead>
 */
class ByProjectKeyMeQuoteRequestsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyMeQuoteRequestsHead
    {
