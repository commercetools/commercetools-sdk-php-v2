 ...
 * @template-implements Versioned<ByProjectKeyMeQuoteRequestsByIDDelete>
 * @template-implements Conflicting<ByProjectKeyMeQuoteRequestsByIDDelete>
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsByIDDelete>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsByIDDelete>
 * @template-implements Deprecatable200<ByProjectKeyMeQuoteRequestsByIDDelete>
 */
class ByProjectKeyMeQuoteRequestsByIDDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withVersion($version): ByProjectKeyMeQuoteRequestsByIDDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsByIDDelete
    {
