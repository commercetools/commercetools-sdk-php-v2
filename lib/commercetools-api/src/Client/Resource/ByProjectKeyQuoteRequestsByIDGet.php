 ...
 * @template-implements Expandable<ByProjectKeyQuoteRequestsByIDGet>
 * @template-implements Errorable<ByProjectKeyQuoteRequestsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyQuoteRequestsByIDGet>
 */
class ByProjectKeyQuoteRequestsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyQuoteRequestsByIDGet
    {
