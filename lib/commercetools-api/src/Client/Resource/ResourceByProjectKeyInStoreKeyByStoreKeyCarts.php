...
class ResourceByProjectKeyInStoreKeyByStoreKeyCarts extends ApiResource
{
    ...
    /**
     */
    public function customerIdWithCustomerIdValueMerge(?string $customerId = null): ResourceByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdMerge
    {
        $args = $this->getArgs();
        if (!is_null($customerId)) {
            $args['customerId'] = $customerId;
        ...
        return new ResourceByProjectKeyInStoreKeyByStoreKeyCartsCustomerIdByCustomerIdMerge($args, $this->getClient());
    }
    /**
     */
     ...
     * @psalm-param array<string, scalar|scalar[]> $headers
     */
    public function head($body = null, array $headers = []): ByProjectKeyInStoreKeyByStoreKeyCartsHead
    {
        $args = $this->getArgs();

        return new ByProjectKeyInStoreKeyByStoreKeyCartsHead($args['projectKey'], $args['storeKey'], $body, $headers, $this->getClient());
    }
    /**
