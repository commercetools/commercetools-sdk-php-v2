...
class ByProjectKeyZonesGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|ZonePagedQueryResponse|T|null
     */
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyZonesGet
    {
