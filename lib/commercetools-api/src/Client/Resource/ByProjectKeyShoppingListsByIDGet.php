 ...
 * @template-implements Expandable<ByProjectKeyShoppingListsByIDGet>
 * @template-implements Errorable<ByProjectKeyShoppingListsByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyShoppingListsByIDGet>
 */
class ByProjectKeyShoppingListsByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
