 ...
 *
 */
class ByProjectKeyVariantsByIDImagesPost extends ApiRequest
{
    /**
     ...
     * @return JsonObject|Variant|T|null
     */
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|JsonObject|Variant
     */
     ...
     */
    public function withFilename($filename): ByProjectKeyVariantsByIDImagesPost
    {
     ...
     */
    public function withStaged($staged): ByProjectKeyVariantsByIDImagesPost
    {
