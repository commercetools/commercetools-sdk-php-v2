 ...
 * @template-implements Expandable<ByProjectKeyStagedQuotesPost>
 * @template-implements Deprecatable201<ByProjectKeyStagedQuotesPost>
 * @template-implements Errorable<ByProjectKeyStagedQuotesPost>
 */
class ByProjectKeyStagedQuotesPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyStagedQuotesPost
    {
