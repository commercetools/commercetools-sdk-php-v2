 ...
 * @template-implements Versioned<ByProjectKeyInStoreKeyByStoreKeyMeDelete>
 * @template-implements Conflicting<ByProjectKeyInStoreKeyByStoreKeyMeDelete>
 */
class ByProjectKeyInStoreKeyByStoreKeyMeDelete extends ApiRequest implements Versioned, Conflicting
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{storeKey}'], [urlencode($projectKey), urlencode($storeKey)], '{projectKey}/in-store/key={storeKey}/me');
     ...
     */
    public function withVersion($version): ByProjectKeyInStoreKeyByStoreKeyMeDelete
    {
