 ...
 * @template-implements ProjectionSelectingVariant<ByProjectKeyVariantProjectionsKeyByKeyHead>
 * @template-implements ProjectionValidating<ByProjectKeyVariantProjectionsKeyByKeyHead>
 * @template-implements Errorable<ByProjectKeyVariantProjectionsKeyByKeyHead>
 * @template-implements Deprecatable200<ByProjectKeyVariantProjectionsKeyByKeyHead>
 */
class ByProjectKeyVariantProjectionsKeyByKeyHead extends ApiRequest implements ProjectionSelectingVariant, ProjectionValidating, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withStaged($staged): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCurrency($priceCurrency): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCountry($priceCountry): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceCustomerGroup($priceCustomerGroup): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withPriceChannel($priceChannel): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withLocaleProjection($localeProjection): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
     ...
     */
    public function withFilterAttributes($filterAttributes): ByProjectKeyVariantProjectionsKeyByKeyHead
    {
