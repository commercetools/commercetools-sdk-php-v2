 ...
 * @template-implements Errorable<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDHead>
 */
class ByProjectKeyAsAssociateByAssociateIdBusinessUnitsByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
