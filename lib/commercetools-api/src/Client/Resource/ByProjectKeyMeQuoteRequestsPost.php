 ...
 * @template-implements Expandable<ByProjectKeyMeQuoteRequestsPost>
 * @template-implements Deprecatable201<ByProjectKeyMeQuoteRequestsPost>
 * @template-implements Errorable<ByProjectKeyMeQuoteRequestsPost>
 */
class ByProjectKeyMeQuoteRequestsPost extends ApiRequest implements Expandable, Deprecatable201, Errorable
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyMeQuoteRequestsPost
    {
