...
class ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsKeyByKeyDelete extends ApiRequest implements Versioned, Conflicting, Expandable, Errorable, Deprecatable200
{
     ...
     */
    public function withVersion($version): ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsKeyByKeyDelete
    {
     ...
     */
    public function withExpand($expand): ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsKeyByKeyDelete
    {
