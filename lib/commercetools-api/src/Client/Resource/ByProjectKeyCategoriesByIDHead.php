 ...
 * @template-implements Errorable<ByProjectKeyCategoriesByIDHead>
 * @template-implements Deprecatable200<ByProjectKeyCategoriesByIDHead>
 */
class ByProjectKeyCategoriesByIDHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
