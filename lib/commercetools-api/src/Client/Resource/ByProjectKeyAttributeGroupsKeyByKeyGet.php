 ...
 * @template-implements Expandable<ByProjectKeyAttributeGroupsKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyAttributeGroupsKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyAttributeGroupsKeyByKeyGet>
 */
class ByProjectKeyAttributeGroupsKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyAttributeGroupsKeyByKeyGet
    {
