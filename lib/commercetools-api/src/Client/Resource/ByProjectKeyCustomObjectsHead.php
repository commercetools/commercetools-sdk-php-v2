 ...
 * @template-implements Errorable<ByProjectKeyCustomObjectsHead>
 * @template-implements Deprecatable200<ByProjectKeyCustomObjectsHead>
 */
class ByProjectKeyCustomObjectsHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withWhere($where): ByProjectKeyCustomObjectsHead
    {
