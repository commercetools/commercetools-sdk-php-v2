 ...
 *
 */
class ByProjectKeySubscriptionsByIDHealthGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{ID}'], [urlencode($projectKey), urlencode($ID)], '{projectKey}/subscriptions/{ID}/health');
