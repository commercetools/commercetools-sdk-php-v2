 ...
 * @template-implements Expandable<ByProjectKeyTaxCategoriesKeyByKeyGet>
 * @template-implements Errorable<ByProjectKeyTaxCategoriesKeyByKeyGet>
 * @template-implements Deprecatable200<ByProjectKeyTaxCategoriesKeyByKeyGet>
 */
class ByProjectKeyTaxCategoriesKeyByKeyGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withExpand($expand): ByProjectKeyTaxCategoriesKeyByKeyGet
    {
