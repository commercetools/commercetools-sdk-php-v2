 ...
 * @template-implements Expandable<ByProjectKeyTypesByIDGet>
 * @template-implements Errorable<ByProjectKeyTypesByIDGet>
 * @template-implements Deprecatable200<ByProjectKeyTypesByIDGet>
 */
class ByProjectKeyTypesByIDGet extends ApiRequest implements Expandable, Errorable, Deprecatable200
{
    /**
