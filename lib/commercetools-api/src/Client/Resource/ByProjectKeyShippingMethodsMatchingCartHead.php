 ...
 * @template-implements Errorable<ByProjectKeyShippingMethodsMatchingCartHead>
 * @template-implements Deprecatable200<ByProjectKeyShippingMethodsMatchingCartHead>
 */
class ByProjectKeyShippingMethodsMatchingCartHead extends ApiRequest implements Errorable, Deprecatable200
{
    /**
     ...
     */
    public function withCartId($cartId): ByProjectKeyShippingMethodsMatchingCartHead
    {
