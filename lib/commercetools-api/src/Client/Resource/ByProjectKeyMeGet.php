...
class ByProjectKeyMeGet extends ApiRequest
{
     ...
     * @psalm-return ErrorResponse|JsonObject|MyCustomer|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = MyCustomerModel::class;
     ...
     */
    public function withPredicateParam(string $paramName, $predicateParam): ByProjectKeyMeGet
    {
