...
The cart must have a shipping address set before creating an order. When using Composable Commerce TaxMode,
...
When using Composable Commerce TaxMode, the shipping address is used for tax calculation.
