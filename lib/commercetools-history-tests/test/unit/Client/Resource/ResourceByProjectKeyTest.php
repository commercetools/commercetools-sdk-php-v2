...
class ResourceByProjectKeyTest extends TestCase
{
    ...
    {
        return [
            'ByProjectKeyGet_withResourceTypes' => [
            ...
            'ByProjectKeyGet_withBusinessUnit' => [
                function (HistoryRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->get()
            ...
            'ByProjectKeyGet_withResourceIds' => [
                function (HistoryRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->get()
            ...
            'ByProjectKeyGet_withWithTotal' => [
                ...
                'get',
                'test_projectKey?withTotal=withTotal',
            ],
            'ByProjectKeyGet' => [
                function (HistoryRequestBuilder $builder): RequestInterface {
                    return $builder
