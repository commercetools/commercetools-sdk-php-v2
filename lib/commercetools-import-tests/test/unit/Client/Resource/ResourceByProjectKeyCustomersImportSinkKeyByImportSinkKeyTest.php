...
/**
 * @covers \Commercetools\Import\Client\Resource\ByProjectKeyCustomersImportSinkKeyByImportSinkKeyPost
 * @covers \Commercetools\Import\Client\Resource\ResourceByProjectKeyCustomersImportSinkKeyByImportSinkKey
 */
class ResourceByProjectKeyCustomersImportSinkKeyByImportSinkKeyTest extends TestCase
{
    /**
    ...
    public function getRequests()
    {
        return [
            'ByProjectKeyCustomersImportSinkKeyByImportSinkKeyPost' => [
                ...
                'post',
                'test_projectKey/customers/importSinkKey=test_importSinkKey',
            ]
        ];
    }
    ...
    public function getResources()
    {
        return [
            ...
            'ResourceByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperations' => [
                ...
                ResourceByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperations::class,
    ...
    {
        return [
            'ByProjectKeyCustomersImportSinkKeyByImportSinkKeyPost_201' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->customers()
            ...
            'ByProjectKeyCustomersImportSinkKeyByImportSinkKeyPost_599' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->customers()
