...
use Commercetools\Import\Client\Resource\ResourceByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsById;
 ...
 * @covers \Commercetools\Import\Client\Resource\ResourceByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperations
 */
class ResourceByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsTest extends TestCase
{
    ...
    public function getRequests()
    {
        return [
            ...
            'ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet_withSort' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->productDrafts()
            ...
            'ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet_withDebug' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->productDrafts()
                ...
                'get',
                'test_projectKey/product-drafts/importSinkKey=test_importSinkKey/import-operations?debug=debug',
            ],
    ...
    {
        return [
            'ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet_200' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->productDrafts()
