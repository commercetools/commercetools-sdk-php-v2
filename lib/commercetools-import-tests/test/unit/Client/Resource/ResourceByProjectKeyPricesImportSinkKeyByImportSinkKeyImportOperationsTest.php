...
class ResourceByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsTest extends TestCase
{
    ...
    public function getRequests()
    {
        return [
            'ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet_withLimit' => [
                ...
                'get',
                'test_projectKey/prices/importSinkKey=test_importSinkKey/import-operations?limit=limit',
            ],
            'ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet_withOffset' => [
                ...
                'get',
                'test_projectKey/prices/importSinkKey=test_importSinkKey/import-operations?offset=offset',
            ],
            'ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet_withSort' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->prices()
            ...
            'ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet_withDebug' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->prices()
                ...
                'get',
                'test_projectKey/prices/importSinkKey=test_importSinkKey/import-operations?debug=debug',
            ],
    ...
    public function getRequestBuilderResponses()
    {
        return [
            ...
            'ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet_599' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->prices()
