...
class ResourceByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportOperationsTest extends TestCase
{
    ...
    public function getRequests()
    {
        return [
            'ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportOperationsGet_withLimit' => [
                ...
                'get',
                'test_projectKey/product-variant-patches/importSinkKey=test_importSinkKey/import-operations?limit=limit',
            ],
            ...
            'ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportOperationsGet_withDebug' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue('test_projectKey')
                        ->productVariantPatches()
                ...
                'get',
                'test_projectKey/product-variant-patches/importSinkKey=test_importSinkKey/import-operations?debug=debug',
            ],
    ...
    public function getRequestBuilderResponses()
    {
        return [
            ...
            'ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportOperationsGet_599' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->productVariantPatches()
