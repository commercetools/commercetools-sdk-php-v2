...
use Commercetools\Import\Client\Resource\ResourceByProjectKeyInventoriesImportSinkKeyByImportSinkKey;
...
class ResourceByProjectKeyInventoriesTest extends TestCase
{
    ...
    public function getResources()
    {
        return [
            ...
            'ResourceByProjectKeyInventoriesImportSinkKeyByImportSinkKey' => [
                function (ImportRequestBuilder $builder): ResourceByProjectKeyInventoriesImportSinkKeyByImportSinkKey {
                    return $builder
                        ->withProjectKeyValue("test_projectKey")
                        ->inventories()
                        ->importSinkKeyWithImportSinkKeyValue("test_importSinkKey");
                },
                ResourceByProjectKeyInventoriesImportSinkKeyByImportSinkKey::class,
                ['projectKey' => 'test_projectKey', 'importSinkKey' => 'test_importSinkKey'],
                '/{projectKey}/inventories/importSinkKey={importSinkKey}'
            ]
        ];
    }
