 ...
 * @covers \Commercetools\Import\Client\Resource\ResourceByProjectKeyProductsImportSinkKeyByImportSinkKeyResourceKeyByResourceKey
 */
class ResourceByProjectKeyProductsImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyTest extends TestCase
{
    ...
    public function getRequests()
    {
        return [
            'ByProjectKeyProductsImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyDelete' => [
                ...
                'delete',
                'test_projectKey/products/importSinkKey=test_importSinkKey/resourceKey=test_resourceKey',
            ]
        ];
    }
    ...
    {
        return [
            'ByProjectKeyProductsImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyDelete_200' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->products()
            ...
            'ByProjectKeyProductsImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyDelete_599' => [
                function (ImportRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKeyValue("projectKey")
                        ->products()
