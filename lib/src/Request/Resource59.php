...
class Resource59 extends Resource
{
     ...
     * @return Resource60
     */
    public function withKey($key = null): Resource60 {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new Resource60($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return Resource61
     */
    public function withId($ID = null): Resource61 {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new Resource61($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
