...
class ResourceByProjectKeyOrdersOrderNumberByOrderNumber extends Resource
{
    /**
     ...
     */
    public function post(OrderUpdate $body = null): ByProjectKeyOrdersOrderNumberByOrderNumberPost {
        $args = $this->getArgs();
