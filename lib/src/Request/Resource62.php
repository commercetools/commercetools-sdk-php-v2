...
class Resource62 extends Resource
{
    /**
     * @return Resource63
     */
    public function withKey($key = null): Resource63 {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new Resource63($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return Resource64
     */
    public function withId($ID = null): Resource64 {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new Resource64($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
