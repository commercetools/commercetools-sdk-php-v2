...
class Resource53 extends Resource
{
     ...
     * @return Resource54
     */
    public function withKey($key = null): Resource54 {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new Resource54($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return Resource55
     */
    public function withId($ID = null): Resource55 {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new Resource55($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
