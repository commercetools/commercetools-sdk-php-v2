...
class ResourceByProjectKeyReviews extends Resource
{
    /**
     * @return ResourceByProjectKeyReviewsKeyByKey
     */
    public function withKey($key = null): ResourceByProjectKeyReviewsKeyByKey {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeyReviewsKeyByKey($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return ResourceByProjectKeyReviewsByID
     */
    public function withId($ID = null): ResourceByProjectKeyReviewsByID {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeyReviewsByID($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
