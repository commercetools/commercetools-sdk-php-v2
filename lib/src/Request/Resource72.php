...
class Resource72 extends Resource
{
     ...
     * @return Resource73
     */
    public function withKey($key = null): Resource73 {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new Resource73($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return Resource74
     */
    public function withId($ID = null): Resource74 {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new Resource74($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
