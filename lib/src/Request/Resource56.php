...
class Resource56 extends Resource
{
     ...
     * @return Resource57
     */
    public function withKey($key = null): Resource57 {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new Resource57($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return Resource58
     */
    public function withId($ID = null): Resource58 {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new Resource58($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
