...
class ResourceByProjectKeyExtensions extends Resource
{
    /**
     * @return ResourceByProjectKeyExtensionsKeyByKey
     */
    public function withKey($key = null): ResourceByProjectKeyExtensionsKeyByKey {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeyExtensionsKeyByKey($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return ResourceByProjectKeyExtensionsByID
     */
    public function withId($ID = null): ResourceByProjectKeyExtensionsByID {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeyExtensionsByID($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
