...
class ResourceByProjectKeySubscriptions extends Resource
{
    /**
     * @return ResourceByProjectKeySubscriptionsKeyByKey
     */
    public function withKey($key = null): ResourceByProjectKeySubscriptionsKeyByKey {
        $args = array_merge($this->getArgs(), array_filter(['key' => $key], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeySubscriptionsKeyByKey($this->getUri() . '/key={key}', $args, $this->getMapper());
    }
    /**
     * @return ResourceByProjectKeySubscriptionsByID
     */
    public function withId($ID = null): ResourceByProjectKeySubscriptionsByID {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeySubscriptionsByID($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
