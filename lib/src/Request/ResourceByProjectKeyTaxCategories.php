...
class ResourceByProjectKeyTaxCategories extends Resource
{
    /**
     * @return ResourceByProjectKeyTaxCategoriesByID
     */
    public function withId($ID = null): ResourceByProjectKeyTaxCategoriesByID {
        $args = array_merge($this->getArgs(), array_filter(['ID' => $ID], function($value) { return !is_null($value); }));
        return new ResourceByProjectKeyTaxCategoriesByID($this->getUri() . '/{ID}', $args, $this->getMapper());
    }
