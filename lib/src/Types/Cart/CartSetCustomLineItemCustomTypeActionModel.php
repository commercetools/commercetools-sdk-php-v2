...
class CartSetCustomLineItemCustomTypeActionModel extends CartUpdateActionModel implements CartSetCustomLineItemCustomTypeAction {
    ...
    public function getCustomLineItemId()
    {
        if (is_null($this->customLineItemId)) {
            $value = $this->raw(CartSetCustomLineItemCustomTypeAction::FIELD_CUSTOM_LINE_ITEM_ID);
            $value = (string)$value;
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            $value = $this->raw(CartSetCustomLineItemCustomTypeAction::FIELD_FIELDS);
            $value = (string)$value;
            $this->fields = $value;
        }
        return $this->fields;
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            $value = $this->raw(CartSetCustomLineItemCustomTypeAction::FIELD_TYPE);
            if (is_null($value)) {
