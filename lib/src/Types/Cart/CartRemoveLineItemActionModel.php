...
class CartRemoveLineItemActionModel extends CartUpdateActionModel implements CartRemoveLineItemAction
{
    ...
    public function getLineItemId()
    {
        if (is_null($this->lineItemId)) {
            $value = $this->raw(CartRemoveLineItemAction::FIELD_LINE_ITEM_ID);
            $value = (string)$value;
    ...
    public function getQuantity()
    {
        if (is_null($this->quantity)) {
            $value = $this->raw(CartRemoveLineItemAction::FIELD_QUANTITY);
            $value = (int)$value;
            $this->quantity = $value;
        }
    ...
    public function getExternalPrice()
    {
        if (is_null($this->externalPrice)) {
            $value = $this->raw(CartRemoveLineItemAction::FIELD_EXTERNAL_PRICE);
            if (is_null($value)) {
    ...
    public function getExternalTotalPrice()
    {
        if (is_null($this->externalTotalPrice)) {
            $value = $this->raw(CartRemoveLineItemAction::FIELD_EXTERNAL_TOTAL_PRICE);
            if (is_null($value)) {
