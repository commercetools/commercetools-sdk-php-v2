...
class CartAddLineItemActionModel extends CartUpdateActionModel implements CartAddLineItemAction {
    ...
    public function getCustom()
    {
        if (is_null($this->custom)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_CUSTOM);
            if (is_null($value)) {
    ...
    public function getDistributionChannel()
    {
        if (is_null($this->distributionChannel)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_DISTRIBUTION_CHANNEL);
            if (is_null($value)) {
    ...
    public function getExternalTaxRate()
    {
        if (is_null($this->externalTaxRate)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_EXTERNAL_TAX_RATE);
            if (is_null($value)) {
    ...
    public function getProductId()
    {
        if (is_null($this->productId)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_PRODUCT_ID);
            $value = (string)$value;
    ...
    public function getVariantId()
    {
        if (is_null($this->variantId)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_VARIANT_ID);
            $value = (int)$value;
    ...
    {
        if (is_null($this->sku)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_SKU);
            $value = (string)$value;
            $this->sku = $value;
        }
        return $this->sku;
    ...
    public function getQuantity()
    {
        if (is_null($this->quantity)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_QUANTITY);
            $value = (int)$value;
            $this->quantity = $value;
        }
    ...
    public function getSupplyChannel()
    {
        if (is_null($this->supplyChannel)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_SUPPLY_CHANNEL);
            if (is_null($value)) {
                return $this->mapData(ChannelReference::class, null);
            }
            $value = $this->mapData(ChannelReference::class, $value);
    ...
    public function getExternalPrice()
    {
        if (is_null($this->externalPrice)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_EXTERNAL_PRICE);
            if (is_null($value)) {
    ...
    public function getExternalTotalPrice()
    {
        if (is_null($this->externalTotalPrice)) {
            $value = $this->raw(CartAddLineItemAction::FIELD_EXTERNAL_TOTAL_PRICE);
            if (is_null($value)) {
