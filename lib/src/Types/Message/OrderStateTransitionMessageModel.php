...
class OrderStateTransitionMessageModel extends MessageModel implements OrderStateTransitionMessage {
    ...
    public function getState()
    {
        if (is_null($this->state)) {
            $value = $this->raw(OrderStateTransitionMessage::FIELD_STATE);
            if (is_null($value)) {
    ...
    public function getForce()
    {
        if (is_null($this->force)) {
            $value = $this->raw(OrderStateTransitionMessage::FIELD_FORCE);
            $this->force = $value;
        }
        return $this->force;
    }
