...
interface Message extends JsonObject {
    ...
    const SUB_TYPES = [
        ...
        'CustomerAddressAdded' => Types\Message\CustomerAddressAddedMessage::class,
        'CustomerAddressChanged' => Types\Message\CustomerAddressChangedMessage::class,
        'CustomerAddressRemoved' => Types\Message\CustomerAddressRemovedMessage::class,
        'CustomerCompanyNameSet' => Types\Message\CustomerCompanyNameSetMessage::class,
        'CustomerCreated' => Types\Message\CustomerCreatedMessage::class,
        'CustomerDateOfBirthSet' => Types\Message\CustomerDateOfBirthSetMessage::class,
        'CustomerEmailChanged' => Types\Message\CustomerEmailChangedMessage::class,
        'CustomerEmailVerified' => Types\Message\CustomerEmailVerifiedMessage::class,
        'CustomerGroupSet' => Types\Message\CustomerGroupSetMessage::class,
