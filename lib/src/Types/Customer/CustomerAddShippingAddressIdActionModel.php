...
class CustomerAddShippingAddressIdActionModel extends CustomerUpdateActionModel implements CustomerAddShippingAddressIdAction {
    ...
    public function getAddressId()
    {
        if (is_null($this->addressId)) {
            $value = $this->raw(CustomerAddShippingAddressIdAction::FIELD_ADDRESS_ID);
            $value = (string)$value;
