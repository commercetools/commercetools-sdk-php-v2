...
class TaxRateDraftModel extends JsonObjectModel implements TaxRateDraft {
    ...
    public function getName()
    {
        if (is_null($this->name)) {
            $value = $this->raw(TaxRateDraft::FIELD_NAME);
            $value = (string)$value;
            $this->name = $value;
        }
        return $this->name;
    ...
    public function getAmount()
    {
        if (is_null($this->amount)) {
            $value = $this->raw(TaxRateDraft::FIELD_AMOUNT);
            $value = (int)$value;
            $this->amount = $value;
        }
        return $this->amount;
    ...
    public function getIncludedInPrice()
    {
        if (is_null($this->includedInPrice)) {
            $value = $this->raw(TaxRateDraft::FIELD_INCLUDED_IN_PRICE);
    ...
    public function getCountry()
    {
        if (is_null($this->country)) {
            $value = $this->raw(TaxRateDraft::FIELD_COUNTRY);
            $value = (string)$value;
            $this->country = $value;
        }
        return $this->country;
    ...
    public function getState()
    {
        if (is_null($this->state)) {
            $value = $this->raw(TaxRateDraft::FIELD_STATE);
            $value = (string)$value;
            $this->state = $value;
        }
        return $this->state;
    ...
    public function getSubRates()
    {
        if (is_null($this->subRates)) {
            $value = $this->raw(TaxRateDraft::FIELD_SUB_RATES);
            if (is_null($value)) {
