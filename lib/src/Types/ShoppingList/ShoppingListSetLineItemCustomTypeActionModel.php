...
class ShoppingListSetLineItemCustomTypeActionModel extends ShoppingListUpdateActionModel implements ShoppingListSetLineItemCustomTypeAction
{
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            $value = $this->raw(ShoppingListSetLineItemCustomTypeAction::FIELD_FIELDS);
            $value = (string)$value;
            $this->fields = $value;
        }
        return $this->fields;
    ...
    public function getLineItemId()
    {
        if (is_null($this->lineItemId)) {
            $value = $this->raw(ShoppingListSetLineItemCustomTypeAction::FIELD_LINE_ITEM_ID);
            $value = (string)$value;
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            $value = $this->raw(ShoppingListSetLineItemCustomTypeAction::FIELD_TYPE);
            if (is_null($value)) {
