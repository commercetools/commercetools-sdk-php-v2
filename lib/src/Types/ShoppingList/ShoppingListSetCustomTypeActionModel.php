...
class ShoppingListSetCustomTypeActionModel extends ShoppingListUpdateActionModel implements ShoppingListSetCustomTypeAction
{
    ...
    public function getFields()
    {
        if (is_null($this->fields)) {
            $value = $this->raw(ShoppingListSetCustomTypeAction::FIELD_FIELDS);
            $value = (string)$value;
            $this->fields = $value;
        }
        return $this->fields;
    ...
    public function getType()
    {
        if (is_null($this->type)) {
            $value = $this->raw(ShoppingListSetCustomTypeAction::FIELD_TYPE);
            if (is_null($value)) {
