 ...
 * @covers \Commercetools\Api\Client\Resource\ResourceByProjectKeyMePaymentKeyByKey
 */
class ResourceByProjectKeyMePaymentKeyByKeyTest extends TestCase
{
    ...
    public function getRequests()
    {
        return [
            'ByProjectKeyMePaymentKeyByKeyPost' => [
                ...
                'post',
                'test_projectKey/me/payment/key=test_key',
            ]
        ];
    }
    ...
    {
        return [
            'ByProjectKeyMePaymentKeyByKeyPost_599' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
