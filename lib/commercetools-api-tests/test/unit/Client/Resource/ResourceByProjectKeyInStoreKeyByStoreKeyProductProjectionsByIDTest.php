...
use Commercetools\Api\Client\Resource\ResourceByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDVariantAttributes;
...
class ResourceByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDTest extends TestCase
{
    ...
    {
        return [
            'ResourceByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDVariantAttributes' => [
                function (ApiRequestBuilder $builder): ResourceByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDVariantAttributes {
                    return $builder
                        ->withProjectKey("test_projectKey")
                        ->inStoreKeyWithStoreKeyValue("test_storeKey")
                        ->productProjections()
                ...
                ResourceByProjectKeyInStoreKeyByStoreKeyProductProjectionsByIDVariantAttributes::class,
