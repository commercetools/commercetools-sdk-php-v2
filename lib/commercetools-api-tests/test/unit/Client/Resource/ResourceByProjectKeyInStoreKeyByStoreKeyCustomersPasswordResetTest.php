 ...
 * @covers \Commercetools\Api\Client\Resource\ResourceByProjectKeyInStoreKeyByStoreKeyCustomersPasswordReset
 */
class ResourceByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetTest extends TestCase
{
    ...
    {
        return [
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost_200' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost_400' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost_502' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordResetPost_503' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
