 ...
 * @covers \Commercetools\Api\Client\Resource\ResourceByProjectKeyMePasswordReset
 */
class ResourceByProjectKeyMePasswordResetTest extends TestCase
{
    ...
    {
        return [
            'ByProjectKeyMePasswordResetPost_200' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
            ...
            'ByProjectKeyMePasswordResetPost_400' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
            ...
            'ByProjectKeyMePasswordResetPost_403' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
            ...
            'ByProjectKeyMePasswordResetPost_502' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
            ...
            'ByProjectKeyMePasswordResetPost_503' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
            ...
            'ByProjectKeyMePasswordResetPost_599' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->me()
