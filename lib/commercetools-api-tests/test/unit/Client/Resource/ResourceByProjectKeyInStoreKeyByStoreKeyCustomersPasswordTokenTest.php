 ...
 * @covers \Commercetools\Api\Client\Resource\ResourceByProjectKeyInStoreKeyByStoreKeyCustomersPasswordToken
 */
class ResourceByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenTest extends TestCase
{
    ...
    public function getRequestBuilderResponses()
    {
        return [
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost_401' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost_403' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost_404' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
            ...
            'ByProjectKeyInStoreKeyByStoreKeyCustomersPasswordTokenPost_500' => [
                function (ApiRequestBuilder $builder): RequestInterface {
                    return $builder
                        ->withProjectKey("projectKey")
                        ->inStoreKeyWithStoreKeyValue("storeKey")
