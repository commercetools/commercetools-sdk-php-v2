 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductDraftsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductDraftsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-drafts/import-containers/{importContainerKey}');
