...
class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/prices/importSinkKey={importSinkKey}/import-items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportItemsGet
    {
