 ...
 */
class ResourceByProjectKeyOrderPatchesImportContainers extends ApiResource
{
    /**
    ...
    public function withImportContainerKeyValue(?string $importContainerKey = null): ResourceByProjectKeyOrderPatchesImportContainersByImportContainerKey
    {
        ...
        return new ResourceByProjectKeyOrderPatchesImportContainersByImportContainerKey($args, $this->getClient());
    }
}
