 ...
 * @template-implements SecuredByManageCustomers<ByProjectKeyCustomersImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyCustomersImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageCustomers
{
    /**
