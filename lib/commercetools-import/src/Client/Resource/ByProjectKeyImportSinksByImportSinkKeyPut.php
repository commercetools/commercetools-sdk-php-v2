 ...
 * @template-implements SecuredByManageImportSinks<ByProjectKeyImportSinksByImportSinkKeyPut>
 */
class ByProjectKeyImportSinksByImportSinkKeyPut extends ApiRequest implements SecuredByManageImportSinks
{
    /**
