 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductVariantsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-variants/import-containers/{importContainerKey}');
