 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/products/import-containers/{importContainerKey}');
