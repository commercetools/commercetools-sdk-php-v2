 ...
 * @template-implements SecuredByManageOrders<ByProjectKeyOrdersImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyOrdersImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageOrders
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/orders/import-containers/{importContainerKey}');
