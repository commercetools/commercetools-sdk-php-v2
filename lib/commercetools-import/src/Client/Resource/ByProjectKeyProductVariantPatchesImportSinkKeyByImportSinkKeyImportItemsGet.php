...
class ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/product-variant-patches/importSinkKey={importSinkKey}/import-items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportItemsGet
    {
