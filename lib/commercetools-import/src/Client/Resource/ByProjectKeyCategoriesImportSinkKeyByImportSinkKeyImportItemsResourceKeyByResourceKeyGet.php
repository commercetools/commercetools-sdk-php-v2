...
class ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyImportItemsResourceKeyByResourceKeyGet extends ApiRequest
{
    /**
     * @param ?object $body
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '{projectKey}/categories/importSinkKey={importSinkKey}/import-items/resourceKey={resourceKey}');
