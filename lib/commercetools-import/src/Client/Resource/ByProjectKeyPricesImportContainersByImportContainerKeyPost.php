 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyPricesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyPricesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/prices/import-containers/{importContainerKey}');
