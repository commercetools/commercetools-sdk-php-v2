 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/product-types/importSinkKey={importSinkKey}/import-operations');
     ...
     */
    public function withSort($sort): ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
