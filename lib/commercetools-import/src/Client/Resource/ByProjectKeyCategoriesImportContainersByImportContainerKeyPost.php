...
class ByProjectKeyCategoriesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/categories/import-containers/{importContainerKey}');
