 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsByIdGet>
 */
class ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportOperationsByIdGet extends ApiRequest implements SecuredByViewProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{id}'], [$projectKey, $importSinkKey, $id], '{projectKey}/product-types/importSinkKey={importSinkKey}/import-operations/{id}');
