...
class ByProjectKeyImportSinksByImportSinkKeyItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '/{projectKey}/import-sinks/{importSinkKey}/items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyImportSinksByImportSinkKeyItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyImportSinksByImportSinkKeyItemsGet
    {
