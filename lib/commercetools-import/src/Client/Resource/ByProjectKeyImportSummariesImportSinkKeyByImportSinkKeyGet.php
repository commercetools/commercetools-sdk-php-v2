...
use Models\Importsummaries\ImportSummary;
use Models\Importsummaries\ImportSummaryModel;
...
class ByProjectKeyImportSummariesImportSinkKeyByImportSinkKeyGet extends ApiRequest
{
    /**
     * @param ?object $body
