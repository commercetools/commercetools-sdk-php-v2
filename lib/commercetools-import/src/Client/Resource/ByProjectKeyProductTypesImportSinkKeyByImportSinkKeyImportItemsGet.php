...
class ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/product-types/importSinkKey={importSinkKey}/import-items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyProductTypesImportSinkKeyByImportSinkKeyImportItemsGet
    {
