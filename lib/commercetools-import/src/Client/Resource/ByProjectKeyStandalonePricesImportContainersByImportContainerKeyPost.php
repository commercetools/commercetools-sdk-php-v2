 ...
 * @template-implements SecuredByManageStandalonePrices<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageStandalonePrices
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/standalone-prices/import-containers/{importContainerKey}');
