...
class ByProjectKeyProductVariantPatchesImportSinkKeyByImportSinkKeyImportItemsResourceKeyByResourceKeyGet extends ApiRequest
{
    /**
     * @param ?object $body
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '{projectKey}/product-variant-patches/importSinkKey={importSinkKey}/import-items/resourceKey={resourceKey}');
