 ...
 * @template-implements SecuredByViewImportContainers<ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet>
 */
class ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet extends ApiRequest implements SecuredByViewImportContainers
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/import-containers/{importContainerKey}/import-operations');
     ...
     */
    public function withLimit($limit): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
     ...
     */
    public function withOffset($offset): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
     ...
     */
    public function withSort($sort): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
     ...
     */
    public function withResourceKey($resourceKey): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
     ...
     */
    public function withState($state): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyImportContainersByImportContainerKeyImportOperationsGet
    {
