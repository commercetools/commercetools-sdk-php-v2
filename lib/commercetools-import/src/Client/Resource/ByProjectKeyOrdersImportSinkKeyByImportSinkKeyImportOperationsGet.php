...
class ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest
{
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/orders/importSinkKey={importSinkKey}/import-operations');
     ...
     */
    public function withLimit($limit): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withOffset($offset): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withSort($sort): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withResourceKey($resourceKey): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withState($state): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyOrdersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
