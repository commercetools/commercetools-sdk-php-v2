...
class ByProjectKeyInventoriesImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyDelete extends ApiRequest
{
    /**
     * @param ?object $body
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '{projectKey}/inventories/importSinkKey={importSinkKey}/resourceKey={resourceKey}');
