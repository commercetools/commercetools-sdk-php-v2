...
class ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/products/importSinkKey={importSinkKey}/import-items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportItemsGet
    {
