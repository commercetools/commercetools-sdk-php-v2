...
class ByProjectKeyImportSinksByImportSinkKeyItemsByResourceKeyGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '/{projectKey}/import-sinks/{importSinkKey}/items/{resourceKey}');
