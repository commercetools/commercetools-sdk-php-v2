 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/products/importSinkKey={importSinkKey}/import-operations');
     ...
     */
    public function withSort($sort): ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsGet
    {
