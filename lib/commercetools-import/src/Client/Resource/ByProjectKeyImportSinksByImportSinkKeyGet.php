 ...
 * @template-implements SecuredByViewImportSinks<ByProjectKeyImportSinksByImportSinkKeyGet>
 */
class ByProjectKeyImportSinksByImportSinkKeyGet extends ApiRequest implements SecuredByViewImportSinks
{
    /**
