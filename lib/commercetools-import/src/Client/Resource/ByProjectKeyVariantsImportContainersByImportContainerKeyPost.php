 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyVariantsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyVariantsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/variants/import-containers/{importContainerKey}');
