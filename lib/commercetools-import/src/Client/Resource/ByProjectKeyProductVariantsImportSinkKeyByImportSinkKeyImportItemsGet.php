...
class ByProjectKeyProductVariantsImportSinkKeyByImportSinkKeyImportItemsGet extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/product-variants/importSinkKey={importSinkKey}/import-items');
     ...
     * @param mixed $limit
     */
    public function withLimit($limit): ByProjectKeyProductVariantsImportSinkKeyByImportSinkKeyImportItemsGet
    {
     ...
     * @param mixed $offset
     */
    public function withOffset($offset): ByProjectKeyProductVariantsImportSinkKeyByImportSinkKeyImportItemsGet
    {
