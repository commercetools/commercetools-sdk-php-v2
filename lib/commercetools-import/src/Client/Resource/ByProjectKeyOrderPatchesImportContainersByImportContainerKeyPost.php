 ...
 * @template-implements SecuredByManageOrders<ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyOrderPatchesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageOrders
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/order-patches/import-containers/{importContainerKey}');
