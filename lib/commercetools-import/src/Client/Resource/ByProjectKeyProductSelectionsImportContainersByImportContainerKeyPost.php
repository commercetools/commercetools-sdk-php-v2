 ...
 * @template-implements SecuredByManageProductSelections<ByProjectKeyProductSelectionsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductSelectionsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProductSelections
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-selections/import-containers/{importContainerKey}');
