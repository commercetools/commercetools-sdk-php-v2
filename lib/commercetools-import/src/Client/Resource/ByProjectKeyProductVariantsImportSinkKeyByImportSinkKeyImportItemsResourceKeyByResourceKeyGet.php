...
class ByProjectKeyProductVariantsImportSinkKeyByImportSinkKeyImportItemsResourceKeyByResourceKeyGet extends ApiRequest
{
    /**
     * @param ?object $body
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '{projectKey}/product-variants/importSinkKey={importSinkKey}/import-items/resourceKey={resourceKey}');
