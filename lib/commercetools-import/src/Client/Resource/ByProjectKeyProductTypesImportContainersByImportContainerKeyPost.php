 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductTypesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductTypesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-types/import-containers/{importContainerKey}');
