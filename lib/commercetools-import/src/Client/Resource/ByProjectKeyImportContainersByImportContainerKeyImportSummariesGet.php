 ...
 * @template-implements SecuredByViewImportContainers<ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet>
 */
class ByProjectKeyImportContainersByImportContainerKeyImportSummariesGet extends ApiRequest implements SecuredByViewImportContainers
{
    /**
     ...
     * @return ImportSummary|JsonObject|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = ImportSummaryModel::class;
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|ImportSummary|JsonObject
     */
