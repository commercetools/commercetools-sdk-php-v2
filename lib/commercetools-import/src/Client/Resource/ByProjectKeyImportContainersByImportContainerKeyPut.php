...
use Commercetools\Import\Models\Importcontainers\ImportContainerModel;
 ...
 * @template-implements SecuredByManageImportContainers<ByProjectKeyImportContainersByImportContainerKeyPut>
 */
class ByProjectKeyImportContainersByImportContainerKeyPut extends ApiRequest implements SecuredByManageImportContainers
{
    /**
    ...
    public function __construct(string $projectKey, string $importContainerKey, $body = null, array $headers = [], ClientInterface $client = null)
    {
        ...
        parent::__construct($client, 'PUT', $uri, $headers, is_object($body) || is_array($body) ? json_encode($body) : $body);
    }

    /**
     * @template T of JsonObject
     * @psalm-param ?class-string<T> $resultType
     * @return ErrorResponse|ImportContainer|JsonObject|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = ImportContainerModel::class;
