...
class ByProjectKeyPricesImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyDelete extends ApiRequest
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{resourceKey}'], [$projectKey, $importSinkKey, $resourceKey], '{projectKey}/prices/importSinkKey={importSinkKey}/resourceKey={resourceKey}');
