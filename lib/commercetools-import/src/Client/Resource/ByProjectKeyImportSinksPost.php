 ...
 * @template-implements SecuredByManageImportSinks<ByProjectKeyImportSinksPost>
 */
class ByProjectKeyImportSinksPost extends ApiRequest implements SecuredByManageImportSinks
{
    /**
