 ...
 * @template-implements SecuredByManageDiscountCodes<ByProjectKeyDiscountCodesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyDiscountCodesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageDiscountCodes
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/discount-codes/import-containers/{importContainerKey}');
