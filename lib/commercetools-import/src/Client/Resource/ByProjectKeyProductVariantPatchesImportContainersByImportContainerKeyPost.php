 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductVariantPatchesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductVariantPatchesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-variant-patches/import-containers/{importContainerKey}');
