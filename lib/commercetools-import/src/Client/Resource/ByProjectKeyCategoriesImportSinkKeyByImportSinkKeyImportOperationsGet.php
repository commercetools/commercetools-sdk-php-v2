 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewProducts
{
    /**
     ...
     */
    public function withSort($sort): ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
