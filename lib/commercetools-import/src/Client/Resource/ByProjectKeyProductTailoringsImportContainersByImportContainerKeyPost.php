 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyProductTailoringsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyProductTailoringsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/product-tailorings/import-containers/{importContainerKey}');
