 ...
 * @template-implements SecuredByManageProducts<ByProjectKeyInventoriesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyInventoriesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/inventories/import-containers/{importContainerKey}');
