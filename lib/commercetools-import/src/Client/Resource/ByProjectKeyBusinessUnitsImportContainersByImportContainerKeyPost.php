 ...
 * @template-implements SecuredByManageBusinessUnits<ByProjectKeyBusinessUnitsImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyBusinessUnitsImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageBusinessUnits
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/business-units/import-containers/{importContainerKey}');
