 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdGet>
 */
class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsByIdGet extends ApiRequest implements SecuredByViewProducts
{
    /**
