 ...
 * @template-implements SecuredByViewCustomers<ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewCustomers
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}'], [$projectKey, $importSinkKey], '{projectKey}/customers/importSinkKey={importSinkKey}/import-operations');
     ...
     */
    public function withLimit($limit): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withOffset($offset): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withSort($sort): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withResourceKey($resourceKey): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withState($state): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyCustomersImportSinkKeyByImportSinkKeyImportOperationsGet
    {
