 ...
 * @template-implements SecuredByManageTypes<ByProjectKeyTypesImportContainersByImportContainerKeyPost>
 */
class ByProjectKeyTypesImportContainersByImportContainerKeyPost extends ApiRequest implements SecuredByManageTypes
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importContainerKey}'], [urlencode($projectKey), urlencode($importContainerKey)], '{projectKey}/types/import-containers/{importContainerKey}');
