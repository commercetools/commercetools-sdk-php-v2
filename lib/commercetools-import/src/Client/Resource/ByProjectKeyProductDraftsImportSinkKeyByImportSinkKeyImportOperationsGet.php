 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewProducts
{
    /**
