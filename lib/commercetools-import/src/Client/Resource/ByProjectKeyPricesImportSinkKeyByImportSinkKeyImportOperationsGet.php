 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet>
 */
class ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet extends ApiRequest implements SecuredByViewProducts
{
    /**
     ...
     */
    public function withSort($sort): ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
     ...
     */
    public function withDebug($debug): ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsGet
    {
