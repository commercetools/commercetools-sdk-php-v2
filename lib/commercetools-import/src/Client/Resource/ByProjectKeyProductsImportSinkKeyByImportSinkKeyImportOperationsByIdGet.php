 ...
 * @template-implements SecuredByViewProducts<ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsByIdGet>
 */
class ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsByIdGet extends ApiRequest implements SecuredByViewProducts
{
    /**
    ...
    {
        $uri = str_replace(['{projectKey}', '{importSinkKey}', '{id}'], [$projectKey, $importSinkKey, $id], '{projectKey}/products/importSinkKey={importSinkKey}/import-operations/{id}');
