 ...
 * @internal
 */
final class TypeImportRequestModel extends JsonObjectModel implements TypeImportRequest
{
    ...
    public function __construct(
        ?TypeImportCollection $resources = null,
        ?string $type = null
    ) {
    ...
    public function getResources()
    {
        if (is_null($this->resources)) {
            ...
            $this->resources = TypeImportCollection::fromArray($data);
        }
