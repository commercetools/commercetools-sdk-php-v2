 ...
 * @internal
 */
final class ProductTailoringImportRequestModel extends JsonObjectModel implements ProductTailoringImportRequest
{
    ...
    public function __construct(
        ?ProductTailoringImportCollection $resources = null,
        ?string $type = null
    ) {
    ...
    public function getResources()
    {
        if (is_null($this->resources)) {
            ...
            $this->resources = ProductTailoringImportCollection::fromArray($data);
        }
