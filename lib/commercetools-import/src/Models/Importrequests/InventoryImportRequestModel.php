 ...
 * @internal
 */
final class InventoryImportRequestModel extends JsonObjectModel implements InventoryImportRequest
{
    ...
    public function getResources()
    {
        if (is_null($this->resources)) {
            ...
            $this->resources = InventoryImportCollection::fromArray($data);
        }
