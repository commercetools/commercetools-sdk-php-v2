...
use Commercetools\Import\Models\Common\BusinessUnitKeyReferenceBuilder;
...
/**
 * @implements Builder<DivisionBusinessUnitImport>
 */
final class DivisionBusinessUnitImportBuilder implements Builder
{
    /**
    ...
    public function build(): DivisionBusinessUnitImport
    {
        return new DivisionBusinessUnitImportModel(
            $this->key,
            $this->name,
            $this->status,
            $this->contactEmail,
    ...
    public static function of(): DivisionBusinessUnitImportBuilder
    {
        return new self();
    }
}
