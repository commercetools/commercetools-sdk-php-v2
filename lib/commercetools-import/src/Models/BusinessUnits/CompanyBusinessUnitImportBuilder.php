...
/**
 * @implements Builder<CompanyBusinessUnitImport>
 */
final class CompanyBusinessUnitImportBuilder implements Builder
{
    /**
    ...
    public function build(): CompanyBusinessUnitImport
    {
        return new CompanyBusinessUnitImportModel(
            $this->key,
            $this->name,
            $this->status,
            $this->contactEmail,
    ...
    public static function of(): CompanyBusinessUnitImportBuilder
    {
        return new self();
    }
}
