 ...
 */
final class ReferencedResourceNotFoundBuilder implements Builder
{
    /**
    ...
    public function build(): ReferencedResourceNotFound
    {
        return new ReferencedResourceNotFoundModel(
            $this->message,
            $this->typeId,
            $this->id,
            $this->key
    ...
    public static function of(): ReferencedResourceNotFoundBuilder
    {
        return new self();
    }
}
