...
/**
 * @implements Builder<AnyAttribute>
 */
final class AnyAttributeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AnyAttribute
    {
        return new AnyAttributeModel(
            $this->name,
            $this->type,
            $this->value
        );
    ...
    public static function of(): AnyAttributeBuilder
    {
        return new self();
    }
}
