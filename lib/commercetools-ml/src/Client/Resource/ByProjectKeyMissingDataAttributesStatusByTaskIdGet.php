...
use Commercetools\Ml\Models\MissingData\MissingDataTaskStatus;
use Commercetools\Ml\Models\MissingData\MissingDataTaskStatusModel;
...
class ByProjectKeyMissingDataAttributesStatusByTaskIdGet extends ApiRequest
{
    ...
    {
        $uri = str_replace(['{projectKey}', '{taskId}'], [$projectKey, $taskId], '{projectKey}/missing-data/attributes/status/{taskId}');
     ...
     * @return JsonObject|MissingDataTaskStatus|T|null
     */
    public function mapFromResponse(?ResponseInterface $response, string $resultType = null)
    {
        ...
        if (is_null($resultType)) {
            switch ($response->getStatusCode()) {
                case '200':
                    $resultType = MissingDataTaskStatusModel::class;
     ...
     * @psalm-param ?class-string<T> $resultType
     *
     * @return null|T|JsonObject|MissingDataTaskStatus
     */
