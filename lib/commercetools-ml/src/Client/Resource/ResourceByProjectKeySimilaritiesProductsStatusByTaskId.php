 ...
 */
class ResourceByProjectKeySimilaritiesProductsStatusByTaskId extends ApiResource
{
    /**
     ...
     */
    public function get($body = null, array $headers = []): ByProjectKeySimilaritiesProductsStatusByTaskIdGet
    {
        $args = $this->getArgs();
