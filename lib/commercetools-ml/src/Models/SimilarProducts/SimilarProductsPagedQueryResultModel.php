...
final class SimilarProductsPagedQueryResultModel extends JsonObjectModel implements SimilarProductsPagedQueryResult
{
    ...
    public function getCount()
    {
        if (is_null($this->count)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(SimilarProductsPagedQueryResult::FIELD_COUNT);
            if (is_null($data)) {
                return null;
            }
            $this->count = (int) $data;
    ...
    public function getTotal()
    {
        if (is_null($this->total)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(SimilarProductsPagedQueryResult::FIELD_TOTAL);
            if (is_null($data)) {
                return null;
            }
            $this->total = (int) $data;
    ...
    public function getOffset()
    {
        if (is_null($this->offset)) {
            /** @psalm-var ?int $data */
            $data = $this->raw(SimilarProductsPagedQueryResult::FIELD_OFFSET);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getResults()
    {
        if (is_null($this->results)) {
            ...
            $data = $this->raw(SimilarProductsPagedQueryResult::FIELD_RESULTS);
            if (is_null($data)) {
                return null;
            }
    ...
    public function getMeta()
    {
        if (is_null($this->meta)) {
            ...
            $data = $this->raw(SimilarProductsPagedQueryResult::FIELD_META);
            if (is_null($data)) {
                return null;
            }
