...
class ByProjectKeyByResourceTypeGet extends ApiRequest
{
     ...
     */
    public function withUserIds($userIds): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withResourceIds($resourceIds): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withAssociateId($associateId): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withBusinessUnit($businessUnit): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withResourceKey($resourceKey): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withStores($stores): ByProjectKeyByResourceTypeGet
    {
     ...
     */
    public function withWithTotal($withTotal): ByProjectKeyByResourceTypeGet
    {
