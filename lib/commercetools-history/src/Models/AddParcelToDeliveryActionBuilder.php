...
/**
 * @implements Builder<AddParcelToDeliveryAction>
 */
final class AddParcelToDeliveryActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddParcelToDeliveryAction
    {
        return new AddParcelToDeliveryActionModel(
            $this->change,
            $this->deliveryId,
    ...
    public static function of(): AddParcelToDeliveryActionBuilder
    {
        return new self();
    }
}
