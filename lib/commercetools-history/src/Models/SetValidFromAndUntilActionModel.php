 ...
 * @internal
 */
final class SetValidFromAndUntilActionModel extends JsonObjectModel implements SetValidFromAndUntilAction
{
    public const DISCRIMINATOR_VALUE = 'SetValidFromAndUntilAction';
    /**
     * @var ?string
     */
    protected $type;
