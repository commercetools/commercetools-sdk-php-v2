 ...
 * @internal
 */
final class RemoveCustomLineItemActionModel extends JsonObjectModel implements RemoveCustomLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveCustomLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
