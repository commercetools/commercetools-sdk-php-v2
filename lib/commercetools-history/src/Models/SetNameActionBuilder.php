...
/**
 * @implements Builder<SetNameAction>
 */
final class SetNameActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetNameAction
    {
        return new SetNameActionModel(
            $this->change,
    ...
    public static function of(): SetNameActionBuilder
    {
        return new self();
    }
}
