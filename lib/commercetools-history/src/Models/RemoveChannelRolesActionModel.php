 ...
 * @internal
 */
final class RemoveChannelRolesActionModel extends JsonObjectModel implements RemoveChannelRolesAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveChannelRolesAction';
    /**
     * @var ?string
     */
    protected $type;
