...
/**
 * @implements Builder<SetBillingAddressAction>
 */
final class SetBillingAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetBillingAddressAction
    {
        return new SetBillingAddressActionModel(
            $this->change,
    ...
    public static function of(): SetBillingAddressActionBuilder
    {
        return new self();
    }
}
