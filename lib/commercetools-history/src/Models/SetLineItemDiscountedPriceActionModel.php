 ...
 * @internal
 */
final class SetLineItemDiscountedPriceActionModel extends JsonObjectModel implements SetLineItemDiscountedPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemDiscountedPriceAction';
    /**
     * @var ?string
     */
    protected $type;
