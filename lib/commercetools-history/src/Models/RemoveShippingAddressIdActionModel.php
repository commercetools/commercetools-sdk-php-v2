 ...
 * @internal
 */
final class RemoveShippingAddressIdActionModel extends JsonObjectModel implements RemoveShippingAddressIdAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveShippingAddressIdAction';
    /**
     * @var ?string
     */
    protected $type;
