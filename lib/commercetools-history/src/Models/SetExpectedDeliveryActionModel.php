 ...
 * @internal
 */
final class SetExpectedDeliveryActionModel extends JsonObjectModel implements SetExpectedDeliveryAction
{
    public const DISCRIMINATOR_VALUE = 'SetExpectedDeliveryAction';
    /**
     * @var ?string
     */
    protected $type;
