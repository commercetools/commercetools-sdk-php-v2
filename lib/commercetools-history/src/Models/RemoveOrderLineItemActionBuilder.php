...
/**
 * @implements Builder<RemoveOrderLineItemAction>
 */
final class RemoveOrderLineItemActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveOrderLineItemAction
    {
        return new RemoveOrderLineItemActionModel(
            $this->change,
    ...
    public static function of(): RemoveOrderLineItemActionBuilder
    {
        return new self();
    }
}
