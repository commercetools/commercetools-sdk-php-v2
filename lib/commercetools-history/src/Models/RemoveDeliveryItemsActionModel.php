 ...
 * @internal
 */
final class RemoveDeliveryItemsActionModel extends JsonObjectModel implements RemoveDeliveryItemsAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveDeliveryItemsAction';
    /**
     * @var ?string
     */
    protected $type;
