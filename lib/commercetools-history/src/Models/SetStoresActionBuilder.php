...
/**
 * @implements Builder<SetStoresAction>
 */
final class SetStoresActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetStoresAction
    {
        return new SetStoresActionModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): SetStoresActionBuilder
    {
        return new self();
    }
}
