...
/**
 * @implements Builder<SetTargetAction>
 */
final class SetTargetActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetTargetAction
    {
        return new SetTargetActionModel(
            $this->change,
    ...
    public static function of(): SetTargetActionBuilder
    {
        return new self();
    }
}
