 ...
 * @internal
 */
final class SetDefaultShippingAddressActionModel extends JsonObjectModel implements SetDefaultShippingAddressAction
{
    public const DISCRIMINATOR_VALUE = 'SetDefaultShippingAddressAction';
    /**
     * @var ?string
     */
    protected $type;
