 ...
 * @internal
 */
final class ChangeCartPredicateActionModel extends JsonObjectModel implements ChangeCartPredicateAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeCartPredicateAction';
    /**
     * @var ?string
     */
    protected $type;
