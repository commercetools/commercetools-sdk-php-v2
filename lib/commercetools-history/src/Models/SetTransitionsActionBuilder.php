...
/**
 * @implements Builder<SetTransitionsAction>
 */
final class SetTransitionsActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetTransitionsAction
    {
        return new SetTransitionsActionModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): SetTransitionsActionBuilder
    {
        return new self();
    }
}
