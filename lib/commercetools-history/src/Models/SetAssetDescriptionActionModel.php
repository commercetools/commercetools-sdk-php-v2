 ...
 * @internal
 */
final class SetAssetDescriptionActionModel extends JsonObjectModel implements SetAssetDescriptionAction
{
    public const DISCRIMINATOR_VALUE = 'SetAssetDescriptionAction';
    /**
     * @var ?string
     */
    protected $type;
