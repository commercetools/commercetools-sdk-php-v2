 ...
 * @internal
 */
final class AddReturnInfoActionModel extends JsonObjectModel implements AddReturnInfoAction
{
    public const DISCRIMINATOR_VALUE = 'AddReturnInfoAction';
    /**
     * @var ?string
     */
    protected $type;
