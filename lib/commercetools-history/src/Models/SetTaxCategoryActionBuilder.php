...
/**
 * @implements Builder<SetTaxCategoryAction>
 */
final class SetTaxCategoryActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetTaxCategoryAction
    {
        return new SetTaxCategoryActionModel(
            $this->change,
    ...
    public static function of(): SetTaxCategoryActionBuilder
    {
        return new self();
    }
}
