 ...
 * @internal
 */
final class SetStatusInterfaceCodeChangeModel extends JsonObjectModel implements SetStatusInterfaceCodeChange
{
    public const DISCRIMINATOR_VALUE = 'SetStatusInterfaceCodeChange';
    /**
     * @var ?string
     */
    protected $type;
