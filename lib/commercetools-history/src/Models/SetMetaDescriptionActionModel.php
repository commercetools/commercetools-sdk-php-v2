 ...
 * @internal
 */
final class SetMetaDescriptionActionModel extends JsonObjectModel implements SetMetaDescriptionAction
{
    public const DISCRIMINATOR_VALUE = 'SetMetaDescriptionAction';
    /**
     * @var ?string
     */
    protected $type;
