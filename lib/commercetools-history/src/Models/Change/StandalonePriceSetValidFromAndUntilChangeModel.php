 ...
 * @internal
 */
final class StandalonePriceSetValidFromAndUntilChangeModel extends JsonObjectModel implements StandalonePriceSetValidFromAndUntilChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceSetValidFromAndUntilChange';
    /**
     *
     * @var ?string
     */
