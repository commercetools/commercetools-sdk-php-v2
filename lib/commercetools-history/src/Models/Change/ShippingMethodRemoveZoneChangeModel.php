 ...
 * @internal
 */
final class ShippingMethodRemoveZoneChangeModel extends JsonObjectModel implements ShippingMethodRemoveZoneChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodRemoveZoneChange';
    /**
     *
     * @var ?string
     */
