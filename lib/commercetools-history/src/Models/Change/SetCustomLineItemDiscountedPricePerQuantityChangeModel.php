 ...
 * @internal
 */
final class SetCustomLineItemDiscountedPricePerQuantityChangeModel extends JsonObjectModel implements SetCustomLineItemDiscountedPricePerQuantityChange
{

    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemDiscountedPricePerQuantityChange';
    /**
     *
     * @var ?string
     */
