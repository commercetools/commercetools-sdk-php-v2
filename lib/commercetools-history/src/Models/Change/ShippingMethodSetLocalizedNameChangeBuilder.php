...
/**
 * @implements Builder<ShippingMethodSetLocalizedNameChange>
 */
final class ShippingMethodSetLocalizedNameChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodSetLocalizedNameChange
    {
        return new ShippingMethodSetLocalizedNameChangeModel(
            $this->change,
    ...
    public static function of(): ShippingMethodSetLocalizedNameChangeBuilder
    {
        return new self();
    }
}
