 ...
 * @internal
 */
final class ShippingMethodChangeIsDefaultChangeModel extends JsonObjectModel implements ShippingMethodChangeIsDefaultChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodChangeIsDefaultChange';
    /**
     *
     * @var ?string
     */
