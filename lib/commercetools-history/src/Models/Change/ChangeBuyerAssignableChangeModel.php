 ...
 * @internal
 */
final class ChangeBuyerAssignableChangeModel extends JsonObjectModel implements ChangeBuyerAssignableChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeBuyerAssignableChange';
    /**
     *
     * @var ?string
     */
