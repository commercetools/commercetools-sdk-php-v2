 ...
 * @internal
 */
final class SetReturnItemCustomLineItemCustomTypeChangeModel extends JsonObjectModel implements SetReturnItemCustomLineItemCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetReturnItemCustomLineItemCustomTypeChange';
    /**
     *
     * @var ?string
     */
