 ...
 * @internal
 */
final class StandalonePriceSetPriceTiersChangeModel extends JsonObjectModel implements StandalonePriceSetPriceTiersChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceSetPriceTiersChange';
    /**
     *
     * @var ?string
     */
    ...
    public function __construct(
        ?string $change = null,
        ?PriceTierCollection $addedItems = null,
        ?PriceTierCollection $removedItems = null,
        ?PriceTierCollection $previousValue = null,
        ?PriceTierCollection $nextValue = null,
        ?string $type = null
    ) {
        $this->change = $change;
    ...
    public function getAddedItems()
    {
        if (is_null($this->addedItems)) {
            ...
            $this->addedItems = PriceTierCollection::fromArray($data);
        }
    ...
    public function getRemovedItems()
    {
        if (is_null($this->removedItems)) {
            ...
            $this->removedItems = PriceTierCollection::fromArray($data);
        }
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue = PriceTierCollection::fromArray($data);
        }
    ...
    public function getNextValue()
    {
        if (is_null($this->nextValue)) {
            ...
            $this->nextValue = PriceTierCollection::fromArray($data);
        }
