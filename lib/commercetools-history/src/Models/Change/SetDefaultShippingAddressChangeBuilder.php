...
/**
 * @implements Builder<SetDefaultShippingAddressChange>
 */
final class SetDefaultShippingAddressChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetDefaultShippingAddressChange
    {
        return new SetDefaultShippingAddressChangeModel(
            $this->change,
    ...
    public static function of(): SetDefaultShippingAddressChangeBuilder
    {
        return new self();
    }
}
