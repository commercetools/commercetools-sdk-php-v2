 ...
 */
final class SetReturnItemLineItemCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetReturnItemLineItemCustomTypeChange
    {
        return new SetReturnItemLineItemCustomTypeChangeModel(
            $this->change,
            $this->variant,
    ...
    public static function of(): SetReturnItemLineItemCustomTypeChangeBuilder
    {
        return new self();
    }
}
