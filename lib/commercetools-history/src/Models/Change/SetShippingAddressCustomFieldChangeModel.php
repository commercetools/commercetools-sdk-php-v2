 ...
 * @internal
 */
final class SetShippingAddressCustomFieldChangeModel extends JsonObjectModel implements SetShippingAddressCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingAddressCustomFieldChange';
    /**
     *
     * @var ?string
     */
