 ...
 * @internal
 */
final class SetShippingInfoDiscountedPriceChangeModel extends JsonObjectModel implements SetShippingInfoDiscountedPriceChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingInfoDiscountedPriceChange';
    /**
     *
     * @var ?string
     */
