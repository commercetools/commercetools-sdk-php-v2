 ...
 */
final class SetShippingMethodTaxCategoryChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetShippingMethodTaxCategoryChange
    {
        return new SetShippingMethodTaxCategoryChangeModel(
            $this->change,
            $this->taxMode,
    ...
    public static function of(): SetShippingMethodTaxCategoryChangeBuilder
    {
        return new self();
    }
}
