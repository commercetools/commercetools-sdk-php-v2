...
/**
 * @implements Builder<StandalonePriceSetCustomTypeChange>
 */
final class StandalonePriceSetCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceSetCustomTypeChange
    {
        return new StandalonePriceSetCustomTypeChangeModel(
            $this->change,
    ...
    public static function of(): StandalonePriceSetCustomTypeChangeBuilder
    {
        return new self();
    }
}
