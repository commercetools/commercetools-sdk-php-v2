...
final class ChangeTransactionTimestampChangeBuilder implements Builder
{
    ...
    public function build(): ChangeTransactionTimestampChange
    {
        return new ChangeTransactionTimestampChangeModel(
            $this->change,
    ...
    public static function of(): ChangeTransactionTimestampChangeBuilder
    {
        return new self();
    }
}
