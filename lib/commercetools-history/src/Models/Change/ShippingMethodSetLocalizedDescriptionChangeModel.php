 ...
 * @internal
 */
final class ShippingMethodSetLocalizedDescriptionChangeModel extends JsonObjectModel implements ShippingMethodSetLocalizedDescriptionChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodSetLocalizedDescriptionChange';
    /**
     *
     * @var ?string
     */
