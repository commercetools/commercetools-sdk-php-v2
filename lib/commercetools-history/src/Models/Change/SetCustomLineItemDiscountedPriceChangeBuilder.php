 ...
 */
final class SetCustomLineItemDiscountedPriceChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetCustomLineItemDiscountedPriceChange
    {
        return new SetCustomLineItemDiscountedPriceChangeModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemDiscountedPriceChangeBuilder
    {
        return new self();
    }
}
