 ...
 * @internal
 */
final class SetTransactionCustomFieldChangeModel extends JsonObjectModel implements SetTransactionCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetTransactionCustomFieldChange';
    /**
     *
     * @var ?string
     */
