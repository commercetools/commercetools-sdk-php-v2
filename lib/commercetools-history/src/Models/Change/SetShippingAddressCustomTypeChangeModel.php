 ...
 * @internal
 */
final class SetShippingAddressCustomTypeChangeModel extends JsonObjectModel implements SetShippingAddressCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingAddressCustomTypeChange';
    /**
     *
     * @var ?string
     */
