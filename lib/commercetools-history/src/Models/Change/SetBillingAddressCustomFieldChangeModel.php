 ...
 * @internal
 */
final class SetBillingAddressCustomFieldChangeModel extends JsonObjectModel implements SetBillingAddressCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetBillingAddressCustomFieldChange';
    /**
     *
     * @var ?string
     */
