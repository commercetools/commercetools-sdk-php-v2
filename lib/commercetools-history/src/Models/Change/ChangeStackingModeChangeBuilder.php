...
/**
 * @implements Builder<ChangeStackingModeChange>
 */
final class ChangeStackingModeChangeBuilder implements Builder
{
    ...
    public function build(): ChangeStackingModeChange
    {
        return new ChangeStackingModeChangeModel(
            $this->change,
            $this->nextValue,
            $this->previousValue
        );
    ...
    public static function of(): ChangeStackingModeChangeBuilder
    {
        return new self();
    }
}
