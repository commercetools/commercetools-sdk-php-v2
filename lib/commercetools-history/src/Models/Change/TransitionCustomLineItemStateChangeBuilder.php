...
/**
 * @implements Builder<TransitionCustomLineItemStateChange>
 */
final class TransitionCustomLineItemStateChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public static function of(): TransitionCustomLineItemStateChangeBuilder
    {
        return new self();
    }
}
