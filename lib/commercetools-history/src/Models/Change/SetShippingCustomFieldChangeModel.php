 ...
 * @internal
 */
final class SetShippingCustomFieldChangeModel extends JsonObjectModel implements SetShippingCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingCustomFieldChange';
    /**
     *
     * @var ?string
     */
