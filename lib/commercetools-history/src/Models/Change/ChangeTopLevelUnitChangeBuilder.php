...
/**
 * @implements Builder<ChangeTopLevelUnitChange>
 */
final class ChangeTopLevelUnitChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeTopLevelUnitChange
    {
    ...
    public static function of(): ChangeTopLevelUnitChangeBuilder
    {
        return new self();
    }
}
