 ...
 * @internal
 */
final class ShippingMethodSetCustomFieldChangeModel extends JsonObjectModel implements ShippingMethodSetCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodSetCustomFieldChange';
    /**
     *
     * @var ?string
     */
