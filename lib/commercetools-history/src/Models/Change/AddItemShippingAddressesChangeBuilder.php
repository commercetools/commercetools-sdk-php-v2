...
/**
 * @implements Builder<AddItemShippingAddressesChange>
 */
final class AddItemShippingAddressesChangeBuilder implements Builder
{
    ...
    public function build(): AddItemShippingAddressesChange
    {
        return new AddItemShippingAddressesChangeModel(
            $this->change,
    ...
    public static function of(): AddItemShippingAddressesChangeBuilder
    {
        return new self();
    }
}
