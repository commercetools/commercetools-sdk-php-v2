...
/**
 * @implements Builder<SetItemShippingAddressCustomTypeChange>
 */
final class SetItemShippingAddressCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetItemShippingAddressCustomTypeChange
    {
        return new SetItemShippingAddressCustomTypeChangeModel(
            $this->change,
            $this->addressId,
    ...
    public static function of(): SetItemShippingAddressCustomTypeChangeBuilder
    {
        return new self();
    }
}
