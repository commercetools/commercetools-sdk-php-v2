 ...
 * @internal
 */
final class ChangeAssociateModeChangeModel extends JsonObjectModel implements ChangeAssociateModeChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeAssociateModeChange';
    /**
     *
     * @var ?string
     */
