 ...
 * @internal
 */
final class SetCustomLineItemDiscountedPriceChangeModel extends JsonObjectModel implements SetCustomLineItemDiscountedPriceChange
{

    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemDiscountedPriceChange';
    /**
     *
     * @var ?string
     */
