 ...
 * @internal
 */
final class SetTaxedShippingPriceChangeModel extends JsonObjectModel implements SetTaxedShippingPriceChange
{

    public const DISCRIMINATOR_VALUE = 'SetTaxedShippingPriceChange';
    /**
     *
     * @var ?string
     */
