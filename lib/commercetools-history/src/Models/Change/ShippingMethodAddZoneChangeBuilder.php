 ...
 */
final class ShippingMethodAddZoneChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodAddZoneChange
    {
        return new ShippingMethodAddZoneChangeModel(
            $this->change,
            $this->nextValue instanceof ReferenceBuilder ? $this->nextValue->build() : $this->nextValue
        );
    }

    public static function of(): ShippingMethodAddZoneChangeBuilder
    {
        return new self();
    }
}
