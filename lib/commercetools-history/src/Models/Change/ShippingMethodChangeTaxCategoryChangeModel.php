 ...
 * @internal
 */
final class ShippingMethodChangeTaxCategoryChangeModel extends JsonObjectModel implements ShippingMethodChangeTaxCategoryChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodChangeTaxCategoryChange';
    /**
     *
     * @var ?string
     */
