...
/**
 * @implements Builder<SetCustomLineItemMoneyChange>
 */
final class SetCustomLineItemMoneyChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemMoneyChange
    {
        return new SetCustomLineItemMoneyChangeModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemMoneyChangeBuilder
    {
        return new self();
    }
}
