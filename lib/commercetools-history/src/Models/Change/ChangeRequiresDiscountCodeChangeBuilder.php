...
/**
 * @implements Builder<ChangeRequiresDiscountCodeChange>
 */
final class ChangeRequiresDiscountCodeChangeBuilder implements Builder
{
    ...
    public function build(): ChangeRequiresDiscountCodeChange
    {
        return new ChangeRequiresDiscountCodeChangeModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): ChangeRequiresDiscountCodeChangeBuilder
    {
        return new self();
    }
}
