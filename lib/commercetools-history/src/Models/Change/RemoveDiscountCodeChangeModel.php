 ...
 * @internal
 */
final class RemoveDiscountCodeChangeModel extends JsonObjectModel implements RemoveDiscountCodeChange
{
    ...
    public function __construct(
        ?string $change = null,
        ?DiscountCodeInfo $previousValue = null
    ) {
        $this->change = $change;
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue =  DiscountCodeInfoModel::of($data);
        }
