...
/**
 * @implements Builder<SetBillingAddressCustomTypeChange>
 */
final class SetBillingAddressCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetBillingAddressCustomTypeChange
    {
        return new SetBillingAddressCustomTypeChangeModel(
            $this->change,
    ...
    public static function of(): SetBillingAddressCustomTypeChangeBuilder
    {
        return new self();
    }
}
