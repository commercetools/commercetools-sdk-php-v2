...
/**
 * @implements Builder<SetTransactionCustomTypeChange>
 */
final class SetTransactionCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetTransactionCustomTypeChange
    {
        return new SetTransactionCustomTypeChangeModel(
            $this->change,
    ...
    public static function of(): SetTransactionCustomTypeChangeBuilder
    {
        return new self();
    }
}
