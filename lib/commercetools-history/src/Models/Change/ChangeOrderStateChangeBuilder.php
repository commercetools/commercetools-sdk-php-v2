...
/**
 * @implements Builder<ChangeOrderStateChange>
 */
final class ChangeOrderStateChangeBuilder implements Builder
{
    /**
    ...
    public static function of(): ChangeOrderStateChangeBuilder
    {
        return new self();
    }
}
