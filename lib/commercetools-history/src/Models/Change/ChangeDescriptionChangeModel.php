 ...
 * @internal
 */
final class ChangeDescriptionChangeModel extends JsonObjectModel implements ChangeDescriptionChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeDescriptionChange';
    /**
     *
     * @var ?string
     */
