 ...
 * @internal
 */
final class SetTransactionInterfaceIdChangeModel extends JsonObjectModel implements SetTransactionInterfaceIdChange
{

    public const DISCRIMINATOR_VALUE = 'SetTransactionInterfaceIdChange';
    /**
     *
     * @var ?string
     */
