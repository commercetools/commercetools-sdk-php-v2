...
/**
 * @implements Builder<AddExternalImageChange>
 */
final class AddExternalImageChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddExternalImageChange
    {
        return new AddExternalImageChangeModel(
            $this->change,
            $this->catalogData,
            $this->previousValue,
            $this->nextValue
    ...
    public static function of(): AddExternalImageChangeBuilder
    {
        return new self();
    }
}
