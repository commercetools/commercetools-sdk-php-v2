 ...
 * @internal
 */
final class ShippingMethodSetCustomTypeChangeModel extends JsonObjectModel implements ShippingMethodSetCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodSetCustomTypeChange';
    /**
     *
     * @var ?string
     */
