 ...
 * @internal
 */
final class ChangeIncludedInStatisticsChangeModel extends JsonObjectModel implements ChangeIncludedInStatisticsChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeIncludedInStatisticsChange';
    /**
     *
     * @var ?string
     */
