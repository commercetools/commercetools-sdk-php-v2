...
/**
 * @implements Builder<ChangeAmountPlannedChange>
 */
final class ChangeAmountPlannedChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeAmountPlannedChange
    {
        return new ChangeAmountPlannedChangeModel(
            $this->change,
    ...
    public static function of(): ChangeAmountPlannedChangeBuilder
    {
        return new self();
    }
}
