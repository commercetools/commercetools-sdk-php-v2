 ...
 * @internal
 */
final class SetBillingAddressCustomTypeChangeModel extends JsonObjectModel implements SetBillingAddressCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetBillingAddressCustomTypeChange';
    /**
     *
     * @var ?string
     */
