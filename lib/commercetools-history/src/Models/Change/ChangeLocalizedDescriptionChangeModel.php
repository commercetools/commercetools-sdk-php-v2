 ...
 * @internal
 */
final class ChangeLocalizedDescriptionChangeModel extends JsonObjectModel implements ChangeLocalizedDescriptionChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeLocalizedDescriptionChange';
    /**
