...
/**
 * @implements Builder<ReplaceTaxRateChange>
 */
final class ReplaceTaxRateChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ReplaceTaxRateChange
    {
        return new ReplaceTaxRateChangeModel(
            $this->change,
    ...
    public static function of(): ReplaceTaxRateChangeBuilder
    {
        return new self();
    }
}
