 ...
 * @internal
 */
final class SetCustomerNumberChangeModel extends JsonObjectModel implements SetCustomerNumberChange
{
    public const DISCRIMINATOR_VALUE = 'SetCustomerNumberChange';
    /**
     * @var ?string
     */
    protected $type;
