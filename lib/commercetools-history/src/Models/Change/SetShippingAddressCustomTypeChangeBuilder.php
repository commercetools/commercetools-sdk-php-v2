...
/**
 * @implements Builder<SetShippingAddressCustomTypeChange>
 */
final class SetShippingAddressCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetShippingAddressCustomTypeChange
    {
        return new SetShippingAddressCustomTypeChangeModel(
            $this->change,
    ...
    public static function of(): SetShippingAddressCustomTypeChangeBuilder
    {
        return new self();
    }
}
