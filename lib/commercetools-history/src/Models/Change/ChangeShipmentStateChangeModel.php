 ...
 * @internal
 */
final class ChangeShipmentStateChangeModel extends JsonObjectModel implements ChangeShipmentStateChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeShipmentStateChange';
    /**
     *
     * @var ?string
     */
