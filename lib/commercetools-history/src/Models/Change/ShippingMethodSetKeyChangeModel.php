 ...
 * @internal
 */
final class ShippingMethodSetKeyChangeModel extends JsonObjectModel implements ShippingMethodSetKeyChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodSetKeyChange';
    /**
     *
     * @var ?string
     */
