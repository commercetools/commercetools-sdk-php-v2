 ...
 * @internal
 */
final class SetItemShippingAddressCustomFieldChangeModel extends JsonObjectModel implements SetItemShippingAddressCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetItemShippingAddressCustomFieldChange';
    /**
     *
     * @var ?string
     */
