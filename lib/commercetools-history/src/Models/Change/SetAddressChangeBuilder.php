...
/**
 * @implements Builder<SetAddressChange>
 */
final class SetAddressChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetAddressChange
    {
        return new SetAddressChangeModel(
            $this->change,
    ...
    public static function of(): SetAddressChangeBuilder
    {
        return new self();
    }
}
