 ...
 * @internal
 */
final class ShippingMethodChangeActiveChangeModel extends JsonObjectModel implements ShippingMethodChangeActiveChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodChangeActiveChange';
    /**
     *
     * @var ?string
     */
