 ...
 */
final class SetReturnItemCustomLineItemCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetReturnItemCustomLineItemCustomTypeChange
    {
    ...
    public static function of(): SetReturnItemCustomLineItemCustomTypeChangeBuilder
    {
        return new self();
    }
}
