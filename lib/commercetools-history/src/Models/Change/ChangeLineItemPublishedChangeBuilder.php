 ...
 */
final class ChangeLineItemPublishedChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeLineItemPublishedChange
    {
        return new ChangeLineItemPublishedChangeModel(
            $this->change,
    ...
    public static function of(): ChangeLineItemPublishedChangeBuilder
    {
        return new self();
    }
}
