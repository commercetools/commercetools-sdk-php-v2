...
/**
 * @implements Builder<SetAncestorsChange>
 */
final class SetAncestorsChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetAncestorsChange
    {
        return new SetAncestorsChangeModel(
            $this->change,
            $this->addedItems,
            $this->removedItems,
            $this->previousValue,
    ...
    public static function of(): SetAncestorsChangeBuilder
    {
        return new self();
    }
}
