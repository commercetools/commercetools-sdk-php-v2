 ...
 * @internal
 */
final class SetLocalizedNameChangeModel extends JsonObjectModel implements SetLocalizedNameChange
{

    public const DISCRIMINATOR_VALUE = 'SetLocalizedNameChange';
    /**
     *
     * @var ?string
     */
