 ...
 * @internal
 */
final class UpdateItemShippingAddressChangeModel extends JsonObjectModel implements UpdateItemShippingAddressChange
{

    public const DISCRIMINATOR_VALUE = 'UpdateItemShippingAddressChange';
    /**
     *
     * @var ?string
     */
