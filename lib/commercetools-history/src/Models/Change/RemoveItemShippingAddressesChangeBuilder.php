...
/**
 * @implements Builder<RemoveItemShippingAddressesChange>
 */
final class RemoveItemShippingAddressesChangeBuilder implements Builder
{
    /**
    ...
    public function build(): RemoveItemShippingAddressesChange
    {
        return new RemoveItemShippingAddressesChangeModel(
            $this->change,
    ...
    public static function of(): RemoveItemShippingAddressesChangeBuilder
    {
        return new self();
    }
}
