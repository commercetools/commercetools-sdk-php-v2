 ...
 * @internal
 */
final class ShippingMethodAddZoneChangeModel extends JsonObjectModel implements ShippingMethodAddZoneChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodAddZoneChange';
    /**
     *
     * @var ?string
     */
