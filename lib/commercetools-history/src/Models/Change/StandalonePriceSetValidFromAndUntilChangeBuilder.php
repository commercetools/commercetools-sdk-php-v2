...
use Commercetools\History\Models\ChangeValue\ValidFromAndUntilValueBuilder;

/**
 * @implements Builder<StandalonePriceSetValidFromAndUntilChange>
 */
final class StandalonePriceSetValidFromAndUntilChangeBuilder implements Builder
{
    /**
    ...
    public function build(): StandalonePriceSetValidFromAndUntilChange
    {
        return new StandalonePriceSetValidFromAndUntilChangeModel(
            $this->change,
    ...
    public static function of(): StandalonePriceSetValidFromAndUntilChangeBuilder
    {
        return new self();
    }
}
