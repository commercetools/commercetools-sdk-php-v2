...
/**
 * @implements Builder<AddShoppingListLineItemChange>
 */
final class AddShoppingListLineItemChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddShoppingListLineItemChange
    {
        return new AddShoppingListLineItemChangeModel(
            $this->change,
    ...
    public static function of(): AddShoppingListLineItemChangeBuilder
    {
        return new self();
    }
}
