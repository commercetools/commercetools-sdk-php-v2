...
/**
 * @implements Builder<ChangeLocalizedDescriptionChange>
 */
final class ChangeLocalizedDescriptionChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeLocalizedDescriptionChange
    {
        return new ChangeLocalizedDescriptionChangeModel(
            $this->change,
    ...
    public static function of(): ChangeLocalizedDescriptionChangeBuilder
    {
        return new self();
    }
}
