 ...
 */
final class ChangeTransactionStateChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeTransactionStateChange
    {
    ...
    public static function of(): ChangeTransactionStateChangeBuilder
    {
        return new self();
    }
}
