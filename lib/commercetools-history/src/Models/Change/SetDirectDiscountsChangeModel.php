 ...
 * @internal
 */
final class SetDirectDiscountsChangeModel extends JsonObjectModel implements SetDirectDiscountsChange
{

    public const DISCRIMINATOR_VALUE = 'SetDirectDiscountsChange';
    /**
     *
     * @var ?string
     */
    ...
    public function __construct(
        ?string $change = null,
        ?DirectDiscountCollection $addedItems = null,
        ?DirectDiscountCollection $removedItems = null,
        ?DirectDiscountCollection $previousValue = null,
        ?DirectDiscountCollection $nextValue = null,
        ?string $type = null
    ) {
        $this->change = $change;
    ...
    public function getAddedItems()
    {
        if (is_null($this->addedItems)) {
            ...
            $this->addedItems = DirectDiscountCollection::fromArray($data);
        }
    ...
    public function getRemovedItems()
    {
        if (is_null($this->removedItems)) {
            ...
            $this->removedItems = DirectDiscountCollection::fromArray($data);
        }
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue = DirectDiscountCollection::fromArray($data);
        }
    ...
    public function getNextValue()
    {
        if (is_null($this->nextValue)) {
            ...
            $this->nextValue = DirectDiscountCollection::fromArray($data);
        }
