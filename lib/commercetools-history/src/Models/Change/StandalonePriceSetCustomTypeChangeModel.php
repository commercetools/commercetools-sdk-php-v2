 ...
 * @internal
 */
final class StandalonePriceSetCustomTypeChangeModel extends JsonObjectModel implements StandalonePriceSetCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceSetCustomTypeChange';
    /**
     *
     * @var ?string
     */
