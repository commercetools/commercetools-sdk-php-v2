...
/**
 * @implements Builder<SetLocalizedDescriptionChange>
 */
final class SetLocalizedDescriptionChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetLocalizedDescriptionChange
    {
        return new SetLocalizedDescriptionChangeModel(
            $this->change,
    ...
    public static function of(): SetLocalizedDescriptionChangeBuilder
    {
        return new self();
    }
}
