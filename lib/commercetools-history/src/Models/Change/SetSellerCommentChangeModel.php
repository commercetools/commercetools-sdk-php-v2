 ...
 * @internal
 */
final class SetSellerCommentChangeModel extends JsonObjectModel implements SetSellerCommentChange
{

    public const DISCRIMINATOR_VALUE = 'SetSellerCommentChange';
    /**
     *
     * @var ?string
     */
