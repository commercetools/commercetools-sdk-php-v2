 ...
 * @internal
 */
final class ChangeQuoteStateChangeModel extends JsonObjectModel implements ChangeQuoteStateChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeQuoteStateChange';
    /**
     *
     * @var ?string
     */
