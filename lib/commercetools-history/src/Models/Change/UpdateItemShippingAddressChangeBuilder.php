...
/**
 * @implements Builder<UpdateItemShippingAddressChange>
 */
final class UpdateItemShippingAddressChangeBuilder implements Builder
{
    /**
    ...
    public function build(): UpdateItemShippingAddressChange
    {
        return new UpdateItemShippingAddressChangeModel(
            $this->change,
    ...
    public static function of(): UpdateItemShippingAddressChangeBuilder
    {
        return new self();
    }
}
