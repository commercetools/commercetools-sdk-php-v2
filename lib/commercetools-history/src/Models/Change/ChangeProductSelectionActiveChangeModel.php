 ...
 * @internal
 */
final class ChangeProductSelectionActiveChangeModel extends JsonObjectModel implements ChangeProductSelectionActiveChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeProductSelectionActiveChange';
    /**
     *
     * @var ?string
     */
