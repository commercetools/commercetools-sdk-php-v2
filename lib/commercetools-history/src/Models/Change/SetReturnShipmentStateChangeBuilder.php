...
final class SetReturnShipmentStateChangeBuilder implements Builder
{
    ...
    public function build(): SetReturnShipmentStateChange
    {
        return new SetReturnShipmentStateChangeModel(
            $this->change,
            $this->nextValue,
            $this->previousValue
        );
    ...
    public static function of(): SetReturnShipmentStateChangeBuilder
    {
        return new self();
    }
}
