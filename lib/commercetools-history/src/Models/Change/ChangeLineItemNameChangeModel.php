 ...
 * @internal
 */
final class ChangeLineItemNameChangeModel extends JsonObjectModel implements ChangeLineItemNameChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeLineItemNameChange';
    /**
     *
     * @var ?string
     */
