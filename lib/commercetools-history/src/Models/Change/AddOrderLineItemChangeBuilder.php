...
/**
 * @implements Builder<AddOrderLineItemChange>
 */
final class AddOrderLineItemChangeBuilder implements Builder
{
    /**
    ...
    public function build(): AddOrderLineItemChange
    {
        return new AddOrderLineItemChangeModel(
            $this->change,
    ...
    public static function of(): AddOrderLineItemChangeBuilder
    {
        return new self();
    }
}
