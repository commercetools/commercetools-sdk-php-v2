 ...
 * @internal
 */
final class SetDeliveryAddressCustomFieldChangeModel extends JsonObjectModel implements SetDeliveryAddressCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetDeliveryAddressCustomFieldChange';
    /**
     *
     * @var ?string
     */
