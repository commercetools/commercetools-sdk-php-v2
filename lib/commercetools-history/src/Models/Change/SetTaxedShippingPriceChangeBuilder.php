...
/**
 * @implements Builder<SetTaxedShippingPriceChange>
 */
final class SetTaxedShippingPriceChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetTaxedShippingPriceChange
    {
        return new SetTaxedShippingPriceChangeModel(
            $this->change,
    ...
    public static function of(): SetTaxedShippingPriceChangeBuilder
    {
        return new self();
    }
}
