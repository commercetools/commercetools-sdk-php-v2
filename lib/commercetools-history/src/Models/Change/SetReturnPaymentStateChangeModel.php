 ...
 * @internal
 */
final class SetReturnPaymentStateChangeModel extends JsonObjectModel implements SetReturnPaymentStateChange
{
    public const DISCRIMINATOR_VALUE = 'SetReturnPaymentStateChange';
    /**
     * @var ?string
     */
    protected $type;
