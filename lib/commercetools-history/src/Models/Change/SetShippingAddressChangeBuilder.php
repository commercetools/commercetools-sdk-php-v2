...
/**
 * @implements Builder<SetShippingAddressChange>
 */
final class SetShippingAddressChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetShippingAddressChange
    {
        return new SetShippingAddressChangeModel(
            $this->change,
    ...
    public static function of(): SetShippingAddressChangeBuilder
    {
        return new self();
    }
}
