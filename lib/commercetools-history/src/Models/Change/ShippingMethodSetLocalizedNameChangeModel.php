 ...
 * @internal
 */
final class ShippingMethodSetLocalizedNameChangeModel extends JsonObjectModel implements ShippingMethodSetLocalizedNameChange
{

    public const DISCRIMINATOR_VALUE = 'ShippingMethodSetLocalizedNameChange';
    /**
     *
     * @var ?string
     */
