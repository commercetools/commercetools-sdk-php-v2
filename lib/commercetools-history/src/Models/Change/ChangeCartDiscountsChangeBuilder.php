...
/**
 * @implements Builder<ChangeCartDiscountsChange>
 */
final class ChangeCartDiscountsChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeCartDiscountsChange
    {
        return new ChangeCartDiscountsChangeModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): ChangeCartDiscountsChangeBuilder
    {
        return new self();
    }
}
