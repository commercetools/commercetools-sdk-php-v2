 ...
 * @internal
 */
final class ChangeParentUnitChangeModel extends JsonObjectModel implements ChangeParentUnitChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeParentUnitChange';
    /**
     *
     * @var ?string
     */
