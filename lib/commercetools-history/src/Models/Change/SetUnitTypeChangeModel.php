...
use Commercetools\History\Models\Common\BusinessUnitResourceIdentifierModel;

/**
 * @internal
 */
final class SetUnitTypeChangeModel extends JsonObjectModel implements SetUnitTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetUnitTypeChange';
    /**
     *
     * @var ?string
     */
