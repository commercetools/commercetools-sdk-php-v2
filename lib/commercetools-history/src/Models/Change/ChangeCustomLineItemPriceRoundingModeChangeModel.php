 ...
 * @internal
 */
final class ChangeCustomLineItemPriceRoundingModeChangeModel extends JsonObjectModel implements ChangeCustomLineItemPriceRoundingModeChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeCustomLineItemPriceRoundingModeChange';
    /**
     *
     * @var ?string
     */
