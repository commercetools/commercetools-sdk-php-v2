...
/**
 * @implements Builder<ShippingMethodSetCustomTypeChange>
 */
final class ShippingMethodSetCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodSetCustomTypeChange
    {
        return new ShippingMethodSetCustomTypeChangeModel(
            $this->change,
    ...
    public static function of(): ShippingMethodSetCustomTypeChangeBuilder
    {
        return new self();
    }
}
