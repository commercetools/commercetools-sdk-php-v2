...
/**
 * @implements Builder<SetBillingAddressChange>
 */
final class SetBillingAddressChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetBillingAddressChange
    {
        return new SetBillingAddressChangeModel(
            $this->change,
    ...
    public static function of(): SetBillingAddressChangeBuilder
    {
        return new self();
    }
}
