 ...
 */
final class ShippingMethodRemoveZoneChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodRemoveZoneChange
    {
        return new ShippingMethodRemoveZoneChangeModel(
            $this->change,
            $this->previousValue instanceof ReferenceBuilder ? $this->previousValue->build() : $this->previousValue
        );
    }

    public static function of(): ShippingMethodRemoveZoneChangeBuilder
    {
        return new self();
    }
}
