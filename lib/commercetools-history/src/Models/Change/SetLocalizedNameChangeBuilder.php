...
/**
 * @implements Builder<SetLocalizedNameChange>
 */
final class SetLocalizedNameChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetLocalizedNameChange
    {
        return new SetLocalizedNameChangeModel(
            $this->change,
    ...
    public static function of(): SetLocalizedNameChangeBuilder
    {
        return new self();
    }
}
