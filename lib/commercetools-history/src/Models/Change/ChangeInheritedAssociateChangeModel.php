 ...
 * @internal
 */
final class ChangeInheritedAssociateChangeModel extends JsonObjectModel implements ChangeInheritedAssociateChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeInheritedAssociateChange';
    /**
     *
     * @var ?string
     */
