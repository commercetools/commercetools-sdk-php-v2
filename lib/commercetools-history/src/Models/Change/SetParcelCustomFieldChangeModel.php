 ...
 * @internal
 */
final class SetParcelCustomFieldChangeModel extends JsonObjectModel implements SetParcelCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetParcelCustomFieldChange';
    /**
     *
     * @var ?string
     */
