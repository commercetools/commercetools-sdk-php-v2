 ...
 * @internal
 */
final class StandalonePriceChangeActiveChangeModel extends JsonObjectModel implements StandalonePriceChangeActiveChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceChangeActiveChange';
    /**
     *
     * @var ?string
     */
