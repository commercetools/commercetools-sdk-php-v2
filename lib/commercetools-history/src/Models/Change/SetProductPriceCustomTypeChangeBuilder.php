...
/**
 * @implements Builder<SetProductPriceCustomTypeChange>
 */
final class SetProductPriceCustomTypeChangeBuilder implements Builder
{
    ...
    public function build(): SetProductPriceCustomTypeChange
    {
        return new SetProductPriceCustomTypeChangeModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): SetProductPriceCustomTypeChangeBuilder
    {
        return new self();
    }
}
