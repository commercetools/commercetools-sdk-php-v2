...
/**
 * @implements Builder<ChangeParentChange>
 */
final class ChangeParentChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeParentChange
    {
        return new ChangeParentChangeModel(
            $this->change,
    ...
    public static function of(): ChangeParentChangeBuilder
    {
        return new self();
    }
}
