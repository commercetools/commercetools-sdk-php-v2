...
/**
 * @implements Builder<SetDeliveryCustomTypeChange>
 */
final class SetDeliveryCustomTypeChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetDeliveryCustomTypeChange
    {
        return new SetDeliveryCustomTypeChangeModel(
            $this->change,
            $this->deliveryId,
    ...
    public static function of(): SetDeliveryCustomTypeChangeBuilder
    {
        return new self();
    }
}
