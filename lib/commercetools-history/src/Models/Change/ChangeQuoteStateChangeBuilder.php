...
/**
 * @implements Builder<ChangeQuoteStateChange>
 */
final class ChangeQuoteStateChangeBuilder implements Builder
{
    /**
    ...
    public static function of(): ChangeQuoteStateChangeBuilder
    {
        return new self();
    }
}
