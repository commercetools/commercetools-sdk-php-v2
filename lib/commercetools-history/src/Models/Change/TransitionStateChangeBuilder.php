...
/**
 * @implements Builder<TransitionStateChange>
 */
final class TransitionStateChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): TransitionStateChange
    {
        return new TransitionStateChangeModel(
            $this->change,
    ...
    public static function of(): TransitionStateChangeBuilder
    {
        return new self();
    }
}
