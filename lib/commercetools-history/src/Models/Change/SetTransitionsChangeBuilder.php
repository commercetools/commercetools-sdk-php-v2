...
/**
 * @implements Builder<SetTransitionsChange>
 */
final class SetTransitionsChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetTransitionsChange
    {
        return new SetTransitionsChangeModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): SetTransitionsChangeBuilder
    {
        return new self();
    }
}
