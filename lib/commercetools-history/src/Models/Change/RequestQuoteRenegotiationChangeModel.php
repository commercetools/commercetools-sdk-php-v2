 ...
 * @internal
 */
final class RequestQuoteRenegotiationChangeModel extends JsonObjectModel implements RequestQuoteRenegotiationChange
{

    public const DISCRIMINATOR_VALUE = 'RequestQuoteRenegotiationChange';
    /**
     *
     * @var ?string
     */
