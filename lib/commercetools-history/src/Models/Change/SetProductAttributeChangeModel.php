 ...
 * @internal
 */
final class SetProductAttributeChangeModel extends JsonObjectModel implements SetProductAttributeChange
{

    public const DISCRIMINATOR_VALUE = 'SetProductAttributeChange';
    /**
     *
     * @var ?string
     */
