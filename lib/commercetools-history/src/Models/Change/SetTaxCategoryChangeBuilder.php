...
/**
 * @implements Builder<SetTaxCategoryChange>
 */
final class SetTaxCategoryChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetTaxCategoryChange
    {
        return new SetTaxCategoryChangeModel(
            $this->change,
    ...
    public static function of(): SetTaxCategoryChangeBuilder
    {
        return new self();
    }
}
