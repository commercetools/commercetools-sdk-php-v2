...
/**
 * @implements Builder<ChangeCustomLineItemQuantityChange>
 */
final class ChangeCustomLineItemQuantityChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeCustomLineItemQuantityChange
    {
    ...
    public static function of(): ChangeCustomLineItemQuantityChangeBuilder
    {
        return new self();
    }
}
