...
/**
 * @implements Builder<SetBusinessUnitChange>
 */
final class SetBusinessUnitChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetBusinessUnitChange
    {
        return new SetBusinessUnitChangeModel(
            $this->change,
    ...
    public static function of(): SetBusinessUnitChangeBuilder
    {
        return new self();
    }
}
