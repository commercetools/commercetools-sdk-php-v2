...
/**
 * @implements Builder<AddShippingAddressIdChange>
 */
final class AddShippingAddressIdChangeBuilder implements Builder
{
    /**
    ...
    public function build(): AddShippingAddressIdChange
    {
        return new AddShippingAddressIdChangeModel(
            $this->change,
            $this->previousValue,
            $this->nextValue,
    ...
    public static function of(): AddShippingAddressIdChangeBuilder
    {
        return new self();
    }
}
