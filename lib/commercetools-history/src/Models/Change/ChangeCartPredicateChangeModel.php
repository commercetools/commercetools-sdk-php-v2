 ...
 * @internal
 */
final class ChangeCartPredicateChangeModel extends JsonObjectModel implements ChangeCartPredicateChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeCartPredicateChange';
    /**
     *
     * @var ?string
     */
