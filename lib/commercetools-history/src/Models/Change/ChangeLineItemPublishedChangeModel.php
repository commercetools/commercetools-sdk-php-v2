 ...
 * @internal
 */
final class ChangeLineItemPublishedChangeModel extends JsonObjectModel implements ChangeLineItemPublishedChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeLineItemPublishedChange';
    /**
     *
     * @var ?string
     */
