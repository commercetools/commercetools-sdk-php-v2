...
/**
 * @implements Builder<SetSupplyChannelChange>
 */
final class SetSupplyChannelChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetSupplyChannelChange
    {
        return new SetSupplyChannelChangeModel(
            $this->change,
    ...
    public static function of(): SetSupplyChannelChangeBuilder
    {
        return new self();
    }
}
