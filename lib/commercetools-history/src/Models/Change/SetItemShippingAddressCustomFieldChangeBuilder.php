 ...
 */
final class SetItemShippingAddressCustomFieldChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetItemShippingAddressCustomFieldChange
    {
        return new SetItemShippingAddressCustomFieldChangeModel(
            $this->change,
            $this->addressId,
            $this->name,
            $this->customTypeId,
    ...
    public static function of(): SetItemShippingAddressCustomFieldChangeBuilder
    {
        return new self();
    }
}
