...
/**
 * @implements Builder<ShippingMethodChangeTaxCategoryChange>
 */
final class ShippingMethodChangeTaxCategoryChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodChangeTaxCategoryChange
    {
        return new ShippingMethodChangeTaxCategoryChangeModel(
            $this->change,
    ...
    public static function of(): ShippingMethodChangeTaxCategoryChangeBuilder
    {
        return new self();
    }
}
