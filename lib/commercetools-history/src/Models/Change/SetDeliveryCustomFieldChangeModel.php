 ...
 * @internal
 */
final class SetDeliveryCustomFieldChangeModel extends JsonObjectModel implements SetDeliveryCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'SetDeliveryCustomFieldChange';
    /**
     *
     * @var ?string
     */
