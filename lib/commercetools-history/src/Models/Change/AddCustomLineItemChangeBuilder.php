...
/**
 * @implements Builder<AddCustomLineItemChange>
 */
final class AddCustomLineItemChangeBuilder implements Builder
{
    /**
    ...
    public function build(): AddCustomLineItemChange
    {
        return new AddCustomLineItemChangeModel(
            $this->change,
    ...
    public static function of(): AddCustomLineItemChangeBuilder
    {
        return new self();
    }
}
