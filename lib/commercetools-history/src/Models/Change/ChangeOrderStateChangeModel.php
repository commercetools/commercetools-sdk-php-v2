 ...
 * @internal
 */
final class ChangeOrderStateChangeModel extends JsonObjectModel implements ChangeOrderStateChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeOrderStateChange';
    /**
     *
     * @var ?string
     */
