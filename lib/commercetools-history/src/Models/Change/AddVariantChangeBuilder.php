...
/**
 * @implements Builder<AddVariantChange>
 */
final class AddVariantChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddVariantChange
    {
        return new AddVariantChangeModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): AddVariantChangeBuilder
    {
        return new self();
    }
}
