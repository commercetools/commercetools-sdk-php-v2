...
/**
 * @implements Builder<RemoveShippingAddressIdChange>
 */
final class RemoveShippingAddressIdChangeBuilder implements Builder
{
    /**
    ...
    public function build(): RemoveShippingAddressIdChange
    {
        return new RemoveShippingAddressIdChangeModel(
            $this->change,
            $this->previousValue,
            $this->nextValue,
    ...
    public static function of(): RemoveShippingAddressIdChangeBuilder
    {
        return new self();
    }
}
