 ...
 * @internal
 */
final class SetItemShippingAddressCustomTypeChangeModel extends JsonObjectModel implements SetItemShippingAddressCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetItemShippingAddressCustomTypeChange';
    /**
     *
     * @var ?string
     */
