 ...
 * @internal
 */
final class ChangeTopLevelUnitChangeModel extends JsonObjectModel implements ChangeTopLevelUnitChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeTopLevelUnitChange';
    /**
     *
     * @var ?string
     */
