 ...
 * @internal
 */
final class StandalonePriceChangeValueChangeModel extends JsonObjectModel implements StandalonePriceChangeValueChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceChangeValueChange';
    /**
     *
     * @var ?string
     */
