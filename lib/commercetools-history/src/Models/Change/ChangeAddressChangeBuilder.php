...
/**
 * @implements Builder<ChangeAddressChange>
 */
final class ChangeAddressChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeAddressChange
    {
        return new ChangeAddressChangeModel(
            $this->change,
    ...
    public static function of(): ChangeAddressChangeBuilder
    {
        return new self();
    }
}
