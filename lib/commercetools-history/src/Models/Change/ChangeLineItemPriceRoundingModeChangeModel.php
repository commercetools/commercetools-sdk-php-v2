 ...
 * @internal
 */
final class ChangeLineItemPriceRoundingModeChangeModel extends JsonObjectModel implements ChangeLineItemPriceRoundingModeChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeLineItemPriceRoundingModeChange';
    /**
     *
     * @var ?string
     */
