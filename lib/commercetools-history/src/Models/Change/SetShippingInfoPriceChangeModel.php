 ...
 * @internal
 */
final class SetShippingInfoPriceChangeModel extends JsonObjectModel implements SetShippingInfoPriceChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingInfoPriceChange';
    /**
     *
     * @var ?string
     */
