 ...
 */
final class SetLineItemProductKeyChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetLineItemProductKeyChange
    {
    ...
    public static function of(): SetLineItemProductKeyChangeBuilder
    {
        return new self();
    }
}
