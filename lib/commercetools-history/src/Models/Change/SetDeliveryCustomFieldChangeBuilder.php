...
/**
 * @implements Builder<SetDeliveryCustomFieldChange>
 */
final class SetDeliveryCustomFieldChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetDeliveryCustomFieldChange
    {
        return new SetDeliveryCustomFieldChangeModel(
            $this->change,
            $this->deliveryId,
            $this->name,
            $this->customTypeId,
    ...
    public static function of(): SetDeliveryCustomFieldChangeBuilder
    {
        return new self();
    }
}
