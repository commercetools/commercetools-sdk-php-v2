 ...
 * @internal
 */
final class SetDeliveryCustomTypeChangeModel extends JsonObjectModel implements SetDeliveryCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetDeliveryCustomTypeChange';
    /**
     *
     * @var ?string
     */
