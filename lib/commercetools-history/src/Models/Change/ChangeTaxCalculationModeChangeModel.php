 ...
 * @internal
 */
final class ChangeTaxCalculationModeChangeModel extends JsonObjectModel implements ChangeTaxCalculationModeChange
{

    public const DISCRIMINATOR_VALUE = 'ChangeTaxCalculationModeChange';
    /**
     *
     * @var ?string
     */
