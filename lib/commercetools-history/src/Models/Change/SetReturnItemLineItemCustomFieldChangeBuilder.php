 ...
 */
final class SetReturnItemLineItemCustomFieldChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetReturnItemLineItemCustomFieldChange
    {
        return new SetReturnItemLineItemCustomFieldChangeModel(
            $this->change,
            $this->variant,
    ...
    public static function of(): SetReturnItemLineItemCustomFieldChangeBuilder
    {
        return new self();
    }
}
