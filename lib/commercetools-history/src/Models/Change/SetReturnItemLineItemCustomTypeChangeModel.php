 ...
 * @internal
 */
final class SetReturnItemLineItemCustomTypeChangeModel extends JsonObjectModel implements SetReturnItemLineItemCustomTypeChange
{

    public const DISCRIMINATOR_VALUE = 'SetReturnItemLineItemCustomTypeChange';
    /**
     *
     * @var ?string
     */
