 ...
 * @internal
 */
final class SetOrderTotalPriceChangeModel extends JsonObjectModel implements SetOrderTotalPriceChange
{
    public const DISCRIMINATOR_VALUE = 'SetOrderTotalPriceChange';
    /**
     * @var ?string
     */
    protected $type;
