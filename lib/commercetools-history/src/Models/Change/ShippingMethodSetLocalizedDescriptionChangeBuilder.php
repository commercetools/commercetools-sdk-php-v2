 ...
 */
final class ShippingMethodSetLocalizedDescriptionChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ShippingMethodSetLocalizedDescriptionChange
    {
        return new ShippingMethodSetLocalizedDescriptionChangeModel(
            $this->change,
    ...
    public static function of(): ShippingMethodSetLocalizedDescriptionChangeBuilder
    {
        return new self();
    }
}
