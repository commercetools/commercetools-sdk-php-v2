 ...
 * @internal
 */
final class StandalonePriceSetCustomFieldChangeModel extends JsonObjectModel implements StandalonePriceSetCustomFieldChange
{

    public const DISCRIMINATOR_VALUE = 'StandalonePriceSetCustomFieldChange';
    /**
     *
     * @var ?string
     */
