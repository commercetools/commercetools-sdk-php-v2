 ...
 * @internal
 */
final class SetShippingMethodTaxCategoryChangeModel extends JsonObjectModel implements SetShippingMethodTaxCategoryChange
{

    public const DISCRIMINATOR_VALUE = 'SetShippingMethodTaxCategoryChange';
    /**
     *
     * @var ?string
     */
