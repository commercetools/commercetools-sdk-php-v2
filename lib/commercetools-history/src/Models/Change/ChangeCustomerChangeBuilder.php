...
/**
 * @implements Builder<ChangeCustomerChange>
 */
final class ChangeCustomerChangeBuilder implements Builder
{
    /**
    ...
    public function build(): ChangeCustomerChange
    {
        return new ChangeCustomerChangeModel(
            $this->change,
    ...
    public static function of(): ChangeCustomerChangeBuilder
    {
        return new self();
    }
}
