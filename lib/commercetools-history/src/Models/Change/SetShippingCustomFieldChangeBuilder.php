...
/**
 * @implements Builder<SetShippingCustomFieldChange>
 */
final class SetShippingCustomFieldChangeBuilder implements Builder
{
    /**
    ...
    public function build(): SetShippingCustomFieldChange
    {
    ...
    public static function of(): SetShippingCustomFieldChangeBuilder
    {
        return new self();
    }
}
