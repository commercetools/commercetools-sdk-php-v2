...
/**
 * @implements Builder<SetOrderLineItemCustomFieldAction>
 */
final class SetOrderLineItemCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetOrderLineItemCustomFieldAction
    {
        return new SetOrderLineItemCustomFieldActionModel(
            $this->change,
            $this->customTypeId,
            $this->name,
            $this->variant,
    ...
    public static function of(): SetOrderLineItemCustomFieldActionBuilder
    {
        return new self();
    }
}
