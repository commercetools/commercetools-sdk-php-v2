...
/**
 * @implements Builder<RemoveTextLineItemAction>
 */
final class RemoveTextLineItemActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveTextLineItemAction
    {
        return new RemoveTextLineItemActionModel(
            $this->change,
    ...
    public static function of(): RemoveTextLineItemActionBuilder
    {
        return new self();
    }
}
