 ...
 * @internal
 */
final class AddInterfaceInteractionActionModel extends JsonObjectModel implements AddInterfaceInteractionAction
{
    public const DISCRIMINATOR_VALUE = 'AddInterfaceInteractionAction';
    /**
     * @var ?string
     */
    protected $type;
