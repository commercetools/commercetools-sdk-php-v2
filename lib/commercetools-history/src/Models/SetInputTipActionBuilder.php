...
/**
 * @implements Builder<SetInputTipAction>
 */
final class SetInputTipActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetInputTipAction
    {
        return new SetInputTipActionModel(
            $this->change,
            $this->attributeName,
    ...
    public static function of(): SetInputTipActionBuilder
    {
        return new self();
    }
}
