 ...
 * @internal
 */
final class AddShoppingListLineItemActionModel extends JsonObjectModel implements AddShoppingListLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'AddShoppingListLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
