 ...
 * @internal
 */
final class SetDistributionChannelsActionModel extends JsonObjectModel implements SetDistributionChannelsAction
{
    public const DISCRIMINATOR_VALUE = 'SetDistributionChannelsAction';
    /**
     * @var ?string
     */
    protected $type;
