...
/**
 * @implements Builder<SetCustomerChange>
 */
final class SetCustomerChangeBuilder implements Builder
{
    ...
    public function build(): SetCustomerChange
    {
        return new SetCustomerChangeModel(
            $this->change,
    ...
    public static function of(): SetCustomerChangeBuilder
    {
        return new self();
    }
}
