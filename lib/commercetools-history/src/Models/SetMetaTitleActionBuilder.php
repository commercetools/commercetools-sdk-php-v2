...
/**
 * @implements Builder<SetMetaTitleAction>
 */
final class SetMetaTitleActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMetaTitleAction
    {
        return new SetMetaTitleActionModel(
            $this->change,
    ...
    public static function of(): SetMetaTitleActionBuilder
    {
        return new self();
    }
}
