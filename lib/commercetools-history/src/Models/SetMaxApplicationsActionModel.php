 ...
 * @internal
 */
final class SetMaxApplicationsActionModel extends JsonObjectModel implements SetMaxApplicationsAction
{
    public const DISCRIMINATOR_VALUE = 'SetMaxApplicationsAction';
    /**
     * @var ?string
     */
    protected $type;
