...
/**
 * @implements Builder<SetCustomFieldAction>
 */
final class SetCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomFieldAction
    {
        return new SetCustomFieldActionModel(
            $this->change,
            $this->name,
            $this->customTypeId,
            $this->nextValue,
    ...
    public static function of(): SetCustomFieldActionBuilder
    {
        return new self();
    }
}
