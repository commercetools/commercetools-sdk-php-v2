...
/**
 * @implements Builder<ChangeAddressAction>
 */
final class ChangeAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeAddressAction
    {
        return new ChangeAddressActionModel(
            $this->change,
    ...
    public static function of(): ChangeAddressActionBuilder
    {
        return new self();
    }
}
