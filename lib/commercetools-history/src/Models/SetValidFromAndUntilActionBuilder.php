...
/**
 * @implements Builder<SetValidFromAndUntilAction>
 */
final class SetValidFromAndUntilActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetValidFromAndUntilAction
    {
        return new SetValidFromAndUntilActionModel(
            $this->change,
    ...
    public static function of(): SetValidFromAndUntilActionBuilder
    {
        return new self();
    }
}
