 ...
 * @internal
 */
final class SetOrderTotalPriceActionModel extends JsonObjectModel implements SetOrderTotalPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetOrderTotalPriceAction';
    /**
     * @var ?string
     */
    protected $type;
