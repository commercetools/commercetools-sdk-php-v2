 ...
 * @internal
 */
final class SetDefaultBillingAddressActionModel extends JsonObjectModel implements SetDefaultBillingAddressAction
{
    public const DISCRIMINATOR_VALUE = 'SetDefaultBillingAddressAction';
    /**
     * @var ?string
     */
    protected $type;
