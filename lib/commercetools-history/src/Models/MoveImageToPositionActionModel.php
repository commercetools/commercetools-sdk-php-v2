 ...
 * @internal
 */
final class MoveImageToPositionActionModel extends JsonObjectModel implements MoveImageToPositionAction
{
    public const DISCRIMINATOR_VALUE = 'MoveImageToPositionAction';
    /**
     * @var ?string
     */
    protected $type;
