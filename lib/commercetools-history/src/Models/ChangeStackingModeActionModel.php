 ...
 * @internal
 */
final class ChangeStackingModeActionModel extends JsonObjectModel implements ChangeStackingModeAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeStackingModeAction';
    /**
     * @var ?string
     */
    protected $type;
