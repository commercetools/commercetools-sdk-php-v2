 ...
 * @internal
 */
final class RemoveItemShippingAddressesActionModel extends JsonObjectModel implements RemoveItemShippingAddressesAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveItemShippingAddressesAction';
    /**
     * @var ?string
     */
    protected $type;
