...
/**
 * @implements Builder<RemoveVariantAction>
 */
final class RemoveVariantActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveVariantAction
    {
        return new RemoveVariantActionModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): RemoveVariantActionBuilder
    {
        return new self();
    }
}
