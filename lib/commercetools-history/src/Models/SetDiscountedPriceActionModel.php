 ...
 * @internal
 */
final class SetDiscountedPriceActionModel extends JsonObjectModel implements SetDiscountedPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetDiscountedPriceAction';
    /**
     * @var ?string
     */
    protected $type;
