 ...
 * @internal
 */
final class RemoveShoppingListLineItemActionModel extends JsonObjectModel implements RemoveShoppingListLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveShoppingListLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
