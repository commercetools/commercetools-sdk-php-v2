 ...
 * @internal
 */
final class SetReturnShipmentStateActionModel extends JsonObjectModel implements SetReturnShipmentStateAction
{
    public const DISCRIMINATOR_VALUE = 'SetReturnShipmentStateAction';
    /**
     * @var ?string
     */
    protected $type;
