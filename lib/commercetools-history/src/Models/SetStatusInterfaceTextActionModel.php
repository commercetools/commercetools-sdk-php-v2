 ...
 * @internal
 */
final class SetStatusInterfaceTextActionModel extends JsonObjectModel implements SetStatusInterfaceTextAction
{
    public const DISCRIMINATOR_VALUE = 'SetStatusInterfaceTextAction';
    /**
     * @var ?string
     */
    protected $type;
