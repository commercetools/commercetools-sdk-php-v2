...
/**
 * @implements Builder<MoveImageToPositionAction>
 */
final class MoveImageToPositionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): MoveImageToPositionAction
    {
        return new MoveImageToPositionActionModel(
            $this->change,
            $this->catalogData,
            $this->previousValue,
            $this->nextValue
    ...
    public static function of(): MoveImageToPositionActionBuilder
    {
        return new self();
    }
}
