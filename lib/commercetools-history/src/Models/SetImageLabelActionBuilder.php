...
/**
 * @implements Builder<SetImageLabelAction>
 */
final class SetImageLabelActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetImageLabelAction
    {
        return new SetImageLabelActionModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): SetImageLabelActionBuilder
    {
        return new self();
    }
}
