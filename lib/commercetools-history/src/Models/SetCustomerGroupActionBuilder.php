...
/**
 * @implements Builder<SetCustomerGroupAction>
 */
final class SetCustomerGroupActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomerGroupAction
    {
        return new SetCustomerGroupActionModel(
            $this->change,
    ...
    public static function of(): SetCustomerGroupActionBuilder
    {
        return new self();
    }
}
