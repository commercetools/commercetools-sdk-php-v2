 ...
 * @internal
 */
final class SetOrderLineItemCustomTypeActionModel extends JsonObjectModel implements SetOrderLineItemCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'SetOrderLineItemCustomTypeAction';
    /**
     * @var ?string
     */
    protected $type;
