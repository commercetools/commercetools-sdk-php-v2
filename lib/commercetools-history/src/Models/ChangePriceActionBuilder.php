...
/**
 * @implements Builder<ChangePriceAction>
 */
final class ChangePriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangePriceAction
    {
        return new ChangePriceActionModel(
            $this->change,
            $this->catalogData,
            $this->priceId,
    ...
    public static function of(): ChangePriceActionBuilder
    {
        return new self();
    }
}
