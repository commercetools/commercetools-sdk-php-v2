...
/**
 * @implements Builder<SetStoreAction>
 */
final class SetStoreActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetStoreAction
    {
        return new SetStoreActionModel(
            $this->change,
    ...
    public static function of(): SetStoreActionBuilder
    {
        return new self();
    }
}
