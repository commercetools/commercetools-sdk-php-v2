 ...
 * @internal
 */
final class RemoveShoppingListLineItemChangeModel extends JsonObjectModel implements RemoveShoppingListLineItemChange
{
    public const DISCRIMINATOR_VALUE = 'RemoveShoppingListLineItemChange';
    /**
     * @var ?string
     */
    protected $type;
