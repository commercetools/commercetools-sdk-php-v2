 ...
 * @internal
 */
final class SetShoppingListLineItemCustomFieldActionModel extends JsonObjectModel implements SetShoppingListLineItemCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'SetShoppingListLineItemCustomFieldAction';
    /**
     * @var ?string
     */
    protected $type;
