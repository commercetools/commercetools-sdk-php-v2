 ...
 * @internal
 */
final class AddCustomLineItemActionModel extends JsonObjectModel implements AddCustomLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'AddCustomLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
