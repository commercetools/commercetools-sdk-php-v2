 ...
 * @internal
 */
final class SetMethodInfoInterfaceActionModel extends JsonObjectModel implements SetMethodInfoInterfaceAction
{
    public const DISCRIMINATOR_VALUE = 'SetMethodInfoInterfaceAction';
    /**
     * @var ?string
     */
    protected $type;
