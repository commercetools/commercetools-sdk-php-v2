...
/**
 * @implements Builder<RemoveParcelFromDeliveryAction>
 */
final class RemoveParcelFromDeliveryActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveParcelFromDeliveryAction
    {
        return new RemoveParcelFromDeliveryActionModel(
            $this->change,
            $this->deliveryId,
    ...
    public static function of(): RemoveParcelFromDeliveryActionBuilder
    {
        return new self();
    }
}
