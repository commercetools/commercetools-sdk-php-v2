...
/**
 * @implements Builder<RemoveItemShippingAddressesAction>
 */
final class RemoveItemShippingAddressesActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveItemShippingAddressesAction
    {
        return new RemoveItemShippingAddressesActionModel(
            $this->change,
    ...
    public static function of(): RemoveItemShippingAddressesActionBuilder
    {
        return new self();
    }
}
