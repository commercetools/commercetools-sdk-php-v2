...
/**
 * @implements Builder<SetAddressAction>
 */
final class SetAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetAddressAction
    {
        return new SetAddressActionModel(
            $this->change,
    ...
    public static function of(): SetAddressActionBuilder
    {
        return new self();
    }
}
