...
/**
 * @implements Builder<SetTextLineItemDescriptionAction>
 */
final class SetTextLineItemDescriptionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetTextLineItemDescriptionAction
    {
        return new SetTextLineItemDescriptionActionModel(
            $this->change,
    ...
    public static function of(): SetTextLineItemDescriptionActionBuilder
    {
        return new self();
    }
}
