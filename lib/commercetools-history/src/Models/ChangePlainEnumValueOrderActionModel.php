 ...
 * @internal
 */
final class ChangePlainEnumValueOrderActionModel extends JsonObjectModel implements ChangePlainEnumValueOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangePlainEnumValueOrderAction';
    /**
     * @var ?string
     */
    protected $type;
