 ...
 * @internal
 */
final class SetReturnPaymentStateActionModel extends JsonObjectModel implements SetReturnPaymentStateAction
{
    public const DISCRIMINATOR_VALUE = 'SetReturnPaymentStateAction';
    /**
     * @var ?string
     */
    protected $type;
