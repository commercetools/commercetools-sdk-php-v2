 ...
 * @internal
 */
final class ChangePlainEnumValueLabelActionModel extends JsonObjectModel implements ChangePlainEnumValueLabelAction
{
    public const DISCRIMINATOR_VALUE = 'ChangePlainEnumValueLabelAction';
    /**
     * @var ?string
     */
    protected $type;
