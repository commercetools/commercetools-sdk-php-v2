 ...
 * @internal
 */
final class SetCustomLineItemTotalPriceActionModel extends JsonObjectModel implements SetCustomLineItemTotalPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemTotalPriceAction';
    /**
     * @var ?string
     */
    protected $type;
