 ...
 * @internal
 */
final class ChangeEnumValueLabelActionModel extends JsonObjectModel implements ChangeEnumValueLabelAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeEnumValueLabelAction';
    /**
     * @var ?string
     */
    protected $type;
