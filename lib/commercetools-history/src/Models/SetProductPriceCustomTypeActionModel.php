 ...
 * @internal
 */
final class SetProductPriceCustomTypeActionModel extends JsonObjectModel implements SetProductPriceCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'SetProductPriceCustomTypeAction';
    /**
     * @var ?string
     */
    protected $type;
