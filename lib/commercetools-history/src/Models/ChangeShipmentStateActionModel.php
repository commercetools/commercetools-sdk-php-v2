 ...
 * @internal
 */
final class ChangeShipmentStateActionModel extends JsonObjectModel implements ChangeShipmentStateAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeShipmentStateAction';
    /**
     * @var ?string
     */
    protected $type;
