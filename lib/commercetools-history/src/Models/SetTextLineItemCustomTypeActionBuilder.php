...
/**
 * @implements Builder<SetTextLineItemCustomTypeAction>
 */
final class SetTextLineItemCustomTypeActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetTextLineItemCustomTypeAction
    {
        return new SetTextLineItemCustomTypeActionModel(
            $this->change,
    ...
    public static function of(): SetTextLineItemCustomTypeActionBuilder
    {
        return new self();
    }
}
