 ...
 * @internal
 */
final class ChangeEnumValueOrderActionModel extends JsonObjectModel implements ChangeEnumValueOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeEnumValueOrderAction';
    /**
     * @var ?string
     */
    protected $type;
