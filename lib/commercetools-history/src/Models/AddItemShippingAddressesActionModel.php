 ...
 * @internal
 */
final class AddItemShippingAddressesActionModel extends JsonObjectModel implements AddItemShippingAddressesAction
{
    public const DISCRIMINATOR_VALUE = 'AddItemShippingAddressesAction';
    /**
     * @var ?string
     */
    protected $type;
