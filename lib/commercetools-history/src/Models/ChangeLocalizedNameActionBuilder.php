...
/**
 * @implements Builder<ChangeLocalizedNameAction>
 */
final class ChangeLocalizedNameActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeLocalizedNameAction
    {
        return new ChangeLocalizedNameActionModel(
            $this->change,
    ...
    public static function of(): ChangeLocalizedNameActionBuilder
    {
        return new self();
    }
}
