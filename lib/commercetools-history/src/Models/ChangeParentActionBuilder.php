...
/**
 * @implements Builder<ChangeParentAction>
 */
final class ChangeParentActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeParentAction
    {
        return new ChangeParentActionModel(
            $this->change,
    ...
    public static function of(): ChangeParentActionBuilder
    {
        return new self();
    }
}
