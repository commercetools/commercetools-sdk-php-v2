 ...
 * @internal
 */
final class ChangeFieldDefinitionOrderActionModel extends JsonObjectModel implements ChangeFieldDefinitionOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeFieldDefinitionOrderAction';
    /**
     * @var ?string
     */
    protected $type;
