...
/**
 * @implements Builder<SetMethodInfoNameAction>
 */
final class SetMethodInfoNameActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMethodInfoNameAction
    {
        return new SetMethodInfoNameActionModel(
            $this->change,
    ...
    public static function of(): SetMethodInfoNameActionBuilder
    {
        return new self();
    }
}
