...
/**
 * @implements Builder<ChangeEnumValueOrderAction>
 */
final class ChangeEnumValueOrderActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeEnumValueOrderAction
    {
        return new ChangeEnumValueOrderActionModel(
            $this->change,
            $this->fieldName,
            $this->nextValue,
            $this->previousValue
    ...
    public static function of(): ChangeEnumValueOrderActionBuilder
    {
        return new self();
    }
}
