 ...
 * @internal
 */
final class RemoveParcelFromDeliveryActionModel extends JsonObjectModel implements RemoveParcelFromDeliveryAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveParcelFromDeliveryAction';
    /**
     * @var ?string
     */
    protected $type;
