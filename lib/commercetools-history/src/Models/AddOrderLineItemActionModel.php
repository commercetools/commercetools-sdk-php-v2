 ...
 * @internal
 */
final class AddOrderLineItemActionModel extends JsonObjectModel implements AddOrderLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'AddOrderLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
