 ...
 * @internal
 */
final class SetMethodInfoNameActionModel extends JsonObjectModel implements SetMethodInfoNameAction
{
    public const DISCRIMINATOR_VALUE = 'SetMethodInfoNameAction';
    /**
     * @var ?string
     */
    protected $type;
