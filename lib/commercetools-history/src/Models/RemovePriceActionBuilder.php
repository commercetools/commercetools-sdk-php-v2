...
/**
 * @implements Builder<RemovePriceAction>
 */
final class RemovePriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemovePriceAction
    {
        return new RemovePriceActionModel(
            $this->change,
            $this->catalogData,
            $this->priceId,
    ...
    public static function of(): RemovePriceActionBuilder
    {
        return new self();
    }
}
