 ...
 * @internal
 */
final class ChangeCartDiscountsActionModel extends JsonObjectModel implements ChangeCartDiscountsAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeCartDiscountsAction';
    /**
     * @var ?string
     */
    protected $type;
