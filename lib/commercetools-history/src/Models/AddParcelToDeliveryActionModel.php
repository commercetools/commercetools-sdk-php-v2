 ...
 * @internal
 */
final class AddParcelToDeliveryActionModel extends JsonObjectModel implements AddParcelToDeliveryAction
{
    public const DISCRIMINATOR_VALUE = 'AddParcelToDeliveryAction';
    /**
     * @var ?string
     */
    protected $type;
