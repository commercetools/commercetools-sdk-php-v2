 ...
 * @internal
 */
final class SetAssetCustomTypeActionModel extends JsonObjectModel implements SetAssetCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'SetAssetCustomTypeAction';
    /**
     * @var ?string
     */
    protected $type;
