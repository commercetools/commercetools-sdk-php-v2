 ...
 * @internal
 */
final class RemoveLocalizedEnumValuesActionModel extends JsonObjectModel implements RemoveLocalizedEnumValuesAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveLocalizedEnumValuesAction';
    /**
     * @var ?string
     */
    protected $type;
