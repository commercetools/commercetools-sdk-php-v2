...
/**
 * @implements Builder<RemoveShoppingListLineItemAction>
 */
final class RemoveShoppingListLineItemActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveShoppingListLineItemAction
    {
        return new RemoveShoppingListLineItemActionModel(
            $this->change,
    ...
    public static function of(): RemoveShoppingListLineItemActionBuilder
    {
        return new self();
    }
}
