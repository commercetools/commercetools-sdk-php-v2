 ...
 * @internal
 */
final class ChangeTextLineItemsOrderActionModel extends JsonObjectModel implements ChangeTextLineItemsOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeTextLineItemsOrderAction';
    /**
     * @var ?string
     */
    protected $type;
