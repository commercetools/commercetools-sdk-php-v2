...
/**
 * @implements Builder<SetVariantAvailabilityAction>
 */
final class SetVariantAvailabilityActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetVariantAvailabilityAction
    {
        return new SetVariantAvailabilityActionModel(
            $this->change,
            $this->catalogData,
            $this->variant,
    ...
    public static function of(): SetVariantAvailabilityActionBuilder
    {
        return new self();
    }
}
