...
/**
 * @implements Builder<TransitionStateAction>
 */
final class TransitionStateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): TransitionStateAction
    {
        return new TransitionStateActionModel(
            $this->change,
    ...
    public static function of(): TransitionStateActionBuilder
    {
        return new self();
    }
}
