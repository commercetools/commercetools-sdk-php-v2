...
/**
 * @implements Builder<AddCustomLineItemAction>
 */
final class AddCustomLineItemActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddCustomLineItemAction
    {
        return new AddCustomLineItemActionModel(
            $this->change,
    ...
    public static function of(): AddCustomLineItemActionBuilder
    {
        return new self();
    }
}
