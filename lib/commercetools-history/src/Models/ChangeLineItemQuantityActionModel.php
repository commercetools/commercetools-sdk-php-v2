 ...
 * @internal
 */
final class ChangeLineItemQuantityActionModel extends JsonObjectModel implements ChangeLineItemQuantityAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeLineItemQuantityAction';
    /**
     * @var ?string
     */
    protected $type;
