...
/**
 * @implements Builder<SetGeoLocationAction>
 */
final class SetGeoLocationActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetGeoLocationAction
    {
        return new SetGeoLocationActionModel(
            $this->change,
    ...
    public static function of(): SetGeoLocationActionBuilder
    {
        return new self();
    }
}
