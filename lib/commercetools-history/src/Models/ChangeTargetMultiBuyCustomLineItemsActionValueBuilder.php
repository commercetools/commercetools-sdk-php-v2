...
/**
 * @implements Builder<ChangeTargetMultiBuyCustomLineItemsActionValue>
 */
final class ChangeTargetMultiBuyCustomLineItemsActionValueBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeTargetMultiBuyCustomLineItemsActionValue
    {
        return new ChangeTargetMultiBuyCustomLineItemsActionValueModel(
            $this->predicate,
    ...
    public static function of(): ChangeTargetMultiBuyCustomLineItemsActionValueBuilder
    {
        return new self();
    }
}
