 ...
 * @internal
 */
final class ChangeAmountPlannedActionModel extends JsonObjectModel implements ChangeAmountPlannedAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeAmountPlannedAction';
    /**
     * @var ?string
     */
    protected $type;
