 ...
 * @internal
 */
final class RemoveAttributeDefinitionActionModel extends JsonObjectModel implements RemoveAttributeDefinitionAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveAttributeDefinitionAction';
    /**
     * @var ?string
     */
    protected $type;
