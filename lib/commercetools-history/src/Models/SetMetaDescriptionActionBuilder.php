...
/**
 * @implements Builder<SetMetaDescriptionAction>
 */
final class SetMetaDescriptionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMetaDescriptionAction
    {
        return new SetMetaDescriptionActionModel(
            $this->change,
    ...
    public static function of(): SetMetaDescriptionActionBuilder
    {
        return new self();
    }
}
