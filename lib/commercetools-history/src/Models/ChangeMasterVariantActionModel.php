 ...
 * @internal
 */
final class ChangeMasterVariantActionModel extends JsonObjectModel implements ChangeMasterVariantAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeMasterVariantAction';
    /**
     * @var ?string
     */
    protected $type;
