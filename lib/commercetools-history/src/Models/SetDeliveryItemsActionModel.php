 ...
 * @internal
 */
final class SetDeliveryItemsActionModel extends JsonObjectModel implements SetDeliveryItemsAction
{
    public const DISCRIMINATOR_VALUE = 'SetDeliveryItemsAction';
    /**
     * @var ?string
     */
    protected $type;
