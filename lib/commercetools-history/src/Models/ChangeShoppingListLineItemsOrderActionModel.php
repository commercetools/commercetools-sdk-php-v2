 ...
 * @internal
 */
final class ChangeShoppingListLineItemsOrderActionModel extends JsonObjectModel implements ChangeShoppingListLineItemsOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeShoppingListLineItemsOrderAction';
    /**
     * @var ?string
     */
    protected $type;
