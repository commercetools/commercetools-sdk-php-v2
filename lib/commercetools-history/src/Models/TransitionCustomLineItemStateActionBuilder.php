...
/**
 * @implements Builder<TransitionCustomLineItemStateAction>
 */
final class TransitionCustomLineItemStateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): TransitionCustomLineItemStateAction
    {
        return new TransitionCustomLineItemStateActionModel(
            $this->change,
            $this->lineItemId,
            $this->stateId,
            $this->nextValue,
    ...
    public static function of(): TransitionCustomLineItemStateActionBuilder
    {
        return new self();
    }
}
