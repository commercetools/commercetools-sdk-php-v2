 ...
 * @internal
 */
final class SetSearchKeywordsActionModel extends JsonObjectModel implements SetSearchKeywordsAction
{
    public const DISCRIMINATOR_VALUE = 'SetSearchKeywordsAction';
    /**
     * @var ?string
     */
    protected $type;
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue =  SearchKeywordsModel::of($data);
        }
    ...
    public function getNextValue()
    {
        if (is_null($this->nextValue)) {
            ...
            $this->nextValue =  SearchKeywordsModel::of($data);
        }
