 ...
 * @internal
 */
final class SetAssetCustomFieldActionModel extends JsonObjectModel implements SetAssetCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'SetAssetCustomFieldAction';
    /**
     * @var ?string
     */
    protected $type;
