...
/**
 * @implements Builder<SetMetaTitleChange>
 */
final class SetMetaTitleChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMetaTitleChange
    {
        return new SetMetaTitleChangeModel(
            $this->change,
    ...
    public static function of(): SetMetaTitleChangeBuilder
    {
        return new self();
    }
}
