 ...
 * @internal
 */
final class ChangeCustomLineItemQuantityActionModel extends JsonObjectModel implements ChangeCustomLineItemQuantityAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeCustomLineItemQuantityAction';
    /**
     * @var ?string
     */
    protected $type;
