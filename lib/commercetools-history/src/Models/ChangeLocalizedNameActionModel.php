 ...
 * @internal
 */
final class ChangeLocalizedNameActionModel extends JsonObjectModel implements ChangeLocalizedNameAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeLocalizedNameAction';
    /**
     * @var ?string
     */
    protected $type;
