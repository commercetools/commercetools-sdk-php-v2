 ...
 * @internal
 */
final class SetImageLabelActionModel extends JsonObjectModel implements SetImageLabelAction
{
    public const DISCRIMINATOR_VALUE = 'SetImageLabelAction';
    /**
     * @var ?string
     */
    protected $type;
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue =  ImageModel::of($data);
        }
    ...
    public function getNextValue()
    {
        if (is_null($this->nextValue)) {
            ...
            $this->nextValue =  ImageModel::of($data);
        }
