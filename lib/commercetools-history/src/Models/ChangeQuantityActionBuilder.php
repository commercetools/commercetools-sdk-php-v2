...
/**
 * @implements Builder<ChangeQuantityAction>
 */
final class ChangeQuantityActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeQuantityAction
    {
        return new ChangeQuantityActionModel(
            $this->change,
    ...
    public static function of(): ChangeQuantityActionBuilder
    {
        return new self();
    }
}
