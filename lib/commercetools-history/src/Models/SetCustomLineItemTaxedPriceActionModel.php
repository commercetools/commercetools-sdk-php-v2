 ...
 * @internal
 */
final class SetCustomLineItemTaxedPriceActionModel extends JsonObjectModel implements SetCustomLineItemTaxedPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemTaxedPriceAction';
    /**
     * @var ?string
     */
    protected $type;
