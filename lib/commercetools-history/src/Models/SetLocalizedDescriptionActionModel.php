 ...
 * @internal
 */
final class SetLocalizedDescriptionActionModel extends JsonObjectModel implements SetLocalizedDescriptionAction
{
    public const DISCRIMINATOR_VALUE = 'SetLocalizedDescriptionAction';
    /**
     * @var ?string
     */
    protected $type;
