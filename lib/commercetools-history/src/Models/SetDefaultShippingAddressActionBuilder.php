...
/**
 * @implements Builder<SetDefaultShippingAddressAction>
 */
final class SetDefaultShippingAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDefaultShippingAddressAction
    {
        return new SetDefaultShippingAddressActionModel(
            $this->change,
    ...
    public static function of(): SetDefaultShippingAddressActionBuilder
    {
        return new self();
    }
}
