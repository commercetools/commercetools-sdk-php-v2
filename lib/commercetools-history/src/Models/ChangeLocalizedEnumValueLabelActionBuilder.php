...
/**
 * @implements Builder<ChangeLocalizedEnumValueLabelAction>
 */
final class ChangeLocalizedEnumValueLabelActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeLocalizedEnumValueLabelAction
    {
        return new ChangeLocalizedEnumValueLabelActionModel(
            $this->change,
            $this->fieldName,
            $this->attributeName,
            $this->valueKey,
    ...
    public static function of(): ChangeLocalizedEnumValueLabelActionBuilder
    {
        return new self();
    }
}
