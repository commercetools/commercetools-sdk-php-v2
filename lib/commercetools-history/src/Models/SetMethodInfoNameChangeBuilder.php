...
/**
 * @implements Builder<SetMethodInfoNameChange>
 */
final class SetMethodInfoNameChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMethodInfoNameChange
    {
        return new SetMethodInfoNameChangeModel(
            $this->change,
    ...
    public static function of(): SetMethodInfoNameChangeBuilder
    {
        return new self();
    }
}
