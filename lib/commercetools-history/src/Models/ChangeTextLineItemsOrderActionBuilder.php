...
/**
 * @implements Builder<ChangeTextLineItemsOrderAction>
 */
final class ChangeTextLineItemsOrderActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeTextLineItemsOrderAction
    {
        return new ChangeTextLineItemsOrderActionModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): ChangeTextLineItemsOrderActionBuilder
    {
        return new self();
    }
}
