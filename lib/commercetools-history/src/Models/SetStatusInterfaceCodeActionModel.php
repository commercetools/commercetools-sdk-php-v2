 ...
 * @internal
 */
final class SetStatusInterfaceCodeActionModel extends JsonObjectModel implements SetStatusInterfaceCodeAction
{
    public const DISCRIMINATOR_VALUE = 'SetStatusInterfaceCodeAction';
    /**
     * @var ?string
     */
    protected $type;
