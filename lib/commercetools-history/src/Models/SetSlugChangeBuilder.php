...
/**
 * @implements Builder<SetSlugChange>
 */
final class SetSlugChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetSlugChange
    {
        return new SetSlugChangeModel(
            $this->change,
    ...
    public static function of(): SetSlugChangeBuilder
    {
        return new self();
    }
}
