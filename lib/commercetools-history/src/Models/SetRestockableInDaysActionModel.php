 ...
 * @internal
 */
final class SetRestockableInDaysActionModel extends JsonObjectModel implements SetRestockableInDaysAction
{
    public const DISCRIMINATOR_VALUE = 'SetRestockableInDaysAction';
    /**
     * @var ?string
     */
    protected $type;
