...
/**
 * @implements Builder<AddVariantAction>
 */
final class AddVariantActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddVariantAction
    {
        return new AddVariantActionModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): AddVariantActionBuilder
    {
        return new self();
    }
}
