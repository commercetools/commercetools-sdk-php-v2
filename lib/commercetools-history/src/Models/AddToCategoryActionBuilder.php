...
/**
 * @implements Builder<AddToCategoryAction>
 */
final class AddToCategoryActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddToCategoryAction
    {
        return new AddToCategoryActionModel(
            $this->change,
    ...
    public static function of(): AddToCategoryActionBuilder
    {
        return new self();
    }
}
