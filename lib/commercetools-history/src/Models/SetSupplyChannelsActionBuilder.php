...
/**
 * @implements Builder<SetSupplyChannelsAction>
 */
final class SetSupplyChannelsActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetSupplyChannelsAction
    {
        return new SetSupplyChannelsActionModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): SetSupplyChannelsActionBuilder
    {
        return new self();
    }
}
