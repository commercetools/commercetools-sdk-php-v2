 ...
 * @internal
 */
final class ChangeDescriptionActionModel extends JsonObjectModel implements ChangeDescriptionAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeDescriptionAction';
    /**
     * @var ?string
     */
    protected $type;
