 ...
 * @internal
 */
final class SetCustomerEmailActionModel extends JsonObjectModel implements SetCustomerEmailAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomerEmailAction';
    /**
     * @var ?string
     */
    protected $type;
