...
/**
 * @implements Builder<SetDefaultBillingAddressAction>
 */
final class SetDefaultBillingAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDefaultBillingAddressAction
    {
        return new SetDefaultBillingAddressActionModel(
            $this->change,
    ...
    public static function of(): SetDefaultBillingAddressActionBuilder
    {
        return new self();
    }
}
