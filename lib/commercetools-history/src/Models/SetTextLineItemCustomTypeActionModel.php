 ...
 * @internal
 */
final class SetTextLineItemCustomTypeActionModel extends JsonObjectModel implements SetTextLineItemCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'SetTextLineItemCustomTypeAction';
    /**
     * @var ?string
     */
    protected $type;
