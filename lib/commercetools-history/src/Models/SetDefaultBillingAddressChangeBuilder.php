...
/**
 * @implements Builder<SetDefaultBillingAddressChange>
 */
final class SetDefaultBillingAddressChangeBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDefaultBillingAddressChange
    {
        return new SetDefaultBillingAddressChangeModel(
            $this->change,
    ...
    public static function of(): SetDefaultBillingAddressChangeBuilder
    {
        return new self();
    }
}
