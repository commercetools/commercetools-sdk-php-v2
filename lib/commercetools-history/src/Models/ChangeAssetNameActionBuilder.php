...
/**
 * @implements Builder<ChangeAssetNameAction>
 */
final class ChangeAssetNameActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeAssetNameAction
    {
        return new ChangeAssetNameActionModel(
            $this->change,
    ...
    public static function of(): ChangeAssetNameActionBuilder
    {
        return new self();
    }
}
