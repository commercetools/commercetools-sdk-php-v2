 ...
 * @internal
 */
final class TransitionLineItemStateActionModel extends JsonObjectModel implements TransitionLineItemStateAction
{
    public const DISCRIMINATOR_VALUE = 'TransitionLineItemStateAction';
    /**
     * @var ?string
     */
    protected $type;
