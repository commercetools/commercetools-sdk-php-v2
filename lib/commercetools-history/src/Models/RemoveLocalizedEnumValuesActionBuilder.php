...
/**
 * @implements Builder<RemoveLocalizedEnumValuesAction>
 */
final class RemoveLocalizedEnumValuesActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveLocalizedEnumValuesAction
    {
        return new RemoveLocalizedEnumValuesActionModel(
            $this->change,
            $this->attributeName,
    ...
    public static function of(): RemoveLocalizedEnumValuesActionBuilder
    {
        return new self();
    }
}
