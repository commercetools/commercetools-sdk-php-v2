...
/**
 * @implements Builder<RemovePaymentAction>
 */
final class RemovePaymentActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemovePaymentAction
    {
        return new RemovePaymentActionModel(
            $this->change,
    ...
    public static function of(): RemovePaymentActionBuilder
    {
        return new self();
    }
}
