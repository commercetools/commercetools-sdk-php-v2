 ...
 * @internal
 */
final class SetLineItemShippingDetailsActionModel extends JsonObjectModel implements SetLineItemShippingDetailsAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemShippingDetailsAction';
    /**
     * @var ?string
     */
    protected $type;
