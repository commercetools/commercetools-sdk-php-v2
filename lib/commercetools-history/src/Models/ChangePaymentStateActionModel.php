 ...
 * @internal
 */
final class ChangePaymentStateActionModel extends JsonObjectModel implements ChangePaymentStateAction
{
    public const DISCRIMINATOR_VALUE = 'ChangePaymentStateAction';
    /**
     * @var ?string
     */
    protected $type;
