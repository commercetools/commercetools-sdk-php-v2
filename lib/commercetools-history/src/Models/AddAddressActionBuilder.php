...
/**
 * @implements Builder<AddAddressAction>
 */
final class AddAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddAddressAction
    {
        return new AddAddressActionModel(
            $this->change,
    ...
    public static function of(): AddAddressActionBuilder
    {
        return new self();
    }
}
