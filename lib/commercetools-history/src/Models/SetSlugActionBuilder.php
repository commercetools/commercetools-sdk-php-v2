...
/**
 * @implements Builder<SetSlugAction>
 */
final class SetSlugActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetSlugAction
    {
        return new SetSlugActionModel(
            $this->change,
    ...
    public static function of(): SetSlugActionBuilder
    {
        return new self();
    }
}
