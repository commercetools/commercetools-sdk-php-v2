 ...
 * @internal
 */
final class AddExternalImageActionModel extends JsonObjectModel implements AddExternalImageAction
{
    public const DISCRIMINATOR_VALUE = 'AddExternalImageAction';
    /**
     * @var ?string
     */
    protected $type;
