...
/**
 * @implements Builder<ChangeTargetMultiBuyLineItemsActionValue>
 */
final class ChangeTargetMultiBuyLineItemsActionValueBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeTargetMultiBuyLineItemsActionValue
    {
        return new ChangeTargetMultiBuyLineItemsActionValueModel(
            $this->predicate,
    ...
    public static function of(): ChangeTargetMultiBuyLineItemsActionValueBuilder
    {
        return new self();
    }
}
