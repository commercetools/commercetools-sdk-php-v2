 ...
 * @internal
 */
final class RemoveEnumValuesActionModel extends JsonObjectModel implements RemoveEnumValuesAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveEnumValuesAction';
    /**
     * @var ?string
     */
    protected $type;
