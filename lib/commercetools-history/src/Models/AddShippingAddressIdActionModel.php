 ...
 * @internal
 */
final class AddShippingAddressIdActionModel extends JsonObjectModel implements AddShippingAddressIdAction
{
    public const DISCRIMINATOR_VALUE = 'AddShippingAddressIdAction';
    /**
     * @var ?string
     */
    protected $type;
