 ...
 * @internal
 */
final class ChangeReviewRatingStatisticsActionModel extends JsonObjectModel implements ChangeReviewRatingStatisticsAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeReviewRatingStatisticsAction';
    /**
     * @var ?string
     */
    protected $type;
