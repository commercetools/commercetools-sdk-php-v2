 ...
 * @internal
 */
final class RemoveFromCategoryActionModel extends JsonObjectModel implements RemoveFromCategoryAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveFromCategoryAction';
    /**
     * @var ?string
     */
    protected $type;
