 ...
 * @internal
 */
final class AddLocalizedEnumValueActionModel extends JsonObjectModel implements AddLocalizedEnumValueAction
{
    public const DISCRIMINATOR_VALUE = 'AddLocalizedEnumValueAction';
    /**
     * @var ?string
     */
    protected $type;
