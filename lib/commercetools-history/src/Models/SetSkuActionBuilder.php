...
/**
 * @implements Builder<SetSkuAction>
 */
final class SetSkuActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetSkuAction
    {
        return new SetSkuActionModel(
            $this->change,
            $this->catalogData,
            $this->previousValue,
            $this->nextValue
    ...
    public static function of(): SetSkuActionBuilder
    {
        return new self();
    }
}
