 ...
 * @internal
 */
final class ChangeShoppingListLineItemQuantityActionModel extends JsonObjectModel implements ChangeShoppingListLineItemQuantityAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeShoppingListLineItemQuantityAction';
    /**
     * @var ?string
     */
    protected $type;
