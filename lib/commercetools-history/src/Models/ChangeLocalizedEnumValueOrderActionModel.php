 ...
 * @internal
 */
final class ChangeLocalizedEnumValueOrderActionModel extends JsonObjectModel implements ChangeLocalizedEnumValueOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeLocalizedEnumValueOrderAction';
    /**
     * @var ?string
     */
    protected $type;
