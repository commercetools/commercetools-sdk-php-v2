...
/**
 * @implements Builder<SetCustomLineItemCustomFieldAction>
 */
final class SetCustomLineItemCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemCustomFieldAction
    {
        return new SetCustomLineItemCustomFieldActionModel(
            $this->change,
            $this->name,
    ...
    public static function of(): SetCustomLineItemCustomFieldActionBuilder
    {
        return new self();
    }
}
