 ...
 * @internal
 */
final class SetSupplyChannelActionModel extends JsonObjectModel implements SetSupplyChannelAction
{
    public const DISCRIMINATOR_VALUE = 'SetSupplyChannelAction';
    /**
     * @var ?string
     */
    protected $type;
