...
/**
 * @implements Builder<ChangeTransactionStateAction>
 */
final class ChangeTransactionStateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeTransactionStateAction
    {
        return new ChangeTransactionStateActionModel(
            $this->change,
    ...
    public static function of(): ChangeTransactionStateActionBuilder
    {
        return new self();
    }
}
