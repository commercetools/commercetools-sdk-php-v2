 ...
 * @internal
 */
final class SetLineItemTotalPriceActionModel extends JsonObjectModel implements SetLineItemTotalPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemTotalPriceAction';
    /**
     * @var ?string
     */
    protected $type;
