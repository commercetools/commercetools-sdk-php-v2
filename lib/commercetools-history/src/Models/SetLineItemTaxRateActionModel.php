 ...
 * @internal
 */
final class SetLineItemTaxRateActionModel extends JsonObjectModel implements SetLineItemTaxRateAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemTaxRateAction';
    /**
     * @var ?string
     */
    protected $type;
