 ...
 * @internal
 */
final class SetCustomLineItemCustomTypeActionModel extends JsonObjectModel implements SetCustomLineItemCustomTypeAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemCustomTypeAction';
    /**
     * @var ?string
     */
    protected $type;
