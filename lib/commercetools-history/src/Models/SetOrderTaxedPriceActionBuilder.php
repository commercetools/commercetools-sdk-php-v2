...
/**
 * @implements Builder<SetOrderTaxedPriceAction>
 */
final class SetOrderTaxedPriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetOrderTaxedPriceAction
    {
        return new SetOrderTaxedPriceActionModel(
            $this->change,
    ...
    public static function of(): SetOrderTaxedPriceActionBuilder
    {
        return new self();
    }
}
