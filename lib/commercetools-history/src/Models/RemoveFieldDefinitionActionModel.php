 ...
 * @internal
 */
final class RemoveFieldDefinitionActionModel extends JsonObjectModel implements RemoveFieldDefinitionAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveFieldDefinitionAction';
    /**
     * @var ?string
     */
    protected $type;
