 ...
 * @internal
 */
final class SetLineItemProductSlugActionModel extends JsonObjectModel implements SetLineItemProductSlugAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemProductSlugAction';
    /**
     * @var ?string
     */
    protected $type;
