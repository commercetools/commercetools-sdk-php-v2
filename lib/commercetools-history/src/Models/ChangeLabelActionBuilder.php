...
/**
 * @implements Builder<ChangeLabelAction>
 */
final class ChangeLabelActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeLabelAction
    {
        return new ChangeLabelActionModel(
            $this->change,
            $this->fieldName,
            $this->attributeName,
    ...
    public static function of(): ChangeLabelActionBuilder
    {
        return new self();
    }
}
