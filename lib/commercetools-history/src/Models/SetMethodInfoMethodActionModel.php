 ...
 * @internal
 */
final class SetMethodInfoMethodActionModel extends JsonObjectModel implements SetMethodInfoMethodAction
{
    public const DISCRIMINATOR_VALUE = 'SetMethodInfoMethodAction';
    /**
     * @var ?string
     */
    protected $type;
