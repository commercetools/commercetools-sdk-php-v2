...
/**
 * @implements Builder<SetDeliveryAddressAction>
 */
final class SetDeliveryAddressActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDeliveryAddressAction
    {
        return new SetDeliveryAddressActionModel(
            $this->change,
            $this->deliveryId,
    ...
    public static function of(): SetDeliveryAddressActionBuilder
    {
        return new self();
    }
}
