 ...
 * @internal
 */
final class SetDeliveryAddressActionModel extends JsonObjectModel implements SetDeliveryAddressAction
{
    public const DISCRIMINATOR_VALUE = 'SetDeliveryAddressAction';
    /**
     * @var ?string
     */
    protected $type;
