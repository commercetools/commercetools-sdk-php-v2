...
/**
 * @implements Builder<SetCustomLineItemMoneyAction>
 */
final class SetCustomLineItemMoneyActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemMoneyAction
    {
        return new SetCustomLineItemMoneyActionModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemMoneyActionBuilder
    {
        return new self();
    }
}
