 ...
 * @internal
 */
final class SetLineItemPriceActionModel extends JsonObjectModel implements SetLineItemPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemPriceAction';
    /**
     * @var ?string
     */
    protected $type;
