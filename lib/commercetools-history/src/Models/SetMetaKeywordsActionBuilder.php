...
/**
 * @implements Builder<SetMetaKeywordsAction>
 */
final class SetMetaKeywordsActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetMetaKeywordsAction
    {
        return new SetMetaKeywordsActionModel(
            $this->change,
    ...
    public static function of(): SetMetaKeywordsActionBuilder
    {
        return new self();
    }
}
