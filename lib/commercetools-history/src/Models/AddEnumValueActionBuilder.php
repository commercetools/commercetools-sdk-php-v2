...
/**
 * @implements Builder<AddEnumValueAction>
 */
final class AddEnumValueActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddEnumValueAction
    {
        return new AddEnumValueActionModel(
            $this->change,
            $this->fieldName,
    ...
    public static function of(): AddEnumValueActionBuilder
    {
        return new self();
    }
}
