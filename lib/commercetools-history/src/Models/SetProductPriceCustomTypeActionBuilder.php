...
/**
 * @implements Builder<SetProductPriceCustomTypeAction>
 */
final class SetProductPriceCustomTypeActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetProductPriceCustomTypeAction
    {
        return new SetProductPriceCustomTypeActionModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): SetProductPriceCustomTypeActionBuilder
    {
        return new self();
    }
}
