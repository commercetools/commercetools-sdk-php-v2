 ...
 * @internal
 */
final class SetLineItemDiscountedPricePerQuantityActionModel extends JsonObjectModel implements SetLineItemDiscountedPricePerQuantityAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemDiscountedPricePerQuantityAction';
    /**
     * @var ?string
     */
    protected $type;
