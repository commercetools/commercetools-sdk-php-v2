...
/**
 * @implements Builder<AddFieldDefinitionAction>
 */
final class AddFieldDefinitionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddFieldDefinitionAction
    {
        return new AddFieldDefinitionActionModel(
            $this->change,
            $this->nextValue instanceof FieldDefinitionBuilder ? $this->nextValue->build() : $this->nextValue
        );
    }

    public static function of(): AddFieldDefinitionActionBuilder
    {
        return new self();
    }
}
