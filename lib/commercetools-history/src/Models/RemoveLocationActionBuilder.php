...
/**
 * @implements Builder<RemoveLocationAction>
 */
final class RemoveLocationActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveLocationAction
    {
        return new RemoveLocationActionModel(
            $this->change,
    ...
    public static function of(): RemoveLocationActionBuilder
    {
        return new self();
    }
}
