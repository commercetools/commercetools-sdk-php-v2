 ...
 * @internal
 */
final class ChangeAssetOrderActionModel extends JsonObjectModel implements ChangeAssetOrderAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeAssetOrderAction';
    /**
     * @var ?string
     */
    protected $type;
