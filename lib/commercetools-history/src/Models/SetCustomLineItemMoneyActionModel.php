 ...
 * @internal
 */
final class SetCustomLineItemMoneyActionModel extends JsonObjectModel implements SetCustomLineItemMoneyAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemMoneyAction';
    /**
     * @var ?string
     */
    protected $type;
