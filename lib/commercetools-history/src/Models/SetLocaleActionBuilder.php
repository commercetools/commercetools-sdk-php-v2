...
/**
 * @implements Builder<SetLocaleAction>
 */
final class SetLocaleActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetLocaleAction
    {
        return new SetLocaleActionModel(
            $this->change,
            $this->previousValue,
            $this->nextValue
        );
    ...
    public static function of(): SetLocaleActionBuilder
    {
        return new self();
    }
}
