...
/**
 * @implements Builder<SetCustomerAction>
 */
final class SetCustomerActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomerAction
    {
        return new SetCustomerActionModel(
            $this->change,
    ...
    public static function of(): SetCustomerActionBuilder
    {
        return new self();
    }
}
