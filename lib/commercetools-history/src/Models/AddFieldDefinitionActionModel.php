 ...
 * @internal
 */
final class AddFieldDefinitionActionModel extends JsonObjectModel implements AddFieldDefinitionAction
{
    public const DISCRIMINATOR_VALUE = 'AddFieldDefinitionAction';
    /**
     * @var ?string
     */
    protected $type;
