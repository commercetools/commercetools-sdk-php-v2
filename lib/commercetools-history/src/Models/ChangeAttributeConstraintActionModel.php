 ...
 * @internal
 */
final class ChangeAttributeConstraintActionModel extends JsonObjectModel implements ChangeAttributeConstraintAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeAttributeConstraintAction';
    /**
     * @var ?string
     */
    protected $type;
