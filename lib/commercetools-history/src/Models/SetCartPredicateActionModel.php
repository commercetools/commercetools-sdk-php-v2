 ...
 * @internal
 */
final class SetCartPredicateActionModel extends JsonObjectModel implements SetCartPredicateAction
{
    public const DISCRIMINATOR_VALUE = 'SetCartPredicateAction';
    /**
     * @var ?string
     */
    protected $type;
