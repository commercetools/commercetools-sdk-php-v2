...
/**
 * @implements Builder<SetLocalizedDescriptionAction>
 */
final class SetLocalizedDescriptionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetLocalizedDescriptionAction
    {
        return new SetLocalizedDescriptionActionModel(
            $this->change,
    ...
    public static function of(): SetLocalizedDescriptionActionBuilder
    {
        return new self();
    }
}
