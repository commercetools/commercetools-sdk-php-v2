 ...
 * @internal
 */
final class SetTextLineItemDescriptionActionModel extends JsonObjectModel implements SetTextLineItemDescriptionAction
{
    public const DISCRIMINATOR_VALUE = 'SetTextLineItemDescriptionAction';
    /**
     * @var ?string
     */
    protected $type;
