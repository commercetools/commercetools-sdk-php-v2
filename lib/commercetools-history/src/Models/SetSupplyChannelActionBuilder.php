...
/**
 * @implements Builder<SetSupplyChannelAction>
 */
final class SetSupplyChannelActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetSupplyChannelAction
    {
        return new SetSupplyChannelActionModel(
            $this->change,
    ...
    public static function of(): SetSupplyChannelActionBuilder
    {
        return new self();
    }
}
