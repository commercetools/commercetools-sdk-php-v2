...
/**
 * @implements Builder<SetCustomLineItemTaxedPriceAction>
 */
final class SetCustomLineItemTaxedPriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemTaxedPriceAction
    {
        return new SetCustomLineItemTaxedPriceActionModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemTaxedPriceActionBuilder
    {
        return new self();
    }
}
