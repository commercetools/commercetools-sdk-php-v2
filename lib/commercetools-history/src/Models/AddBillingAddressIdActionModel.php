 ...
 * @internal
 */
final class AddBillingAddressIdActionModel extends JsonObjectModel implements AddBillingAddressIdAction
{
    public const DISCRIMINATOR_VALUE = 'AddBillingAddressIdAction';
    /**
     * @var ?string
     */
    protected $type;
