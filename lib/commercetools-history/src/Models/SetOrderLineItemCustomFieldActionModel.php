 ...
 * @internal
 */
final class SetOrderLineItemCustomFieldActionModel extends JsonObjectModel implements SetOrderLineItemCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'SetOrderLineItemCustomFieldAction';
    /**
     * @var ?string
     */
    protected $type;
