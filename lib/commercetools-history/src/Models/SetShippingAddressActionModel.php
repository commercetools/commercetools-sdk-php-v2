 ...
 * @internal
 */
final class SetShippingAddressActionModel extends JsonObjectModel implements SetShippingAddressAction
{
    public const DISCRIMINATOR_VALUE = 'SetShippingAddressAction';
    /**
     * @var ?string
     */
    protected $type;
