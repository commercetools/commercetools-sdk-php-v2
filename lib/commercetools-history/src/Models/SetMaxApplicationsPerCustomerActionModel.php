 ...
 * @internal
 */
final class SetMaxApplicationsPerCustomerActionModel extends JsonObjectModel implements SetMaxApplicationsPerCustomerAction
{
    public const DISCRIMINATOR_VALUE = 'SetMaxApplicationsPerCustomerAction';
    /**
     * @var ?string
     */
    protected $type;
