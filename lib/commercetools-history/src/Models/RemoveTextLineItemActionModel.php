 ...
 * @internal
 */
final class RemoveTextLineItemActionModel extends JsonObjectModel implements RemoveTextLineItemAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveTextLineItemAction';
    /**
     * @var ?string
     */
    protected $type;
    ...
    public function getPreviousValue()
    {
        if (is_null($this->previousValue)) {
            ...
            $this->previousValue =  TextLineItemModel::of($data);
        }
