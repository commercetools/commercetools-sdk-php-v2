...
/**
 * @implements Builder<RemoveTaxRateAction>
 */
final class RemoveTaxRateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveTaxRateAction
    {
        return new RemoveTaxRateActionModel(
            $this->change,
    ...
    public static function of(): RemoveTaxRateActionBuilder
    {
        return new self();
    }
}
