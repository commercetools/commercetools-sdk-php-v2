...
/**
 * @implements Builder<SetLineItemPriceAction>
 */
final class SetLineItemPriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetLineItemPriceAction
    {
        return new SetLineItemPriceActionModel(
            $this->change,
    ...
    public static function of(): SetLineItemPriceActionBuilder
    {
        return new self();
    }
}
