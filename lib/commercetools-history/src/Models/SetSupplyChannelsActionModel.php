 ...
 * @internal
 */
final class SetSupplyChannelsActionModel extends JsonObjectModel implements SetSupplyChannelsAction
{
    public const DISCRIMINATOR_VALUE = 'SetSupplyChannelsAction';
    /**
     * @var ?string
     */
    protected $type;
