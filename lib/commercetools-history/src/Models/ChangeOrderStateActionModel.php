 ...
 * @internal
 */
final class ChangeOrderStateActionModel extends JsonObjectModel implements ChangeOrderStateAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeOrderStateAction';
    /**
     * @var ?string
     */
    protected $type;
