 ...
 * @internal
 */
final class SetCustomerGroupActionModel extends JsonObjectModel implements SetCustomerGroupAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomerGroupAction';
    /**
     * @var ?string
     */
    protected $type;
