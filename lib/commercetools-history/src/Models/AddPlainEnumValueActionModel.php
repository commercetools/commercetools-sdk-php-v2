 ...
 * @internal
 */
final class AddPlainEnumValueActionModel extends JsonObjectModel implements AddPlainEnumValueAction
{
    public const DISCRIMINATOR_VALUE = 'AddPlainEnumValueAction';
    /**
     * @var ?string
     */
    protected $type;
