...
/**
 * @implements Builder<SetCustomLineItemTotalPriceAction>
 */
final class SetCustomLineItemTotalPriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemTotalPriceAction
    {
        return new SetCustomLineItemTotalPriceActionModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemTotalPriceActionBuilder
    {
        return new self();
    }
}
