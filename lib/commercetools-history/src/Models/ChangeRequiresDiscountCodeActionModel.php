 ...
 * @internal
 */
final class ChangeRequiresDiscountCodeActionModel extends JsonObjectModel implements ChangeRequiresDiscountCodeAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeRequiresDiscountCodeAction';
    /**
     * @var ?string
     */
    protected $type;
