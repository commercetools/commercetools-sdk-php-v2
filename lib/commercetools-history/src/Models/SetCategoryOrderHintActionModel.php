 ...
 * @internal
 */
final class SetCategoryOrderHintActionModel extends JsonObjectModel implements SetCategoryOrderHintAction
{
    public const DISCRIMINATOR_VALUE = 'SetCategoryOrderHintAction';
    /**
     * @var ?string
     */
    protected $type;
