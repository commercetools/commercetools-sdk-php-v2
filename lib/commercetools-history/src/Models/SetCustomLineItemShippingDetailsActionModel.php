 ...
 * @internal
 */
final class SetCustomLineItemShippingDetailsActionModel extends JsonObjectModel implements SetCustomLineItemShippingDetailsAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemShippingDetailsAction';
    /**
     * @var ?string
     */
    protected $type;
