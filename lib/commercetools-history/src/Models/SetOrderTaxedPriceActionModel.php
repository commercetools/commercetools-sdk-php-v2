 ...
 * @internal
 */
final class SetOrderTaxedPriceActionModel extends JsonObjectModel implements SetOrderTaxedPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetOrderTaxedPriceAction';
    /**
     * @var ?string
     */
    protected $type;
