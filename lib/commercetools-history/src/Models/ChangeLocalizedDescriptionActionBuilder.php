...
/**
 * @implements Builder<ChangeLocalizedDescriptionAction>
 */
final class ChangeLocalizedDescriptionActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeLocalizedDescriptionAction
    {
        return new ChangeLocalizedDescriptionActionModel(
            $this->change,
    ...
    public static function of(): ChangeLocalizedDescriptionActionBuilder
    {
        return new self();
    }
}
