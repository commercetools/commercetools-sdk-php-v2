...
/**
 * @implements Builder<AddPaymentAction>
 */
final class AddPaymentActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddPaymentAction
    {
        return new AddPaymentActionModel(
            $this->change,
    ...
    public static function of(): AddPaymentActionBuilder
    {
        return new self();
    }
}
