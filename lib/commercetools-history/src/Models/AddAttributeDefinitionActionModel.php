 ...
 * @internal
 */
final class AddAttributeDefinitionActionModel extends JsonObjectModel implements AddAttributeDefinitionAction
{
    public const DISCRIMINATOR_VALUE = 'AddAttributeDefinitionAction';
    /**
     * @var ?string
     */
    protected $type;
    ...
    public function getNextValue()
    {
        if (is_null($this->nextValue)) {
            ...
            $this->nextValue =  AttributeDefinitionModel::of($data);
        }
