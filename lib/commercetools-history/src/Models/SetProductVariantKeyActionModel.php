 ...
 * @internal
 */
final class SetProductVariantKeyActionModel extends JsonObjectModel implements SetProductVariantKeyAction
{
    public const DISCRIMINATOR_VALUE = 'SetProductVariantKeyAction';
    /**
     * @var ?string
     */
    protected $type;
