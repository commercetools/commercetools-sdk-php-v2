 ...
 * @internal
 */
final class ChangeTransactionTimestampActionModel extends JsonObjectModel implements ChangeTransactionTimestampAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeTransactionTimestampAction';
    /**
     * @var ?string
     */
    protected $type;
