 ...
 * @internal
 */
final class SetTextLineItemCustomFieldActionModel extends JsonObjectModel implements SetTextLineItemCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'SetTextLineItemCustomFieldAction';
    /**
     * @var ?string
     */
    protected $type;
