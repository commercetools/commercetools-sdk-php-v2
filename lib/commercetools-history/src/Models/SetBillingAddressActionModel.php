 ...
 * @internal
 */
final class SetBillingAddressActionModel extends JsonObjectModel implements SetBillingAddressAction
{
    public const DISCRIMINATOR_VALUE = 'SetBillingAddressAction';
    /**
     * @var ?string
     */
    protected $type;
