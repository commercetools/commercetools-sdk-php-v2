 ...
 * @internal
 */
final class ChangeLocalizedEnumValueLabelActionModel extends JsonObjectModel implements ChangeLocalizedEnumValueLabelAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeLocalizedEnumValueLabelAction';
    /**
     * @var ?string
     */
    protected $type;
