 ...
 * @internal
 */
final class RemoveStateRolesActionModel extends JsonObjectModel implements RemoveStateRolesAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveStateRolesAction';
    /**
     * @var ?string
     */
    protected $type;
