 ...
 * @internal
 */
final class RemoveBillingAddressIdActionModel extends JsonObjectModel implements RemoveBillingAddressIdAction
{
    public const DISCRIMINATOR_VALUE = 'RemoveBillingAddressIdAction';
    /**
     * @var ?string
     */
    protected $type;
