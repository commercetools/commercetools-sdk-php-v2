...
/**
 * @implements Builder<AddOrderLineItemAction>
 */
final class AddOrderLineItemActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddOrderLineItemAction
    {
        return new AddOrderLineItemActionModel(
            $this->change,
    ...
    public static function of(): AddOrderLineItemActionBuilder
    {
        return new self();
    }
}
