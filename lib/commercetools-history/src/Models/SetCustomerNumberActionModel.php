 ...
 * @internal
 */
final class SetCustomerNumberActionModel extends JsonObjectModel implements SetCustomerNumberAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomerNumberAction';
    /**
     * @var ?string
     */
    protected $type;
