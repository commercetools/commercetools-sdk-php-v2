 ...
 * @internal
 */
final class ChangeTextLineItemNameActionModel extends JsonObjectModel implements ChangeTextLineItemNameAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeTextLineItemNameAction';
    /**
     * @var ?string
     */
    protected $type;
