...
/**
 * @implements Builder<SetPricesAction>
 */
final class SetPricesActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetPricesAction
    {
        return new SetPricesActionModel(
            $this->change,
            $this->catalogData,
            $this->variant,
            $this->previousValue,
    ...
    public static function of(): SetPricesActionBuilder
    {
        return new self();
    }
}
