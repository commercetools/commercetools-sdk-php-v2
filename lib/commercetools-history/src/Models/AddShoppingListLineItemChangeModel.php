 ...
 * @internal
 */
final class AddShoppingListLineItemChangeModel extends JsonObjectModel implements AddShoppingListLineItemChange
{
    public const DISCRIMINATOR_VALUE = 'AddShoppingListLineItemChange';
    /**
     * @var ?string
     */
    protected $type;
