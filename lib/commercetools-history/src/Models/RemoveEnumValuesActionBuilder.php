...
/**
 * @implements Builder<RemoveEnumValuesAction>
 */
final class RemoveEnumValuesActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): RemoveEnumValuesAction
    {
        return new RemoveEnumValuesActionModel(
            $this->change,
            $this->attributeName,
    ...
    public static function of(): RemoveEnumValuesActionBuilder
    {
        return new self();
    }
}
