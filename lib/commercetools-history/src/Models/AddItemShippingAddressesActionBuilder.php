...
/**
 * @implements Builder<AddItemShippingAddressesAction>
 */
final class AddItemShippingAddressesActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddItemShippingAddressesAction
    {
        return new AddItemShippingAddressesActionModel(
            $this->change,
    ...
    public static function of(): AddItemShippingAddressesActionBuilder
    {
        return new self();
    }
}
