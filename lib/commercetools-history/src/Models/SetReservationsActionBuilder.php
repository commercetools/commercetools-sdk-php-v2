...
/**
 * @implements Builder<SetReservationsAction>
 */
final class SetReservationsActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetReservationsAction
    {
        return new SetReservationsActionModel(
            $this->change,
            $this->nextValue,
            $this->previousValue
        );
    ...
    public static function of(): SetReservationsActionBuilder
    {
        return new self();
    }
}
