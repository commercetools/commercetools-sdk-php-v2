...
/**
 * @implements Builder<SetDeliveryItemsAction>
 */
final class SetDeliveryItemsActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDeliveryItemsAction
    {
        return new SetDeliveryItemsActionModel(
            $this->change,
            $this->deliveryId,
            $this->nextValue,
            $this->previousValue
    ...
    public static function of(): SetDeliveryItemsActionBuilder
    {
        return new self();
    }
}
