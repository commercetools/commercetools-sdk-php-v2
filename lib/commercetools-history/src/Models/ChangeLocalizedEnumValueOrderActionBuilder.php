...
/**
 * @implements Builder<ChangeLocalizedEnumValueOrderAction>
 */
final class ChangeLocalizedEnumValueOrderActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ChangeLocalizedEnumValueOrderAction
    {
        return new ChangeLocalizedEnumValueOrderActionModel(
            $this->change,
            $this->fieldName,
            $this->attributeName,
            $this->nextValue,
    ...
    public static function of(): ChangeLocalizedEnumValueOrderActionBuilder
    {
        return new self();
    }
}
