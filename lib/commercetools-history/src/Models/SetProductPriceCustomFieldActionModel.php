 ...
 * @internal
 */
final class SetProductPriceCustomFieldActionModel extends JsonObjectModel implements SetProductPriceCustomFieldAction
{
    public const DISCRIMINATOR_VALUE = 'SetProductPriceCustomFieldAction';
    /**
     * @var ?string
     */
    protected $type;
