...
/**
 * @implements Builder<SetDiscountedPriceAction>
 */
final class SetDiscountedPriceActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetDiscountedPriceAction
    {
        return new SetDiscountedPriceActionModel(
            $this->change,
            $this->catalogData,
            $this->variant,
            $this->priceId,
    ...
    public static function of(): SetDiscountedPriceActionBuilder
    {
        return new self();
    }
}
