 ...
 * @internal
 */
final class SetCustomLineItemTaxRateActionModel extends JsonObjectModel implements SetCustomLineItemTaxRateAction
{
    public const DISCRIMINATOR_VALUE = 'SetCustomLineItemTaxRateAction';
    /**
     * @var ?string
     */
    protected $type;
