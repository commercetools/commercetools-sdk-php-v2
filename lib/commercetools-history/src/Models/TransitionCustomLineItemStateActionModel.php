 ...
 * @internal
 */
final class TransitionCustomLineItemStateActionModel extends JsonObjectModel implements TransitionCustomLineItemStateAction
{
    public const DISCRIMINATOR_VALUE = 'TransitionCustomLineItemStateAction';
    /**
     * @var ?string
     */
    protected $type;
