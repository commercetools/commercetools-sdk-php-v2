 ...
 * @internal
 */
final class ChangeAttributeOrderByNameActionModel extends JsonObjectModel implements ChangeAttributeOrderByNameAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeAttributeOrderByNameAction';
    /**
     * @var ?string
     */
    protected $type;
