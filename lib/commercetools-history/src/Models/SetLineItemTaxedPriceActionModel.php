 ...
 * @internal
 */
final class SetLineItemTaxedPriceActionModel extends JsonObjectModel implements SetLineItemTaxedPriceAction
{
    public const DISCRIMINATOR_VALUE = 'SetLineItemTaxedPriceAction';
    /**
     * @var ?string
     */
    protected $type;
