 ...
 * @internal
 */
final class ChangeTransactionStateActionModel extends JsonObjectModel implements ChangeTransactionStateAction
{
    public const DISCRIMINATOR_VALUE = 'ChangeTransactionStateAction';
    /**
     * @var ?string
     */
    protected $type;
