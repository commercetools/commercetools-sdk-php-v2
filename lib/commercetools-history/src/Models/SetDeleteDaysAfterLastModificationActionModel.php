 ...
 * @internal
 */
final class SetDeleteDaysAfterLastModificationActionModel extends JsonObjectModel implements SetDeleteDaysAfterLastModificationAction
{
    public const DISCRIMINATOR_VALUE = 'SetDeleteDaysAfterLastModificationAction';
    /**
     * @var ?string
     */
    protected $type;
