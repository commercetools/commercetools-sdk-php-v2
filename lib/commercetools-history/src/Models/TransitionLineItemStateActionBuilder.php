...
/**
 * @implements Builder<TransitionLineItemStateAction>
 */
final class TransitionLineItemStateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): TransitionLineItemStateAction
    {
        return new TransitionLineItemStateActionModel(
            $this->change,
            $this->lineItemId,
            $this->stateId,
            $this->nextValue,
    ...
    public static function of(): TransitionLineItemStateActionBuilder
    {
        return new self();
    }
}
