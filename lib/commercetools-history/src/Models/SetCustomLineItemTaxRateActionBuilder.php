...
/**
 * @implements Builder<SetCustomLineItemTaxRateAction>
 */
final class SetCustomLineItemTaxRateActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetCustomLineItemTaxRateAction
    {
        return new SetCustomLineItemTaxRateActionModel(
            $this->change,
    ...
    public static function of(): SetCustomLineItemTaxRateActionBuilder
    {
        return new self();
    }
}
