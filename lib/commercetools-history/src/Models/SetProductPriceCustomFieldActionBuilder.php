...
/**
 * @implements Builder<SetProductPriceCustomFieldAction>
 */
final class SetProductPriceCustomFieldActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): SetProductPriceCustomFieldAction
    {
        return new SetProductPriceCustomFieldActionModel(
            $this->change,
            $this->catalogData,
    ...
    public static function of(): SetProductPriceCustomFieldActionBuilder
    {
        return new self();
    }
}
