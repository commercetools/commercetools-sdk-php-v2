 ...
 * @internal
 */
final class SetVariantAvailabilityActionModel extends JsonObjectModel implements SetVariantAvailabilityAction
{
    public const DISCRIMINATOR_VALUE = 'SetVariantAvailabilityAction';
    /**
     * @var ?string
     */
    protected $type;
