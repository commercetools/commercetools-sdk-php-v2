...
/**
 * @implements Builder<AddExternalImageAction>
 */
final class AddExternalImageActionBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): AddExternalImageAction
    {
        return new AddExternalImageActionModel(
            $this->change,
            $this->catalogData,
            $this->previousValue,
            $this->nextValue
    ...
    public static function of(): AddExternalImageActionBuilder
    {
        return new self();
    }
}
