...
use Commercetools\Api\Models\ProductType\ProductTypeDraftModel;
...
class ProductTypeFixture
{
    ...
    {
        $request = $builder->with()->productTypes()->withId($resource->getId())->delete()->withVersion($resource->getVersion());
