...
.PHONY: build_api_sdk build_import_sdk build_import_sdk build_ml_sdk gen_api_sdk gen_import_sdk gen_ml_sdk
...
parallel_gen_sdks: install_deps generate_base generate_api generate_import generate_ml

parallel_test_sdks_bc: install_deps parallel_gen_sdks
	vendor/bin/phpunit --testsuite=unit

parallel_gen_sdk_tests: install_deps parallel_test_sdks_bc parallel_generate_api_test parallel_generate_import_test parallel_generate_ml_test
